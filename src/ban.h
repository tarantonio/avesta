...
<head>
 ...
 var codesite_token = "ABZ6GAfAVKmx8dCCVeNeaO-MkORjdP5Eew:1406096221764";
 
 
 var CS_env = {"projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAfAVKmx8dCCVeNeaO-MkORjdP5Eew:1406096221764", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fban.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>ban.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/ban.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/ban.h?r=22" title="Previous">&lsaquo;r22</a></li>
...
><td class="source">#ifndef __OTSERV_BAN_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_BAN_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">struct LoginBlock{<br></td></tr
><tr
id=sl_svn102_31

><td class="source">	uint32_t lastLoginTime;<br></td></tr
><tr
id=sl_svn102_32

><td class="source">	uint32_t numberOfLogins;<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">struct ConnectBlock{<br></td></tr
><tr
id=sl_svn102_36

><td class="source">	uint64_t lastConnection;<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">typedef std::map&lt;uint32_t, LoginBlock &gt; IpLoginMap;<br></td></tr
><tr
id=sl_svn102_40

><td class="source">typedef std::map&lt;uint32_t, ConnectBlock &gt; IpConnectMap;<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">enum BanType_t{<br></td></tr
><tr
id=sl_svn102_43

><td class="source">	BANTYPE_IP_BANISHMENT = 1,<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	BANTYPE_NAMELOCK = 2,<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	BANTYPE_BANISHMENT = 3,<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	BANTYPE_NOTATION = 4,<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	BANTYPE_DELETION = 5<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">struct Ban {<br></td></tr
><tr
id=sl_svn102_51

><td class="source">	BanType_t type;<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	uint32_t id, added, expires, adminid;<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	std::string reason, comment, value, param;<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">class BanManager {<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">	BanManager();<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	void loadSettings();<br></td></tr
><tr
id=sl_svn102_62

><td class="source">	bool clearTemporaryBans();<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">	bool isIpBanished(uint32_t ip, uint32_t mask = 0xFFFFFFFF) const;<br></td></tr
><tr
id=sl_svn102_65

><td class="source">	bool isNameLocked(std::string name) const;<br></td></tr
><tr
id=sl_svn102_66

><td class="source">	bool isBanished(uint32_t account) const;<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	bool isDeleted(uint32_t account) const;<br></td></tr
><tr
id=sl_svn102_68

><td class="source">	bool isIpDisabled(uint32_t clientip) const;<br></td></tr
><tr
id=sl_svn102_69
...
><td class="source">	void addIpBanishment(uint32_t ip, uint32_t time, uint32_t adminId, std::string reason, std::string comment);<br></td></tr
><tr
id=sl_svn102_71

><td class="source">	void addNamelock(std::string name, uint32_t adminId, std::string reason, std::string comment);<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	void addBanishment(std::string name, uint32_t time, uint32_t adminId, std::string reason, std::string comment);<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	void addDeletion(std::string name, uint32_t adminId, std::string reason, std::string comment);<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	void addNotation(std::string name, uint32_t adminId, std::string reason, std::string comment);<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">	bool removeIpBanishment(uint32_t ip);<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	bool removeNamelock(std::string name);<br></td></tr
><tr
id=sl_svn102_78

><td class="source">	bool removeBanishment(std::string name);<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	bool removeDeletion(std::string name);<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	bool removeNotations(std::string name);<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">	bool acceptConnection(uint32_t clientip);<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	void addConnectionAttempt(uint32_t clientup);<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	void addLoginAttempt(uint32_t clientip, bool isSuccess);<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">	uint32_t getNotationsCount(uint32_t account);<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	std::vector&lt;Ban&gt; getBans(BanType_t type) const;<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	IpLoginMap ipLoginMap;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	IpConnectMap ipConnectMap;<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">	uint32_t loginTimeout;<br></td></tr
><tr
id=sl_svn102_94

><td class="source">	uint32_t maxLoginTries;<br></td></tr
><tr
id=sl_svn102_95

><td class="source">	uint32_t retryTimeout;<br></td></tr
><tr
id=sl_svn102_96
...
><td class="source">	mutable boost::recursive_mutex banLock;<br></td></tr
><tr
id=sl_svn102_98
...
><td class="source">	friend class IOBan;<br></td></tr
><tr
id=sl_svn102_100
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/ban.h&amp;old_path=/trunk/src/ban.h&amp;old=22">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/ban.h';
 ...
 <a href="/p/avesta74/source/detail?spec=svn102&r=22">r22</a>
 by RSXQ66
 on Sep 26, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=22&amp;format=side&amp;path=/trunk/src/ban.h&amp;old_path=/trunk/src/ban.h&amp;old=7">Diff</a>
 <br>
 <pre class="ifOpened">some fixes</pre>
 </div>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/ban.h&amp;old_path=/trunk/src/ban.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/ban.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/ban.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/ban.h'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAfAVKmx8dCCVeNeaO-MkORjdP5Eew:1406096221764", "domainName": null}, '', 'svn102', paths,
