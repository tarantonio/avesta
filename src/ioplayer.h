...
<head>
 ...
 var codesite_token = "ABZ6GAcQHZ6vKNVjshLjclhmjNymCMQHsg:1406096540913";
 
 
 var CS_env = {"relativeBaseUrl": "", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "token": "ABZ6GAcQHZ6vKNVjshLjclhmjNymCMQHsg:1406096540913", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fioplayer.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>ioplayer.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/ioplayer.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/ioplayer.h?r=37" title="Previous">&lsaquo;r37</a></li>
...
><td class="source">// Base class for the Player Loader/Saver<br></td></tr
><tr
id=sl_svn102_5
...
><td class="source">#ifndef __IOPLAYER_H<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __IOPLAYER_H<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">class PlayerGroup<br></td></tr
><tr
id=sl_svn102_31
...
><td class="source">	PlayerGroup(){};<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">	uint64_t m_flags;<br></td></tr
><tr
id=sl_svn102_38

><td class="source">	uint32_t m_access;<br></td></tr
><tr
id=sl_svn102_39

><td class="source">	uint32_t m_maxDepotItems;<br></td></tr
><tr
id=sl_svn102_40

><td class="source">	uint32_t m_maxVip;<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">typedef std::pair&lt;int32_t, Item*&gt; itemBlock;<br></td></tr
><tr
id=sl_svn102_44

><td class="source">typedef std::list&lt;itemBlock&gt; ItemBlockList;<br></td></tr
><tr
id=sl_svn102_45
...
><td class="source">/** Class responsible for loading players from database. */<br></td></tr
><tr
id=sl_svn102_47

><td class="source">class IOPlayer {<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">	IOPlayer() {}<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	static IOPlayer* instance()<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">	/** Load a player<br></td></tr
><tr
id=sl_svn102_59

><td class="source">	  * \param player Player structure to load to<br></td></tr
><tr
id=sl_svn102_60

><td class="source">	  * \param name Name of the player<br></td></tr
><tr
id=sl_svn102_61

><td class="source">	  * \param preload if set to true only group, guid and account id will be loaded, default: false<br></td></tr
><tr
id=sl_svn102_62

><td class="source">	  * \return returns true if the player was successfully loaded<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">	bool loadPlayer(Player* player, const std::string&amp; name, bool preload = false);<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	/** Save a player<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	  * \param player the player to save<br></td></tr
><tr
id=sl_svn102_68

><td class="source">	  * \return true if the player was successfully saved<br></td></tr
><tr
id=sl_svn102_69
...
><td class="source">	bool savePlayer(Player* player);<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">	//bool loadDepot(Player* player, unsigned long depotId);<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">	bool getGuidByName(uint32_t&amp; guid, std::string&amp; name);<br></td></tr
><tr
id=sl_svn102_75

><td class="source">	uint32_t getAccountIdByName(std::string&amp; name);<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	bool getGuidByNameEx(uint32_t&amp; guid, bool&amp; specialVip, std::string&amp; name);<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	bool getNameByGuid(uint32_t guid, std::string&amp; name);<br></td></tr
><tr
id=sl_svn102_78

><td class="source">	bool getGuildIdByName(uint32_t&amp; guildId, const std::string&amp; guildName);<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	bool playerExists(std::string name);<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	uint32_t getLastIP(std::string name) const;<br></td></tr
><tr
id=sl_svn102_81

><td class="source">	void saveDeath(std::string name, uint32_t time, uint16_t level, std::string killer, std::string altKiller);<br></td></tr
><tr
id=sl_svn102_82
...
><td class="source">	bool hasFlag(std::string name, PlayerFlags value);<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	uint32_t getAccessByName(std::string name);<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">	bool storeNameByGuid(Database &amp;mysql, uint32_t guid);<br></td></tr
><tr
id=sl_svn102_88
...
><td class="source">	const PlayerGroup* getPlayerGroup(uint32_t groupid);<br></td></tr
><tr
id=sl_svn102_90

><td class="source">	bool internalHasFlag(uint32_t groupId, PlayerFlags value);<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">	struct StringCompareCase<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">		bool operator()(const std::string&amp; l, const std::string&amp; r) const<br></td></tr
><tr
id=sl_svn102_95
...
><td class="source">			return asLowerCaseString(l).compare(asLowerCaseString(r)) &lt; 0;<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">	typedef std::map&lt;int,std::pair&lt;Item*,int&gt; &gt; ItemMap;<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">	void loadItems(ItemMap&amp; itemMap, DBResult* result);<br></td></tr
><tr
id=sl_svn102_103

><td class="source">	bool saveItems(Player* player, const ItemBlockList&amp; itemList, DBInsert&amp; query_insert);<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	typedef std::map&lt;uint32_t, std::string&gt; NameCacheMap;<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	typedef std::map&lt;std::string, uint32_t, StringCompareCase&gt; GuidCacheMap;<br></td></tr
><tr
id=sl_svn102_107

><td class="source">	typedef std::map&lt;uint32_t, PlayerGroup*&gt; PlayerGroupMap;<br></td></tr
><tr
id=sl_svn102_108
...
><td class="source">	PlayerGroupMap playerGroupMap;<br></td></tr
><tr
id=sl_svn102_110

><td class="source">	NameCacheMap nameCacheMap;<br></td></tr
><tr
id=sl_svn102_111

><td class="source">	GuidCacheMap guidCacheMap;<br></td></tr
><tr
id=sl_svn102_112
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/ioplayer.h&amp;old_path=/trunk/src/ioplayer.h&amp;old=37">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/ioplayer.h';
 ...
 by r...@ymail.com
 on Apr 9, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=37&amp;format=side&amp;path=/trunk/src/ioplayer.h&amp;old_path=/trunk/src/ioplayer.h&amp;old=7">Diff</a>
 <br>
...
rope with pool on rope spot fix</pre>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/ioplayer.h&amp;old_path=/trunk/src/ioplayer.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/ioplayer.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/ioplayer.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/ioplayer.h'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl": "", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "token": "ABZ6GAcQHZ6vKNVjshLjclhmjNymCMQHsg:1406096540913", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com"}, '', 'svn102', paths,
