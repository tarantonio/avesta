...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fitem.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>item.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/item.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/item.cpp?r=96" title="Previous">&lsaquo;r96</a></li>
...
><td class="source">// Represents an item<br></td></tr
><tr
id=sl_svn102_5
...
><td class="source">#include &quot;teleport.h&quot;<br></td></tr
><tr
id=sl_svn102_27

><td class="source">#include &quot;trashholder.h&quot;<br></td></tr
><tr
id=sl_svn102_28

><td class="source">#include &quot;mailbox.h&quot;<br></td></tr
><tr
id=sl_svn102_29
...
><td class="source">Items Item::items;<br></td></tr
><tr
id=sl_svn102_45
...
><td class="source">Item* Item::CreateItem(const uint16_t _type, uint16_t _count /*= 1*/)<br></td></tr
><tr
id=sl_svn102_47
...
><td class="source">	const ItemType&amp; it = Item::items[_type];<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">		if(it.isDepot()){<br></td></tr
><tr
id=sl_svn102_54

><td class="source">			newItem = new Depot(_type);<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">		else if(it.isContainer()){<br></td></tr
><tr
id=sl_svn102_57

><td class="source">			newItem = new Container(_type);<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">		else if(it.isTeleport()){<br></td></tr
><tr
id=sl_svn102_60

><td class="source">			newItem = new Teleport(_type);<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">		else if(it.isMagicField()){<br></td></tr
><tr
id=sl_svn102_63

><td class="source">			newItem = new MagicField(_type);<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">		else if(it.isDoor()){<br></td></tr
><tr
id=sl_svn102_66

><td class="source">			newItem = new Door(_type);<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">		else if(it.isTrashHolder()){<br></td></tr
><tr
id=sl_svn102_69

><td class="source">			newItem = new TrashHolder(_type, it.magicEffect);<br></td></tr
><tr
id=sl_svn102_70
...
><td class="source">		else if(it.isMailbox()){<br></td></tr
><tr
id=sl_svn102_72

><td class="source">			newItem = new Mailbox(_type);<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">		else if(it.isBed()){<br></td></tr
><tr
id=sl_svn102_76

><td class="source">			newItem = new BedItem(_type);<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">			newItem = new Item(_type, _count);<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">		newItem-&gt;useThing2();<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">Item* Item::CreateItem(PropStream&amp; propStream)<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	uint16_t _id;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	if(!propStream.GET_UINT16(_id)){<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">	const ItemType&amp; iType = Item::items[_id];<br></td></tr
><tr
id=sl_svn102_96

><td class="source">	uint8_t _count = 0;<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">	if(iType.stackable || iType.isSplash() || iType.isFluidContainer()){<br></td></tr
><tr
id=sl_svn102_99

><td class="source">		if(!propStream.GET_UINT8(_count)){<br></td></tr
><tr
id=sl_svn102_100
...
><td class="source">	return Item::CreateItem(_id, _count);<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">Item::Item(const uint16_t _type, uint16_t _count /*= 0*/) :<br></td></tr
><tr
id=sl_svn102_108

><td class="source">	ItemAttributes()<br></td></tr
><tr
id=sl_svn102_109
...
><td class="source">	id = _type;<br></td></tr
><tr
id=sl_svn102_111
...
><td class="source">	const ItemType&amp; it = items[id];<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">	if(it.charges != 0){<br></td></tr
><tr
id=sl_svn102_116

><td class="source">		setCharges(it.charges);<br></td></tr
><tr
id=sl_svn102_117
...
><td class="source">	if(it.isFluidContainer() || it.isSplash()){<br></td></tr
><tr
id=sl_svn102_120

><td class="source">		setFluidType(_count);<br></td></tr
><tr
id=sl_svn102_121
...
><td class="source">	else if(it.stackable &amp;&amp; _count != 0){<br></td></tr
><tr
id=sl_svn102_123

><td class="source">		count = _count;<br></td></tr
><tr
id=sl_svn102_124
...
><td class="source">	else if(it.charges != 0 &amp;&amp; _count != 0){<br></td></tr
><tr
id=sl_svn102_126

><td class="source">		setCharges(_count);<br></td></tr
><tr
id=sl_svn102_127
...
><td class="source">	setDefaultDuration();<br></td></tr
><tr
id=sl_svn102_130

><td class="source">	loadedOnMap = false;<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">Item::Item(const Item &amp;i) :<br></td></tr
><tr
id=sl_svn102_134

><td class="source">	Thing(), ItemAttributes()<br></td></tr
><tr
id=sl_svn102_135
...
><td class="source">	//std::cout &lt;&lt; &quot;Item copy constructor &quot; &lt;&lt; this &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_137

><td class="source">	id = i.id;<br></td></tr
><tr
id=sl_svn102_138

><td class="source">	count = i.count;<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">	m_attributes = i.m_attributes;<br></td></tr
><tr
id=sl_svn102_141

><td class="source">	if(i.m_firstAttr){<br></td></tr
><tr
id=sl_svn102_142

><td class="source">		m_firstAttr = new Attribute(*i.m_firstAttr);<br></td></tr
><tr
id=sl_svn102_143
...
><td class="source">Item* Item::clone() const<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">	Item* _item = Item::CreateItem(id, count);<br></td></tr
><tr
id=sl_svn102_151

><td class="source">	_item-&gt;m_attributes = m_attributes;<br></td></tr
><tr
id=sl_svn102_152

><td class="source">	if(m_firstAttr){<br></td></tr
><tr
id=sl_svn102_153

><td class="source">		_item-&gt;m_firstAttr = new Attribute(*m_firstAttr);<br></td></tr
><tr
id=sl_svn102_154
...
><td class="source">void Item::copyAttributes(Item* item)<br></td></tr
><tr
id=sl_svn102_160
...
><td class="source">	m_attributes = item-&gt;m_attributes;<br></td></tr
><tr
id=sl_svn102_162

><td class="source">	if(item-&gt;m_firstAttr){<br></td></tr
><tr
id=sl_svn102_163

><td class="source">		m_firstAttr = new Attribute(*item-&gt;m_firstAttr);<br></td></tr
><tr
id=sl_svn102_164
...
><td class="source">	removeAttribute(ATTR_ITEM_DECAYING);<br></td></tr
><tr
id=sl_svn102_167

><td class="source">	removeAttribute(ATTR_ITEM_DURATION);<br></td></tr
><tr
id=sl_svn102_168
...
><td class="source">	//std::cout &lt;&lt; &quot;Item destructor &quot; &lt;&lt; this &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_173
...
><td class="source">	if(getUniqueId() != 0){<br></td></tr
><tr
id=sl_svn102_175

><td class="source">		ScriptEnviroment::removeUniqueThing(this);<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">void Item::setDefaultSubtype()<br></td></tr
><tr
id=sl_svn102_180
...
><td class="source">void Item::setID(uint16_t newid)<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">	const ItemType&amp; prevIt = Item::items[id];<br></td></tr
><tr
id=sl_svn102_192

><td class="source">	id = newid;<br></td></tr
><tr
id=sl_svn102_193
...
><td class="source">	const ItemType&amp; it = Item::items[newid];<br></td></tr
><tr
id=sl_svn102_195

><td class="source">	uint32_t newDuration = it.decayTime * 1000;<br></td></tr
><tr
id=sl_svn102_196
...
><td class="source">	if(newDuration == 0 &amp;&amp; !it.stopTime &amp;&amp; it.decayTo == -1){<br></td></tr
><tr
id=sl_svn102_198
...
><td class="source">	if(newDuration &gt; 0 &amp;&amp; (!prevIt.stopTime || !hasAttribute(ATTR_ITEM_DURATION)) ){<br></td></tr
><tr
id=sl_svn102_203

><td class="source">		setDecaying(DECAYING_FALSE);<br></td></tr
><tr
id=sl_svn102_204

><td class="source">		setDuration(newDuration);<br></td></tr
><tr
id=sl_svn102_205
...
><td class="source">bool Item::hasSubType() const<br></td></tr
><tr
id=sl_svn102_209
...
><td class="source">	return it.hasSubType();<br></td></tr
><tr
id=sl_svn102_212
...
><td class="source">uint16_t Item::getSubType() const<br></td></tr
><tr
id=sl_svn102_215
...
><td class="source">		return getFluidType();<br></td></tr
><tr
id=sl_svn102_220
...
><td class="source">	else if(it.charges != 0){<br></td></tr
><tr
id=sl_svn102_222

><td class="source">		return getCharges();<br></td></tr
><tr
id=sl_svn102_223
...
><td class="source">Player* Item::getHoldingPlayer()<br></td></tr
><tr
id=sl_svn102_229
...
><td class="source">	Cylinder* p = getParent();<br></td></tr
><tr
id=sl_svn102_231
...
><td class="source">		if(p-&gt;getCreature())<br></td></tr
><tr
id=sl_svn102_233

><td class="source">			// Must be a player, creatures are not cylinders<br></td></tr
><tr
id=sl_svn102_234

><td class="source">			return p-&gt;getCreature()-&gt;getPlayer();<br></td></tr
><tr
id=sl_svn102_235

><td class="source">		p = p-&gt;getParent();<br></td></tr
><tr
id=sl_svn102_236
...
><td class="source">const Player* Item::getHoldingPlayer() const<br></td></tr
><tr
id=sl_svn102_242
...
><td class="source">	return const_cast&lt;Item*&gt;(this)-&gt;getHoldingPlayer();<br></td></tr
><tr
id=sl_svn102_244
...
><td class="source">void Item::setSubType(uint16_t n)<br></td></tr
><tr
id=sl_svn102_247
...
><td class="source">		setFluidType(n);<br></td></tr
><tr
id=sl_svn102_252
...
><td class="source">		setCharges(n);<br></td></tr
><tr
id=sl_svn102_255
...
><td class="source">		count = n;<br></td></tr
><tr
id=sl_svn102_258
...
><td class="source">Attr_ReadValue Item::readAttr(AttrTypes_t attr, PropStream&amp; propStream)<br></td></tr
><tr
id=sl_svn102_262
...
><td class="source">		case ATTR_COUNT:<br></td></tr
><tr
id=sl_svn102_265
...
><td class="source">			setSubType(_count);<br></td></tr
><tr
id=sl_svn102_272
...
><td class="source">		case ATTR_ACTION_ID:<br></td></tr
><tr
id=sl_svn102_276
...
><td class="source">			uint16_t _actionid = 0;<br></td></tr
><tr
id=sl_svn102_278

><td class="source">			if(!propStream.GET_UINT16(_actionid)){<br></td></tr
><tr
id=sl_svn102_279
...
><td class="source">			setActionId(_actionid);<br></td></tr
><tr
id=sl_svn102_283
...
><td class="source">		case ATTR_UNIQUE_ID:<br></td></tr
><tr
id=sl_svn102_287
...
><td class="source">			uint16_t _uniqueid;<br></td></tr
><tr
id=sl_svn102_289

><td class="source">			if(!propStream.GET_UINT16(_uniqueid)){<br></td></tr
><tr
id=sl_svn102_290
...
><td class="source">			setUniqueId(_uniqueid);<br></td></tr
><tr
id=sl_svn102_294
...
><td class="source">		case ATTR_TEXT:<br></td></tr
><tr
id=sl_svn102_298
...
><td class="source">			std::string _text;<br></td></tr
><tr
id=sl_svn102_300

><td class="source">			if(!propStream.GET_STRING(_text)){<br></td></tr
><tr
id=sl_svn102_301
...
><td class="source">			setText(_text);<br></td></tr
><tr
id=sl_svn102_305
...
><td class="source">		case ATTR_WRITTENBY:<br></td></tr
><tr
id=sl_svn102_309
...
><td class="source">			std::string _writer;<br></td></tr
><tr
id=sl_svn102_311

><td class="source">			if(!propStream.GET_STRING(_writer)){<br></td></tr
><tr
id=sl_svn102_312
...
><td class="source">			setWriter(_writer);<br></td></tr
><tr
id=sl_svn102_316
...
><td class="source">		case ATTR_DESC:<br></td></tr
><tr
id=sl_svn102_320
...
><td class="source">			setSpecialDescription(_text);<br></td></tr
><tr
id=sl_svn102_327
...
><td class="source">		case ATTR_RUNE_CHARGES:<br></td></tr
><tr
id=sl_svn102_331
...
><td class="source">			uint8_t _charges = 1;<br></td></tr
><tr
id=sl_svn102_333

><td class="source">			if(!propStream.GET_UINT8(_charges)){<br></td></tr
><tr
id=sl_svn102_334
...
><td class="source">			setSubType(_charges);<br></td></tr
><tr
id=sl_svn102_338
...
><td class="source">		case ATTR_DURATION:<br></td></tr
><tr
id=sl_svn102_342
...
><td class="source">			uint32_t duration = 0;<br></td></tr
><tr
id=sl_svn102_344

><td class="source">			if(!propStream.GET_UINT32(duration)){<br></td></tr
><tr
id=sl_svn102_345
...
><td class="source">			if(((int32_t)duration) &lt; 0){<br></td></tr
><tr
id=sl_svn102_349

><td class="source">				duration = 0;<br></td></tr
><tr
id=sl_svn102_350
...
><td class="source">			setDuration(duration);<br></td></tr
><tr
id=sl_svn102_352
...
><td class="source">		case ATTR_DECAYING_STATE:<br></td></tr
><tr
id=sl_svn102_356
...
><td class="source">			uint8_t state = 0;<br></td></tr
><tr
id=sl_svn102_358

><td class="source">			if(!propStream.GET_UINT8(state)){<br></td></tr
><tr
id=sl_svn102_359
...
><td class="source">			if(state != DECAYING_FALSE){<br></td></tr
><tr
id=sl_svn102_363

><td class="source">				setDecaying(DECAYING_PENDING);<br></td></tr
><tr
id=sl_svn102_364
...
><td class="source">		//these should be handled through derived classes<br></td></tr
><tr
id=sl_svn102_369

><td class="source">		//If these are called then something has changed in the items.otb since the map was saved<br></td></tr
><tr
id=sl_svn102_370

><td class="source">		//just read the values<br></td></tr
><tr
id=sl_svn102_371
...
><td class="source">		//Depot class<br></td></tr
><tr
id=sl_svn102_373

><td class="source">		case ATTR_DEPOT_ID:<br></td></tr
><tr
id=sl_svn102_374
...
><td class="source">		//Door class<br></td></tr
><tr
id=sl_svn102_384

><td class="source">		case ATTR_HOUSEDOORID:<br></td></tr
><tr
id=sl_svn102_385
...
><td class="source">			uint8_t _doorId;<br></td></tr
><tr
id=sl_svn102_387

><td class="source">			if(!propStream.GET_UINT8(_doorId)){<br></td></tr
><tr
id=sl_svn102_388
...
><td class="source">		//Bed class<br></td></tr
><tr
id=sl_svn102_395
...
><td class="source">		// Teleport class<br></td></tr
><tr
id=sl_svn102_416

><td class="source">		case ATTR_TELE_DEST:<br></td></tr
><tr
id=sl_svn102_417
...
><td class="source">			TeleportDest tele_dest;<br></td></tr
><tr
id=sl_svn102_419

><td class="source">			if(		!propStream.GET_UINT16(tele_dest._x) ||<br></td></tr
><tr
id=sl_svn102_420

><td class="source">					!propStream.GET_UINT16(tele_dest._y) ||<br></td></tr
><tr
id=sl_svn102_421

><td class="source">					!propStream.GET_UINT8(tele_dest._z))<br></td></tr
><tr
id=sl_svn102_422
...
><td class="source">		// Container class<br></td></tr
><tr
id=sl_svn102_430
...
><td class="source">			//We cant continue parse attributes since there is<br></td></tr
><tr
id=sl_svn102_438

><td class="source">			//container data after this attribute.<br></td></tr
><tr
id=sl_svn102_439
...
><td class="source">			std::cout &lt;&lt; &quot;attr=&quot; &lt;&lt; attr &lt;&lt;&quot;\n&quot;;<br></td></tr
><tr
id=sl_svn102_444
...
><td class="source">bool Item::unserializeAttr(PropStream&amp; propStream)<br></td></tr
><tr
id=sl_svn102_451
...
><td class="source">	while(propStream.GET_UINT8(attr_type) &amp;&amp; attr_type != 0){<br></td></tr
><tr
id=sl_svn102_454

><td class="source">		Attr_ReadValue ret = readAttr((AttrTypes_t)attr_type, propStream);<br></td></tr
><tr
id=sl_svn102_455

><td class="source">		if(ret == ATTR_READ_ERROR){<br></td></tr
><tr
id=sl_svn102_456
...
><td class="source">		else if(ret == ATTR_READ_END){<br></td></tr
><tr
id=sl_svn102_459
...
><td class="source">bool Item::unserializeItemNode(FileLoader&amp; f, NODE node, PropStream&amp; propStream)<br></td></tr
><tr
id=sl_svn102_467
...
><td class="source">	return unserializeAttr(propStream);<br></td></tr
><tr
id=sl_svn102_469
...
><td class="source">bool Item::serializeAttr(PropWriteStream&amp; propWriteStream) const<br></td></tr
><tr
id=sl_svn102_472
...
><td class="source">	if(isStackable() || isSplash() || isFluidContainer()){<br></td></tr
><tr
id=sl_svn102_474

><td class="source">		uint8_t _count = getSubType();<br></td></tr
><tr
id=sl_svn102_475

><td class="source">		propWriteStream.ADD_UINT8(ATTR_COUNT);<br></td></tr
><tr
id=sl_svn102_476

><td class="source">		propWriteStream.ADD_UINT8(_count);<br></td></tr
><tr
id=sl_svn102_477
...
><td class="source">	if(hasCharges()){<br></td></tr
><tr
id=sl_svn102_480

><td class="source">		uint8_t _count = getCharges();<br></td></tr
><tr
id=sl_svn102_481

><td class="source">		propWriteStream.ADD_UINT8(ATTR_RUNE_CHARGES);<br></td></tr
><tr
id=sl_svn102_482
...
><td class="source">	if(!isNotMoveable() /*moveable*/){<br></td></tr
><tr
id=sl_svn102_486

><td class="source">		uint16_t _actionId = getActionId();<br></td></tr
><tr
id=sl_svn102_487

><td class="source">		if(_actionId){<br></td></tr
><tr
id=sl_svn102_488

><td class="source">			propWriteStream.ADD_UINT8(ATTR_ACTION_ID);<br></td></tr
><tr
id=sl_svn102_489

><td class="source">			propWriteStream.ADD_UINT16(_actionId);<br></td></tr
><tr
id=sl_svn102_490
...
><td class="source">	const std::string&amp; _text = getText();<br></td></tr
><tr
id=sl_svn102_494

><td class="source">	if(_text.length() &gt; 0){<br></td></tr
><tr
id=sl_svn102_495

><td class="source">		propWriteStream.ADD_UINT8(ATTR_TEXT);<br></td></tr
><tr
id=sl_svn102_496

><td class="source">		propWriteStream.ADD_STRING(_text);<br></td></tr
><tr
id=sl_svn102_497
...
><td class="source">	const std::string&amp; _writer = getWriter();<br></td></tr
><tr
id=sl_svn102_500

><td class="source">	if(_writer.length() &gt; 0){<br></td></tr
><tr
id=sl_svn102_501

><td class="source">		propWriteStream.ADD_UINT8(ATTR_WRITTENBY);<br></td></tr
><tr
id=sl_svn102_502

><td class="source">		propWriteStream.ADD_STRING(_writer);<br></td></tr
><tr
id=sl_svn102_503
...
><td class="source">	const std::string&amp; _specialDesc = getSpecialDescription();<br></td></tr
><tr
id=sl_svn102_506

><td class="source">	if(_specialDesc.length() &gt; 0){<br></td></tr
><tr
id=sl_svn102_507

><td class="source">		propWriteStream.ADD_UINT8(ATTR_DESC);<br></td></tr
><tr
id=sl_svn102_508

><td class="source">		propWriteStream.ADD_STRING(_specialDesc);<br></td></tr
><tr
id=sl_svn102_509
...
><td class="source">	uint32_t duration = getDuration();<br></td></tr
><tr
id=sl_svn102_512

><td class="source">	if(duration != 0){<br></td></tr
><tr
id=sl_svn102_513

><td class="source">		propWriteStream.ADD_UINT8(ATTR_DURATION);<br></td></tr
><tr
id=sl_svn102_514

><td class="source">		propWriteStream.ADD_UINT32(duration);<br></td></tr
><tr
id=sl_svn102_515
...
><td class="source">	uint32_t decayState = getDecaying();<br></td></tr
><tr
id=sl_svn102_518

><td class="source">	if(decayState == DECAYING_TRUE || decayState == DECAYING_PENDING){<br></td></tr
><tr
id=sl_svn102_519

><td class="source">		propWriteStream.ADD_UINT8(ATTR_DECAYING_STATE);<br></td></tr
><tr
id=sl_svn102_520

><td class="source">		propWriteStream.ADD_UINT8(decayState);<br></td></tr
><tr
id=sl_svn102_521
...
><td class="source">bool Item::hasProperty(enum ITEMPROPERTY prop) const<br></td></tr
><tr
id=sl_svn102_527
...
><td class="source">		case BLOCKSOLID:<br></td></tr
><tr
id=sl_svn102_532
...
><td class="source">		case MOVEABLE:<br></td></tr
><tr
id=sl_svn102_537

><td class="source">			if(it.moveable &amp;&amp; getUniqueId() == 0)<br></td></tr
><tr
id=sl_svn102_538
...
><td class="source">		case HASHEIGHT:<br></td></tr
><tr
id=sl_svn102_542

><td class="source">			if(it.hasHeight)<br></td></tr
><tr
id=sl_svn102_543
...
><td class="source">		case BLOCKPROJECTILE:<br></td></tr
><tr
id=sl_svn102_547

><td class="source">			if(it.blockProjectile)<br></td></tr
><tr
id=sl_svn102_548
...
><td class="source">		case BLOCKPATH:<br></td></tr
><tr
id=sl_svn102_552

><td class="source">			if(it.blockPathFind)<br></td></tr
><tr
id=sl_svn102_553
...
><td class="source">		case ISVERTICAL:<br></td></tr
><tr
id=sl_svn102_557

><td class="source">			if(it.isVertical)<br></td></tr
><tr
id=sl_svn102_558
...
><td class="source">		case ISHORIZONTAL:<br></td></tr
><tr
id=sl_svn102_562

><td class="source">			if(it.isHorizontal)<br></td></tr
><tr
id=sl_svn102_563
...
><td class="source">		case IMMOVABLEBLOCKSOLID:<br></td></tr
><tr
id=sl_svn102_567

><td class="source">			if(it.blockSolid &amp;&amp; (!it.moveable || getUniqueId() != 0))<br></td></tr
><tr
id=sl_svn102_568
...
><td class="source">		case IMMOVABLEBLOCKPATH:<br></td></tr
><tr
id=sl_svn102_572

><td class="source">            if(it.blockPathFind &amp;&amp; (!it.moveable || getUniqueId() != 0))<br></td></tr
><tr
id=sl_svn102_573
...
><td class="source">		case SUPPORTHANGABLE:<br></td></tr
><tr
id=sl_svn102_577

><td class="source">            if(it.isHorizontal || it.isVertical)<br></td></tr
><tr
id=sl_svn102_578
...
><td class="source">        case IMMOVABLENOFIELDBLOCKPATH:<br></td></tr
><tr
id=sl_svn102_582

><td class="source">            if(!it.isMagicField() &amp;&amp; it.blockPathFind &amp;&amp; (!it.moveable || getUniqueId() != 0))<br></td></tr
><tr
id=sl_svn102_583
...
><td class="source">        case NOFIELDBLOCKPATH:<br></td></tr
><tr
id=sl_svn102_587

><td class="source">            if(!it.isMagicField() &amp;&amp; it.blockPathFind)<br></td></tr
><tr
id=sl_svn102_588
...
><td class="source">double Item::getWeight() const<br></td></tr
><tr
id=sl_svn102_598
...
><td class="source">	if(isStackable()){<br></td></tr
><tr
id=sl_svn102_600

><td class="source">		return items[id].weight * std::max((int32_t)1, (int32_t)count);<br></td></tr
><tr
id=sl_svn102_601
...
><td class="source">	return items[id].weight;<br></td></tr
><tr
id=sl_svn102_604
...
><td class="source">std::string Item::getDescription(const ItemType&amp; it, int32_t lookDistance,<br></td></tr
><tr
id=sl_svn102_607

><td class="source">	const Item* item /*= NULL*/, int32_t subType /*= -1*/)<br></td></tr
><tr
id=sl_svn102_608
...
><td class="source">		subType = item-&gt;getSubType();<br></td></tr
><tr
id=sl_svn102_613
...
><td class="source">	if(it.name.length()){<br></td></tr
><tr
id=sl_svn102_616

><td class="source">		if(it.stackable &amp;&amp; item &amp;&amp; item-&gt;getItemCount() &gt; 1){<br></td></tr
><tr
id=sl_svn102_617

><td class="source">			if(it.showCount){<br></td></tr
><tr
id=sl_svn102_618

><td class="source">				s &lt;&lt; (int)item-&gt;getItemCount() &lt;&lt; &quot; &quot;;<br></td></tr
><tr
id=sl_svn102_619
...
><td class="source">			s &lt;&lt; it.pluralName;<br></td></tr
><tr
id=sl_svn102_622
...
><td class="source">			if(!it.article.empty()){<br></td></tr
><tr
id=sl_svn102_625

><td class="source">				s &lt;&lt; it.article &lt;&lt; &quot; &quot;;<br></td></tr
><tr
id=sl_svn102_626
...
><td class="source">			s &lt;&lt; it.name;<br></td></tr
><tr
id=sl_svn102_628
...
><td class="source">		s &lt;&lt; &quot;an item of type &quot; &lt;&lt; it.id;<br></td></tr
><tr
id=sl_svn102_632
...
><td class="source">	if(it.isRune()){<br></td></tr
><tr
id=sl_svn102_635

><td class="source">		uint32_t charges = std::max((uint32_t)1, (uint32_t)(item == NULL ? it.charges : item-&gt;getCharges()));<br></td></tr
><tr
id=sl_svn102_636
...
><td class="source">		if(it.runeLevel &gt; 0 || it.runeMagLevel &gt; 0){<br></td></tr
><tr
id=sl_svn102_638

><td class="source">			if(it.runeLevel &gt; 0){<br></td></tr
><tr
id=sl_svn102_639

><td class="source">				s &lt;&lt; &quot; for level &quot; &lt;&lt; it.runeLevel;<br></td></tr
><tr
id=sl_svn102_640
...
><td class="source">			if(it.runeMagLevel &gt; 0){<br></td></tr
><tr
id=sl_svn102_642
...
><td class="source">					s &lt;&lt; &quot; and&quot;;<br></td></tr
><tr
id=sl_svn102_644
...
><td class="source">				s &lt;&lt; &quot; for magic level &quot; &lt;&lt; it.runeMagLevel;<br></td></tr
><tr
id=sl_svn102_646
...
><td class="source">		s &lt;&lt; &quot;. It&#39;s &quot; &lt;&lt; it.article &lt;&lt; &quot; \&quot;&quot; &lt;&lt; it.runeSpellName &lt;&lt; &quot;\&quot;-spell (&quot; &lt;&lt; charges &lt;&lt; &quot;x). &quot;;<br></td></tr
><tr
id=sl_svn102_649
...
><td class="source">	else if(it.weaponType != WEAPON_NONE){<br></td></tr
><tr
id=sl_svn102_651

><td class="source">		if(it.weaponType == WEAPON_DIST &amp;&amp; it.amuType != AMMO_NONE){<br></td></tr
><tr
id=sl_svn102_652

><td class="source">			if(it.attack != 0){<br></td></tr
><tr
id=sl_svn102_653

><td class="source">				s &lt;&lt; &quot;, Atk&quot; &lt;&lt; std::showpos &lt;&lt; it.attack &lt;&lt; std::noshowpos;<br></td></tr
><tr
id=sl_svn102_654
...
><td class="source">		else if(it.weaponType != WEAPON_AMMO &amp;&amp; it.weaponType != WEAPON_WAND){ // Arrows and Bolts doesn&#39;t show atk<br></td></tr
><tr
id=sl_svn102_657
...
><td class="source">				s &lt;&lt; &quot;Atk:&quot; &lt;&lt; (int)it.attack;<br></td></tr
><tr
id=sl_svn102_660
...
><td class="source">			if(it.defense != 0){<br></td></tr
><tr
id=sl_svn102_663
...
><td class="source">				s &lt;&lt; &quot;Def:&quot; &lt;&lt; (int)it.defense;<br></td></tr
><tr
id=sl_svn102_667
...
><td class="source">			if(it.abilities.stats[STAT_MAGICPOINTS] != 0){<br></td></tr
><tr
id=sl_svn102_670

><td class="source">				if(it.attack != 0 || it.defense != 0)<br></td></tr
><tr
id=sl_svn102_671
...
><td class="source">				s &lt;&lt; &quot;magic level &quot; &lt;&lt; std::showpos &lt;&lt; (int)it.abilities.stats[STAT_MAGICPOINTS] &lt;&lt; std::noshowpos;<br></td></tr
><tr
id=sl_svn102_674
...
><td class="source">	else if(it.armor != 0 || it.abilities.absorb.any()){<br></td></tr
><tr
id=sl_svn102_680

><td class="source">		if(it.showCharges){<br></td></tr
><tr
id=sl_svn102_681

><td class="source">			if(subType &gt; 1){<br></td></tr
><tr
id=sl_svn102_682

><td class="source">				s &lt;&lt; &quot; that has &quot; &lt;&lt; (int32_t)subType &lt;&lt; &quot; charges left&quot;;<br></td></tr
><tr
id=sl_svn102_683
...
><td class="source">				s &lt;&lt; &quot; that has 1 charge left&quot;;<br></td></tr
><tr
id=sl_svn102_686
...
><td class="source">		s &lt;&lt; &quot; (Arm:&quot; &lt;&lt; it.armor &lt;&lt; &quot;).&quot;;<br></td></tr
><tr
id=sl_svn102_690
...
><td class="source">	else if(it.isFluidContainer()){<br></td></tr
><tr
id=sl_svn102_692

><td class="source">		if(item &amp;&amp; item-&gt;getFluidType() != 0){<br></td></tr
><tr
id=sl_svn102_693

><td class="source">			s &lt;&lt; &quot; of &quot; &lt;&lt; items[item-&gt;getFluidType()].name &lt;&lt; &quot;.&quot;;<br></td></tr
><tr
id=sl_svn102_694
...
><td class="source">			s &lt;&lt; &quot;. It is empty.&quot;;<br></td></tr
><tr
id=sl_svn102_697
...
><td class="source">	else if(it.isSplash()){<br></td></tr
><tr
id=sl_svn102_700

><td class="source">		s &lt;&lt; &quot; of &quot;;<br></td></tr
><tr
id=sl_svn102_701
...
><td class="source">			s &lt;&lt; items[item-&gt;getFluidType()].name;<br></td></tr
><tr
id=sl_svn102_703
...
><td class="source">			s &lt;&lt; items[1].name;<br></td></tr
><tr
id=sl_svn102_706
...
><td class="source">		s &lt;&lt; &quot; (Vol:&quot; &lt;&lt; (int)it.maxItems &lt;&lt; &quot;).&quot;;<br></td></tr
><tr
id=sl_svn102_710
...
><td class="source">	else if(it.isKey()){<br></td></tr
><tr
id=sl_svn102_712
...
><td class="source">			s &lt;&lt; &quot; (Key:&quot; &lt;&lt; (int)item-&gt;getActionId() &lt;&lt; &quot;).&quot;;<br></td></tr
><tr
id=sl_svn102_714
...
><td class="source">			s &lt;&lt; &quot; (Key:&quot; &lt;&lt; (int)0 &lt;&lt; &quot;).&quot;;<br></td></tr
><tr
id=sl_svn102_717
...
><td class="source">	else if(it.allowDistRead){<br></td></tr
><tr
id=sl_svn102_720

><td class="source">		s &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_721
...
><td class="source">		if(item &amp;&amp; item-&gt;getText() != &quot;&quot;){<br></td></tr
><tr
id=sl_svn102_723

><td class="source">			if(lookDistance &lt;= 4){<br></td></tr
><tr
id=sl_svn102_724

><td class="source">				if(item-&gt;getWriter().length()){<br></td></tr
><tr
id=sl_svn102_725

><td class="source">					s &lt;&lt; item-&gt;getWriter() &lt;&lt; &quot; wrote: &quot;;<br></td></tr
><tr
id=sl_svn102_726
...
><td class="source">					s &lt;&lt; &quot;You read: &quot;;<br></td></tr
><tr
id=sl_svn102_729
...
><td class="source">				s &lt;&lt; item-&gt;getText();<br></td></tr
><tr
id=sl_svn102_732
...
><td class="source">				s &lt;&lt; &quot;You are too far away to read it.&quot;;<br></td></tr
><tr
id=sl_svn102_735
...
><td class="source">			s &lt;&lt; &quot;Nothing is written on it.&quot;;<br></td></tr
><tr
id=sl_svn102_739
...
><td class="source">	else if(it.showCharges){<br></td></tr
><tr
id=sl_svn102_742

><td class="source">		uint32_t charges = (item == NULL ? it.charges : item-&gt;getCharges());<br></td></tr
><tr
id=sl_svn102_743

><td class="source">		if(charges &gt; 1){<br></td></tr
><tr
id=sl_svn102_744

><td class="source">			s &lt;&lt; &quot; that has &quot; &lt;&lt; (int)charges &lt;&lt; &quot; charges left.&quot;;<br></td></tr
><tr
id=sl_svn102_745
...
><td class="source">	else if(it.showDuration){<br></td></tr
><tr
id=sl_svn102_751

><td class="source">		if(item &amp;&amp; item-&gt;hasAttribute(ATTR_ITEM_DURATION)){<br></td></tr
><tr
id=sl_svn102_752

><td class="source">			int32_t duration = item-&gt;getDuration() / 1000;<br></td></tr
><tr
id=sl_svn102_753

><td class="source">			s &lt;&lt; &quot; that has energy for &quot;;<br></td></tr
><tr
id=sl_svn102_754
...
><td class="source">			if(duration &gt;= 120){<br></td></tr
><tr
id=sl_svn102_756

><td class="source">				s &lt;&lt; duration / 60 &lt;&lt; &quot; minutes left.&quot;;<br></td></tr
><tr
id=sl_svn102_757
...
><td class="source">			else if(duration &gt; 60){<br></td></tr
><tr
id=sl_svn102_759

><td class="source">				s &lt;&lt; &quot;1 minute left.&quot;;<br></td></tr
><tr
id=sl_svn102_760
...
><td class="source">				s &lt;&lt; &quot; less than a minute left.&quot;;<br></td></tr
><tr
id=sl_svn102_763
...
><td class="source">			s &lt;&lt; &quot; that is brand-new.&quot;;<br></td></tr
><tr
id=sl_svn102_767
...
><td class="source">	if(it.wieldInfo != 0){<br></td></tr
><tr
id=sl_svn102_774

><td class="source">		s &lt;&lt; std::endl &lt;&lt; &quot;It can only be wielded properly by &quot;;<br></td></tr
><tr
id=sl_svn102_775

><td class="source">		if(it.wieldInfo &amp; WIELDINFO_PREMIUM){<br></td></tr
><tr
id=sl_svn102_776

><td class="source">			s &lt;&lt; &quot;premium &quot;;<br></td></tr
><tr
id=sl_svn102_777
...
><td class="source">		if(it.wieldInfo &amp; WIELDINFO_VOCREQ){<br></td></tr
><tr
id=sl_svn102_780

><td class="source">			s &lt;&lt; it.vocationString;<br></td></tr
><tr
id=sl_svn102_781
...
><td class="source">			s &lt;&lt; &quot;players&quot;;<br></td></tr
><tr
id=sl_svn102_784
...
><td class="source">		if(it.wieldInfo &amp; WIELDINFO_LEVEL){<br></td></tr
><tr
id=sl_svn102_787

><td class="source">			s &lt;&lt; &quot; of level &quot; &lt;&lt; (int)it.minReqLevel &lt;&lt; &quot; or higher&quot;;<br></td></tr
><tr
id=sl_svn102_788
...
><td class="source">		if(it.wieldInfo &amp; WIELDINFO_MAGLV){<br></td></tr
><tr
id=sl_svn102_791
...
><td class="source">			s &lt;&lt; &quot; magic level &quot; &lt;&lt; (int)it.minReqMagicLevel &lt;&lt; &quot; or higher&quot;;<br></td></tr
><tr
id=sl_svn102_798
...
><td class="source">	if(lookDistance &lt;= 1){<br></td></tr
><tr
id=sl_svn102_804

><td class="source">		double weight = (item == NULL ? it.weight : item-&gt;getWeight());<br></td></tr
><tr
id=sl_svn102_805

><td class="source">		if(weight &gt; 0){<br></td></tr
><tr
id=sl_svn102_806

><td class="source">			s &lt;&lt; std::endl &lt;&lt; getWeightDescription(it, weight);<br></td></tr
><tr
id=sl_svn102_807
...
><td class="source">	if(item &amp;&amp; item-&gt;getSpecialDescription() != &quot;&quot;){<br></td></tr
><tr
id=sl_svn102_811

><td class="source">		s &lt;&lt; std::endl &lt;&lt; item-&gt;getSpecialDescription().c_str();<br></td></tr
><tr
id=sl_svn102_812
...
><td class="source">	else if(it.description.length() &amp;&amp; lookDistance &lt;= 1){<br></td></tr
><tr
id=sl_svn102_814

><td class="source">		s &lt;&lt; std::endl &lt;&lt; it.description;<br></td></tr
><tr
id=sl_svn102_815
...
><td class="source">std::string Item::getDescription(int32_t lookDistance) const<br></td></tr
><tr
id=sl_svn102_821
...
><td class="source">	s &lt;&lt; getDescription(it, lookDistance, this);<br></td></tr
><tr
id=sl_svn102_826
...
><td class="source">std::string Item::getXRayDescription() const<br></td></tr
><tr
id=sl_svn102_830
...
><td class="source">	ret &lt;&lt; &quot;ID: &quot; &lt;&lt; getID() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_834

><td class="source">	uint16_t actionId = getActionId();<br></td></tr
><tr
id=sl_svn102_835

><td class="source">	uint16_t uniqueId = getUniqueId();<br></td></tr
><tr
id=sl_svn102_836

><td class="source">	if(actionId &gt; 0)<br></td></tr
><tr
id=sl_svn102_837

><td class="source">		ret &lt;&lt; &quot;Action ID: &quot; &lt;&lt; actionId &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_838

><td class="source">	if(uniqueId &gt; 0)<br></td></tr
><tr
id=sl_svn102_839

><td class="source">		ret &lt;&lt; &quot;Unique ID: &quot; &lt;&lt; uniqueId &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_840
...
><td class="source">	if (getContainer())<br></td></tr
><tr
id=sl_svn102_842

><td class="source">		ret &lt;&lt; &quot;There are &quot; &lt;&lt; getContainer()-&gt;getTotalAmountOfItemsInside() - 1 &lt;&lt; &quot; things inside of this.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_843
...
><td class="source">std::string Item::getWeightDescription() const<br></td></tr
><tr
id=sl_svn102_849
...
><td class="source">	double weight = getWeight();<br></td></tr
><tr
id=sl_svn102_851
...
><td class="source">		return getWeightDescription(weight);<br></td></tr
><tr
id=sl_svn102_853
...
><td class="source">std::string Item::getWeightDescription(double weight) const<br></td></tr
><tr
id=sl_svn102_860
...
><td class="source">	const ItemType&amp; it = Item::items[id];<br></td></tr
><tr
id=sl_svn102_862

><td class="source">	return getWeightDescription(it, weight, count);<br></td></tr
><tr
id=sl_svn102_863
...
><td class="source">std::string Item::getWeightDescription(const ItemType&amp; it, double weight, uint32_t count /*= 1*/)<br></td></tr
><tr
id=sl_svn102_866
...
><td class="source">	if(it.stackable &amp;&amp; count &gt; 1){<br></td></tr
><tr
id=sl_svn102_869

><td class="source">		ss &lt;&lt; &quot;They weigh &quot; &lt;&lt; std::fixed &lt;&lt; std::setprecision(2) &lt;&lt; weight &lt;&lt; &quot; oz.&quot;;<br></td></tr
><tr
id=sl_svn102_870
...
><td class="source">		ss &lt;&lt; &quot;It weighs &quot; &lt;&lt; std::fixed &lt;&lt; std::setprecision(2) &lt;&lt; weight &lt;&lt; &quot; oz.&quot;;<br></td></tr
><tr
id=sl_svn102_873
...
><td class="source">	return ss.str();<br></td></tr
><tr
id=sl_svn102_875
...
><td class="source">void Item::setUniqueId(uint16_t n)<br></td></tr
><tr
id=sl_svn102_878
...
><td class="source">	ItemAttributes::setUniqueId(n);<br></td></tr
><tr
id=sl_svn102_883

><td class="source">	ScriptEnviroment::addUniqueThing(this);<br></td></tr
><tr
id=sl_svn102_884
...
><td class="source">bool Item::canDecay()<br></td></tr
><tr
id=sl_svn102_887
...
><td class="source">	if(getUniqueId() != 0 || getActionId() != 0){<br></td></tr
><tr
id=sl_svn102_893
...
><td class="source">	return (items[id].decayTo != -1);<br></td></tr
><tr
id=sl_svn102_897
...
><td class="source">int Item::getWorth() const<br></td></tr
><tr
id=sl_svn102_900
...
><td class="source">	switch(getID()){<br></td></tr
><tr
id=sl_svn102_902

><td class="source">	case ITEM_COINS_GOLD:<br></td></tr
><tr
id=sl_svn102_903

><td class="source">		return getItemCount();<br></td></tr
><tr
id=sl_svn102_904

><td class="source">	case ITEM_COINS_PLATINUM:<br></td></tr
><tr
id=sl_svn102_905

><td class="source">		return getItemCount() * 100;<br></td></tr
><tr
id=sl_svn102_906

><td class="source">	case ITEM_COINS_CRYSTAL:<br></td></tr
><tr
id=sl_svn102_907

><td class="source">		return getItemCount() * 10000;<br></td></tr
><tr
id=sl_svn102_908
...
><td class="source">void Item::getLight(LightInfo&amp; lightInfo)<br></td></tr
><tr
id=sl_svn102_914
...
><td class="source">	lightInfo.color = it.lightColor;<br></td></tr
><tr
id=sl_svn102_917

><td class="source">	lightInfo.level = it.lightLevel;<br></td></tr
><tr
id=sl_svn102_918
...
><td class="source">std::string ItemAttributes::emptyString(&quot;&quot;);<br></td></tr
><tr
id=sl_svn102_921
...
><td class="source">const std::string&amp; ItemAttributes::getStrAttr(itemAttrTypes type) const<br></td></tr
><tr
id=sl_svn102_923
...
><td class="source">	if(!validateStrAttrType(type))<br></td></tr
><tr
id=sl_svn102_925

><td class="source">		return emptyString;<br></td></tr
><tr
id=sl_svn102_926
...
><td class="source">	//this will *NOT* create the attribute if it does not exist<br></td></tr
><tr
id=sl_svn102_928

><td class="source">	Attribute* attr = getAttrConst(type);<br></td></tr
><tr
id=sl_svn102_929

><td class="source">	if(attr){<br></td></tr
><tr
id=sl_svn102_930

><td class="source">		return *(std::string*)attr-&gt;value;<br></td></tr
><tr
id=sl_svn102_931
...
><td class="source">void ItemAttributes::setStrAttr(itemAttrTypes type, const std::string&amp; value)<br></td></tr
><tr
id=sl_svn102_938
...
><td class="source">	if(value.length() == 0)<br></td></tr
><tr
id=sl_svn102_943
...
><td class="source">	//this will create the attribute if it does not exist<br></td></tr
><tr
id=sl_svn102_946

><td class="source">	Attribute* attr = getAttr(type);<br></td></tr
><tr
id=sl_svn102_947
...
><td class="source">		//if has a previous value delete it<br></td></tr
><tr
id=sl_svn102_949

><td class="source">		if(attr-&gt;value){<br></td></tr
><tr
id=sl_svn102_950

><td class="source">			delete (std::string*)attr-&gt;value;<br></td></tr
><tr
id=sl_svn102_951
...
><td class="source">		//create the new value as string<br></td></tr
><tr
id=sl_svn102_953

><td class="source">		attr-&gt;value = (void*)new std::string(value);<br></td></tr
><tr
id=sl_svn102_954
...
><td class="source">bool ItemAttributes::hasAttribute(itemAttrTypes type) const<br></td></tr
><tr
id=sl_svn102_958
...
><td class="source">	if(!validateIntAttrType(type))<br></td></tr
><tr
id=sl_svn102_960
...
><td class="source">void ItemAttributes::removeAttribute(itemAttrTypes type)<br></td></tr
><tr
id=sl_svn102_971
...
><td class="source">	//check if we have it<br></td></tr
><tr
id=sl_svn102_973

><td class="source">	if((type &amp; m_attributes) != 0){<br></td></tr
><tr
id=sl_svn102_974

><td class="source">		//go trough the linked list until find it<br></td></tr
><tr
id=sl_svn102_975

><td class="source">		Attribute* prevAttr = NULL;<br></td></tr
><tr
id=sl_svn102_976

><td class="source">		Attribute* curAttr = m_firstAttr;<br></td></tr
><tr
id=sl_svn102_977

><td class="source">		while(curAttr != NULL){<br></td></tr
><tr
id=sl_svn102_978

><td class="source">			if(curAttr-&gt;type == type){<br></td></tr
><tr
id=sl_svn102_979

><td class="source">				//found so remove it from the linked list<br></td></tr
><tr
id=sl_svn102_980

><td class="source">				if(prevAttr){<br></td></tr
><tr
id=sl_svn102_981

><td class="source">					prevAttr-&gt;next = curAttr-&gt;next;<br></td></tr
><tr
id=sl_svn102_982
...
><td class="source">					m_firstAttr = curAttr-&gt;next;<br></td></tr
><tr
id=sl_svn102_985
...
><td class="source">				//remove it from flags<br></td></tr
><tr
id=sl_svn102_987

><td class="source">				m_attributes = m_attributes &amp; ~type;<br></td></tr
><tr
id=sl_svn102_988
...
><td class="source">				//delete string if it is string type<br></td></tr
><tr
id=sl_svn102_990
...
><td class="source">					delete (std::string*)curAttr-&gt;value;<br></td></tr
><tr
id=sl_svn102_992
...
><td class="source">				//finally delete the attribute and return<br></td></tr
><tr
id=sl_svn102_994

><td class="source">				delete curAttr;<br></td></tr
><tr
id=sl_svn102_995
...
><td class="source">			//advance in the linked list<br></td></tr
><tr
id=sl_svn102_999

><td class="source">			prevAttr = curAttr;<br></td></tr
><tr
id=sl_svn102_1000

><td class="source">			curAttr = curAttr-&gt;next;<br></td></tr
><tr
id=sl_svn102_1001
...
><td class="source">uint32_t ItemAttributes::getIntAttr(itemAttrTypes type) const<br></td></tr
><tr
id=sl_svn102_1006
...
><td class="source">		return static_cast&lt;uint32_t&gt;(0xFFFFFFFF &amp; reinterpret_cast&lt;ptrdiff_t&gt;(attr-&gt;value));<br></td></tr
><tr
id=sl_svn102_1013
...
><td class="source">void ItemAttributes::setIntAttr(itemAttrTypes type, int32_t value)<br></td></tr
><tr
id=sl_svn102_1020
...
><td class="source">		attr-&gt;value = reinterpret_cast&lt;void*&gt;(static_cast&lt;ptrdiff_t&gt;(value));<br></td></tr
><tr
id=sl_svn102_1027
...
><td class="source">void ItemAttributes::increaseIntAttr(itemAttrTypes type, int32_t value)<br></td></tr
><tr
id=sl_svn102_1031
...
><td class="source">		attr-&gt;value = reinterpret_cast&lt;void*&gt;(static_cast&lt;ptrdiff_t&gt;(static_cast&lt;uint32_t&gt;(0xFFFFFFFF &amp; reinterpret_cast&lt;ptrdiff_t&gt;(attr-&gt;value)) + value));<br></td></tr
><tr
id=sl_svn102_1038
...
><td class="source">bool ItemAttributes::validateIntAttrType(itemAttrTypes type)<br></td></tr
><tr
id=sl_svn102_1042
...
><td class="source">	//list of numeric type attributes<br></td></tr
><tr
id=sl_svn102_1044
...
><td class="source">		case ATTR_ITEM_ACTIONID:<br></td></tr
><tr
id=sl_svn102_1046

><td class="source">		case ATTR_ITEM_UNIQUEID:<br></td></tr
><tr
id=sl_svn102_1047

><td class="source">		case ATTR_ITEM_OWNER:<br></td></tr
><tr
id=sl_svn102_1048

><td class="source">		case ATTR_ITEM_DURATION:<br></td></tr
><tr
id=sl_svn102_1049

><td class="source">		case ATTR_ITEM_DECAYING:<br></td></tr
><tr
id=sl_svn102_1050

><td class="source">		//case ATTR_ITEM_WRITTENDATE:<br></td></tr
><tr
id=sl_svn102_1051

><td class="source">		case ATTR_ITEM_CHARGES:<br></td></tr
><tr
id=sl_svn102_1052

><td class="source">		case ATTR_ITEM_FLUIDTYPE:<br></td></tr
><tr
id=sl_svn102_1053

><td class="source">		case ATTR_ITEM_DOORID:<br></td></tr
><tr
id=sl_svn102_1054
...
><td class="source">bool ItemAttributes::validateStrAttrType(itemAttrTypes type)<br></td></tr
><tr
id=sl_svn102_1063
...
><td class="source">	//list of text type attributes<br></td></tr
><tr
id=sl_svn102_1065
...
><td class="source">		case ATTR_ITEM_DESC:<br></td></tr
><tr
id=sl_svn102_1067

><td class="source">		case ATTR_ITEM_TEXT:<br></td></tr
><tr
id=sl_svn102_1068

><td class="source">		case ATTR_ITEM_WRITTENBY:<br></td></tr
><tr
id=sl_svn102_1069
...
><td class="source">void ItemAttributes::addAttr(Attribute* attr)<br></td></tr
><tr
id=sl_svn102_1078
...
><td class="source">	//add an attribute to the linked list<br></td></tr
><tr
id=sl_svn102_1080
...
><td class="source">		//is not the first, so look for the end of the list<br></td></tr
><tr
id=sl_svn102_1082
...
><td class="source">		while(curAttr-&gt;next){<br></td></tr
><tr
id=sl_svn102_1084
...
><td class="source">		//and add it at the end<br></td></tr
><tr
id=sl_svn102_1087

><td class="source">		curAttr-&gt;next = attr;<br></td></tr
><tr
id=sl_svn102_1088
...
><td class="source">		//is the first<br></td></tr
><tr
id=sl_svn102_1091

><td class="source">		m_firstAttr = attr;<br></td></tr
><tr
id=sl_svn102_1092
...
><td class="source">	//add it to flags<br></td></tr
><tr
id=sl_svn102_1094

><td class="source">	m_attributes = m_attributes | attr-&gt;type;<br></td></tr
><tr
id=sl_svn102_1095
...
><td class="source">ItemAttributes::Attribute* ItemAttributes::getAttrConst(itemAttrTypes type) const<br></td></tr
><tr
id=sl_svn102_1098
...
><td class="source">	//check flags<br></td></tr
><tr
id=sl_svn102_1100
...
><td class="source">	//it is here, so search it in the linked list<br></td></tr
><tr
id=sl_svn102_1104
...
><td class="source">	while(curAttr){<br></td></tr
><tr
id=sl_svn102_1106
...
><td class="source">			return curAttr;<br></td></tr
><tr
id=sl_svn102_1109
...
><td class="source">	std::cout &lt;&lt; &quot;Warning: [ItemAttributes::getAttrConst] (type &amp; m_attributes) != 0 but attribute not found&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1114
...
><td class="source">ItemAttributes::Attribute* ItemAttributes::getAttr(itemAttrTypes type)<br></td></tr
><tr
id=sl_svn102_1118
...
><td class="source">	Attribute* curAttr;<br></td></tr
><tr
id=sl_svn102_1120
...
><td class="source">		//if that type was not present add it<br></td></tr
><tr
id=sl_svn102_1122

><td class="source">		curAttr = new Attribute(type);<br></td></tr
><tr
id=sl_svn102_1123

><td class="source">		addAttr(curAttr);<br></td></tr
><tr
id=sl_svn102_1124
...
><td class="source">		//was present, search and return it<br></td></tr
><tr
id=sl_svn102_1128

><td class="source">		curAttr = m_firstAttr;<br></td></tr
><tr
id=sl_svn102_1129
...
><td class="source">	std::cout &lt;&lt; &quot;Warning: [ItemAttributes::getAttr] (type &amp; m_attributes) != 0 but attribute not found&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1137
...
><td class="source">void ItemAttributes::deleteAttrs(Attribute* attr)<br></td></tr
><tr
id=sl_svn102_1143
...
><td class="source">	//deletes all attributes recursively<br></td></tr
><tr
id=sl_svn102_1145
...
><td class="source">		//if is string type, delete the allocated string<br></td></tr
><tr
id=sl_svn102_1147

><td class="source">		if(validateStrAttrType(attr-&gt;type)){<br></td></tr
><tr
id=sl_svn102_1148
...
><td class="source">		Attribute* next_attr = attr-&gt;next;<br></td></tr
><tr
id=sl_svn102_1151

><td class="source">		attr-&gt;next = NULL;<br></td></tr
><tr
id=sl_svn102_1152

><td class="source">		//delete next while it was not NULL<br></td></tr
><tr
id=sl_svn102_1153

><td class="source">		if(next_attr){<br></td></tr
><tr
id=sl_svn102_1154

><td class="source">			deleteAttrs(next_attr);<br></td></tr
><tr
id=sl_svn102_1155
...
><td class="source">		delete attr;<br></td></tr
><tr
id=sl_svn102_1157
...
><td class="source">void Item::__startDecaying()<br></td></tr
><tr
id=sl_svn102_1161
...
><td class="source">	g_game.startDecay(this);<br></td></tr
><tr
id=sl_svn102_1163
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 29, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=97&amp;format=side&amp;path=/trunk/src/item.cpp&amp;old_path=/trunk/src/item.cpp&amp;old=96">Diff</a>
 </div>
 <pre>more fixes</pre>
 </div>
 ...
 var selected_path = '/trunk/src/item.cpp';
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=96&amp;format=side&amp;path=/trunk/src/item.cpp&amp;old_path=/trunk/src/item.cpp&amp;old=95">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/item.cpp&amp;old_path=/trunk/src/item.cpp&amp;old=91">Diff</a>
 <br>
...
don't recommend using this revision</pre>
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/item.cpp&amp;old_path=/trunk/src/item.cpp&amp;old=86">Diff</a>
 <br>
 <pre class="ifOpened">compilation fix and some minor changes</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/item.cpp&start=97">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 25113 bytes,
 1163 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/item.cpp">View raw file</a></div>
 </div>
