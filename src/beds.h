...
<head>
 ...
 var codesite_token = "ABZ6GAf6r-NEDLXXS3uByZD8RysDQE-vmg:1406096237598";
 
 
 var CS_env = {"assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "relativeBaseUrl": "", "token": "ABZ6GAf6r-NEDLXXS3uByZD8RysDQE-vmg:1406096237598", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fbeds.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>beds.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/beds.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/beds.h?r=86" title="Previous">&lsaquo;r86</a></li>
...
><td class="source">#ifndef __OTS_BEDS_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTS_BEDS_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">class BedItem : public Item<br></td></tr
><tr
id=sl_svn102_36
...
><td class="source">	BedItem(uint16_t id);<br></td></tr
><tr
id=sl_svn102_39

><td class="source">	virtual ~BedItem();<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">	virtual BedItem* getBed(){ return this; }<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	virtual const BedItem* getBed() const { return this; }<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	virtual bool canRemove() const {return (house == NULL); }<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	uint32_t getSleeper() const { return sleeperGUID; }<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	void setSleeper(uint32_t guid){ sleeperGUID = guid; }<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	time_t getSleepStart() const { return sleepStart; }<br></td></tr
><tr
id=sl_svn102_54

><td class="source">	void setSleepStart(time_t now){ sleepStart = now; }<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">	House* getHouse() const { return house; }<br></td></tr
><tr
id=sl_svn102_57

><td class="source">	void setHouse(House* h){ house = h; }<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	bool canUse(Player* player);<br></td></tr
><tr
id=sl_svn102_60

><td class="source">	void sleep(Player* player);<br></td></tr
><tr
id=sl_svn102_61

><td class="source">	void wakeUp(Player* player);<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">	BedItem* getNextBedItem();<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">	void updateAppearance(const Player* player);<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	void regeneratePlayer(Player* player) const;<br></td></tr
><tr
id=sl_svn102_68

><td class="source">	void internalSetSleeper(const Player* player);<br></td></tr
><tr
id=sl_svn102_69

><td class="source">	void internalRemoveSleeper();<br></td></tr
><tr
id=sl_svn102_70
...
><td class="source">	uint32_t sleeperGUID;<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	time_t sleepStart;<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">class Beds<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	BedItem* getBedBySleeper(uint32_t guid);<br></td></tr
><tr
id=sl_svn102_85

><td class="source">	void setBedSleeper(BedItem* bed, uint32_t guid);<br></td></tr
><tr
id=sl_svn102_86
...
><td class="source">	Beds(){ BedSleepersMap.clear(); }<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	std::map&lt;uint32_t, BedItem*&gt; BedSleepersMap;<br></td></tr
><tr
id=sl_svn102_91
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/beds.h&amp;old_path=/trunk/src/beds.h&amp;old=86">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/beds.h';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=86&amp;format=side&amp;path=/trunk/src/beds.h&amp;old_path=/trunk/src/beds.h&amp;old=52">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/beds.h&amp;old_path=/trunk/src/beds.h&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/beds.h&amp;old_path=/trunk/src/beds.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/beds.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/beds.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/beds.h'}
 codereviews = CR_controller.setup(
 {"assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "relativeBaseUrl": "", "token": "ABZ6GAf6r-NEDLXXS3uByZD8RysDQE-vmg:1406096237598", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74"}, '', 'svn102', paths,
