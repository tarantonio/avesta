...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAeDJTslsVtnSG1meWXftmh95pFIZQ:1406096382257";
 
 
 var CS_env = {"profileUrl": "/u/108692122734644646415/", "domainName": null, "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAeDJTslsVtnSG1meWXftmh95pFIZQ:1406096382257", "projectHomeUrl": "/p/avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fchat.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>chat.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/chat.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/chat.h?r=54" title="Previous">&lsaquo;r54</a></li>
...
><td class="source">#ifndef __OTSERV_CHAT_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_CHAT_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">typedef std::map&lt;uint32_t, Player*&gt; UsersMap;<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">enum ChannelID {<br></td></tr
><tr
id=sl_svn102_36

><td class="source">	CHANNEL_GUILD      = 0x00,<br></td></tr
><tr
id=sl_svn102_37

><td class="source">	CHANNEL_RULE_REP   = 0x03,<br></td></tr
><tr
id=sl_svn102_38

><td class="source">	CHANNEL_GAME_CHAT  = 0x04,<br></td></tr
><tr
id=sl_svn102_39

><td class="source">	CHANNEL_TRADE      = 0x05,<br></td></tr
><tr
id=sl_svn102_40

><td class="source">	//CHANNEL_TRADE_ROOK = 0x06,<br></td></tr
><tr
id=sl_svn102_41

><td class="source">	CHANNEL_RL_CHAT    = 0x07,<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	//CHANNEL_PARTY      = 0x08,<br></td></tr
><tr
id=sl_svn102_43

><td class="source">	CHANNEL_HELP       = 0x09,<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	CHANNEL_PRIVATE    = 0xFFFF<br></td></tr
><tr
id=sl_svn102_45
...
><td class="source">class ChatChannel<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">	ChatChannel(uint16_t channelId, std::string channelName);<br></td></tr
><tr
id=sl_svn102_51

><td class="source">	virtual ~ChatChannel(){}<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">	bool addUser(Player* player);<br></td></tr
><tr
id=sl_svn102_54

><td class="source">	bool removeUser(Player* player);<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">	bool talk(Player* fromPlayer, SpeakClasses type, const std::string&amp; text, uint32_t time = 0);<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">	const std::string&amp; getName(){ return m_name; }<br></td></tr
><tr
id=sl_svn102_59

><td class="source">	const uint16_t getId(){ return m_id; }<br></td></tr
><tr
id=sl_svn102_60

><td class="source">	const UsersMap&amp; getUsers(){ return m_users; }<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	virtual const uint32_t getOwner(){ return 0; }<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">	UsersMap m_users;<br></td></tr
><tr
id=sl_svn102_66

><td class="source">	std::string m_name;<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	uint16_t m_id;<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">class PrivateChatChannel : public ChatChannel<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">	PrivateChatChannel(uint16_t channelId, std::string channelName);<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	virtual ~PrivateChatChannel(){};<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">	virtual const uint32_t getOwner(){return m_owner;}<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	void setOwner(uint32_t id){m_owner = id;}<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	void invitePlayer(Player* player, Player* invitePlayer);<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	void excludePlayer(Player* player, Player* excludePlayer);<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">	bool addInvited(Player* player);<br></td></tr
><tr
id=sl_svn102_85

><td class="source">	bool removeInvited(Player* player);<br></td></tr
><tr
id=sl_svn102_86
...
><td class="source">	void closeChannel();<br></td></tr
><tr
id=sl_svn102_88
...
><td class="source">	typedef std::map&lt;uint32_t, Player*&gt; InvitedMap;<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">	InvitedMap m_invites;<br></td></tr
><tr
id=sl_svn102_93

><td class="source">	uint32_t m_owner;<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">typedef std::list&lt;ChatChannel*&gt; ChannelList;<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">class Chat<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">	ChatChannel* createChannel(Player* player, uint16_t channelId);<br></td></tr
><tr
id=sl_svn102_104

><td class="source">	bool deleteChannel(Player* player, uint16_t channelId);<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">	bool addUserToChannel(Player* player, uint16_t channelId);<br></td></tr
><tr
id=sl_svn102_107

><td class="source">	bool removeUserFromChannel(Player* player, uint16_t channelId);<br></td></tr
><tr
id=sl_svn102_108

><td class="source">	void removeUserFromAllChannels(Player* player);<br></td></tr
><tr
id=sl_svn102_109
...
><td class="source">	uint16_t getFreePrivateChannelId();<br></td></tr
><tr
id=sl_svn102_111

><td class="source">	bool isPrivateChannel(uint16_t channelId);<br></td></tr
><tr
id=sl_svn102_112

><td class="source">	bool isMuteableChannel(uint16_t channelId, SpeakClasses type);<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">	bool talkToChannel(Player* player, SpeakClasses type,<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">	std::string getChannelName(Player* player, uint16_t channelId);	<br></td></tr
><tr
id=sl_svn102_118

><td class="source">	ChannelList getChannelList(Player* player);<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">	ChatChannel* getChannel(Player* player, uint16_t channelId);<br></td></tr
><tr
id=sl_svn102_121

><td class="source">	ChatChannel* getChannelById(uint16_t channelId);<br></td></tr
><tr
id=sl_svn102_122

><td class="source">	PrivateChatChannel* getPrivateChannel(Player* player);<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">	typedef std::map&lt;uint16_t, ChatChannel*&gt; NormalChannelMap;<br></td></tr
><tr
id=sl_svn102_126

><td class="source">	typedef std::map&lt;uint32_t, ChatChannel*&gt; GuildChannelMap;<br></td></tr
><tr
id=sl_svn102_127

><td class="source">	NormalChannelMap m_normalChannels;<br></td></tr
><tr
id=sl_svn102_128

><td class="source">	GuildChannelMap m_guildChannels;<br></td></tr
><tr
id=sl_svn102_129
...
><td class="source">	typedef std::map&lt;uint16_t, PrivateChatChannel*&gt; PrivateChannelMap;<br></td></tr
><tr
id=sl_svn102_131

><td class="source">	PrivateChannelMap m_privateChannels;<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	ChatChannel* dummyPrivate;<br></td></tr
><tr
id=sl_svn102_134
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/chat.h&amp;old_path=/trunk/src/chat.h&amp;old=54">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/chat.h';
 ...
 by r...@ymail.com
 on Jul 10, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=54&amp;format=side&amp;path=/trunk/src/chat.h&amp;old_path=/trunk/src/chat.h&amp;old=52">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/chat.h&amp;old_path=/trunk/src/chat.h&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/chat.h&amp;old_path=/trunk/src/chat.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/chat.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/chat.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/chat.h'}
