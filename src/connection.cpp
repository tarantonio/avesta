...
<head>
 ...
 var codesite_token = "ABZ6GAdVKexa7LaNIXg-EW3csjY1iNC9hQ:1406096423375";
 
 
 var CS_env = {"loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdVKexa7LaNIXg-EW3csjY1iNC9hQ:1406096423375", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fconnection.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>connection.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/connection.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/connection.cpp?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#include &quot;protocol.h&quot;<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">#include &quot;protocolgame.h&quot;<br></td></tr
><tr
id=sl_svn102_25
...
><td class="source">uint32_t Connection::connectionCount = 0;<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">Connection* ConnectionManager::createConnection(boost::asio::io_service&amp; io_service)<br></td></tr
><tr
id=sl_svn102_38
...
><td class="source">	#ifdef __DEBUG_NET_DETAIL__<br></td></tr
><tr
id=sl_svn102_40

><td class="source">	std::cout &lt;&lt; &quot;Create new Connection&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	boost::recursive_mutex::scoped_lock lockClass(m_connectionManagerLock);<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	Connection* connection = new Connection(io_service);<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	m_connections.push_back(connection);<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	return connection;<br></td></tr
><tr
id=sl_svn102_47
...
><td class="source">void ConnectionManager::releaseConnection(Connection* connection)<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	std::cout &lt;&lt; &quot;Releasing connection&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">	std::list&lt;Connection*&gt;::iterator it =<br></td></tr
><tr
id=sl_svn102_57

><td class="source">		std::find(m_connections.begin(), m_connections.end(), connection);<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	if(it != m_connections.end()){<br></td></tr
><tr
id=sl_svn102_60

><td class="source">		m_connections.erase(it);<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">		std::cout &lt;&lt; &quot;Error: [ConnectionManager::releaseConnection] Connection not found&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">void ConnectionManager::closeAll()<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	std::cout &lt;&lt; &quot;Closing all connections&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">	std::list&lt;Connection*&gt;::iterator it = m_connections.begin();<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	while(it != m_connections.end()){<br></td></tr
><tr
id=sl_svn102_75

><td class="source">		boost::system::error_code error;<br></td></tr
><tr
id=sl_svn102_76

><td class="source">		(*it)-&gt;m_socket.shutdown(boost::asio::ip::tcp::socket::shutdown_both, error);<br></td></tr
><tr
id=sl_svn102_77

><td class="source">		(*it)-&gt;m_socket.close(error);<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	m_connections.clear();<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">void Connection::closeConnection()<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	//any thread<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	std::cout &lt;&lt; &quot;Connection::closeConnection&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">	boost::recursive_mutex::scoped_lock lockClass(m_connectionLock);<br></td></tr
><tr
id=sl_svn102_94

><td class="source">	if(m_closeState != CLOSE_STATE_NONE)<br></td></tr
><tr
id=sl_svn102_95
...
><td class="source">	m_closeState = CLOSE_STATE_REQUESTED;<br></td></tr
><tr
id=sl_svn102_98
...
><td class="source">	Dispatcher::getDispatcher().addTask(<br></td></tr
><tr
id=sl_svn102_100

><td class="source">		createTask(boost::bind(&amp;Connection::closeConnectionTask, this)));<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">void Connection::closeConnectionTask()<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	std::cout &lt;&lt; &quot;Connection::closeConnectionTask&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_108
...
><td class="source">	m_connectionLock.lock();<br></td></tr
><tr
id=sl_svn102_111

><td class="source">	if(m_closeState != CLOSE_STATE_REQUESTED){<br></td></tr
><tr
id=sl_svn102_112

><td class="source">		std::cout &lt;&lt; &quot;Error: [Connection::closeConnectionTask] m_closeState = &quot; &lt;&lt; m_closeState &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_113

><td class="source">		m_connectionLock.unlock();<br></td></tr
><tr
id=sl_svn102_114
...
><td class="source">	m_closeState = CLOSE_STATE_CLOSING;<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">	if(m_protocol){<br></td></tr
><tr
id=sl_svn102_120
...
><td class="source">			createTask(boost::bind(&amp;Protocol::releaseProtocol, m_protocol)));<br></td></tr
><tr
id=sl_svn102_122

><td class="source">		m_protocol-&gt;setConnection(NULL);<br></td></tr
><tr
id=sl_svn102_123

><td class="source">		m_protocol = NULL;<br></td></tr
><tr
id=sl_svn102_124
...
><td class="source">	if(!closingConnection()){<br></td></tr
><tr
id=sl_svn102_127
...
><td class="source">bool Connection::closingConnection()<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	std::cout &lt;&lt; &quot;Connection::closingConnection&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_136
...
><td class="source">	if(m_pendingWrite == 0 || m_writeError == true){<br></td></tr
><tr
id=sl_svn102_139

><td class="source">		if(!m_socketClosed){<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">			std::cout &lt;&lt; &quot;Closing socket&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">			m_socket.shutdown(boost::asio::ip::tcp::socket::shutdown_both, error);<br></td></tr
><tr
id=sl_svn102_146

><td class="source">			if(error){<br></td></tr
><tr
id=sl_svn102_147

><td class="source">				if(error == boost::asio::error::not_connected){<br></td></tr
><tr
id=sl_svn102_148

><td class="source">					//Transport endpoint is not connected.<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">					PRINT_ASIO_ERROR(&quot;Shutdown&quot;);<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">			m_socket.close(error);<br></td></tr
><tr
id=sl_svn102_155

><td class="source">			m_socketClosed = true;<br></td></tr
><tr
id=sl_svn102_156
...
><td class="source">				PRINT_ASIO_ERROR(&quot;Close&quot;);<br></td></tr
><tr
id=sl_svn102_158
...
><td class="source">		if(m_pendingRead == 0){<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">			std::cout &lt;&lt; &quot;Deleting Connection&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_164
...
><td class="source">				createTask(boost::bind(&amp;Connection::releaseConnection, this)));<br></td></tr
><tr
id=sl_svn102_170
...
><td class="source">void Connection::releaseConnection()<br></td></tr
><tr
id=sl_svn102_178
...
><td class="source">	if(m_refCount &gt; 0){<br></td></tr
><tr
id=sl_svn102_180

><td class="source">		//Reschedule it and try again.<br></td></tr
><tr
id=sl_svn102_181
...
><td class="source">			boost::bind(&amp;Connection::releaseConnection, this)));<br></td></tr
><tr
id=sl_svn102_183
...
><td class="source">		deleteConnectionTask();<br></td></tr
><tr
id=sl_svn102_186
...
><td class="source">void Connection::deleteConnectionTask()<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">	//dispather thread<br></td></tr
><tr
id=sl_svn102_192

><td class="source">	assert(m_refCount == 0);<br></td></tr
><tr
id=sl_svn102_193
...
><td class="source">	delete this;<br></td></tr
><tr
id=sl_svn102_195
...
><td class="source">void Connection::acceptConnection()<br></td></tr
><tr
id=sl_svn102_198
...
><td class="source">	// Read size of te first packet<br></td></tr
><tr
id=sl_svn102_200

><td class="source">	m_pendingRead++;<br></td></tr
><tr
id=sl_svn102_201

><td class="source">	boost::asio::async_read(m_socket,<br></td></tr
><tr
id=sl_svn102_202

><td class="source">		boost::asio::buffer(m_msg.getBuffer(), NetworkMessage::header_length),<br></td></tr
><tr
id=sl_svn102_203

><td class="source">		boost::bind(&amp;Connection::parseHeader, this, boost::asio::placeholders::error));<br></td></tr
><tr
id=sl_svn102_204
...
><td class="source">void Connection::parseHeader(const boost::system::error_code&amp; error)<br></td></tr
><tr
id=sl_svn102_207
...
><td class="source">	if(m_closeState == CLOSE_STATE_CLOSING){<br></td></tr
><tr
id=sl_svn102_211
...
><td class="source">	int32_t size = m_msg.decodeHeader();<br></td></tr
><tr
id=sl_svn102_218

><td class="source">	if(!error &amp;&amp; size &gt; 0 &amp;&amp; size &lt; NETWORKMESSAGE_MAXSIZE - 16){<br></td></tr
><tr
id=sl_svn102_219

><td class="source">		// Read packet content<br></td></tr
><tr
id=sl_svn102_220
...
><td class="source">		m_msg.setMessageLength(size + NetworkMessage::header_length);<br></td></tr
><tr
id=sl_svn102_222

><td class="source">		boost::asio::async_read(m_socket, boost::asio::buffer(m_msg.getBodyBuffer(), size),<br></td></tr
><tr
id=sl_svn102_223

><td class="source">			boost::bind(&amp;Connection::parsePacket, this, boost::asio::placeholders::error));<br></td></tr
><tr
id=sl_svn102_224
...
><td class="source">		handleReadError(error);<br></td></tr
><tr
id=sl_svn102_227
...
><td class="source">void Connection::parsePacket(const boost::system::error_code&amp; error)<br></td></tr
><tr
id=sl_svn102_232
...
><td class="source">		// Protocol selection<br></td></tr
><tr
id=sl_svn102_244
...
><td class="source">			// Protocol depends on the first byte of the packet<br></td></tr
><tr
id=sl_svn102_246

><td class="source">			uint8_t protocolId = m_msg.GetByte();<br></td></tr
><tr
id=sl_svn102_247

><td class="source">			switch(protocolId){<br></td></tr
><tr
id=sl_svn102_248

><td class="source">			case 0x01: // Login server protocol<br></td></tr
><tr
id=sl_svn102_249

><td class="source">				m_protocol = new ProtocolLogin(this);<br></td></tr
><tr
id=sl_svn102_250
...
><td class="source">			case 0x0A: // World server protocol<br></td></tr
><tr
id=sl_svn102_252

><td class="source">				m_protocol = new ProtocolGame(this);<br></td></tr
><tr
id=sl_svn102_253
...
><td class="source">			case 0xFF: // Status protocol<br></td></tr
><tr
id=sl_svn102_255

><td class="source">				m_protocol = new ProtocolStatus(this);<br></td></tr
><tr
id=sl_svn102_256
...
><td class="source">				// No valid protocol<br></td></tr
><tr
id=sl_svn102_259

><td class="source">				closeConnection();<br></td></tr
><tr
id=sl_svn102_260
...
><td class="source">			m_protocol-&gt;onRecvFirstMessage(m_msg);<br></td></tr
><tr
id=sl_svn102_265
...
><td class="source">			// Send the packet to the current protocol<br></td></tr
><tr
id=sl_svn102_268

><td class="source">			m_protocol-&gt;onRecvMessage(m_msg);<br></td></tr
><tr
id=sl_svn102_269
...
><td class="source">		// Wait to the next packet<br></td></tr
><tr
id=sl_svn102_272
...
><td class="source">void Connection::handleReadError(const boost::system::error_code&amp; error)<br></td></tr
><tr
id=sl_svn102_284
...
><td class="source">	PRINT_ASIO_ERROR(&quot;Reading - detail&quot;);<br></td></tr
><tr
id=sl_svn102_287
...
><td class="source">	if(error == boost::asio::error::operation_aborted){<br></td></tr
><tr
id=sl_svn102_289

><td class="source">		//Operation aborted because connection will be closed<br></td></tr
><tr
id=sl_svn102_290

><td class="source">		//Do NOT call closeConnection() from here<br></td></tr
><tr
id=sl_svn102_291
...
><td class="source">	else if(error == boost::asio::error::eof){<br></td></tr
><tr
id=sl_svn102_293

><td class="source">		//No more to read<br></td></tr
><tr
id=sl_svn102_294
...
><td class="source">	else if(error == boost::asio::error::connection_reset ||<br></td></tr
><tr
id=sl_svn102_297

><td class="source">			error == boost::asio::error::connection_aborted){<br></td></tr
><tr
id=sl_svn102_298

><td class="source">		//Connection closed remotely<br></td></tr
><tr
id=sl_svn102_299
...
><td class="source">		PRINT_ASIO_ERROR(&quot;Reading&quot;);<br></td></tr
><tr
id=sl_svn102_303
...
><td class="source">	m_readError = true;<br></td></tr
><tr
id=sl_svn102_306
...
><td class="source">bool Connection::send(OutputMessage_ptr msg)<br></td></tr
><tr
id=sl_svn102_309
...
><td class="source">	std::cout &lt;&lt; &quot;Connection::send init&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_312
...
><td class="source">	if(m_closeState == CLOSE_STATE_CLOSING || m_writeError){<br></td></tr
><tr
id=sl_svn102_316
...
><td class="source">	if(m_pendingWrite == 0){<br></td></tr
><tr
id=sl_svn102_321

><td class="source">		msg-&gt;getProtocol()-&gt;onSendMessage(msg);<br></td></tr
><tr
id=sl_svn102_322
...
><td class="source">		TRACK_MESSAGE(msg);<br></td></tr
><tr
id=sl_svn102_324
...
><td class="source">		std::cout &lt;&lt; &quot;Connection::send &quot; &lt;&lt; msg-&gt;getMessageLength() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_327
...
><td class="source">		internalSend(msg);<br></td></tr
><tr
id=sl_svn102_329
...
><td class="source">		std::cout &lt;&lt; &quot;Connection::send Adding to queue &quot; &lt;&lt; msg-&gt;getMessageLength() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_333
...
><td class="source">		OutputMessagePool* outputPool = OutputMessagePool::getInstance();<br></td></tr
><tr
id=sl_svn102_337

><td class="source">		outputPool-&gt;addToAutoSend(msg);<br></td></tr
><tr
id=sl_svn102_338
...
><td class="source">void Connection::internalSend(OutputMessage_ptr msg)<br></td></tr
><tr
id=sl_svn102_344
...
><td class="source">    m_pendingWrite++;<br></td></tr
><tr
id=sl_svn102_347

><td class="source">	boost::asio::async_write(m_socket,<br></td></tr
><tr
id=sl_svn102_348

><td class="source">		boost::asio::buffer(msg-&gt;getOutputBuffer(), msg-&gt;getMessageLength()),<br></td></tr
><tr
id=sl_svn102_349

><td class="source">		boost::bind(&amp;Connection::onWriteOperation, this, msg, boost::asio::placeholders::error));<br></td></tr
><tr
id=sl_svn102_350
...
><td class="source">uint32_t Connection::getIP() const<br></td></tr
><tr
id=sl_svn102_353
...
><td class="source">	//Ip is expressed in network byte order<br></td></tr
><tr
id=sl_svn102_355
...
><td class="source">	const boost::asio::ip::tcp::endpoint endpoint = m_socket.remote_endpoint(error);<br></td></tr
><tr
id=sl_svn102_357
...
><td class="source">		return htonl(endpoint.address().to_v4().to_ulong());<br></td></tr
><tr
id=sl_svn102_359
...
><td class="source">		PRINT_ASIO_ERROR(&quot;Getting remote ip&quot;);<br></td></tr
><tr
id=sl_svn102_362
...
><td class="source">void Connection::onWriteOperation(OutputMessage_ptr msg, const boost::system::error_code&amp; error)<br></td></tr
><tr
id=sl_svn102_367
...
><td class="source">	std::cout &lt;&lt; &quot;onWriteOperation&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_370
...
><td class="source">	msg.reset();<br></td></tr
><tr
id=sl_svn102_377
...
><td class="source">		handleWriteError(error);<br></td></tr
><tr
id=sl_svn102_380
...
><td class="source">void Connection::handleWriteError(const boost::system::error_code&amp; error)<br></td></tr
><tr
id=sl_svn102_393
...
><td class="source">	PRINT_ASIO_ERROR(&quot;Writing - detail&quot;);<br></td></tr
><tr
id=sl_svn102_396
...
><td class="source">		PRINT_ASIO_ERROR(&quot;Writting&quot;);<br></td></tr
><tr
id=sl_svn102_412
...
><td class="source">	m_writeError = true;<br></td></tr
><tr
id=sl_svn102_415
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/connection.cpp&amp;old_path=/trunk/src/connection.cpp&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/connection.cpp';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/connection.cpp&amp;old_path=/trunk/src/connection.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/connection.cpp&start=52">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 11038 bytes,
 415 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/connection.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/connection.cpp'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdVKexa7LaNIXg-EW3csjY1iNC9hQ:1406096423375", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null}, '', 'svn102', paths,
