...
<head>
 ...
 var codesite_token = "ABZ6GAcOmt4UpR4x-4faT3uIzuRf_t2C6w:1406096613199";
 
 
 var CS_env = {"loggedInUserEmail": "jose.guitian@coremain.com", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "token": "ABZ6GAcOmt4UpR4x-4faT3uIzuRf_t2C6w:1406096613199", "domainName": null, "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fnetworkmessage.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>networkmessage.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/networkmessage.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/networkmessage.h?r=86" title="Previous">&lsaquo;r86</a></li>
...
><td class="source">#ifndef __OTSERV_NETWORK_MESSAGE_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_NETWORK_MESSAGE_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">class NetworkMessage<br></td></tr
><tr
id=sl_svn102_36
...
><td class="source">	enum { header_length = 2 };<br></td></tr
><tr
id=sl_svn102_39

><td class="source">	enum { max_body_length = NETWORKMESSAGE_MAXSIZE - header_length };<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">	// constructor/destructor<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	NetworkMessage(){<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	virtual ~NetworkMessage(){};<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">	// resets the internal buffer to an empty message<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">		m_overrun = false;<br></td></tr
><tr
id=sl_svn102_51

><td class="source">		m_MsgSize = 0;<br></td></tr
><tr
id=sl_svn102_52

><td class="source">		m_ReadPos = 4;<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">	// simply read functions for incoming message<br></td></tr
><tr
id=sl_svn102_56

><td class="source">	uint8_t  GetByte(){<br></td></tr
><tr
id=sl_svn102_57

><td class="source">		return m_MsgBuf[m_ReadPos++];<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	uint16_t GetU16(){<br></td></tr
><tr
id=sl_svn102_62

><td class="source">		if(!expectRead(2)){<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">		uint16_t v = *(uint16_t*)(m_MsgBuf + m_ReadPos);<br></td></tr
><tr
id=sl_svn102_67

><td class="source">		m_ReadPos += 2;<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	uint32_t GetU32(){<br></td></tr
><tr
id=sl_svn102_71

><td class="source">		if(!expectRead(4)){<br></td></tr
><tr
id=sl_svn102_72
...
><td class="source">		uint32_t v = *(uint32_t*)(m_MsgBuf + m_ReadPos);<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">	uint32_t PeekU32(){<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">		return swap_uint16(v);<br></td></tr
><tr
id=sl_svn102_96
...
><td class="source">		return swap_uint32(v);<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">	uint16_t GetSpriteId(){<br></td></tr
><tr
id=sl_svn102_117

><td class="source">		return GetU16();<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">	std::string GetString();<br></td></tr
><tr
id=sl_svn102_121

><td class="source">	std::string GetRaw();<br></td></tr
><tr
id=sl_svn102_122

><td class="source">	Position GetPosition();<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">	// skips count unknown/unused bytes in an incoming message<br></td></tr
><tr
id=sl_svn102_125

><td class="source">	void SkipBytes(int count){m_ReadPos += count;}<br></td></tr
><tr
id=sl_svn102_126
...
><td class="source">	// simply write functions for outgoing message<br></td></tr
><tr
id=sl_svn102_128

><td class="source">	void AddByte(uint8_t value){<br></td></tr
><tr
id=sl_svn102_129

><td class="source">		if(canAdd(1)){<br></td></tr
><tr
id=sl_svn102_130

><td class="source">			m_MsgBuf[m_ReadPos++] = value;<br></td></tr
><tr
id=sl_svn102_131

><td class="source">			m_MsgSize++;<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	void AddU16(uint16_t value){<br></td></tr
><tr
id=sl_svn102_137

><td class="source">		if(canAdd(2)){<br></td></tr
><tr
id=sl_svn102_138

><td class="source">			*(uint16_t*)(m_MsgBuf + m_ReadPos) = value;<br></td></tr
><tr
id=sl_svn102_139

><td class="source">			m_ReadPos += 2; m_MsgSize += 2;<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">	void AddU32(uint32_t value){<br></td></tr
><tr
id=sl_svn102_143

><td class="source">		if(canAdd(4)){<br></td></tr
><tr
id=sl_svn102_144

><td class="source">			*(uint32_t*)(m_MsgBuf + m_ReadPos) = value;<br></td></tr
><tr
id=sl_svn102_145

><td class="source">			m_ReadPos += 4; m_MsgSize += 4;<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">			*(uint16_t*)(m_MsgBuf + m_ReadPos) = swap_uint16(value);<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">			*(uint32_t*)(m_MsgBuf + m_ReadPos) = swap_uint32(value);<br></td></tr
><tr
id=sl_svn102_158
...
><td class="source">	void AddBytes(const char* bytes, uint32_t size);<br></td></tr
><tr
id=sl_svn102_163

><td class="source">	void AddPaddingBytes(uint32_t n);<br></td></tr
><tr
id=sl_svn102_164
...
><td class="source">	void AddString(const std::string &amp;value){AddString(value.c_str());}<br></td></tr
><tr
id=sl_svn102_166

><td class="source">	void AddString(const char* value);<br></td></tr
><tr
id=sl_svn102_167
...
><td class="source">	// write functions for complex types<br></td></tr
><tr
id=sl_svn102_169

><td class="source">	void AddPosition(const Position &amp;pos);<br></td></tr
><tr
id=sl_svn102_170

><td class="source">	void AddItem(uint16_t id, uint8_t count);<br></td></tr
><tr
id=sl_svn102_171

><td class="source">	void AddItem(const Item *item);<br></td></tr
><tr
id=sl_svn102_172

><td class="source">	void AddItemId(const Item *item);<br></td></tr
><tr
id=sl_svn102_173

><td class="source">	void AddItemId(uint16_t itemId);<br></td></tr
><tr
id=sl_svn102_174

><td class="source">	void AddCreature(const Creature *creature, bool known, unsigned int remove);<br></td></tr
><tr
id=sl_svn102_175
...
><td class="source">	int32_t getMessageLength() const { return m_MsgSize; }<br></td></tr
><tr
id=sl_svn102_177

><td class="source">	void setMessageLength(int32_t newSize) { m_MsgSize = newSize; }<br></td></tr
><tr
id=sl_svn102_178

><td class="source">	int32_t getReadPos() const { return m_ReadPos; }<br></td></tr
><tr
id=sl_svn102_179

><td class="source">	void setReadPos(int32_t pos) {m_ReadPos = pos; }<br></td></tr
><tr
id=sl_svn102_180
...
><td class="source">	int32_t decodeHeader();<br></td></tr
><tr
id=sl_svn102_182
...
><td class="source">	bool isOverrun(){ return m_overrun; };<br></td></tr
><tr
id=sl_svn102_184
...
><td class="source">	char* getBuffer() { return (char*)&amp;m_MsgBuf[0]; }<br></td></tr
><tr
id=sl_svn102_186

><td class="source">	char* getBodyBuffer() { m_ReadPos = 2; return (char*)&amp;m_MsgBuf[header_length]; }<br></td></tr
><tr
id=sl_svn102_187
...
><td class="source">	inline bool canAdd(int size)<br></td></tr
><tr
id=sl_svn102_195
...
><td class="source">		return (size + m_ReadPos &lt; NETWORKMESSAGE_MAXSIZE - 16);<br></td></tr
><tr
id=sl_svn102_197
...
><td class="source">	inline bool expectRead(int32_t size){<br></td></tr
><tr
id=sl_svn102_200

><td class="source">		if(size &gt;= (NETWORKMESSAGE_MAXSIZE - m_ReadPos)){<br></td></tr
><tr
id=sl_svn102_201

><td class="source">			m_overrun = true;<br></td></tr
><tr
id=sl_svn102_202
...
><td class="source">	int32_t m_MsgSize;<br></td></tr
><tr
id=sl_svn102_209

><td class="source">	int32_t m_ReadPos;<br></td></tr
><tr
id=sl_svn102_210
...
><td class="source">	bool m_overrun;<br></td></tr
><tr
id=sl_svn102_212
...
><td class="source">	uint8_t m_MsgBuf[NETWORKMESSAGE_MAXSIZE];<br></td></tr
><tr
id=sl_svn102_214
...
><td class="source">typedef boost::shared_ptr&lt;NetworkMessage&gt; NetworkMessage_ptr;<br></td></tr
><tr
id=sl_svn102_217
...
><td class="source">#endif // #ifndef __NETWORK_MESSAGE_H__<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/networkmessage.h&amp;old_path=/trunk/src/networkmessage.h&amp;old=86">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/networkmessage.h';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=86&amp;format=side&amp;path=/trunk/src/networkmessage.h&amp;old_path=/trunk/src/networkmessage.h&amp;old=57">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 10, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=57&amp;format=side&amp;path=/trunk/src/networkmessage.h&amp;old_path=/trunk/src/networkmessage.h&amp;old=52">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/networkmessage.h&amp;old_path=/trunk/src/networkmessage.h&amp;old=7">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/networkmessage.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/networkmessage.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/networkmessage.h'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": "jose.guitian@coremain.com", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "token": "ABZ6GAcOmt4UpR4x-4faT3uIzuRf_t2C6w:1406096613199", "domainName": null, "projectName": "avesta74"}, '', 'svn102', paths,
