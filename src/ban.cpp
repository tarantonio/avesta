...
<head>
 ...
 var codesite_token = "ABZ6GAcOpOtqjZjtvPy8T8y6TLlCcPHw0A:1406096218865";
 
 
 var CS_env = {"projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAcOpOtqjZjtvPy8T8y6TLlCcPHw0A:1406096218865", "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fban.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>ban.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/ban.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/ban.cpp?r=52" title="Previous">&lsaquo;r52</a></li>
...
><td class="source">BanManager::BanManager()<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">void BanManager::loadSettings()<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">	maxLoginTries = (uint32_t)g_config.getNumber(ConfigManager::LOGIN_TRIES);<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	retryTimeout = (uint32_t)g_config.getNumber(ConfigManager::RETRY_TIMEOUT) / 1000;<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	loginTimeout = (uint32_t)g_config.getNumber(ConfigManager::LOGIN_TIMEOUT) / 1000;<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">bool BanManager::clearTemporaryBans() <br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	query &lt;&lt; &quot;UPDATE `bans` SET `active` = 0 WHERE `expires` = 0&quot;;<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	return db-&gt;executeQuery(query.str());<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">bool BanManager::isIpBanished(uint32_t clientip, uint32_t mask /*= 0xFFFFFFFF*/) const<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">	if(clientip != 0){<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">			&quot;SELECT &quot;<br></td></tr
><tr
id=sl_svn102_66

><td class="source">				&quot;COUNT(*) AS `count` &quot;<br></td></tr
><tr
id=sl_svn102_67

><td class="source">			&quot;FROM &quot;<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">			&quot;WHERE &quot;<br></td></tr
><tr
id=sl_svn102_70

><td class="source">				&quot;`type` = &quot; &lt;&lt; BANTYPE_IP_BANISHMENT &lt;&lt; &quot; AND &quot;<br></td></tr
><tr
id=sl_svn102_71

><td class="source">				&quot;((&quot; &lt;&lt; clientip &lt;&lt; &quot; &amp; &quot; &lt;&lt; mask &lt;&lt; &quot; &amp; `param`) = (`value` &amp; `param` &amp; &quot; &lt;&lt; mask &lt;&lt; &quot;)) AND &quot;<br></td></tr
><tr
id=sl_svn102_72

><td class="source">				&quot;`active` = 1 AND &quot;<br></td></tr
><tr
id=sl_svn102_73

><td class="source">				&quot;(`expires` &gt;= &quot; &lt;&lt; currentTime &lt;&lt; &quot; OR `expires` = 0)&quot;;<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">		if((result = db-&gt;storeQuery(query.str())) != NULL){<br></td></tr
><tr
id=sl_svn102_76

><td class="source">			int t = result-&gt;getDataInt(&quot;count&quot;);<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">			return t &gt; 0;<br></td></tr
><tr
id=sl_svn102_79
...
><td class="source">bool BanManager::isNameLocked(std::string name) const<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	if (!IOPlayer::instance()-&gt;getGuidByName(_guid, name)) {<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">	query &lt;&lt; &quot;SELECT `id` FROM `bans` WHERE `value` = &quot; &lt;&lt; _guid &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_NAMELOCK &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_98
...
><td class="source">bool BanManager::isBanished(uint32_t account) const<br></td></tr
><tr
id=sl_svn102_106
...
><td class="source">	query &lt;&lt; &quot;SELECT `expires` FROM `bans` WHERE `value` = &quot; &lt;&lt; account &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_BANISHMENT &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_112
...
><td class="source">	uint64_t expires = result-&gt;getDataInt(&quot;expires&quot;);<br></td></tr
><tr
id=sl_svn102_116
...
><td class="source">	if(expires == 0 || (uint64_t)time(NULL) &lt;= expires)<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">bool BanManager::isDeleted(uint32_t account) const<br></td></tr
><tr
id=sl_svn102_124
...
><td class="source">	query &lt;&lt; &quot;SELECT `id` FROM `bans` WHERE `value` = &quot; &lt;&lt; account &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_DELETION &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_130
...
><td class="source">bool BanManager::isIpDisabled(uint32_t clientip) const<br></td></tr
><tr
id=sl_svn102_138
...
><td class="source">	if(maxLoginTries == 0)<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">		banLock.lock();<br></td></tr
><tr
id=sl_svn102_144
...
><td class="source">		IpLoginMap::const_iterator it = ipLoginMap.find(clientip);<br></td></tr
><tr
id=sl_svn102_147

><td class="source">		if(it != ipLoginMap.end()){<br></td></tr
><tr
id=sl_svn102_148

><td class="source">			if( (it-&gt;second.numberOfLogins &gt;= maxLoginTries) &amp;&amp;<br></td></tr
><tr
id=sl_svn102_149

><td class="source">				(currentTime &lt; it-&gt;second.lastLoginTime + loginTimeout) )<br></td></tr
><tr
id=sl_svn102_150
...
><td class="source">				banLock.unlock();<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">bool BanManager::acceptConnection(uint32_t clientip)<br></td></tr
><tr
id=sl_svn102_163
...
><td class="source">	uint64_t currentTime = OTSYS_TIME();<br></td></tr
><tr
id=sl_svn102_170
...
><td class="source">	IpConnectMap::iterator it = ipConnectMap.find(clientip);<br></td></tr
><tr
id=sl_svn102_172

><td class="source">	if(it == ipConnectMap.end()){<br></td></tr
><tr
id=sl_svn102_173

><td class="source">		ConnectBlock cb;<br></td></tr
><tr
id=sl_svn102_174

><td class="source">		cb.lastConnection = currentTime;<br></td></tr
><tr
id=sl_svn102_175
...
><td class="source">		ipConnectMap[clientip] = cb;<br></td></tr
><tr
id=sl_svn102_177
...
><td class="source">	if(currentTime - it-&gt;second.lastConnection &lt; 1000){<br></td></tr
><tr
id=sl_svn102_183
...
><td class="source">	it-&gt;second.lastConnection = currentTime;<br></td></tr
><tr
id=sl_svn102_188
...
><td class="source">void BanManager::addLoginAttempt(uint32_t clientip, bool isSuccess)<br></td></tr
><tr
id=sl_svn102_194
...
><td class="source">		IpLoginMap::iterator it = ipLoginMap.find(clientip);<br></td></tr
><tr
id=sl_svn102_201
...
><td class="source">			LoginBlock lb;<br></td></tr
><tr
id=sl_svn102_203

><td class="source">			lb.lastLoginTime = 0;<br></td></tr
><tr
id=sl_svn102_204

><td class="source">			lb.numberOfLogins = 0;<br></td></tr
><tr
id=sl_svn102_205
...
><td class="source">			ipLoginMap[clientip] = lb;<br></td></tr
><tr
id=sl_svn102_207

><td class="source">			it = ipLoginMap.find(clientip);<br></td></tr
><tr
id=sl_svn102_208
...
><td class="source">			it-&gt;second.numberOfLogins = 0;<br></td></tr
><tr
id=sl_svn102_212
...
><td class="source">		if(!isSuccess || (currentTime &lt; it-&gt;second.lastLoginTime + retryTimeout)){<br></td></tr
><tr
id=sl_svn102_215

><td class="source">			++it-&gt;second.numberOfLogins;<br></td></tr
><tr
id=sl_svn102_216
...
><td class="source">		it-&gt;second.lastLoginTime = currentTime;<br></td></tr
><tr
id=sl_svn102_222
...
><td class="source">void BanManager::addIpBanishment(uint32_t ip, uint32_t time, uint32_t adminId, std::string reason, std::string comment)<br></td></tr
><tr
id=sl_svn102_228
...
><td class="source">	if(ip == 0 || isIpBanished(ip)) <br></td></tr
><tr
id=sl_svn102_230
...
><td class="source">	stmt.setQuery(&quot;INSERT INTO `bans` (`type`, `value`, `param`, `expires`, `added`, `admin_id`, `reason`, `comment`) VALUES &quot;);<br></td></tr
><tr
id=sl_svn102_237
...
><td class="source">	query &lt;&lt; BANTYPE_IP_BANISHMENT &lt;&lt; &quot;, &quot; &lt;&lt; ip &lt;&lt; &quot;, 4294967295, &quot; &lt;&lt; time &lt;&lt; &quot;, &quot; &lt;&lt; std::time(NULL) &lt;&lt; &quot;, &quot; &lt;&lt; adminId &lt;&lt; &quot;, \&quot;&quot; &lt;&lt; reason &lt;&lt; &quot;\&quot;, &quot; &lt;&lt; db-&gt;escapeString(comment);<br></td></tr
><tr
id=sl_svn102_239
...
><td class="source">void BanManager::addNamelock(std::string name, uint32_t adminId, std::string reason, std::string comment)<br></td></tr
><tr
id=sl_svn102_249
...
><td class="source">	if (!IOPlayer::instance()-&gt;getGuidByName(_guid, name) || isNameLocked(name))<br></td></tr
><tr
id=sl_svn102_252
...
><td class="source">	stmt.setQuery(&quot;INSERT INTO `bans` (`type`, `value`, `expires`, `added`, `admin_id`, `reason`, `comment`) VALUES&quot;);<br></td></tr
><tr
id=sl_svn102_259
...
><td class="source">	query &lt;&lt; BANTYPE_NAMELOCK &lt;&lt; &quot;, &quot; &lt;&lt; _guid &lt;&lt; &quot;, &#39;-1&#39;, &quot; &lt;&lt; std::time(NULL) &lt;&lt; &quot;, &quot; &lt;&lt; adminId &lt;&lt; &quot;, \&quot;&quot; &lt;&lt; reason &lt;&lt; &quot;\&quot;, &quot; &lt;&lt; db-&gt;escapeString(comment);<br></td></tr
><tr
id=sl_svn102_261
...
><td class="source">void BanManager::addBanishment(std::string name, uint32_t time, uint32_t adminId, std::string reason, std::string comment)<br></td></tr
><tr
id=sl_svn102_271
...
><td class="source">	uint32_t account = IOPlayer::instance()-&gt;getAccountIdByName(name);<br></td></tr
><tr
id=sl_svn102_273

><td class="source">	if (!account || isBanished(account) || isDeleted(account))<br></td></tr
><tr
id=sl_svn102_274
...
><td class="source">	query &lt;&lt; BANTYPE_BANISHMENT &lt;&lt; &quot;, &quot; &lt;&lt; account &lt;&lt; &quot;, &quot; &lt;&lt; time &lt;&lt; &quot;, &quot; &lt;&lt; std::time(NULL) &lt;&lt; &quot;, &quot; &lt;&lt; adminId &lt;&lt; &quot;, \&quot;&quot; &lt;&lt; reason &lt;&lt; &quot;\&quot;, &quot; &lt;&lt; db-&gt;escapeString(comment);<br></td></tr
><tr
id=sl_svn102_283
...
><td class="source">void BanManager::addDeletion(std::string name, uint32_t adminId, std::string reason, std::string comment)<br></td></tr
><tr
id=sl_svn102_293
...
><td class="source">	if (!account || isDeleted(account))<br></td></tr
><tr
id=sl_svn102_296
...
><td class="source">	query &lt;&lt; BANTYPE_DELETION &lt;&lt; &quot;, &quot; &lt;&lt; account &lt;&lt; &quot;, &#39;-1&#39;, &quot; &lt;&lt; time(NULL) &lt;&lt; &quot;, &quot; &lt;&lt; adminId &lt;&lt; &quot;, \&quot;&quot; &lt;&lt; reason &lt;&lt; &quot;\&quot;, &quot; &lt;&lt; db-&gt;escapeString(comment);<br></td></tr
><tr
id=sl_svn102_304
...
><td class="source">void BanManager::addNotation(std::string name, uint32_t adminId, std::string reason, std::string comment)<br></td></tr
><tr
id=sl_svn102_314
...
><td class="source">	if (!account)<br></td></tr
><tr
id=sl_svn102_317
...
><td class="source">	query &lt;&lt; BANTYPE_NOTATION &lt;&lt; &quot;, &quot; &lt;&lt; account &lt;&lt; &quot;, &#39;-1&#39;, &quot; &lt;&lt; time(NULL) &lt;&lt; &quot;, &quot; &lt;&lt; adminId &lt;&lt; &quot;, \&quot;&quot; &lt;&lt; reason &lt;&lt; &quot;\&quot;, &quot; &lt;&lt; db-&gt;escapeString(comment);<br></td></tr
><tr
id=sl_svn102_325
...
><td class="source">bool BanManager::removeIpBanishment(uint32_t ip)<br></td></tr
><tr
id=sl_svn102_335
...
><td class="source">	query &lt;&lt; &quot;UPDATE `bans` SET `active` = 0 WHERE `type` = &quot; &lt;&lt; BANTYPE_IP_BANISHMENT &lt;&lt; &quot; AND `value` = &quot; &lt;&lt; ip  &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_339
...
><td class="source">bool BanManager::removeNamelock(std::string name)<br></td></tr
><tr
id=sl_svn102_343
...
><td class="source">	query &lt;&lt; &quot;UPDATE `bans` SET `active` = 0 WHERE `value` = &quot; &lt;&lt; _guid &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_NAMELOCK &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_351
...
><td class="source">bool BanManager::removeBanishment(std::string name)<br></td></tr
><tr
id=sl_svn102_355
...
><td class="source">	query &lt;&lt; &quot;UPDATE `bans` SET `active` = 0 WHERE `value` = &quot; &lt;&lt; account &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_BANISHMENT &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_363
...
><td class="source">bool BanManager::removeDeletion(std::string name)<br></td></tr
><tr
id=sl_svn102_367
...
><td class="source">	query &lt;&lt; &quot;UPDATE `bans` SET `active` = 0 WHERE `value` = &quot; &lt;&lt; account &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_DELETION &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_375
...
><td class="source">bool BanManager::removeNotations(std::string name)<br></td></tr
><tr
id=sl_svn102_379
...
><td class="source">	query &lt;&lt; &quot;UPDATE `bans` SET `active` = 0 WHERE `value` = &quot; &lt;&lt; account &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_NOTATION &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_387
...
><td class="source">uint32_t BanManager::getNotationsCount(uint32_t account)<br></td></tr
><tr
id=sl_svn102_391
...
><td class="source">	query &lt;&lt; &quot;SELECT COUNT(`id`) AS `count` FROM `bans` WHERE `value` = &quot; &lt;&lt; account &lt;&lt; &quot; AND `type` = &quot; &lt;&lt; BANTYPE_NOTATION &lt;&lt; &quot; AND `active` = 1&quot;;<br></td></tr
><tr
id=sl_svn102_397
...
><td class="source">	const uint32_t count = result-&gt;getDataInt(&quot;count&quot;);<br></td></tr
><tr
id=sl_svn102_401
...
><td class="source">std::vector&lt;Ban&gt; BanManager::getBans(BanType_t type) const <br></td></tr
><tr
id=sl_svn102_406
...
><td class="source">	assert(type == BANTYPE_IP_BANISHMENT || type == BANTYPE_NAMELOCK || type == BANTYPE_BANISHMENT);<br></td></tr
><tr
id=sl_svn102_408
...
><td class="source">			&quot;`expires`, &quot;<br></td></tr
><tr
id=sl_svn102_420

><td class="source">			&quot;`added`, &quot;<br></td></tr
><tr
id=sl_svn102_421

><td class="source">			&quot;`admin_id`, &quot;<br></td></tr
><tr
id=sl_svn102_422

><td class="source">			&quot;`reason`, &quot;<br></td></tr
><tr
id=sl_svn102_423
...
><td class="source">			&quot;`type` = &quot; &lt;&lt; type &lt;&lt; &quot; AND &quot;<br></td></tr
><tr
id=sl_svn102_428
...
><td class="source">	std::vector&lt;Ban&gt; vec;<br></td></tr
><tr
id=sl_svn102_432
...
><td class="source">			Ban ban;<br></td></tr
><tr
id=sl_svn102_435

><td class="source">			ban.type = type;<br></td></tr
><tr
id=sl_svn102_436

><td class="source">			ban.id = result-&gt;getDataInt(&quot;id&quot;);<br></td></tr
><tr
id=sl_svn102_437

><td class="source">			ban.value = result-&gt;getDataString(&quot;value&quot;);<br></td></tr
><tr
id=sl_svn102_438

><td class="source">			ban.param = result-&gt;getDataString(&quot;param&quot;);<br></td></tr
><tr
id=sl_svn102_439

><td class="source">			ban.expires = (uint32_t)result-&gt;getDataLong(&quot;expires&quot;);<br></td></tr
><tr
id=sl_svn102_440

><td class="source">			ban.added = (uint32_t)result-&gt;getDataLong(&quot;id&quot;);<br></td></tr
><tr
id=sl_svn102_441

><td class="source">			ban.adminid = result-&gt;getDataInt(&quot;admin_id&quot;);<br></td></tr
><tr
id=sl_svn102_442

><td class="source">			ban.reason = result-&gt;getDataString(&quot;reason&quot;);<br></td></tr
><tr
id=sl_svn102_443

><td class="source">			ban.comment = result-&gt;getDataString(&quot;comment&quot;);<br></td></tr
><tr
id=sl_svn102_444

><td class="source">			vec.push_back(ban);<br></td></tr
><tr
id=sl_svn102_445
...
><td class="source">	return vec;<br></td></tr
><tr
id=sl_svn102_450
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/ban.cpp&amp;old_path=/trunk/src/ban.cpp&amp;old=52">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/ban.cpp';
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/ban.cpp&amp;old_path=/trunk/src/ban.cpp&amp;old=37">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Apr 9, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=37&amp;format=side&amp;path=/trunk/src/ban.cpp&amp;old_path=/trunk/src/ban.cpp&amp;old=7">Diff</a>
 <br>
...
rope with pool on rope spot fix</pre>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/ban.cpp&amp;old_path=/trunk/src/ban.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/ban.cpp&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 12673 bytes,
 450 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/ban.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/ban.cpp'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAcOpOtqjZjtvPy8T8y6TLlCcPHw0A:1406096218865", "projectName": "avesta74"}, '', 'svn102', paths,
