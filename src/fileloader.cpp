...
<head>
 ...
 var codesite_token = "ABZ6GAet2Gv6xrNnrVkNGnU0txC5Yf0heg:1406096486398";
 
 
 var CS_env = {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAet2Gv6xrNnrVkNGnU0txC5Yf0heg:1406096486398", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Ffileloader.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>fileloader.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/fileloader.cpp?edit=1"
...
><td class="source">FileLoader::FileLoader()<br></td></tr
><tr
id=sl_svn102_29
...
><td class="source">	m_file = NULL;<br></td></tr
><tr
id=sl_svn102_31

><td class="source">	m_root = NULL;<br></td></tr
><tr
id=sl_svn102_32

><td class="source">	m_buffer = new unsigned char[1024];<br></td></tr
><tr
id=sl_svn102_33

><td class="source">	m_buffer_size = 1024;<br></td></tr
><tr
id=sl_svn102_34

><td class="source">	m_lastError = ERROR_NONE;<br></td></tr
><tr
id=sl_svn102_35

><td class="source">	//cache<br></td></tr
><tr
id=sl_svn102_36

><td class="source">	m_use_cache = false;<br></td></tr
><tr
id=sl_svn102_37

><td class="source">	m_cache_size = 0;<br></td></tr
><tr
id=sl_svn102_38

><td class="source">	m_cache_index = NO_VALID_CACHE;<br></td></tr
><tr
id=sl_svn102_39

><td class="source">	m_cache_offset = NO_VALID_CACHE;<br></td></tr
><tr
id=sl_svn102_40

><td class="source">	memset(m_cached_data, 0, sizeof(m_cached_data));<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	if(m_file){<br></td></tr
><tr
id=sl_svn102_47

><td class="source">		fclose(m_file);<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">	NodeStruct::clearNet(m_root);<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	delete[] m_buffer;<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">	for(int i = 0; i &lt; CACHE_BLOCKS; i++){<br></td></tr
><tr
id=sl_svn102_55

><td class="source">		if(m_cached_data[i].data)<br></td></tr
><tr
id=sl_svn102_56

><td class="source">			delete[] m_cached_data[i].data;<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">bool FileLoader::openFile(const char* filename, bool write, bool caching /*= false*/)<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	if(write) {<br></td></tr
><tr
id=sl_svn102_63

><td class="source">		m_file = fopen(filename, &quot;wb&quot;);<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">			uint32_t version = 0;<br></td></tr
><tr
id=sl_svn102_66

><td class="source">			writeData(&amp;version, sizeof(version), false);<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">			m_lastError = ERROR_CAN_NOT_CREATE;<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">		m_file = fopen(filename, &quot;rb&quot;);<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">			uint32_t version;<br></td></tr
><tr
id=sl_svn102_78

><td class="source">			fread(&amp;version, sizeof(version), 1, m_file);<br></td></tr
><tr
id=sl_svn102_79

><td class="source">			if(version &gt; 0){<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">				m_lastError = ERROR_INVALID_FILE_VERSION;<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">				if(caching){<br></td></tr
><tr
id=sl_svn102_87

><td class="source">					m_use_cache = true;<br></td></tr
><tr
id=sl_svn102_88

><td class="source">					fseek(m_file, 0, SEEK_END);<br></td></tr
><tr
id=sl_svn102_89

><td class="source">					int file_size = ftell(m_file);<br></td></tr
><tr
id=sl_svn102_90

><td class="source">					m_cache_size = std::min(32768, std::max(file_size/20, 8192)) &amp; ~0x1FFF;<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">				//parse nodes<br></td></tr
><tr
id=sl_svn102_94

><td class="source">				if(safeSeek(4)){<br></td></tr
><tr
id=sl_svn102_95

><td class="source">					delete m_root;<br></td></tr
><tr
id=sl_svn102_96

><td class="source">					m_root = new NodeStruct();<br></td></tr
><tr
id=sl_svn102_97

><td class="source">					m_root-&gt;start = 4;<br></td></tr
><tr
id=sl_svn102_98

><td class="source">					int byte;<br></td></tr
><tr
id=sl_svn102_99

><td class="source">					if(safeSeek(4) &amp;&amp; readByte(byte) &amp;&amp; byte == NODE_START){<br></td></tr
><tr
id=sl_svn102_100

><td class="source">						bool ret = parseNode(m_root);<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">					m_lastError = ERROR_INVALID_FORMAT;<br></td></tr
><tr
id=sl_svn102_109
...
><td class="source">			m_lastError = ERROR_CAN_NOT_OPEN;<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">bool FileLoader::parseNode(NODE node)<br></td></tr
><tr
id=sl_svn102_121
...
><td class="source">	long pos;<br></td></tr
><tr
id=sl_svn102_124

><td class="source">	NODE currentNode = node;<br></td></tr
><tr
id=sl_svn102_125
...
><td class="source">		//read node type<br></td></tr
><tr
id=sl_svn102_127

><td class="source">		if(readByte(byte)){<br></td></tr
><tr
id=sl_svn102_128

><td class="source">			currentNode-&gt;type = byte;<br></td></tr
><tr
id=sl_svn102_129

><td class="source">			bool setPropsSize = false;<br></td></tr
><tr
id=sl_svn102_130
...
><td class="source">				//search child and next node<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">					if(byte == NODE_START){<br></td></tr
><tr
id=sl_svn102_134

><td class="source">						//child node start<br></td></tr
><tr
id=sl_svn102_135

><td class="source">						if(safeTell(pos)){<br></td></tr
><tr
id=sl_svn102_136

><td class="source">							NODE childNode = new NodeStruct();<br></td></tr
><tr
id=sl_svn102_137

><td class="source">							childNode-&gt;start = pos;<br></td></tr
><tr
id=sl_svn102_138

><td class="source">							setPropsSize = true;<br></td></tr
><tr
id=sl_svn102_139

><td class="source">							currentNode-&gt;propsSize = pos - currentNode-&gt;start - 2;<br></td></tr
><tr
id=sl_svn102_140

><td class="source">							currentNode-&gt;child = childNode;<br></td></tr
><tr
id=sl_svn102_141

><td class="source">							if(!parseNode(childNode)){<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">					else if(byte == NODE_END){<br></td></tr
><tr
id=sl_svn102_150

><td class="source">						//current node end<br></td></tr
><tr
id=sl_svn102_151

><td class="source">						if(!setPropsSize){<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">								//starts next node<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">									NODE nextNode = new NodeStruct();<br></td></tr
><tr
id=sl_svn102_164

><td class="source">									nextNode-&gt;start = pos;<br></td></tr
><tr
id=sl_svn102_165

><td class="source">									currentNode-&gt;next = nextNode;<br></td></tr
><tr
id=sl_svn102_166

><td class="source">									currentNode = nextNode;<br></td></tr
><tr
id=sl_svn102_167
...
><td class="source">								//up 1 level and move 1 position back<br></td></tr
><tr
id=sl_svn102_175

><td class="source">								if(safeTell(pos) &amp;&amp; safeSeek(pos)){<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">								//wrong format<br></td></tr
><tr
id=sl_svn102_184
...
><td class="source">							//end of file?<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">					else if(byte == ESCAPE_CHAR){<br></td></tr
><tr
id=sl_svn102_194
...
><td class="source">const unsigned char* FileLoader::getProps(const NODE node, unsigned long &amp;size)<br></td></tr
><tr
id=sl_svn102_210
...
><td class="source">		if(node-&gt;propsSize &gt;= m_buffer_size){<br></td></tr
><tr
id=sl_svn102_213
...
><td class="source">			m_buffer = new unsigned char[m_buffer_size + 1024];<br></td></tr
><tr
id=sl_svn102_215

><td class="source">			m_buffer_size = m_buffer_size + 1024;<br></td></tr
><tr
id=sl_svn102_216
...
><td class="source">		//get buffer<br></td></tr
><tr
id=sl_svn102_218

><td class="source">		if(readBytes(m_buffer, node-&gt;propsSize, node-&gt;start + 2)){<br></td></tr
><tr
id=sl_svn102_219

><td class="source">			//unscape buffer<br></td></tr
><tr
id=sl_svn102_220

><td class="source">			unsigned int j = 0;<br></td></tr
><tr
id=sl_svn102_221

><td class="source">			bool escaped = false;<br></td></tr
><tr
id=sl_svn102_222

><td class="source">			for(unsigned int i = 0; i &lt; node-&gt;propsSize; ++i, ++j){<br></td></tr
><tr
id=sl_svn102_223

><td class="source">				if(m_buffer[i] == ESCAPE_CHAR){<br></td></tr
><tr
id=sl_svn102_224

><td class="source">					//escape char found, skip it and write next<br></td></tr
><tr
id=sl_svn102_225
...
><td class="source">					m_buffer[j] = m_buffer[i];<br></td></tr
><tr
id=sl_svn102_227

><td class="source">					//is neede a displacement for next bytes<br></td></tr
><tr
id=sl_svn102_228

><td class="source">					escaped = true;<br></td></tr
><tr
id=sl_svn102_229
...
><td class="source">				else if(escaped){<br></td></tr
><tr
id=sl_svn102_231

><td class="source">					//perform that displacement<br></td></tr
><tr
id=sl_svn102_232
...
><td class="source">					//the buffer is right as is<br></td></tr
><tr
id=sl_svn102_236
...
><td class="source">			size = j;<br></td></tr
><tr
id=sl_svn102_239

><td class="source">			return m_buffer;<br></td></tr
><tr
id=sl_svn102_240
...
><td class="source">bool FileLoader::getProps(const NODE node, PropStream &amp;props)<br></td></tr
><tr
id=sl_svn102_252
...
><td class="source">	unsigned long size;<br></td></tr
><tr
id=sl_svn102_254

><td class="source">	const unsigned char* a = getProps(node, size);<br></td></tr
><tr
id=sl_svn102_255

><td class="source">	if(!a){<br></td></tr
><tr
id=sl_svn102_256

><td class="source">		props.init(NULL, 0);<br></td></tr
><tr
id=sl_svn102_257
...
><td class="source">		props.init((char*)a, size);<br></td></tr
><tr
id=sl_svn102_261
...
><td class="source">int FileLoader::setProps(void* data, unsigned short size)<br></td></tr
><tr
id=sl_svn102_266
...
><td class="source">	if(!writeData(data, size, true))<br></td></tr
><tr
id=sl_svn102_269

><td class="source">		return getError();<br></td></tr
><tr
id=sl_svn102_270
...
><td class="source">void FileLoader::startNode(unsigned char type)<br></td></tr
><tr
id=sl_svn102_275
...
><td class="source">	unsigned char nodeBegin = NODE_START;<br></td></tr
><tr
id=sl_svn102_277

><td class="source">	writeData(&amp;nodeBegin, sizeof(nodeBegin), false);<br></td></tr
><tr
id=sl_svn102_278

><td class="source">	writeData(&amp;type, sizeof(type), true);<br></td></tr
><tr
id=sl_svn102_279
...
><td class="source">void FileLoader::endNode()<br></td></tr
><tr
id=sl_svn102_282
...
><td class="source">	unsigned char nodeEnd = NODE_END;<br></td></tr
><tr
id=sl_svn102_284

><td class="source">	writeData(&amp;nodeEnd, sizeof(nodeEnd), false);<br></td></tr
><tr
id=sl_svn102_285
...
><td class="source">const NODE FileLoader::getChildNode(const NODE parent, unsigned long &amp;type)<br></td></tr
><tr
id=sl_svn102_288
...
><td class="source">		NODE child = parent-&gt;child;<br></td></tr
><tr
id=sl_svn102_291
...
><td class="source">			type = child-&gt;type;<br></td></tr
><tr
id=sl_svn102_293
...
><td class="source">		return child;<br></td></tr
><tr
id=sl_svn102_295
...
><td class="source">		type = m_root-&gt;type;<br></td></tr
><tr
id=sl_svn102_298

><td class="source">		return m_root;<br></td></tr
><tr
id=sl_svn102_299
...
><td class="source">const NODE FileLoader::getNextNode(const NODE prev, unsigned long &amp;type)<br></td></tr
><tr
id=sl_svn102_303
...
><td class="source">	if(prev){<br></td></tr
><tr
id=sl_svn102_305

><td class="source">		NODE next = prev-&gt;next;<br></td></tr
><tr
id=sl_svn102_306

><td class="source">		if(next){<br></td></tr
><tr
id=sl_svn102_307

><td class="source">			type = next-&gt;type;<br></td></tr
><tr
id=sl_svn102_308
...
><td class="source">		return next;<br></td></tr
><tr
id=sl_svn102_310
...
><td class="source">		return NO_NODE;<br></td></tr
><tr
id=sl_svn102_313
...
><td class="source">inline bool FileLoader::readByte(int &amp;value)<br></td></tr
><tr
id=sl_svn102_318
...
><td class="source">	if(m_use_cache){<br></td></tr
><tr
id=sl_svn102_320

><td class="source">		if(m_cache_index == NO_VALID_CACHE){<br></td></tr
><tr
id=sl_svn102_321

><td class="source">			m_lastError = ERROR_CACHE_ERROR;<br></td></tr
><tr
id=sl_svn102_322
...
><td class="source">		if(m_cache_offset &gt;= m_cached_data[m_cache_index].size){<br></td></tr
><tr
id=sl_svn102_325

><td class="source">			long pos = m_cache_offset + m_cached_data[m_cache_index].base;<br></td></tr
><tr
id=sl_svn102_326

><td class="source">			long tmp = getCacheBlock(pos);<br></td></tr
><tr
id=sl_svn102_327
...
><td class="source">			m_cache_index = tmp;<br></td></tr
><tr
id=sl_svn102_331

><td class="source">			m_cache_offset = pos - m_cached_data[m_cache_index].base;<br></td></tr
><tr
id=sl_svn102_332
...
><td class="source">		value = m_cached_data[m_cache_index].data[m_cache_offset];<br></td></tr
><tr
id=sl_svn102_337

><td class="source">		m_cache_offset++;<br></td></tr
><tr
id=sl_svn102_338
...
><td class="source">		value = fgetc(m_file);<br></td></tr
><tr
id=sl_svn102_342

><td class="source">		if(value == EOF){<br></td></tr
><tr
id=sl_svn102_343

><td class="source">			m_lastError = ERROR_EOF;<br></td></tr
><tr
id=sl_svn102_344
...
><td class="source">inline bool FileLoader::readBytes(unsigned char* buffer, int size, long pos)<br></td></tr
><tr
id=sl_svn102_352
...
><td class="source">		//seek at pos<br></td></tr
><tr
id=sl_svn102_355

><td class="source">		unsigned long reading, remain = size, bufferPos = 0;<br></td></tr
><tr
id=sl_svn102_356
...
><td class="source">			//prepare cache<br></td></tr
><tr
id=sl_svn102_358

><td class="source">			unsigned long i = getCacheBlock(pos);<br></td></tr
><tr
id=sl_svn102_359

><td class="source">			if(i == NO_VALID_CACHE)<br></td></tr
><tr
id=sl_svn102_360
...
><td class="source">			m_cache_index = i;<br></td></tr
><tr
id=sl_svn102_363

><td class="source">			m_cache_offset = pos - m_cached_data[i].base;<br></td></tr
><tr
id=sl_svn102_364
...
><td class="source">			//get maximun read block size and calculate remaining bytes<br></td></tr
><tr
id=sl_svn102_366

><td class="source">			reading = std::min(remain, m_cached_data[i].size - m_cache_offset);<br></td></tr
><tr
id=sl_svn102_367

><td class="source">			remain = remain - reading;<br></td></tr
><tr
id=sl_svn102_368
...
><td class="source">			//read it<br></td></tr
><tr
id=sl_svn102_370

><td class="source">			memcpy(buffer + bufferPos, m_cached_data[m_cache_index].data + m_cache_offset, reading);<br></td></tr
><tr
id=sl_svn102_371
...
><td class="source">			//update variables<br></td></tr
><tr
id=sl_svn102_373

><td class="source">			m_cache_offset = m_cache_offset + reading;<br></td></tr
><tr
id=sl_svn102_374

><td class="source">			bufferPos = bufferPos + reading;<br></td></tr
><tr
id=sl_svn102_375

><td class="source">			pos = pos + reading;<br></td></tr
><tr
id=sl_svn102_376

><td class="source">		}while(remain &gt; 0);<br></td></tr
><tr
id=sl_svn102_377
...
><td class="source">		if(fseek(m_file, pos, SEEK_SET)){<br></td></tr
><tr
id=sl_svn102_381

><td class="source">			m_lastError = ERROR_SEEK_ERROR;<br></td></tr
><tr
id=sl_svn102_382
...
><td class="source">		size_t value = fread(buffer, 1, size, m_file);<br></td></tr
><tr
id=sl_svn102_385

><td class="source">		if(value != size){<br></td></tr
><tr
id=sl_svn102_386
...
><td class="source">inline bool FileLoader::writeData(void* data, int size, bool unescape)<br></td></tr
><tr
id=sl_svn102_398
...
><td class="source">		unsigned char c = *(((unsigned char*)data) + i);<br></td></tr
><tr
id=sl_svn102_401
...
><td class="source">		if(unescape &amp;&amp; (c == NODE_START || c == NODE_END || c == ESCAPE_CHAR)) {<br></td></tr
><tr
id=sl_svn102_403

><td class="source">			unsigned char escape = ESCAPE_CHAR;<br></td></tr
><tr
id=sl_svn102_404

><td class="source">			int value = fwrite(&amp;escape, 1, 1, m_file);<br></td></tr
><tr
id=sl_svn102_405

><td class="source">			if(value != 1) {<br></td></tr
><tr
id=sl_svn102_406

><td class="source">				m_lastError = ERROR_COULDNOTWRITE;<br></td></tr
><tr
id=sl_svn102_407
...
><td class="source">		int value = fwrite(&amp;c, 1, 1, m_file);<br></td></tr
><tr
id=sl_svn102_412
...
><td class="source">inline bool FileLoader::checks(const NODE node)<br></td></tr
><tr
id=sl_svn102_422
...
><td class="source">		m_lastError = ERROR_NOT_OPEN;<br></td></tr
><tr
id=sl_svn102_425
...
><td class="source">		m_lastError = ERROR_INVALID_NODE;<br></td></tr
><tr
id=sl_svn102_429
...
><td class="source">inline bool FileLoader::safeSeek(unsigned long pos)<br></td></tr
><tr
id=sl_svn102_436
...
><td class="source">inline bool FileLoader::safeTell(long &amp;pos)<br></td></tr
><tr
id=sl_svn102_457
...
><td class="source">		pos = m_cached_data[m_cache_index].base + m_cache_offset - 1;<br></td></tr
><tr
id=sl_svn102_465
...
><td class="source">		pos = ftell(m_file);<br></td></tr
><tr
id=sl_svn102_469
...
><td class="source">			m_lastError = ERROR_TELL_ERROR;<br></td></tr
><tr
id=sl_svn102_471
...
><td class="source">			pos = pos - 1;<br></td></tr
><tr
id=sl_svn102_475
...
><td class="source">inline unsigned long FileLoader::getCacheBlock(unsigned long pos)<br></td></tr
><tr
id=sl_svn102_481
...
><td class="source">	unsigned long i;<br></td></tr
><tr
id=sl_svn102_484

><td class="source">	unsigned long base_pos = pos &amp; ~(m_cache_size - 1);<br></td></tr
><tr
id=sl_svn102_485

><td class="source">	for(i = 0; i &lt; CACHE_BLOCKS; i++){<br></td></tr
><tr
id=sl_svn102_486

><td class="source">		if(m_cached_data[i].loaded){<br></td></tr
><tr
id=sl_svn102_487

><td class="source">			if(m_cached_data[i].base == base_pos){<br></td></tr
><tr
id=sl_svn102_488
...
><td class="source">		i = loadCacheBlock(pos);<br></td></tr
><tr
id=sl_svn102_495
...
><td class="source">long FileLoader::loadCacheBlock(unsigned long pos)<br></td></tr
><tr
id=sl_svn102_500
...
><td class="source">	long i;<br></td></tr
><tr
id=sl_svn102_502

><td class="source">	long loading_cache = -1;<br></td></tr
><tr
id=sl_svn102_503

><td class="source">	long base_pos = pos &amp; ~(m_cache_size - 1);<br></td></tr
><tr
id=sl_svn102_504
...
><td class="source">			loading_cache = i;<br></td></tr
><tr
id=sl_svn102_507
...
><td class="source">	if(loading_cache == -1){<br></td></tr
><tr
id=sl_svn102_511
...
><td class="source">			if((long)(labs((long)m_cached_data[i].base - base_pos)) &gt; (long)(2*m_cache_size)){<br></td></tr
><tr
id=sl_svn102_513
...
><td class="source">			loading_cache = 0;<br></td></tr
><tr
id=sl_svn102_519
...
><td class="source">	if(m_cached_data[loading_cache].data == NULL){<br></td></tr
><tr
id=sl_svn102_523

><td class="source">		m_cached_data[loading_cache].data = new unsigned char[m_cache_size];<br></td></tr
><tr
id=sl_svn102_524
...
><td class="source">	m_cached_data[loading_cache].base = base_pos;<br></td></tr
><tr
id=sl_svn102_527
...
><td class="source">	if(fseek(m_file, m_cached_data[loading_cache].base, SEEK_SET)){<br></td></tr
><tr
id=sl_svn102_529
...
><td class="source">	size_t size = fread(m_cached_data[loading_cache].data, 1, m_cache_size, m_file);<br></td></tr
><tr
id=sl_svn102_534

><td class="source">	m_cached_data[loading_cache].size = size;<br></td></tr
><tr
id=sl_svn102_535
...
><td class="source">	if(size &lt; (pos - m_cached_data[loading_cache].base)){<br></td></tr
><tr
id=sl_svn102_537
...
><td class="source">	m_cached_data[loading_cache].loaded = 1;<br></td></tr
><tr
id=sl_svn102_542
...
><td class="source">	return loading_cache;<br></td></tr
><tr
id=sl_svn102_544
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/fileloader.cpp&amp;old_path=/trunk/src/fileloader.cpp&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/fileloader.cpp';
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/fileloader.cpp&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 12041 bytes,
 544 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/fileloader.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/fileloader.cpp'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAet2Gv6xrNnrVkNGnU0txC5Yf0heg:1406096486398", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null}, '', 'svn102', paths,
