...
<head>
 ...
 var codesite_token = "ABZ6GAdfZlm-_htiXk1bGOuatpkph-JLag:1406096429803";
 
 
 var CS_env = {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdfZlm-_htiXk1bGOuatpkph-JLag:1406096429803", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fconnection.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>connection.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/connection.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/connection.h?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#ifndef __OTSERV_CONNECTION_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_CONNECTION_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">class OutputMessage;<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">#define PRINT_ASIO_ERROR(desc) \<br></td></tr
><tr
id=sl_svn102_39

><td class="source">	std::cout &lt;&lt; &quot;Error: [&quot; &lt;&lt; __FUNCTION__ &lt;&lt; &quot;] &quot; &lt;&lt; desc &lt;&lt; &quot; - Error: &quot; &lt;&lt;  \<br></td></tr
><tr
id=sl_svn102_40

><td class="source">		error.value() &lt;&lt; &quot; Desc: &quot; &lt;&lt; error.message() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">class ConnectionManager<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">	~ConnectionManager()<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	static ConnectionManager* getInstance(){<br></td></tr
><tr
id=sl_svn102_54

><td class="source">		static ConnectionManager instance;<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">	Connection* createConnection(boost::asio::io_service&amp; io_service);<br></td></tr
><tr
id=sl_svn102_59

><td class="source">	void releaseConnection(Connection* connection);<br></td></tr
><tr
id=sl_svn102_60

><td class="source">	void closeAll();<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	std::list&lt;Connection*&gt; m_connections;<br></td></tr
><tr
id=sl_svn102_70

><td class="source">	boost::recursive_mutex m_connectionManagerLock;<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">class Connection : boost::noncopyable<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">	static uint32_t connectionCount;<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">		CLOSE_STATE_NONE = 0,<br></td></tr
><tr
id=sl_svn102_81

><td class="source">		CLOSE_STATE_REQUESTED = 1,<br></td></tr
><tr
id=sl_svn102_82

><td class="source">		CLOSE_STATE_CLOSING = 2,<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">	Connection(boost::asio::io_service&amp; io_service) : m_socket(io_service)<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">		m_refCount = 0;<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">		m_pendingWrite = 0;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">		m_pendingRead = 0;<br></td></tr
><tr
id=sl_svn102_92

><td class="source">		m_closeState = CLOSE_STATE_NONE;<br></td></tr
><tr
id=sl_svn102_93

><td class="source">		m_socketClosed = false;<br></td></tr
><tr
id=sl_svn102_94

><td class="source">		m_writeError = false;<br></td></tr
><tr
id=sl_svn102_95

><td class="source">		m_readError = false;<br></td></tr
><tr
id=sl_svn102_96
...
><td class="source">		connectionCount++;<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">	friend class ConnectionManager;<br></td></tr
><tr
id=sl_svn102_102
...
><td class="source">	~Connection()<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">		ConnectionManager::getInstance()-&gt;releaseConnection(this);<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">	boost::asio::ip::tcp::socket&amp; getHandle() { return m_socket; }<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">	void closeConnection();<br></td></tr
><tr
id=sl_svn102_115

><td class="source">	void acceptConnection();<br></td></tr
><tr
id=sl_svn102_116
...
><td class="source">	bool send(OutputMessage_ptr msg);<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">	uint32_t getIP() const;<br></td></tr
><tr
id=sl_svn102_120
...
><td class="source">	int32_t addRef() {return ++m_refCount;}<br></td></tr
><tr
id=sl_svn102_122

><td class="source">	int32_t unRef() {return --m_refCount;}<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">	void parseHeader(const boost::system::error_code&amp; error);<br></td></tr
><tr
id=sl_svn102_126

><td class="source">	void parsePacket(const boost::system::error_code&amp; error);<br></td></tr
><tr
id=sl_svn102_127
...
><td class="source">	void onWriteOperation(OutputMessage_ptr msg, const boost::system::error_code&amp; error);<br></td></tr
><tr
id=sl_svn102_129
...
><td class="source">	void handleReadError(const boost::system::error_code&amp; error);<br></td></tr
><tr
id=sl_svn102_131

><td class="source">	void handleWriteError(const boost::system::error_code&amp; error);<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	void closeConnectionTask();<br></td></tr
><tr
id=sl_svn102_134

><td class="source">	bool closingConnection();<br></td></tr
><tr
id=sl_svn102_135

><td class="source">	void deleteConnectionTask();<br></td></tr
><tr
id=sl_svn102_136

><td class="source">	void releaseConnection();<br></td></tr
><tr
id=sl_svn102_137
...
><td class="source">	void internalSend(OutputMessage_ptr msg);<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">	NetworkMessage m_msg;<br></td></tr
><tr
id=sl_svn102_141

><td class="source">	boost::asio::ip::tcp::socket m_socket;<br></td></tr
><tr
id=sl_svn102_142

><td class="source">	bool m_socketClosed;<br></td></tr
><tr
id=sl_svn102_143
...
><td class="source">	bool m_writeError;<br></td></tr
><tr
id=sl_svn102_145

><td class="source">	bool m_readError;<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">	int32_t m_pendingWrite;<br></td></tr
><tr
id=sl_svn102_148

><td class="source">	std::list &lt;OutputMessage_ptr&gt; m_outputQueue;<br></td></tr
><tr
id=sl_svn102_149

><td class="source">	int32_t m_pendingRead;<br></td></tr
><tr
id=sl_svn102_150

><td class="source">	uint32_t m_closeState;<br></td></tr
><tr
id=sl_svn102_151

><td class="source">	uint32_t m_refCount;<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">	boost::recursive_mutex m_connectionLock;<br></td></tr
><tr
id=sl_svn102_154
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/connection.h&amp;old_path=/trunk/src/connection.h&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/connection.h';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/connection.h&amp;old_path=/trunk/src/connection.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/connection.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/connection.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/connection.h'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdfZlm-_htiXk1bGOuatpkph-JLag:1406096429803", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null}, '', 'svn102', paths,
