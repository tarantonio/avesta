...
<head>
 ...
 var codesite_token = "ABZ6GAd2kEsCmjAFDsOKJcuAf02synWqAg:1406096500099";
 
 
 var CS_env = {"profileUrl": "/u/108692122734644646415/", "domainName": null, "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAd2kEsCmjAFDsOKJcuAf02synWqAg:1406096500099", "projectHomeUrl": "/p/avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fhouse.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>house.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/house.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/house.cpp?r=86" title="Previous">&lsaquo;r86</a></li>
...
><td class="source">House::House(uint32_t _houseid) :<br></td></tr
><tr
id=sl_svn102_39

><td class="source">transfer_container(ITEM_LOCKER1)<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">	isLoaded = false;<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	houseName = &quot;OTServ headquarter (Flat 1, Area 42)&quot;;<br></td></tr
><tr
id=sl_svn102_43

><td class="source">	houseOwner = 0;<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	posEntry.x = 0;<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	posEntry.y = 0;<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	posEntry.z = 0;<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	paidUntil = 0;<br></td></tr
><tr
id=sl_svn102_48

><td class="source">	houseid = _houseid;<br></td></tr
><tr
id=sl_svn102_49

><td class="source">	rentWarnings = 0;<br></td></tr
><tr
id=sl_svn102_50

><td class="source">	lastWarning = 0;<br></td></tr
><tr
id=sl_svn102_51

><td class="source">	rent = 0;<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	townid = 0;<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	transferItem = NULL;<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">House::~House()<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">void House::addTile(HouseTile* tile)<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">	tile-&gt;setFlag(TILESTATE_PROTECTIONZONE);<br></td></tr
><tr
id=sl_svn102_64

><td class="source">	houseTiles.push_back(tile);<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">void House::setHouseOwner(uint32_t guid)<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	if(isLoaded &amp;&amp; houseOwner == guid)<br></td></tr
><tr
id=sl_svn102_70
...
><td class="source">	isLoaded = true;<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">	if(houseOwner){<br></td></tr
><tr
id=sl_svn102_75

><td class="source">		//send items to depot<br></td></tr
><tr
id=sl_svn102_76

><td class="source">		transferToDepot();<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">		PlayerVector to_kick;<br></td></tr
><tr
id=sl_svn102_79

><td class="source">		 for(HouseTileList::iterator it = houseTiles.begin(); it != houseTiles.end(); ++it){<br></td></tr
><tr
id=sl_svn102_80

><td class="source">			 for(uint32_t i = 0; i &lt; (*it)-&gt;getThingCount(); ++i){<br></td></tr
><tr
id=sl_svn102_81

><td class="source">				 Creature* creature = (*it)-&gt;__getThing(i)-&gt;getCreature();<br></td></tr
><tr
id=sl_svn102_82

><td class="source">				 if(creature != NULL &amp;&amp; creature-&gt;getPlayer())<br></td></tr
><tr
id=sl_svn102_83

><td class="source">					 to_kick.push_back(creature-&gt;getPlayer());<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">		 while(to_kick.empty() == false) {<br></td></tr
><tr
id=sl_svn102_87

><td class="source">			 Player* c = to_kick.back();<br></td></tr
><tr
id=sl_svn102_88

><td class="source">			 to_kick.pop_back();<br></td></tr
><tr
id=sl_svn102_89

><td class="source">			 kickPlayer(NULL, c-&gt;getName());<br></td></tr
><tr
id=sl_svn102_90
...
><td class="source">		// we need to remove players from beds<br></td></tr
><tr
id=sl_svn102_93

><td class="source">		HouseBedItemList::iterator bit;<br></td></tr
><tr
id=sl_svn102_94

><td class="source">		for(bit = bedsList.begin(); bit != bedsList.end(); ++bit) {<br></td></tr
><tr
id=sl_svn102_95

><td class="source">			if((*bit)-&gt;getSleeper() != 0) {<br></td></tr
><tr
id=sl_svn102_96

><td class="source">				(*bit)-&gt;wakeUp(NULL);<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">		//clean access lists<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">		setAccessList(SUBOWNER_LIST, &quot;&quot;);<br></td></tr
><tr
id=sl_svn102_103

><td class="source">		setAccessList(GUEST_LIST, &quot;&quot;);<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">		for(HouseDoorList::iterator it = doorList.begin(); it != doorList.end(); ++it){<br></td></tr
><tr
id=sl_svn102_106

><td class="source">			(*it)-&gt;setAccessList(&quot;&quot;);<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">		//reset paid date<br></td></tr
><tr
id=sl_svn102_110
...
><td class="source">	if(guid != 0 &amp;&amp; IOPlayer::instance()-&gt;getNameByGuid(guid, name)){<br></td></tr
><tr
id=sl_svn102_116

><td class="source">		houseOwner = guid;<br></td></tr
><tr
id=sl_svn102_117

><td class="source">		houseOwnerName = name;<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">	updateDoorDescription();<br></td></tr
><tr
id=sl_svn102_121

><td class="source">	setLastWarning(std::time(NULL)); //So the new owner has one day before he start the payment<br></td></tr
><tr
id=sl_svn102_122
...
><td class="source">void House::updateDoorDescription()<br></td></tr
><tr
id=sl_svn102_125
...
><td class="source">	std::stringstream houseDescription;<br></td></tr
><tr
id=sl_svn102_127

><td class="source">	houseDescription &lt;&lt; &quot;It belongs to house &#39;&quot; &lt;&lt; houseName &lt;&lt; &quot;&#39;. &quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_128
...
><td class="source">	if(houseOwner != 0){<br></td></tr
><tr
id=sl_svn102_130

><td class="source">		houseDescription &lt;&lt; houseOwnerName;<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">		houseDescription &lt;&lt; &quot;Nobody&quot;;<br></td></tr
><tr
id=sl_svn102_134
...
><td class="source">	houseDescription &lt;&lt; &quot; owns this house.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_136
...
><td class="source">	HouseDoorList::iterator it;<br></td></tr
><tr
id=sl_svn102_138

><td class="source">	for(it = doorList.begin(); it != doorList.end(); ++it){<br></td></tr
><tr
id=sl_svn102_139

><td class="source">		(*it)-&gt;setSpecialDescription(houseDescription.str());<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">AccessHouseLevel_t House::getHouseAccessLevel(const Player* player)<br></td></tr
><tr
id=sl_svn102_144
...
><td class="source">	if(player == NULL) // By script<br></td></tr
><tr
id=sl_svn102_146

><td class="source">		return HOUSE_OWNER;<br></td></tr
><tr
id=sl_svn102_147
...
><td class="source">	if(player-&gt;hasFlag(PlayerFlag_CanEditHouses))<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">	if(player-&gt;getGUID() == houseOwner)<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">	if(subOwnerList.isInList(player))<br></td></tr
><tr
id=sl_svn102_155

><td class="source">		return HOUSE_SUBOWNER;<br></td></tr
><tr
id=sl_svn102_156
...
><td class="source">	if(guestList.isInList(player))<br></td></tr
><tr
id=sl_svn102_158

><td class="source">		return HOUSE_GUEST;<br></td></tr
><tr
id=sl_svn102_159
...
><td class="source">	return HOUSE_NO_INVITED;<br></td></tr
><tr
id=sl_svn102_161
...
><td class="source">bool House::kickPlayer(Player* player, const std::string&amp; name)<br></td></tr
><tr
id=sl_svn102_164
...
><td class="source">	Player* kickingPlayer = g_game.getPlayerByName(name);<br></td></tr
><tr
id=sl_svn102_166

><td class="source">	if(kickingPlayer){<br></td></tr
><tr
id=sl_svn102_167

><td class="source">		HouseTile* houseTile = kickingPlayer-&gt;getTile()-&gt;getHouseTile();<br></td></tr
><tr
id=sl_svn102_168
...
><td class="source">		if(houseTile &amp;&amp; houseTile-&gt;getHouse() == this){<br></td></tr
><tr
id=sl_svn102_170

><td class="source">			if(getHouseAccessLevel(player) &gt;= getHouseAccessLevel(kickingPlayer) &amp;&amp; !kickingPlayer-&gt;hasFlag(PlayerFlag_CanEditHouses)){<br></td></tr
><tr
id=sl_svn102_171

><td class="source">				if(g_game.internalTeleport(kickingPlayer, getEntryPosition()) == RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_172

><td class="source">					g_game.addMagicEffect(getEntryPosition(), NM_ME_ENERGY_AREA);<br></td></tr
><tr
id=sl_svn102_173
...
><td class="source">void House::setAccessList(uint32_t listId, const std::string&amp; textlist)<br></td></tr
><tr
id=sl_svn102_182
...
><td class="source">	if(listId == GUEST_LIST){<br></td></tr
><tr
id=sl_svn102_184

><td class="source">		guestList.parseList(textlist);<br></td></tr
><tr
id=sl_svn102_185
...
><td class="source">	else if(listId == SUBOWNER_LIST){<br></td></tr
><tr
id=sl_svn102_187

><td class="source">		subOwnerList.parseList(textlist);<br></td></tr
><tr
id=sl_svn102_188
...
><td class="source">		Door* door = getDoorByNumber(listId);<br></td></tr
><tr
id=sl_svn102_191

><td class="source">		if(door){<br></td></tr
><tr
id=sl_svn102_192

><td class="source">			door-&gt;setAccessList(textlist);<br></td></tr
><tr
id=sl_svn102_193
...
><td class="source">			#ifdef __DEBUG_HOUSES__<br></td></tr
><tr
id=sl_svn102_196

><td class="source">			std::cout &lt;&lt; &quot;Failure: [House::setAccessList] door == NULL, listId = &quot; &lt;&lt; listId &lt;&lt;std::endl;<br></td></tr
><tr
id=sl_svn102_197
...
><td class="source">		//We dont have kick anyone<br></td></tr
><tr
id=sl_svn102_200
...
><td class="source">	//kick uninvited players<br></td></tr
><tr
id=sl_svn102_204

><td class="source">	typedef std::list&lt;Player*&gt; KickPlayerList;<br></td></tr
><tr
id=sl_svn102_205

><td class="source">	KickPlayerList kickList;<br></td></tr
><tr
id=sl_svn102_206

><td class="source">	HouseTileList::iterator it;<br></td></tr
><tr
id=sl_svn102_207

><td class="source">	for(it = houseTiles.begin(); it != houseTiles.end(); ++it){<br></td></tr
><tr
id=sl_svn102_208

><td class="source">		HouseTile* hTile = *it;<br></td></tr
><tr
id=sl_svn102_209

><td class="source">		if(hTile-&gt;creatures.size() &gt; 0){<br></td></tr
><tr
id=sl_svn102_210

><td class="source">			CreatureVector::iterator cit;<br></td></tr
><tr
id=sl_svn102_211

><td class="source">			for(cit = hTile-&gt;creatures.begin(); cit != hTile-&gt;creatures.end(); ++cit){<br></td></tr
><tr
id=sl_svn102_212

><td class="source">				Player* player = (*cit)-&gt;getPlayer();<br></td></tr
><tr
id=sl_svn102_213

><td class="source">				if(player &amp;&amp; isInvited(player) == false){<br></td></tr
><tr
id=sl_svn102_214

><td class="source">					kickList.push_back(player);<br></td></tr
><tr
id=sl_svn102_215
...
><td class="source">	KickPlayerList::iterator itkick;<br></td></tr
><tr
id=sl_svn102_221

><td class="source">	for(itkick = kickList.begin(); itkick != kickList.end(); ++itkick){<br></td></tr
><tr
id=sl_svn102_222

><td class="source">		if(g_game.internalTeleport(*itkick, getEntryPosition()) == RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_223
...
><td class="source">bool House::transferToDepot()<br></td></tr
><tr
id=sl_svn102_229
...
><td class="source">	if(townid == 0) {<br></td></tr
><tr
id=sl_svn102_231
...
><td class="source">	// Empty house is just cleared.<br></td></tr
><tr
id=sl_svn102_236
...
><td class="source">		std::string ownerName;<br></td></tr
><tr
id=sl_svn102_238

><td class="source">		if(IOPlayer::instance()-&gt;getNameByGuid(houseOwner, ownerName)){<br></td></tr
><tr
id=sl_svn102_239

><td class="source">			player = g_game.getPlayerByName(ownerName);<br></td></tr
><tr
id=sl_svn102_240
...
><td class="source">				player = new Player(ownerName, NULL);<br></td></tr
><tr
id=sl_svn102_243
...
><td class="source">				if(!IOPlayer::instance()-&gt;loadPlayer(player, ownerName)){<br></td></tr
><tr
id=sl_svn102_245
...
><td class="source">					std::cout &lt;&lt; &quot;Failure: [House::transferToDepot], can not load player: &quot; &lt;&lt; ownerName &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_248
...
><td class="source">					delete player;<br></td></tr
><tr
id=sl_svn102_251
...
><td class="source">	Depot* depot = player? player-&gt;getDepot(townid, true) : NULL;<br></td></tr
><tr
id=sl_svn102_258
...
><td class="source">	std::list&lt;Item*&gt; moveItemList;<br></td></tr
><tr
id=sl_svn102_260
...
><td class="source">			item = (*it)-&gt;__getThing(i)-&gt;getItem();<br></td></tr
><tr
id=sl_svn102_266
...
><td class="source">				moveItemList.push_back(item);<br></td></tr
><tr
id=sl_svn102_272
...
><td class="source">			else if((tmpContainer = item-&gt;getContainer())){<br></td></tr
><tr
id=sl_svn102_274

><td class="source">				for(ItemList::const_iterator it = tmpContainer-&gt;getItems(); it != tmpContainer-&gt;getEnd(); ++it){<br></td></tr
><tr
id=sl_svn102_275

><td class="source">					moveItemList.push_back(*it);<br></td></tr
><tr
id=sl_svn102_276
...
><td class="source">	for(std::list&lt;Item*&gt;::iterator it = moveItemList.begin(); it != moveItemList.end(); ++it){<br></td></tr
><tr
id=sl_svn102_282

><td class="source">		if(depot) {<br></td></tr
><tr
id=sl_svn102_283

><td class="source">			g_game.internalMoveItem((*it)-&gt;getParent(), depot, INDEX_WHEREEVER,<br></td></tr
><tr
id=sl_svn102_284

><td class="source">				(*it), (*it)-&gt;getItemCount(), NULL, FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_285
...
><td class="source">			g_game.internalRemoveItem(*it);<br></td></tr
><tr
id=sl_svn102_288
...
><td class="source">	if(player &amp;&amp; player-&gt;isOffline()){<br></td></tr
><tr
id=sl_svn102_292

><td class="source">		IOPlayer::instance()-&gt;savePlayer(player);<br></td></tr
><tr
id=sl_svn102_293
...
><td class="source">void House::cleanHouse() <br></td></tr
><tr
id=sl_svn102_300
...
><td class="source">bool House::getAccessList(uint32_t listId, std::string&amp; list) const<br></td></tr
><tr
id=sl_svn102_328
...
><td class="source">		guestList.getList(list);<br></td></tr
><tr
id=sl_svn102_331
...
><td class="source">		subOwnerList.getList(list);<br></td></tr
><tr
id=sl_svn102_335
...
><td class="source">			return door-&gt;getAccessList(list);<br></td></tr
><tr
id=sl_svn102_341
...
><td class="source">			std::cout &lt;&lt; &quot;Failure: [House::getAccessList] door == NULL, listId = &quot; &lt;&lt; listId &lt;&lt;std::endl;<br></td></tr
><tr
id=sl_svn102_345
...
><td class="source">bool House::isInvited(const Player* player)<br></td></tr
><tr
id=sl_svn102_353
...
><td class="source">	if(getHouseAccessLevel(player) != HOUSE_NO_INVITED){<br></td></tr
><tr
id=sl_svn102_355
...
><td class="source">void House::addDoor(Door* door)<br></td></tr
><tr
id=sl_svn102_363
...
><td class="source">	door-&gt;useThing2();<br></td></tr
><tr
id=sl_svn102_365

><td class="source">	doorList.push_back(door);<br></td></tr
><tr
id=sl_svn102_366

><td class="source">	door-&gt;setHouse(this);<br></td></tr
><tr
id=sl_svn102_367
...
><td class="source">void House::removeDoor(Door* door)<br></td></tr
><tr
id=sl_svn102_371
...
><td class="source">	HouseDoorList::iterator it = std::find(doorList.begin(), doorList.end(), door);<br></td></tr
><tr
id=sl_svn102_373

><td class="source">	if(it != doorList.end()){<br></td></tr
><tr
id=sl_svn102_374
...
><td class="source">		doorList.erase(it);<br></td></tr
><tr
id=sl_svn102_376
...
><td class="source">void House::addBed(BedItem* bed)<br></td></tr
><tr
id=sl_svn102_382
...
><td class="source">	bedsList.push_back(bed);<br></td></tr
><tr
id=sl_svn102_384

><td class="source">	bed-&gt;setHouse(this);<br></td></tr
><tr
id=sl_svn102_385
...
><td class="source">Door* House::getDoorByNumber(uint32_t doorId)<br></td></tr
><tr
id=sl_svn102_389
...
><td class="source">		if((*it)-&gt;getDoorId() == doorId){<br></td></tr
><tr
id=sl_svn102_393
...
><td class="source">Door* House::getDoorByNumber(uint32_t doorId) const<br></td></tr
><tr
id=sl_svn102_400
...
><td class="source">	HouseDoorList::const_iterator it;<br></td></tr
><tr
id=sl_svn102_402
...
><td class="source">Door* House::getDoorByPosition(const Position&amp; pos)<br></td></tr
><tr
id=sl_svn102_411
...
><td class="source">		if((*it)-&gt;getPosition() == pos){<br></td></tr
><tr
id=sl_svn102_414
...
><td class="source">bool House::canEditAccessList(uint32_t listId, const Player* player)<br></td></tr
><tr
id=sl_svn102_422
...
><td class="source">	switch(getHouseAccessLevel(player)){<br></td></tr
><tr
id=sl_svn102_424

><td class="source">	case HOUSE_OWNER:<br></td></tr
><tr
id=sl_svn102_425
...
><td class="source">	case HOUSE_SUBOWNER:<br></td></tr
><tr
id=sl_svn102_427

><td class="source">		/*subowners can edit guest access list*/<br></td></tr
><tr
id=sl_svn102_428

><td class="source">		return listId == GUEST_LIST;<br></td></tr
><tr
id=sl_svn102_429
...
><td class="source">HouseTransferItem* House::getTransferItem()<br></td></tr
><tr
id=sl_svn102_435
...
><td class="source">	if(transferItem != NULL)<br></td></tr
><tr
id=sl_svn102_437
...
><td class="source">	transfer_container.setParent(NULL);<br></td></tr
><tr
id=sl_svn102_440

><td class="source">	transferItem =  HouseTransferItem::createHouseTransferItem(this);<br></td></tr
><tr
id=sl_svn102_441

><td class="source">	transfer_container.__addThing(transferItem);<br></td></tr
><tr
id=sl_svn102_442

><td class="source">	return transferItem;<br></td></tr
><tr
id=sl_svn102_443
...
><td class="source">void House::resetTransferItem()<br></td></tr
><tr
id=sl_svn102_446
...
><td class="source">		Item* tmpItem = transferItem;<br></td></tr
><tr
id=sl_svn102_449
...
><td class="source">		transfer_container.__removeThing(tmpItem, tmpItem-&gt;getItemCount());<br></td></tr
><tr
id=sl_svn102_453

><td class="source">		g_game.FreeThing(tmpItem);<br></td></tr
><tr
id=sl_svn102_454
...
><td class="source">HouseTransferItem* HouseTransferItem::createHouseTransferItem(House* house)<br></td></tr
><tr
id=sl_svn102_458
...
><td class="source">	HouseTransferItem* transferItem = new HouseTransferItem(house);<br></td></tr
><tr
id=sl_svn102_460

><td class="source">	transferItem-&gt;useThing2();<br></td></tr
><tr
id=sl_svn102_461

><td class="source">	transferItem-&gt;setID(ITEM_DOCUMENT_RO);<br></td></tr
><tr
id=sl_svn102_462

><td class="source">	transferItem-&gt;setSubType(1);<br></td></tr
><tr
id=sl_svn102_463
...
><td class="source">	stream &lt;&lt; &quot; It is a house transfer document for &#39;&quot; &lt;&lt; house-&gt;getName() &lt;&lt; &quot;&#39;.&quot;;<br></td></tr
><tr
id=sl_svn102_465

><td class="source">	transferItem-&gt;setSpecialDescription(stream.str());<br></td></tr
><tr
id=sl_svn102_466
...
><td class="source">bool HouseTransferItem::onTradeEvent(TradeEvents_t event, Player* owner)<br></td></tr
><tr
id=sl_svn102_470
...
><td class="source">	switch(event){<br></td></tr
><tr
id=sl_svn102_473

><td class="source">		case ON_TRADE_TRANSFER:<br></td></tr
><tr
id=sl_svn102_474
...
><td class="source">			house = getHouse();<br></td></tr
><tr
id=sl_svn102_476
...
><td class="source">				house-&gt;executeTransfer(this, owner);<br></td></tr
><tr
id=sl_svn102_478
...
><td class="source">		case ON_TRADE_CANCEL:<br></td></tr
><tr
id=sl_svn102_485
...
><td class="source">bool House::executeTransfer(HouseTransferItem* item, Player* newOwner)<br></td></tr
><tr
id=sl_svn102_502
...
><td class="source">	if(transferItem != item){<br></td></tr
><tr
id=sl_svn102_504
...
><td class="source">	setHouseOwner(newOwner-&gt;getGUID());<br></td></tr
><tr
id=sl_svn102_508
...
><td class="source">AccessList::AccessList()<br></td></tr
><tr
id=sl_svn102_513
...
><td class="source">bool AccessList::parseList(const std::string&amp; _list)<br></td></tr
><tr
id=sl_svn102_523
...
><td class="source">	playerList.clear();<br></td></tr
><tr
id=sl_svn102_525

><td class="source">	guildList.clear();<br></td></tr
><tr
id=sl_svn102_526

><td class="source">	expressionList.clear();<br></td></tr
><tr
id=sl_svn102_527

><td class="source">	regExList.clear();<br></td></tr
><tr
id=sl_svn102_528

><td class="source">	list = _list;<br></td></tr
><tr
id=sl_svn102_529
...
><td class="source">	if(_list == &quot;&quot;)<br></td></tr
><tr
id=sl_svn102_531
...
><td class="source">	std::stringstream listStream(_list);<br></td></tr
><tr
id=sl_svn102_534

><td class="source">	std::string line;<br></td></tr
><tr
id=sl_svn102_535

><td class="source">	while(getline(listStream, line)){<br></td></tr
><tr
id=sl_svn102_536

><td class="source">		//trim left<br></td></tr
><tr
id=sl_svn102_537

><td class="source">		trim_left(line, &quot; &quot;);<br></td></tr
><tr
id=sl_svn102_538
...
><td class="source">		//trim right<br></td></tr
><tr
id=sl_svn102_541

><td class="source">		trim_right(line, &quot; &quot;);<br></td></tr
><tr
id=sl_svn102_542
...
><td class="source">		std::transform(line.begin(), line.end(), line.begin(), tolower);<br></td></tr
><tr
id=sl_svn102_545
...
><td class="source">		if(line.substr(0,1) == &quot;#&quot;)<br></td></tr
><tr
id=sl_svn102_547
...
><td class="source">		if(line.length() &gt; 100)<br></td></tr
><tr
id=sl_svn102_550
...
><td class="source">		if(line.find(&quot;@&quot;) != std::string::npos){<br></td></tr
><tr
id=sl_svn102_553

><td class="source">			std::string::size_type pos = line.find(&quot;@&quot;);<br></td></tr
><tr
id=sl_svn102_554

><td class="source">			addGuild(line.substr(pos + 1), &quot;&quot;);<br></td></tr
><tr
id=sl_svn102_555
...
><td class="source">		else if(line.find(&quot;!&quot;) != std::string::npos || line.find(&quot;*&quot;) != std::string::npos || line.find(&quot;?&quot;) != std::string::npos){<br></td></tr
><tr
id=sl_svn102_557

><td class="source">			addExpression(line);<br></td></tr
><tr
id=sl_svn102_558
...
><td class="source">			addPlayer(line);<br></td></tr
><tr
id=sl_svn102_561
...
><td class="source">bool AccessList::addPlayer(std::string&amp; name)<br></td></tr
><tr
id=sl_svn102_567
...
><td class="source">	std::string dbName = name;<br></td></tr
><tr
id=sl_svn102_570

><td class="source">	if(IOPlayer::instance()-&gt;getGuidByName(guid, dbName)){<br></td></tr
><tr
id=sl_svn102_571

><td class="source">		if(playerList.find(guid) == playerList.end()){<br></td></tr
><tr
id=sl_svn102_572

><td class="source">			playerList.insert(guid);<br></td></tr
><tr
id=sl_svn102_573
...
><td class="source">bool AccessList::addGuild(const std::string&amp; guildName, const std::string&amp; rank)<br></td></tr
><tr
id=sl_svn102_580
...
><td class="source">	uint32_t guildId;<br></td></tr
><tr
id=sl_svn102_582

><td class="source">	if(IOPlayer::instance()-&gt;getGuildIdByName(guildId, guildName)){<br></td></tr
><tr
id=sl_svn102_583

><td class="source">		if(guildId != 0){<br></td></tr
><tr
id=sl_svn102_584

><td class="source">			for(GuildList::iterator it = guildList.begin(); it != guildList.end(); ++it){<br></td></tr
><tr
id=sl_svn102_585

><td class="source">				if(it-&gt;first == guildId &amp;&amp; boost::algorithm::iequals(rank, it-&gt;second)){<br></td></tr
><tr
id=sl_svn102_586
...
><td class="source">			guildList.push_back(std::pair&lt;uint32_t, std::string&gt;(guildId, rank));<br></td></tr
><tr
id=sl_svn102_591
...
><td class="source">bool AccessList::addExpression(const std::string&amp; expression)<br></td></tr
><tr
id=sl_svn102_598
...
><td class="source">	ExpressionList::iterator it;<br></td></tr
><tr
id=sl_svn102_600

><td class="source">	for(it = expressionList.begin(); it != expressionList.end(); ++it){<br></td></tr
><tr
id=sl_svn102_601

><td class="source">		if((*it) == expression){<br></td></tr
><tr
id=sl_svn102_602
...
><td class="source">	std::string outExp;<br></td></tr
><tr
id=sl_svn102_607

><td class="source">	std::string metachars = &quot;.[{}()\\+|^$&quot;;<br></td></tr
><tr
id=sl_svn102_608
...
><td class="source">	for(std::string::const_iterator it = expression.begin(); it != expression.end(); ++it){<br></td></tr
><tr
id=sl_svn102_610

><td class="source">		if(metachars.find(*it) != std::string::npos){<br></td></tr
><tr
id=sl_svn102_611

><td class="source">			outExp += &quot;\\&quot;;<br></td></tr
><tr
id=sl_svn102_612
...
><td class="source">		outExp += (*it);<br></td></tr
><tr
id=sl_svn102_615
...
><td class="source">	replaceString(outExp, &quot;*&quot;, &quot;.*&quot;);<br></td></tr
><tr
id=sl_svn102_618
...
><td class="source">		if(outExp.length() &gt; 0){<br></td></tr
><tr
id=sl_svn102_622

><td class="source">			expressionList.push_back(outExp);<br></td></tr
><tr
id=sl_svn102_623
...
><td class="source">			if(outExp.substr(0,1) == &quot;!&quot;){<br></td></tr
><tr
id=sl_svn102_625

><td class="source">				if(outExp.length() &gt; 1){<br></td></tr
><tr
id=sl_svn102_626

><td class="source">					//push &#39;NOT&#39; expressions upfront so they are checked first<br></td></tr
><tr
id=sl_svn102_627

><td class="source">					regExList.push_front(std::make_pair(boost::regex(outExp.substr(1)), false));<br></td></tr
><tr
id=sl_svn102_628
...
><td class="source">				regExList.push_back(std::make_pair(boost::regex(outExp), true));<br></td></tr
><tr
id=sl_svn102_632
...
><td class="source">bool AccessList::isInList(const Player* player)<br></td></tr
><tr
id=sl_svn102_643
...
><td class="source">	RegExList::iterator it;<br></td></tr
><tr
id=sl_svn102_645

><td class="source">	std::string name = player-&gt;getName();<br></td></tr
><tr
id=sl_svn102_646

><td class="source">	boost::cmatch what;<br></td></tr
><tr
id=sl_svn102_647
...
><td class="source">	std::transform(name.begin(), name.end(), name.begin(), tolower);<br></td></tr
><tr
id=sl_svn102_649

><td class="source">	for(it = regExList.begin(); it != regExList.end(); ++it){<br></td></tr
><tr
id=sl_svn102_650

><td class="source">		if(boost::regex_match(name.c_str(), what, it-&gt;first)){<br></td></tr
><tr
id=sl_svn102_651
...
><td class="source">	PlayerList::iterator playerIt = playerList.find(player-&gt;getGUID());<br></td></tr
><tr
id=sl_svn102_661

><td class="source">	if(playerIt != playerList.end())<br></td></tr
><tr
id=sl_svn102_662
...
><td class="source">        if((player-&gt;getGuildId() &amp;&amp; it-&gt;first == player-&gt;getGuildId()) &amp;&amp; boost::algorithm::iequals(player-&gt;getGuildRank(), it-&gt;second)){<br></td></tr
><tr
id=sl_svn102_666
...
><td class="source">void AccessList::getList(std::string&amp; _list) const<br></td></tr
><tr
id=sl_svn102_674
...
><td class="source">	_list = list;<br></td></tr
><tr
id=sl_svn102_676
...
><td class="source">Door::Door(uint16_t _type):<br></td></tr
><tr
id=sl_svn102_679

><td class="source">Item(_type)<br></td></tr
><tr
id=sl_svn102_680
...
><td class="source">	accessList = NULL;<br></td></tr
><tr
id=sl_svn102_683
...
><td class="source">Door::~Door()<br></td></tr
><tr
id=sl_svn102_686
...
><td class="source">	if(accessList)<br></td></tr
><tr
id=sl_svn102_688

><td class="source">		delete accessList;<br></td></tr
><tr
id=sl_svn102_689
...
><td class="source">Attr_ReadValue Door::readAttr(AttrTypes_t attr, PropStream&amp; propStream)<br></td></tr
><tr
id=sl_svn102_692
...
><td class="source">	if(ATTR_HOUSEDOORID == attr){<br></td></tr
><tr
id=sl_svn102_694

><td class="source">		unsigned char _doorId = 0;<br></td></tr
><tr
id=sl_svn102_695
...
><td class="source">		setDoorId(_doorId);<br></td></tr
><tr
id=sl_svn102_700
...
><td class="source">bool Door::serializeAttr(PropWriteStream&amp; propWriteStream) const<br></td></tr
><tr
id=sl_svn102_707
...
><td class="source">	//dont call Item::serializeAttr(propWriteStream);<br></td></tr
><tr
id=sl_svn102_709
...
><td class="source">		unsigned char _doorId = getDoorId();<br></td></tr
><tr
id=sl_svn102_713

><td class="source">		propWriteStream.ADD_UINT8(ATTR_HOUSEDOORID);<br></td></tr
><tr
id=sl_svn102_714

><td class="source">		propWriteStream.ADD_UINT8(_doorId);<br></td></tr
><tr
id=sl_svn102_715
...
><td class="source">void Door::setHouse(House* _house)<br></td></tr
><tr
id=sl_svn102_722
...
><td class="source">		std::cout &lt;&lt; &quot;Warning: [Door::setHouse] house != NULL&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_726
...
><td class="source">	house = _house;<br></td></tr
><tr
id=sl_svn102_730
...
><td class="source">		accessList = new AccessList();<br></td></tr
><tr
id=sl_svn102_733
...
><td class="source">bool Door::canUse(const Player* player)<br></td></tr
><tr
id=sl_svn102_737
...
><td class="source">	if(house-&gt;getHouseAccessLevel(player) &gt;= HOUSE_SUBOWNER)<br></td></tr
><tr
id=sl_svn102_742
...
><td class="source">	return accessList-&gt;isInList(player);<br></td></tr
><tr
id=sl_svn102_745
...
><td class="source">void Door::setAccessList(const std::string&amp; textlist)<br></td></tr
><tr
id=sl_svn102_748
...
><td class="source">	accessList-&gt;parseList(textlist);<br></td></tr
><tr
id=sl_svn102_754
...
><td class="source">bool Door::getAccessList(std::string&amp; list) const<br></td></tr
><tr
id=sl_svn102_757
...
><td class="source">		std::cout &lt;&lt; &quot;Failure: [Door::getAccessList] house == NULL&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_761
...
><td class="source">	accessList-&gt;getList(list);<br></td></tr
><tr
id=sl_svn102_766
...
><td class="source">void Door::copyAttributes(Item* item)<br></td></tr
><tr
id=sl_svn102_770
...
><td class="source">	Item::copyAttributes(item);<br></td></tr
><tr
id=sl_svn102_772
...
><td class="source">	if(Door* door = item-&gt;getDoor()){<br></td></tr
><tr
id=sl_svn102_774

><td class="source">		std::string list;<br></td></tr
><tr
id=sl_svn102_775

><td class="source">		if(door-&gt;getAccessList(list)){<br></td></tr
><tr
id=sl_svn102_776

><td class="source">			setAccessList(list);<br></td></tr
><tr
id=sl_svn102_777
...
><td class="source">void Door::onRemoved()<br></td></tr
><tr
id=sl_svn102_782
...
><td class="source">		house-&gt;removeDoor(this);<br></td></tr
><tr
id=sl_svn102_785
...
><td class="source">Houses::Houses()<br></td></tr
><tr
id=sl_svn102_789
...
><td class="source">	std::string strRentPeriod = g_config.getString(ConfigManager::HOUSE_RENT_PERIOD);<br></td></tr
><tr
id=sl_svn102_791
...
><td class="source">	rentPeriod = RENTPERIOD_MONTHLY;<br></td></tr
><tr
id=sl_svn102_793
...
><td class="source">	if(asLowerCaseString(strRentPeriod) == &quot;yearly&quot;){<br></td></tr
><tr
id=sl_svn102_795

><td class="source">		rentPeriod = RENTPERIOD_YEARLY;<br></td></tr
><tr
id=sl_svn102_796
...
><td class="source">	else if(asLowerCaseString(strRentPeriod) == &quot;weekly&quot;){<br></td></tr
><tr
id=sl_svn102_798

><td class="source">		rentPeriod = RENTPERIOD_WEEKLY;<br></td></tr
><tr
id=sl_svn102_799
...
><td class="source">	else if(asLowerCaseString(strRentPeriod) == &quot;daily&quot;){<br></td></tr
><tr
id=sl_svn102_801

><td class="source">		rentPeriod = RENTPERIOD_DAILY;<br></td></tr
><tr
id=sl_svn102_802
...
><td class="source">	else if(asLowerCaseString(strRentPeriod) == &quot;never&quot;){<br></td></tr
><tr
id=sl_svn102_804

><td class="source">		rentPeriod = RENTPERIOD_NEVER;<br></td></tr
><tr
id=sl_svn102_805
...
><td class="source">House* Houses::getHouseByPlayerId(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_814
...
><td class="source">	for(HouseMap::iterator it = houseMap.begin(); it != houseMap.end(); ++it){<br></td></tr
><tr
id=sl_svn102_816
...
><td class="source">		if(house-&gt;getHouseOwner() == playerId){<br></td></tr
><tr
id=sl_svn102_818

><td class="source">			return house;<br></td></tr
><tr
id=sl_svn102_819
...
><td class="source">bool Houses::loadHousesXML(std::string filename)<br></td></tr
><tr
id=sl_svn102_825
...
><td class="source">		xmlNodePtr root, houseNode;<br></td></tr
><tr
id=sl_svn102_829
...
><td class="source">		if(xmlStrcmp(root-&gt;name,(const xmlChar*)&quot;houses&quot;) != 0){<br></td></tr
><tr
id=sl_svn102_832
...
><td class="source">		houseNode = root-&gt;children;<br></td></tr
><tr
id=sl_svn102_840

><td class="source">		while(houseNode){<br></td></tr
><tr
id=sl_svn102_841

><td class="source">			if(xmlStrcmp(houseNode-&gt;name,(const xmlChar*)&quot;house&quot;) == 0){<br></td></tr
><tr
id=sl_svn102_842

><td class="source">				int _houseid = 0;<br></td></tr
><tr
id=sl_svn102_843

><td class="source">				Position entryPos(0, 0, 0);<br></td></tr
><tr
id=sl_svn102_844
...
><td class="source">				if(!readXMLInteger(houseNode, &quot;houseid&quot;, _houseid)){<br></td></tr
><tr
id=sl_svn102_846
...
><td class="source">				House* house = Houses::getInstance().getHouse(_houseid);<br></td></tr
><tr
id=sl_svn102_851
...
><td class="source">					std::cout &lt;&lt; &quot;Error: [Houses::loadHousesXML] Unknown house, id = &quot; &lt;&lt; _houseid &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_853
...
><td class="source">				if(readXMLString(houseNode, &quot;name&quot;, strValue)){<br></td></tr
><tr
id=sl_svn102_858

><td class="source">					house-&gt;setName(strValue);<br></td></tr
><tr
id=sl_svn102_859
...
><td class="source">				if(readXMLInteger(houseNode, &quot;entryx&quot;, intValue)){<br></td></tr
><tr
id=sl_svn102_862

><td class="source">					entryPos.x = intValue;<br></td></tr
><tr
id=sl_svn102_863
...
><td class="source">				if(readXMLInteger(houseNode, &quot;entryy&quot;, intValue)){<br></td></tr
><tr
id=sl_svn102_866

><td class="source">					entryPos.y = intValue;<br></td></tr
><tr
id=sl_svn102_867
...
><td class="source">				if(readXMLInteger(houseNode, &quot;entryz&quot;, intValue)){<br></td></tr
><tr
id=sl_svn102_870

><td class="source">					entryPos.z = intValue;<br></td></tr
><tr
id=sl_svn102_871
...
><td class="source">				if(entryPos.x == 0 &amp;&amp; entryPos.y == 0 &amp;&amp; entryPos.z == 0){<br></td></tr
><tr
id=sl_svn102_874

><td class="source">					std::cout &lt;&lt; &quot;Warning: [Houses::loadHousesXML] House entry not set&quot;<br></td></tr
><tr
id=sl_svn102_875

><td class="source">						&lt;&lt; &quot; - Name: &quot; &lt;&lt; house-&gt;getName()<br></td></tr
><tr
id=sl_svn102_876

><td class="source">						&lt;&lt; &quot; - House id: &quot; &lt;&lt; _houseid &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_877
...
><td class="source">				house-&gt;setEntryPos(entryPos);<br></td></tr
><tr
id=sl_svn102_880
...
><td class="source">				if(readXMLInteger(houseNode, &quot;rent&quot;, intValue)){<br></td></tr
><tr
id=sl_svn102_882

><td class="source">					house-&gt;setRent(intValue);<br></td></tr
><tr
id=sl_svn102_883
...
><td class="source">				if(readXMLInteger(houseNode, &quot;townid&quot;, intValue)){<br></td></tr
><tr
id=sl_svn102_886

><td class="source">					house-&gt;setTownId(intValue);<br></td></tr
><tr
id=sl_svn102_887
...
><td class="source">				house-&gt;setHouseOwner(0);<br></td></tr
><tr
id=sl_svn102_890
...
><td class="source">			houseNode = houseNode-&gt;next;<br></td></tr
><tr
id=sl_svn102_893
...
><td class="source">bool Houses::payHouses()<br></td></tr
><tr
id=sl_svn102_903
...
><td class="source">	if(rentPeriod == RENTPERIOD_NEVER) {<br></td></tr
><tr
id=sl_svn102_905
...
><td class="source">		if(house-&gt;getHouseOwner() != 0 &amp;&amp; house-&gt;getPaidUntil() &lt; currentTime &amp;&amp;<br></td></tr
><tr
id=sl_svn102_913

><td class="source">			 house-&gt;getRent() != 0){<br></td></tr
><tr
id=sl_svn102_914

><td class="source">			uint32_t ownerid = house-&gt;getHouseOwner();<br></td></tr
><tr
id=sl_svn102_915

><td class="source">			Town* town = Towns::getInstance().getTown(house-&gt;getTownId());<br></td></tr
><tr
id=sl_svn102_916
...
><td class="source">				std::cout &lt;&lt; &quot;Warning: [Houses::payHouses] town = NULL, townid = &quot; &lt;&lt;<br></td></tr
><tr
id=sl_svn102_919

><td class="source">					house-&gt;getTownId() &lt;&lt; &quot;, houseid = &quot; &lt;&lt; house-&gt;getHouseId() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_920
...
><td class="source">			if(!IOPlayer::instance()-&gt;getNameByGuid(ownerid, name)){<br></td></tr
><tr
id=sl_svn102_926

><td class="source">				//player doesnt exist, remove it as house owner?<br></td></tr
><tr
id=sl_svn102_927
...
><td class="source">			Player* player = g_game.getPlayerByName(name);<br></td></tr
><tr
id=sl_svn102_932
...
><td class="source">				player = new Player(name, NULL);<br></td></tr
><tr
id=sl_svn102_935
...
><td class="source">				if(!IOPlayer::instance()-&gt;loadPlayer(player, name)){<br></td></tr
><tr
id=sl_svn102_937
...
><td class="source">					std::cout &lt;&lt; &quot;Failure: [Houses::payHouses], can not load player: &quot; &lt;&lt; name &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_939
...
><td class="source">			Depot* depot = player-&gt;getDepot(town-&gt;getTownID(), true);<br></td></tr
><tr
id=sl_svn102_946
...
><td class="source">			// savePlayerHere is an ugly hack<br></td></tr
><tr
id=sl_svn102_948

><td class="source">			// to avoid saving 2 times a not online player<br></td></tr
><tr
id=sl_svn102_949

><td class="source">			// when items are transferred to his depot<br></td></tr
><tr
id=sl_svn102_950

><td class="source">			bool savePlayerHere = true;<br></td></tr
><tr
id=sl_svn102_951
...
><td class="source">				//get money from depot<br></td></tr
><tr
id=sl_svn102_953

><td class="source">				bool useAccBalance = g_config.getBoolean(ConfigManager::USE_ACCBALANCE) != false;<br></td></tr
><tr
id=sl_svn102_954

><td class="source">				bool hasEnoughMoney = false;<br></td></tr
><tr
id=sl_svn102_955
...
><td class="source">				if(useAccBalance){<br></td></tr
><tr
id=sl_svn102_957

><td class="source">					if(player-&gt;balance &gt;= house-&gt;getRent()){<br></td></tr
><tr
id=sl_svn102_958

><td class="source">						player-&gt;balance -= house-&gt;getRent();<br></td></tr
><tr
id=sl_svn102_959

><td class="source">						hasEnoughMoney = true;<br></td></tr
><tr
id=sl_svn102_960
...
><td class="source">					hasEnoughMoney = g_game.removeMoney(depot, house-&gt;getRent(), FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_964
...
><td class="source">				if(hasEnoughMoney){<br></td></tr
><tr
id=sl_svn102_967

><td class="source">					uint32_t paidUntil = currentTime;<br></td></tr
><tr
id=sl_svn102_968

><td class="source">					switch(rentPeriod){<br></td></tr
><tr
id=sl_svn102_969

><td class="source">					case RENTPERIOD_DAILY:<br></td></tr
><tr
id=sl_svn102_970

><td class="source">						paidUntil += 24 * 60 * 60;<br></td></tr
><tr
id=sl_svn102_971
...
><td class="source">					case RENTPERIOD_WEEKLY:<br></td></tr
><tr
id=sl_svn102_973

><td class="source">						paidUntil += 24 * 60 * 60 * 7;<br></td></tr
><tr
id=sl_svn102_974
...
><td class="source">					case RENTPERIOD_MONTHLY:<br></td></tr
><tr
id=sl_svn102_976

><td class="source">						paidUntil += 24 * 60 * 60 * 30;<br></td></tr
><tr
id=sl_svn102_977
...
><td class="source">					case RENTPERIOD_YEARLY:<br></td></tr
><tr
id=sl_svn102_979

><td class="source">						paidUntil += 24 * 60 * 60 * 365;<br></td></tr
><tr
id=sl_svn102_980

><td class="source">					case RENTPERIOD_NEVER:<br></td></tr
><tr
id=sl_svn102_981
...
><td class="source">					house-&gt;setPaidUntil(paidUntil);<br></td></tr
><tr
id=sl_svn102_985
...
><td class="source">				else if(currentTime &gt;= house-&gt;getLastWarning() + 24 * 60 * 60){<br></td></tr
><tr
id=sl_svn102_987

><td class="source">					if(house-&gt;getPayRentWarnings() &gt;= 7){<br></td></tr
><tr
id=sl_svn102_988
...
><td class="source">						// setHouseOwner will load the player,<br></td></tr
><tr
id=sl_svn102_990

><td class="source">						// transfer house items to his depot and then<br></td></tr
><tr
id=sl_svn102_991

><td class="source">						// will save it, so here should not be saved<br></td></tr
><tr
id=sl_svn102_992

><td class="source">						// again<br></td></tr
><tr
id=sl_svn102_993

><td class="source">						savePlayerHere = false;<br></td></tr
><tr
id=sl_svn102_994
...
><td class="source">						int daysLeft = 7 - house-&gt;getPayRentWarnings();<br></td></tr
><tr
id=sl_svn102_997
...
><td class="source">						Item* letter = Item::CreateItem(ITEM_LETTER_STAMPED);<br></td></tr
><tr
id=sl_svn102_999

><td class="source">						std::string period = &quot;&quot;;<br></td></tr
><tr
id=sl_svn102_1000
...
><td class="source">								period = &quot;daily&quot;;<br></td></tr
><tr
id=sl_svn102_1004
...
><td class="source">								period = &quot;weekly&quot;;<br></td></tr
><tr
id=sl_svn102_1008
...
><td class="source">								period = &quot;monthly&quot;;<br></td></tr
><tr
id=sl_svn102_1012
...
><td class="source">								period = &quot;annual&quot;;<br></td></tr
><tr
id=sl_svn102_1016
...
><td class="source">						std::stringstream warningText;<br></td></tr
><tr
id=sl_svn102_1023

><td class="source">						warningText &lt;&lt; &quot;Warning! \n&quot; &lt;&lt;<br></td></tr
><tr
id=sl_svn102_1024

><td class="source">							&quot;The &quot; &lt;&lt; period &lt;&lt; &quot; rent of &quot; &lt;&lt; house-&gt;getRent() &lt;&lt; &quot; gold for your house \&quot;&quot;<br></td></tr
><tr
id=sl_svn102_1025

><td class="source">							&lt;&lt; house-&gt;getName() &lt;&lt; &quot;\&quot; is payable. Have it available within &quot; &lt;&lt; daysLeft &lt;&lt;<br></td></tr
><tr
id=sl_svn102_1026

><td class="source">							&quot; days, or you will lose this house.&quot;;<br></td></tr
><tr
id=sl_svn102_1027
...
><td class="source">						letter-&gt;setText(warningText.str());<br></td></tr
><tr
id=sl_svn102_1029

><td class="source">						g_game.internalAddItem(depot, letter, INDEX_WHEREEVER, FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_1030
...
><td class="source">						house-&gt;setPayRentWarnings(house-&gt;getPayRentWarnings() + 1);<br></td></tr
><tr
id=sl_svn102_1032

><td class="source">						house-&gt;setLastWarning(currentTime);<br></td></tr
><tr
id=sl_svn102_1033
...
><td class="source">			if(player-&gt;isOffline()){<br></td></tr
><tr
id=sl_svn102_1038

><td class="source">				if(savePlayerHere){<br></td></tr
><tr
id=sl_svn102_1039
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/house.cpp&amp;old_path=/trunk/src/house.cpp&amp;old=86">Diff</a>
 </div>
...
don't recommend using this revision</pre>
 ...
 var selected_path = '/trunk/src/house.cpp';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=86&amp;format=side&amp;path=/trunk/src/house.cpp&amp;old_path=/trunk/src/house.cpp&amp;old=56">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 10, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=56&amp;format=side&amp;path=/trunk/src/house.cpp&amp;old_path=/trunk/src/house.cpp&amp;old=37">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Apr 9, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=37&amp;format=side&amp;path=/trunk/src/house.cpp&amp;old_path=/trunk/src/house.cpp&amp;old=24">Diff</a>
 <br>
...
rope with pool on rope spot fix</pre>
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/house.cpp&start=95">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 24680 bytes,
 1047 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/house.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/house.cpp'}
 codereviews = CR_controller.setup(
 {"profileUrl": "/u/108692122734644646415/", "domainName": null, "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAd2kEsCmjAFDsOKJcuAf02synWqAg:1406096500099", "projectHomeUrl": "/p/avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74"}, '', 'svn102', paths,
