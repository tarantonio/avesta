...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fallocator.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>allocator.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/allocator.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/allocator.h?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#ifndef __OTSERV_ALLOCATOR_H<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_ALLOCATOR_H<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">#include &lt;boost/pool/pool.hpp&gt;<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">class dummyallocator {<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">	typedef std::size_t size_type;<br></td></tr
><tr
id=sl_svn102_41

><td class="source">	typedef std::ptrdiff_t difference_type;<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	typedef T* pointer;<br></td></tr
><tr
id=sl_svn102_43

><td class="source">	typedef const T* const_pointer;<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	typedef T&amp; reference;<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	typedef const T&amp; const_reference;<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	typedef T value_type;<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	template &lt;class U&gt; struct rebind {<br></td></tr
><tr
id=sl_svn102_48

><td class="source">		typedef dummyallocator&lt;U&gt; other;<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	dummyallocator(  ) throw(  )                          {}<br></td></tr
><tr
id=sl_svn102_51

><td class="source">	dummyallocator(const dummyallocator&amp;) throw(  )          {}<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	template &lt;class U&gt;<br></td></tr
><tr
id=sl_svn102_53

><td class="source">		dummyallocator(const dummyallocator&lt;U&gt;&amp;) throw(  )       {}<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">	pointer address(reference x) const                 {return &amp;x;}<br></td></tr
><tr
id=sl_svn102_56

><td class="source">	const_pointer address(const_reference x) const     {return &amp;x;}<br></td></tr
><tr
id=sl_svn102_57

><td class="source">	pointer allocate(size_type n, void* hint = 0) {<br></td></tr
><tr
id=sl_svn102_58

><td class="source">		return static_cast&lt;T*&gt;(std::malloc(n * sizeof(T)) );<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	void deallocate(pointer p, size_type n) {<br></td></tr
><tr
id=sl_svn102_61

><td class="source">		std::free(static_cast&lt;void*&gt;(p));<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">	size_type max_size(  ) const throw(  ) {<br></td></tr
><tr
id=sl_svn102_64

><td class="source">		return std::numeric_limits&lt;size_type&gt;::max() / sizeof(T);<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	void construct(pointer p, const T&amp; val) {<br></td></tr
><tr
id=sl_svn102_67

><td class="source">		new(static_cast&lt;void*&gt;(p)) T(val);<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	void destroy(pointer p) {<br></td></tr
><tr
id=sl_svn102_70

><td class="source">		p-&gt;~T(  );<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">void* operator new(size_t bytes, int dummy);<br></td></tr
><tr
id=sl_svn102_75

><td class="source">void* operator new(size_t bytes);<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">void operator delete(void *p);<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">void operator delete(void* p, int dummy);<br></td></tr
><tr
id=sl_svn102_82
...
><td class="source">void allocatorStatsThread(void *a);<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">struct poolTag {<br></td></tr
><tr
id=sl_svn102_90

><td class="source">	size_t poolbytes;<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">class PoolManager {<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">	static PoolManager&amp; getInstance() {<br></td></tr
><tr
id=sl_svn102_96

><td class="source">		static PoolManager instance;<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">	void* allocate(size_t size) {<br></td></tr
><tr
id=sl_svn102_101

><td class="source">		Pools::iterator it;<br></td></tr
><tr
id=sl_svn102_102

><td class="source">		poolLock.lock();<br></td></tr
><tr
id=sl_svn102_103
...
><td class="source">		for(it = pools.begin(); it != pools.end(); ++it) {<br></td></tr
><tr
id=sl_svn102_105

><td class="source">			if(it-&gt;first &gt;= size + sizeof(poolTag)) {<br></td></tr
><tr
id=sl_svn102_106

><td class="source">				//poolTag* tag = reinterpret_cast&lt;poolTag*&gt;(it-&gt;second-&gt;ordered_malloc());<br></td></tr
><tr
id=sl_svn102_107

><td class="source">				poolTag* tag = reinterpret_cast&lt;poolTag*&gt;(it-&gt;second-&gt;malloc());<br></td></tr
><tr
id=sl_svn102_108

><td class="source">				tag-&gt;poolbytes = it-&gt;first;<br></td></tr
><tr
id=sl_svn102_109
...
><td class="source">				poolsStats[it-&gt;first]-&gt;allocations++;<br></td></tr
><tr
id=sl_svn102_111

><td class="source">				poolsStats[it-&gt;first]-&gt;unused+= it-&gt;first - (size + sizeof(poolTag));<br></td></tr
><tr
id=sl_svn102_112
...
><td class="source">				poolLock.unlock();<br></td></tr
><tr
id=sl_svn102_114

><td class="source">				return tag + 1;<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">		poolTag* tag = reinterpret_cast&lt;poolTag*&gt;(std::malloc(size + sizeof(poolTag)));<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">		poolsStats[0]-&gt;allocations++;<br></td></tr
><tr
id=sl_svn102_121

><td class="source">		poolsStats[0]-&gt;unused += size;<br></td></tr
><tr
id=sl_svn102_122
...
><td class="source">		tag-&gt;poolbytes = 0;<br></td></tr
><tr
id=sl_svn102_124
...
><td class="source">	void deallocate(void* deletable) {<br></td></tr
><tr
id=sl_svn102_129

><td class="source">		if(deletable == NULL)<br></td></tr
><tr
id=sl_svn102_130
...
><td class="source">		poolTag* const tag = reinterpret_cast&lt;poolTag*&gt;(deletable) - 1U;<br></td></tr
><tr
id=sl_svn102_133
...
><td class="source">		if(tag-&gt;poolbytes) {<br></td></tr
><tr
id=sl_svn102_135
...
><td class="source">			it = pools.find(tag-&gt;poolbytes);<br></td></tr
><tr
id=sl_svn102_138

><td class="source">			//it-&gt;second-&gt;ordered_free(tag);<br></td></tr
><tr
id=sl_svn102_139

><td class="source">			it-&gt;second-&gt;free(tag);<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">			poolsStats[it-&gt;first]-&gt;deallocations++;<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">			std::free(tag);<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">			poolsStats[0]-&gt;deallocations++;<br></td></tr
><tr
id=sl_svn102_148
...
><td class="source">	void releaseMemory(){<br></td></tr
><tr
id=sl_svn102_155
...
><td class="source">			it-&gt;second-&gt;release_memory();<br></td></tr
><tr
id=sl_svn102_158
...
><td class="source">	void dumpStats(){<br></td></tr
><tr
id=sl_svn102_164
...
><td class="source">		std::ofstream output(&quot;mem_dump.txt&quot;,std::ios_base::app);<br></td></tr
><tr
id=sl_svn102_167

><td class="source">		output &lt;&lt; &quot;Otserv Allocator Stats: &quot; &lt;&lt; std::ctime(&amp;rawtime);<br></td></tr
><tr
id=sl_svn102_168

><td class="source">		PoolsStats::iterator it;<br></td></tr
><tr
id=sl_svn102_169

><td class="source">		for(it = poolsStats.begin(); it != poolsStats.end(); ++it) {<br></td></tr
><tr
id=sl_svn102_170

><td class="source">			output &lt;&lt; (int)(it-&gt;first) &lt;&lt; &quot; alloc: &quot; &lt;&lt; (int64_t)(it-&gt;second-&gt;allocations) &lt;&lt;<br></td></tr
><tr
id=sl_svn102_171

><td class="source">				&quot; dealloc: &quot; &lt;&lt; (int64_t)(it-&gt;second-&gt;deallocations) &lt;&lt;<br></td></tr
><tr
id=sl_svn102_172

><td class="source">				&quot; unused: &quot; &lt;&lt; (int64_t)(it-&gt;second-&gt;unused);<br></td></tr
><tr
id=sl_svn102_173

><td class="source">			if(it-&gt;second-&gt;allocations != 0 &amp;&amp; it-&gt;first != 0){<br></td></tr
><tr
id=sl_svn102_174

><td class="source">				output &lt;&lt; &quot; avg: &quot; &lt;&lt; (int64_t)((it-&gt;first) - (it-&gt;second-&gt;unused)/(it-&gt;second-&gt;allocations)) &lt;&lt;<br></td></tr
><tr
id=sl_svn102_175

><td class="source">				&quot; unused: &quot; &lt;&lt; (int64_t)((it-&gt;second-&gt;unused)*100/(it-&gt;second-&gt;allocations)/(it-&gt;first));<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">			output &lt;&lt; &quot;% N: &quot; &lt;&lt; ((int64_t)(it-&gt;second-&gt;allocations) - (int64_t)(it-&gt;second-&gt;deallocations)) &lt;&lt;<br></td></tr
><tr
id=sl_svn102_178
...
><td class="source">	~PoolManager() {<br></td></tr
><tr
id=sl_svn102_186

><td class="source">		Pools::iterator it = pools.begin();<br></td></tr
><tr
id=sl_svn102_187

><td class="source">		while(it != pools.end()) {<br></td></tr
><tr
id=sl_svn102_188

><td class="source">			std::free(it-&gt;second);<br></td></tr
><tr
id=sl_svn102_189

><td class="source">			pools.erase(it++);<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">		PoolsStats::iterator it2;<br></td></tr
><tr
id=sl_svn102_193

><td class="source">		for(it2 = poolsStats.begin(); it2 != poolsStats.end(); ++it2) {<br></td></tr
><tr
id=sl_svn102_194

><td class="source">			std::free(it2-&gt;second);<br></td></tr
><tr
id=sl_svn102_195

><td class="source">			poolsStats.erase(it2++);<br></td></tr
><tr
id=sl_svn102_196
...
><td class="source">	void addPool(size_t size, size_t next_size) {<br></td></tr
><tr
id=sl_svn102_202

><td class="source">		pools[size] = new(0) boost::pool&lt;boost::default_user_allocator_malloc_free&gt;(size, next_size); <br></td></tr
><tr
id=sl_svn102_203
...
><td class="source">		t_PoolStats * tmp = new(0) t_PoolStats;<br></td></tr
><tr
id=sl_svn102_205

><td class="source">		tmp-&gt;unused = 0;<br></td></tr
><tr
id=sl_svn102_206

><td class="source">		tmp-&gt;allocations = 0;<br></td></tr
><tr
id=sl_svn102_207

><td class="source">		tmp-&gt;deallocations = 0;<br></td></tr
><tr
id=sl_svn102_208

><td class="source">		poolsStats[size] = tmp;<br></td></tr
><tr
id=sl_svn102_209
...
><td class="source">		addPool(32, 32768);<br></td></tr
><tr
id=sl_svn102_214

><td class="source">		addPool(48, 32768);<br></td></tr
><tr
id=sl_svn102_215

><td class="source">		addPool(96, 16384);<br></td></tr
><tr
id=sl_svn102_216

><td class="source">		addPool(128, 1024);<br></td></tr
><tr
id=sl_svn102_217

><td class="source">		addPool(384, 2048);<br></td></tr
><tr
id=sl_svn102_218

><td class="source">		addPool(1024, 128);<br></td></tr
><tr
id=sl_svn102_219

><td class="source">		addPool(8192, 128);<br></td></tr
><tr
id=sl_svn102_220

><td class="source">		addPool(16384, 128);<br></td></tr
><tr
id=sl_svn102_221

><td class="source">		addPool(14, 10000); //Tile class<br></td></tr
><tr
id=sl_svn102_222

><td class="source">		addPool(4, 10000); //Item class<br></td></tr
><tr
id=sl_svn102_223
...
><td class="source">		poolsStats[0] = tmp;<br></td></tr
><tr
id=sl_svn102_230
...
><td class="source">	PoolManager(const PoolManager&amp;);<br></td></tr
><tr
id=sl_svn102_234

><td class="source">	const PoolManager&amp; operator=(const PoolManager&amp;);<br></td></tr
><tr
id=sl_svn102_235
...
><td class="source">	typedef std::map&lt;size_t, boost::pool&lt;boost::default_user_allocator_malloc_free &gt;*, std::less&lt;size_t &gt;, <br></td></tr
><tr
id=sl_svn102_237

><td class="source">		dummyallocator&lt;std::pair&lt;const size_t, boost::pool&lt;boost::default_user_allocator_malloc_free&gt;* &gt; &gt; &gt; Pools;<br></td></tr
><tr
id=sl_svn102_238
...
><td class="source">	Pools pools;<br></td></tr
><tr
id=sl_svn102_240
...
><td class="source">	struct t_PoolStats{<br></td></tr
><tr
id=sl_svn102_242

><td class="source">		int64_t allocations;<br></td></tr
><tr
id=sl_svn102_243

><td class="source">		int64_t deallocations;<br></td></tr
><tr
id=sl_svn102_244

><td class="source">		int64_t unused;<br></td></tr
><tr
id=sl_svn102_245
...
><td class="source">	typedef std::map&lt;size_t, t_PoolStats*, std::less&lt;size_t &gt;, <br></td></tr
><tr
id=sl_svn102_247

><td class="source">		dummyallocator&lt;std::pair&lt;const size_t, t_PoolStats* &gt; &gt; &gt; PoolsStats;<br></td></tr
><tr
id=sl_svn102_248

><td class="source">	PoolsStats poolsStats;<br></td></tr
><tr
id=sl_svn102_249
...
><td class="source">	boost::recursive_mutex poolLock;<br></td></tr
><tr
id=sl_svn102_251
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/allocator.h&amp;old_path=/trunk/src/allocator.h&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/allocator.h';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/allocator.h&amp;old_path=/trunk/src/allocator.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/allocator.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/allocator.h">View raw file</a></div>
 </div>
