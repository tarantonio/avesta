...
<head>
 ...
 var codesite_token = "ABZ6GAejgY9T9yk-_J9eJiYpObCikxr_lQ:1406096461912";
 
 
 var CS_env = {"loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAejgY9T9yk-_J9eJiYpObCikxr_lQ:1406096461912", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fdatabasemysql.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>databasemysql.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/databasemysql.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/databasemysql.cpp?r=95" title="Previous">&lsaquo;r95</a></li>
...
><td class="source">#include &lt;winsock2.h&gt;<br></td></tr
><tr
id=sl_svn102_27
...
><td class="source">#ifdef __MYSQL_ALT_INCLUDE__<br></td></tr
><tr
id=sl_svn102_32

><td class="source">#include &quot;errmsg.h&quot;<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">#include &lt;mysql/errmsg.h&gt;<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">/** DatabaseMySQL definitions */<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">DatabaseMySQL::DatabaseMySQL()<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	// connection handle initialization<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	if(!mysql_init(&amp;m_handle)){<br></td></tr
><tr
id=sl_svn102_48

><td class="source">		std::cout &lt;&lt; &quot;Failed to initialize MySQL connection handle.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	// automatic reconnect<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	my_bool reconnect = true;<br></td></tr
><tr
id=sl_svn102_54

><td class="source">	mysql_options(&amp;m_handle, MYSQL_OPT_RECONNECT, &amp;reconnect);<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">	// connects to database<br></td></tr
><tr
id=sl_svn102_57

><td class="source">	if(!mysql_real_connect(&amp;m_handle, g_config.getString(ConfigManager::SQL_HOST).c_str(), g_config.getString(ConfigManager::SQL_USER).c_str(), g_config.getString(ConfigManager::SQL_PASS).c_str(), g_config.getString(ConfigManager::SQL_DB).c_str(), g_config.getNumber(ConfigManager::SQL_PORT), NULL, 0)){<br></td></tr
><tr
id=sl_svn102_58

><td class="source">		std::cout &lt;&lt; &quot;Failed to connect to database. MYSQL ERROR: &quot; &lt;&lt; mysql_error(&amp;m_handle) &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	if(MYSQL_VERSION_ID &lt; 50019){<br></td></tr
><tr
id=sl_svn102_63

><td class="source">		//mySQL servers &lt; 5.0.19 has a bug where MYSQL_OPT_RECONNECT is (incorrectly) reset by mysql_real_connect calls<br></td></tr
><tr
id=sl_svn102_64

><td class="source">		//See http://dev.mysql.com/doc/refman/5.0/en/mysql-options.html for more information.<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">		std::cout &lt;&lt; &quot;[Warning] Outdated mySQL server detected. Consider upgrading to a newer version.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">	mysql_close(&amp;m_handle);<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">bool DatabaseMySQL::getParam(DBParam_t param)<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">bool DatabaseMySQL::beginTransaction()<br></td></tr
><tr
id=sl_svn102_88
...
><td class="source">bool DatabaseMySQL::rollback()<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">	std::cout &lt;&lt; &quot;ROLLBACK&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">	if( mysql_rollback(&amp;m_handle) != 0){<br></td></tr
><tr
id=sl_svn102_102

><td class="source">		std::cout &lt;&lt; &quot;mysql_rollback(): MYSQL ERROR: &quot; &lt;&lt; mysql_error(&amp;m_handle) &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_103
...
><td class="source">bool DatabaseMySQL::commit()<br></td></tr
><tr
id=sl_svn102_110
...
><td class="source">	std::cout &lt;&lt; &quot;COMMIT&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_116
...
><td class="source">	if( mysql_commit(&amp;m_handle) != 0){<br></td></tr
><tr
id=sl_svn102_118

><td class="source">		std::cout &lt;&lt; &quot;mysql_commit(): MYSQL ERROR: &quot; &lt;&lt; mysql_error(&amp;m_handle) &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">bool DatabaseMySQL::executeQuery(const std::string &amp;query)<br></td></tr
><tr
id=sl_svn102_126
...
><td class="source">	std::cout &lt;&lt; &quot;MYSQL QUERY: &quot; &lt;&lt; query &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	bool state = true;<br></td></tr
><tr
id=sl_svn102_135
...
><td class="source">	// executes the query<br></td></tr
><tr
id=sl_svn102_137

><td class="source">	if(mysql_real_query(&amp;m_handle, query.c_str(), query.length()) != 0){<br></td></tr
><tr
id=sl_svn102_138

><td class="source">		std::cout &lt;&lt; &quot;mysql_real_query(): &quot; &lt;&lt; query &lt;&lt; &quot;: MYSQL ERROR: &quot; &lt;&lt; mysql_error(&amp;m_handle) &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_139

><td class="source">		int error = mysql_errno(&amp;m_handle);<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">		if(error == CR_SERVER_LOST || error == CR_SERVER_GONE_ERROR){<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">		state = false;<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">	// we should call that every time as someone would call executeQuery(&#39;SELECT...&#39;)<br></td></tr
><tr
id=sl_svn102_149

><td class="source">	// as it is described in MySQL manual: &quot;it doesn&#39;t hurt&quot; :P<br></td></tr
><tr
id=sl_svn102_150

><td class="source">	MYSQL_RES* m_res = mysql_store_result(&amp;m_handle);<br></td></tr
><tr
id=sl_svn102_151
...
><td class="source">	if(m_res)<br></td></tr
><tr
id=sl_svn102_153

><td class="source">		mysql_free_result(m_res);<br></td></tr
><tr
id=sl_svn102_154
...
><td class="source">DBResult* DatabaseMySQL::storeQuery(const std::string &amp;query)<br></td></tr
><tr
id=sl_svn102_159
...
><td class="source">	// error occured<br></td></tr
><tr
id=sl_svn102_183
...
><td class="source">		std::cout &lt;&lt; &quot;mysql_store_result(): &quot; &lt;&lt; query &lt;&lt; &quot;: MYSQL ERROR: &quot; &lt;&lt; mysql_error(&amp;m_handle) &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_185
...
><td class="source">	// retriving results of query<br></td></tr
><tr
id=sl_svn102_195

><td class="source">	DBResult* res = new MySQLResult(m_res);<br></td></tr
><tr
id=sl_svn102_196

><td class="source">	return verifyResult(res);<br></td></tr
><tr
id=sl_svn102_197
...
><td class="source">uint64_t DatabaseMySQL::getLastInsertedRowID()<br></td></tr
><tr
id=sl_svn102_200
...
><td class="source">	return (uint64_t)mysql_insert_id(&amp;m_handle);<br></td></tr
><tr
id=sl_svn102_202
...
><td class="source">std::string DatabaseMySQL::escapeString(const std::string &amp;s)<br></td></tr
><tr
id=sl_svn102_205
...
><td class="source">	return escapeBlob( s.c_str(), s.length() );<br></td></tr
><tr
id=sl_svn102_207
...
><td class="source">std::string DatabaseMySQL::escapeBlob(const char* s, uint32_t length)<br></td></tr
><tr
id=sl_svn102_210
...
><td class="source">	char* output = new char[length * 2 + 1];<br></td></tr
><tr
id=sl_svn102_217
...
><td class="source">	mysql_real_escape_string(&amp;m_handle, output, s, length);<br></td></tr
><tr
id=sl_svn102_220

><td class="source">	std::string r = &quot;&#39;&quot;;<br></td></tr
><tr
id=sl_svn102_221

><td class="source">	r += output;<br></td></tr
><tr
id=sl_svn102_222
...
><td class="source">void DatabaseMySQL::freeResult(DBResult* res)<br></td></tr
><tr
id=sl_svn102_228
...
><td class="source">	delete (MySQLResult*)res;<br></td></tr
><tr
id=sl_svn102_230
...
><td class="source">/** MySQLResult definitions */<br></td></tr
><tr
id=sl_svn102_233
...
><td class="source">int32_t MySQLResult::getDataInt(const std::string &amp;s)<br></td></tr
><tr
id=sl_svn102_235
...
><td class="source">		if(m_row[it-&gt;second] == NULL){<br></td></tr
><tr
id=sl_svn102_239
...
><td class="source">			return atoi(m_row[it-&gt;second]);<br></td></tr
><tr
id=sl_svn102_243
...
><td class="source">int64_t MySQLResult::getDataLong(const std::string &amp;s)<br></td></tr
><tr
id=sl_svn102_251
...
><td class="source">			return ATOI64(m_row[it-&gt;second]);<br></td></tr
><tr
id=sl_svn102_259
...
><td class="source">std::string MySQLResult::getDataString(const std::string &amp;s)<br></td></tr
><tr
id=sl_svn102_267
...
><td class="source">			return std::string(m_row[it-&gt;second]);<br></td></tr
><tr
id=sl_svn102_274
...
><td class="source">const char* MySQLResult::getDataStream(const std::string &amp;s, unsigned long &amp;size)<br></td></tr
><tr
id=sl_svn102_281
...
><td class="source">			size = mysql_fetch_lengths(m_handle)[it-&gt;second];<br></td></tr
><tr
id=sl_svn102_290

><td class="source">			return m_row[it-&gt;second];<br></td></tr
><tr
id=sl_svn102_291
...
><td class="source">bool MySQLResult::next()<br></td></tr
><tr
id=sl_svn102_300
...
><td class="source">	m_row = mysql_fetch_row(m_handle);<br></td></tr
><tr
id=sl_svn102_302

><td class="source">	return m_row != NULL;<br></td></tr
><tr
id=sl_svn102_303
...
><td class="source">MySQLResult::MySQLResult(MYSQL_RES* res)<br></td></tr
><tr
id=sl_svn102_306
...
><td class="source">	m_handle = res;<br></td></tr
><tr
id=sl_svn102_308
...
><td class="source">	MYSQL_FIELD* field;<br></td></tr
><tr
id=sl_svn102_311

><td class="source">	int32_t i = 0;<br></td></tr
><tr
id=sl_svn102_312

><td class="source">	while((field = mysql_fetch_field(m_handle))){<br></td></tr
><tr
id=sl_svn102_313

><td class="source">		m_listNames[field-&gt;name] = i;<br></td></tr
><tr
id=sl_svn102_314
...
><td class="source">MySQLResult::~MySQLResult()<br></td></tr
><tr
id=sl_svn102_319
...
><td class="source">	mysql_free_result(m_handle);<br></td></tr
><tr
id=sl_svn102_321
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 29, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=97&amp;format=side&amp;path=/trunk/src/databasemysql.cpp&amp;old_path=/trunk/src/databasemysql.cpp&amp;old=95">Diff</a>
 </div>
 <pre>more fixes</pre>
 </div>
 ...
 var selected_path = '/trunk/src/databasemysql.cpp';
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/databasemysql.cpp&amp;old_path=/trunk/src/databasemysql.cpp&amp;old=7">Diff</a>
 <br>
...
don't recommend using this revision</pre>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/databasemysql.cpp&amp;old_path=/trunk/src/databasemysql.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/databasemysql.cpp&start=97">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/databasemysql.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/databasemysql.cpp'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAejgY9T9yk-_J9eJiYpObCikxr_lQ:1406096461912", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null}, '', 'svn102', paths,
