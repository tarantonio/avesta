...
<head>
 ...
 var codesite_token = "ABZ6GAeXJQsKPdGf0IiyyvDpT0wywu4arw:1406096212178";
 
 
 var CS_env = {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAeXJQsKPdGf0IiyyvDpT0wywu4arw:1406096212178", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fallocator.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>allocator.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/allocator.cpp?edit=1"
...
><td class="source">//normal new/delete<br></td></tr
><tr
id=sl_svn102_27
...
><td class="source">	return PoolManager::getInstance().allocate(bytes);<br></td></tr
><tr
id=sl_svn102_30
...
><td class="source">	PoolManager::getInstance().deallocate(p);<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">//dummy new/delete operators<br></td></tr
><tr
id=sl_svn102_47
...
><td class="source">	return malloc(bytes);<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	std::free(p);<br></td></tr
><tr
id=sl_svn102_60
...
><td class="source">		boost::this_thread::sleep(boost::posix_time::milliseconds(30000));<br></td></tr
><tr
id=sl_svn102_72

><td class="source">		PoolManager::getInstance().dumpStats();<br></td></tr
><tr
id=sl_svn102_73

><td class="source">		//PoolManager::getInstance().releaseMemory();<br></td></tr
><tr
id=sl_svn102_74
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/allocator.cpp&amp;old_path=/trunk/src/allocator.cpp&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/allocator.cpp';
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/allocator.cpp&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/allocator.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/allocator.cpp'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAeXJQsKPdGf0IiyyvDpT0wywu4arw:1406096212178", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null}, '', 'svn102', paths,
