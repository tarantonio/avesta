...
<head>
 ...
 var codesite_token = "ABZ6GAcKISncXVcM_AUobX8PMJLg1uhm-A:1406096384902";
 
 
 var CS_env = {"projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAcKISncXVcM_AUobX8PMJLg1uhm-A:1406096384902", "relativeBaseUrl": "", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fcombat.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>combat.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/combat.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/combat.cpp?r=95" title="Previous">&lsaquo;r95</a></li>
...
><td class="source">#include &quot;const.h&quot;<br></td></tr
><tr
id=sl_svn102_29
...
><td class="source">Combat::Combat()<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	params.condition = NULL;<br></td></tr
><tr
id=sl_svn102_43

><td class="source">	params.valueCallback = NULL;<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	params.tileCallback = NULL;<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	params.targetCallback = NULL;<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	area = NULL;<br></td></tr
><tr
id=sl_svn102_47
...
><td class="source">	formulaType = FORMULA_UNDEFINED;<br></td></tr
><tr
id=sl_svn102_49

><td class="source">	mina = 0.0;<br></td></tr
><tr
id=sl_svn102_50

><td class="source">	minb = 0.0;<br></td></tr
><tr
id=sl_svn102_51

><td class="source">	maxa = 0.0;<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	maxb = 0.0;<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">	delete params.condition;<br></td></tr
><tr
id=sl_svn102_58

><td class="source">	delete params.valueCallback;<br></td></tr
><tr
id=sl_svn102_59

><td class="source">	delete params.tileCallback;<br></td></tr
><tr
id=sl_svn102_60

><td class="source">	delete params.targetCallback;<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">bool Combat::getMinMaxValues(Creature* creature, Creature* target, int32_t&amp; min, int32_t&amp; max) const<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	if(creature-&gt;getCombatValues(min, max)){<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">	else if(Player* player = creature-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_74

><td class="source">		if(params.valueCallback){<br></td></tr
><tr
id=sl_svn102_75

><td class="source">			params.valueCallback-&gt;getMinMaxValues(player, min, max, params.useCharges);<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">			switch(formulaType){<br></td></tr
><tr
id=sl_svn102_80

><td class="source">				case FORMULA_LEVELMAGIC:<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">					max = (int32_t)((player-&gt;getLevel() * 2 + player-&gt;getMagicLevel() * 3) * 1. * mina + minb);<br></td></tr
><tr
id=sl_svn102_83

><td class="source">					min = (int32_t)((player-&gt;getLevel() * 2 + player-&gt;getMagicLevel() * 3) * 1. * maxa + maxb);<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">				case FORMULA_SKILL:<br></td></tr
><tr
id=sl_svn102_88
...
><td class="source">					Item* tool = player-&gt;getWeapon();<br></td></tr
><tr
id=sl_svn102_90

><td class="source">					const Weapon* weapon = g_weapons-&gt;getWeapon(tool);<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">					min = (int32_t)minb;<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">					if(weapon){<br></td></tr
><tr
id=sl_svn102_95

><td class="source">						max = (int32_t)(weapon-&gt;getWeaponDamage(player, target, tool, true) * maxa + maxb);<br></td></tr
><tr
id=sl_svn102_96

><td class="source">						if(params.useCharges &amp;&amp; tool-&gt;hasCharges() &amp;&amp; g_config.getBoolean(ConfigManager::REMOVE_WEAPON_CHARGES)){<br></td></tr
><tr
id=sl_svn102_97

><td class="source">							int32_t newCharge = std::max((int32_t)0, ((int32_t)tool-&gt;getCharges()) - 1);<br></td></tr
><tr
id=sl_svn102_98

><td class="source">							g_game.transformItem(tool, tool-&gt;getID(), newCharge);<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">						max = (int32_t)maxb;<br></td></tr
><tr
id=sl_svn102_103
...
><td class="source">				case FORMULA_VALUE:<br></td></tr
><tr
id=sl_svn102_109
...
><td class="source">                    min = (int32_t)mina;<br></td></tr
><tr
id=sl_svn102_111

><td class="source">                    max = (int32_t)maxa;<br></td></tr
><tr
id=sl_svn102_112
...
><td class="source">			//std::cout &lt;&lt; &quot;No callback set for combat&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">	else if(formulaType == FORMULA_VALUE){<br></td></tr
><tr
id=sl_svn102_126
...
><td class="source">void Combat::getCombatArea(const Position&amp; centerPos, const Position&amp; targetPos, const AreaCombat* area,<br></td></tr
><tr
id=sl_svn102_135

><td class="source">	std::list&lt;Tile*&gt;&amp; list)<br></td></tr
><tr
id=sl_svn102_136
...
><td class="source">		area-&gt;getList(centerPos, targetPos, list);<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">	else if(targetPos.x &gt;= 0 &amp;&amp; targetPos.y &gt;= 0 &amp;&amp; targetPos.z &gt;= 0 &amp;&amp;<br></td></tr
><tr
id=sl_svn102_141

><td class="source">		targetPos.x &lt;= 0xFFFF &amp;&amp; targetPos.y &lt;= 0xFFFF &amp;&amp; targetPos.z &lt; MAP_MAX_LAYERS)<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">		Tile* tile = g_game.getTile(targetPos.x, targetPos.y, targetPos.z);<br></td></tr
><tr
id=sl_svn102_144
...
><td class="source">            tile = new Tile(targetPos.x, targetPos.y, targetPos.z);<br></td></tr
><tr
id=sl_svn102_146

><td class="source">            g_game.setTile(tile);<br></td></tr
><tr
id=sl_svn102_147
...
><td class="source">		list.push_back(tile);<br></td></tr
><tr
id=sl_svn102_150
...
><td class="source">CombatType_t Combat::ConditionToDamageType(ConditionType_t type)<br></td></tr
><tr
id=sl_svn102_154
...
><td class="source">			return COMBAT_FIREDAMAGE;<br></td></tr
><tr
id=sl_svn102_158
...
><td class="source">			return COMBAT_ENERGYDAMAGE;<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">			return COMBAT_POISONDAMAGE;<br></td></tr
><tr
id=sl_svn102_166
...
><td class="source">	return COMBAT_NONE;<br></td></tr
><tr
id=sl_svn102_173
...
><td class="source">ConditionType_t Combat::DamageToConditionType(CombatType_t type)<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">		case COMBAT_FIREDAMAGE: return CONDITION_FIRE;<br></td></tr
><tr
id=sl_svn102_179

><td class="source">		case COMBAT_ENERGYDAMAGE: return CONDITION_ENERGY;<br></td></tr
><tr
id=sl_svn102_180

><td class="source">		case COMBAT_POISONDAMAGE: return CONDITION_POISON;<br></td></tr
><tr
id=sl_svn102_181
...
><td class="source">	return CONDITION_NONE;<br></td></tr
><tr
id=sl_svn102_185
...
><td class="source">bool Combat::isPlayerCombat(const Creature* target)<br></td></tr
><tr
id=sl_svn102_188
...
><td class="source">	if(target-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">	if(target-&gt;isSummon() &amp;&amp; target-&gt;getMaster()-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_194
...
><td class="source">ReturnValue Combat::canTargetCreature(const Player* player, const Creature* target)<br></td></tr
><tr
id=sl_svn102_201
...
><td class="source">	if(player == target){<br></td></tr
><tr
id=sl_svn102_203

><td class="source">		return RET_YOUMAYNOTATTACKTHISPLAYER;<br></td></tr
><tr
id=sl_svn102_204
...
><td class="source">	if(!player-&gt;hasFlag(PlayerFlag_IgnoreProtectionZone)){<br></td></tr
><tr
id=sl_svn102_207

><td class="source">		//pz-zone<br></td></tr
><tr
id=sl_svn102_208
...
><td class="source">			return RET_YOUMAYNOTATTACKAPERSONWHILEINPROTECTIONZONE;<br></td></tr
><tr
id=sl_svn102_210
...
><td class="source">		if(target-&gt;getZone() == ZONE_PROTECTION){<br></td></tr
><tr
id=sl_svn102_212

><td class="source">			return RET_YOUMAYNOTATTACKAPERSONINPROTECTIONZONE;<br></td></tr
><tr
id=sl_svn102_213
...
><td class="source">		//nopvp-zone<br></td></tr
><tr
id=sl_svn102_216

><td class="source">		if(isPlayerCombat(target)){<br></td></tr
><tr
id=sl_svn102_217

><td class="source">			if(player-&gt;getZone() == ZONE_NOPVP){<br></td></tr
><tr
id=sl_svn102_218

><td class="source">				return RET_ACTIONNOTPERMITTEDINANOPVPZONE;<br></td></tr
><tr
id=sl_svn102_219
...
><td class="source">			if(target-&gt;getZone() == ZONE_NOPVP){<br></td></tr
><tr
id=sl_svn102_221
...
><td class="source">	if(player-&gt;hasFlag(PlayerFlag_CannotUseCombat) || !target-&gt;isAttackable()){<br></td></tr
><tr
id=sl_svn102_227
...
><td class="source">			return RET_YOUMAYNOTATTACKTHISCREATURE;<br></td></tr
><tr
id=sl_svn102_232
...
><td class="source">	if (g_config.getBoolean(ConfigManager::TEAM_MODE)) {<br></td></tr
><tr
id=sl_svn102_236

><td class="source">		const Player* targetPlayer = target-&gt;getPlayer();<br></td></tr
><tr
id=sl_svn102_237

><td class="source">		if (player &amp;&amp; targetPlayer &amp;&amp;<br></td></tr
><tr
id=sl_svn102_238

><td class="source">			player-&gt;getGuildId() == targetPlayer-&gt;getGuildId()) <br></td></tr
><tr
id=sl_svn102_239
...
><td class="source">	if(player-&gt;hasSafeMode() &amp;&amp; target-&gt;getPlayer()) {<br></td></tr
><tr
id=sl_svn102_246
...
><td class="source">		    if(player-&gt;getParty()-&gt;isPlayerMember(target-&gt;getPlayer()) ||<br></td></tr
><tr
id=sl_svn102_248

><td class="source">				player-&gt;getParty()-&gt;getLeader() == target) <br></td></tr
><tr
id=sl_svn102_249
...
><td class="source">		        return Combat::canDoCombat(player, target);<br></td></tr
><tr
id=sl_svn102_251
...
><td class="source">		if(target-&gt;getPlayer()-&gt;getSkull() == SKULL_NONE) {<br></td></tr
><tr
id=sl_svn102_254

><td class="source">			if(!Combat::isInPvpZone(player, target)) {<br></td></tr
><tr
id=sl_svn102_255

><td class="source">				return RET_TURNSECUREMODETOATTACKUNMARKEDPLAYERS;<br></td></tr
><tr
id=sl_svn102_256
...
><td class="source">ReturnValue Combat::canDoCombat(const Creature* caster, const Tile* tile, bool isAggressive)<br></td></tr
><tr
id=sl_svn102_265
...
><td class="source">	if(tile-&gt;hasProperty(BLOCKPROJECTILE)){<br></td></tr
><tr
id=sl_svn102_267

><td class="source">		return RET_NOTENOUGHROOM;<br></td></tr
><tr
id=sl_svn102_268
...
><td class="source">	//if(!tile-&gt;ground){<br></td></tr
><tr
id=sl_svn102_271
...
><td class="source">	if(tile-&gt;floorChange()){<br></td></tr
><tr
id=sl_svn102_275
...
><td class="source">	if(tile-&gt;getTeleportItem()){<br></td></tr
><tr
id=sl_svn102_279
...
><td class="source">		if(caster-&gt;getPosition().z &lt; tile-&gt;getPosition().z){<br></td></tr
><tr
id=sl_svn102_284

><td class="source">			return RET_FIRSTGODOWNSTAIRS;<br></td></tr
><tr
id=sl_svn102_285
...
><td class="source">			return RET_FIRSTGOUPSTAIRS;<br></td></tr
><tr
id=sl_svn102_289
...
><td class="source">		if(const Player* player = caster-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_292
...
><td class="source">	if(isAggressive &amp;&amp; tile-&gt;hasFlag(TILESTATE_PROTECTIONZONE)){<br></td></tr
><tr
id=sl_svn102_300

><td class="source">		return RET_ACTIONNOTPERMITTEDINPROTECTIONZONE;<br></td></tr
><tr
id=sl_svn102_301
...
><td class="source">bool Combat::isInPvpZone(const Creature* attacker, const Creature* target)<br></td></tr
><tr
id=sl_svn102_307
...
><td class="source">	if(attacker-&gt;getZone() != ZONE_PVP){<br></td></tr
><tr
id=sl_svn102_309
...
><td class="source">	if(target-&gt;getZone() != ZONE_PVP){<br></td></tr
><tr
id=sl_svn102_313
...
><td class="source">ReturnValue Combat::canDoCombat(const Creature* attacker, const Creature* target)<br></td></tr
><tr
id=sl_svn102_320
...
><td class="source">		if(const Player* targetPlayer = target-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_323

><td class="source">			if(targetPlayer-&gt;hasFlag(PlayerFlag_CannotBeAttacked)){<br></td></tr
><tr
id=sl_svn102_324
...
><td class="source">			if(const Player* attackerPlayer = attacker-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_328

><td class="source">				if(attackerPlayer-&gt;hasFlag(PlayerFlag_CannotAttackPlayer)){<br></td></tr
><tr
id=sl_svn102_329
...
><td class="source">			if(attacker-&gt;isSummon()){<br></td></tr
><tr
id=sl_svn102_334

><td class="source">				if(const Player* masterAttackerPlayer = attacker-&gt;getMaster()-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_335

><td class="source">					if(masterAttackerPlayer-&gt;hasFlag(PlayerFlag_CannotAttackPlayer)){<br></td></tr
><tr
id=sl_svn102_336
...
><td class="source">		else if(target-&gt;getMonster()){<br></td></tr
><tr
id=sl_svn102_342
...
><td class="source">				if(attackerPlayer-&gt;hasFlag(PlayerFlag_CannotAttackMonster)){<br></td></tr
><tr
id=sl_svn102_344
...
><td class="source">		if(attacker-&gt;getPlayer() || (attacker-&gt;isSummon() &amp;&amp; attacker-&gt;getMaster()-&gt;getPlayer()) ){<br></td></tr
><tr
id=sl_svn102_350
...
><td class="source">			if(target-&gt;getPlayer() &amp;&amp; target-&gt;getTile()-&gt;hasFlag(TILESTATE_NOPVPZONE)){<br></td></tr
><tr
id=sl_svn102_352
...
><td class="source">			if(g_game.getWorldType() == WORLD_TYPE_NO_PVP){<br></td></tr
><tr
id=sl_svn102_356
...
><td class="source">					if(!isInPvpZone(attacker, target)){<br></td></tr
><tr
id=sl_svn102_358
...
><td class="source">void Combat::setPlayerCombatValues(formulaType_t _type, double _mina, double _minb, double _maxa, double _maxb)<br></td></tr
><tr
id=sl_svn102_375
...
><td class="source">	formulaType = _type;<br></td></tr
><tr
id=sl_svn102_377
...
><td class="source">bool Combat::setParam(CombatParam_t param, uint32_t value)<br></td></tr
><tr
id=sl_svn102_384
...
><td class="source">		case COMBATPARAM_COMBATTYPE:<br></td></tr
><tr
id=sl_svn102_387
...
><td class="source">			params.combatType = (CombatType_t)value;<br></td></tr
><tr
id=sl_svn102_389
...
><td class="source">		case COMBATPARAM_EFFECT:<br></td></tr
><tr
id=sl_svn102_393
...
><td class="source">			params.impactEffect = (uint8_t)value;<br></td></tr
><tr
id=sl_svn102_395
...
><td class="source">		case COMBATPARAM_DISTANCEEFFECT:<br></td></tr
><tr
id=sl_svn102_399
...
><td class="source">			params.distanceEffect = (uint8_t)value;<br></td></tr
><tr
id=sl_svn102_401
...
><td class="source">		case COMBATPARAM_BLOCKEDBYARMOR:<br></td></tr
><tr
id=sl_svn102_405
...
><td class="source">			params.blockedByArmor = (value != 0);<br></td></tr
><tr
id=sl_svn102_407
...
><td class="source">		case COMBATPARAM_BLOCKEDBYSHIELD:<br></td></tr
><tr
id=sl_svn102_411
...
><td class="source">			params.blockedByShield = (value != 0);<br></td></tr
><tr
id=sl_svn102_413
...
><td class="source">		case COMBATPARAM_TARGETCASTERORTOPMOST:<br></td></tr
><tr
id=sl_svn102_417
...
><td class="source">			params.targetCasterOrTopMost = (value != 0);<br></td></tr
><tr
id=sl_svn102_419
...
><td class="source">		case COMBATPARAM_CREATEITEM:<br></td></tr
><tr
id=sl_svn102_423
...
><td class="source">			params.itemId = value;<br></td></tr
><tr
id=sl_svn102_425
...
><td class="source">		case COMBATPARAM_AGGRESSIVE:<br></td></tr
><tr
id=sl_svn102_429
...
><td class="source">			params.isAggressive = (value != 0);<br></td></tr
><tr
id=sl_svn102_431
...
><td class="source">		case COMBATPARAM_DISPEL:<br></td></tr
><tr
id=sl_svn102_435
...
><td class="source">			params.dispelType = (ConditionType_t)value;<br></td></tr
><tr
id=sl_svn102_437
...
><td class="source">		case COMBATPARAM_USECHARGES:<br></td></tr
><tr
id=sl_svn102_441
...
><td class="source">            params.useCharges = (value != 0);<br></td></tr
><tr
id=sl_svn102_443
...
><td class="source">		case COMBATPARAM_HITEFFECT:<br></td></tr
><tr
id=sl_svn102_447
...
><td class="source">			params.hitEffect = (MagicEffectClasses)value;<br></td></tr
><tr
id=sl_svn102_449
...
><td class="source">		case COMBATPARAM_HITTEXTCOLOR:<br></td></tr
><tr
id=sl_svn102_453
...
><td class="source">			params.hitTextColor = (TextColor_t)value;<br></td></tr
><tr
id=sl_svn102_455
...
><td class="source">bool Combat::setCallback(CallBackParam_t key)<br></td></tr
><tr
id=sl_svn102_468
...
><td class="source">		case CALLBACKPARAM_LEVELMAGICVALUE:<br></td></tr
><tr
id=sl_svn102_471
...
><td class="source">			params.valueCallback = new ValueCallback(FORMULA_LEVELMAGIC);<br></td></tr
><tr
id=sl_svn102_474
...
><td class="source">		case CALLBACKPARAM_SKILLVALUE:<br></td></tr
><tr
id=sl_svn102_478
...
><td class="source">			params.valueCallback = new ValueCallback(FORMULA_SKILL);<br></td></tr
><tr
id=sl_svn102_481
...
><td class="source">		case CALLBACKPARAM_TARGETTILECALLBACK:<br></td></tr
><tr
id=sl_svn102_485
...
><td class="source">			params.tileCallback = new TileCallback();<br></td></tr
><tr
id=sl_svn102_488
...
><td class="source">		case CALLBACKPARAM_TARGETCREATURECALLBACK:<br></td></tr
><tr
id=sl_svn102_492
...
><td class="source">			params.targetCallback = new TargetCallback();<br></td></tr
><tr
id=sl_svn102_495
...
><td class="source">			std::cout &lt;&lt; &quot;Combat::setCallback - Unknown callback type: &quot; &lt;&lt; (uint32_t)key &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_501
...
><td class="source">CallBack* Combat::getCallback(CallBackParam_t key)<br></td></tr
><tr
id=sl_svn102_509
...
><td class="source">			return params.valueCallback;<br></td></tr
><tr
id=sl_svn102_515
...
><td class="source">			return params.tileCallback;<br></td></tr
><tr
id=sl_svn102_520
...
><td class="source">			return params.targetCallback;<br></td></tr
><tr
id=sl_svn102_525
...
><td class="source">bool Combat::CombatHealthFunc(Creature* caster, Creature* target, const CombatParams&amp; params, void* data)<br></td></tr
><tr
id=sl_svn102_532
...
><td class="source">	Combat2Var* var = (Combat2Var*)data;<br></td></tr
><tr
id=sl_svn102_534

><td class="source">	int32_t healthChange = random_range(var-&gt;minChange, var-&gt;maxChange, DISTRO_NORMAL);<br></td></tr
><tr
id=sl_svn102_535
...
><td class="source">	if(g_game.combatBlockHit(params.combatType, caster, target, healthChange, params.blockedByShield, params.blockedByArmor)){<br></td></tr
><tr
id=sl_svn102_537
...
><td class="source">		if (caster &amp;&amp; target) {<br></td></tr
><tr
id=sl_svn102_542

><td class="source">			Player* casterPlayer = caster-&gt;getPlayer();<br></td></tr
><tr
id=sl_svn102_543

><td class="source">			Player* targetPlayer = target-&gt;getPlayer();<br></td></tr
><tr
id=sl_svn102_544

><td class="source">			if (casterPlayer &amp;&amp; targetPlayer) {<br></td></tr
><tr
id=sl_svn102_545

><td class="source">				healthChange = healthChange / 2;<br></td></tr
><tr
id=sl_svn102_546
...
><td class="source">					casterPlayer-&gt;getGuildId() == targetPlayer-&gt;getGuildId()) <br></td></tr
><tr
id=sl_svn102_549
...
><td class="source">					int damagePercent = g_config.getNumber(ConfigManager::DAMAGE_PERCENT);<br></td></tr
><tr
id=sl_svn102_551

><td class="source">					healthChange = (healthChange * damagePercent) / 100;<br></td></tr
><tr
id=sl_svn102_552
...
><td class="source">	bool result = g_game.combatChangeHealth(params.combatType, params.hitEffect, params.hitTextColor, caster, target, healthChange);<br></td></tr
><tr
id=sl_svn102_558
...
><td class="source">		CombatConditionFunc(caster, target, params, NULL);<br></td></tr
><tr
id=sl_svn102_561

><td class="source">		CombatDispelFunc(caster, target, params, NULL);<br></td></tr
><tr
id=sl_svn102_562
...
><td class="source">bool Combat::CombatManaFunc(Creature* caster, Creature* target, const CombatParams&amp; params, void* data)<br></td></tr
><tr
id=sl_svn102_568
...
><td class="source">	int32_t manaChange = random_range(var-&gt;minChange, var-&gt;maxChange, DISTRO_NORMAL);<br></td></tr
><tr
id=sl_svn102_571
...
><td class="source">				manaChange = manaChange / 2;<br></td></tr
><tr
id=sl_svn102_578
...
><td class="source">					manaChange = (manaChange * damagePercent) / 100;<br></td></tr
><tr
id=sl_svn102_584
...
><td class="source">	bool result = g_game.combatChangeMana(caster, target, manaChange);<br></td></tr
><tr
id=sl_svn102_590
...
><td class="source">bool Combat::CombatConditionFunc(Creature* caster, Creature* target, const CombatParams&amp; params, void* data)<br></td></tr
><tr
id=sl_svn102_600
...
><td class="source">	if(params.condition){<br></td></tr
><tr
id=sl_svn102_604

><td class="source">		if(caster == target || !target-&gt;isImmune(params.condition-&gt;getType())){<br></td></tr
><tr
id=sl_svn102_605

><td class="source">			Condition* conditionCopy = params.condition-&gt;clone();<br></td></tr
><tr
id=sl_svn102_606
...
><td class="source">				conditionCopy-&gt;setParam(CONDITIONPARAM_OWNER, caster-&gt;getID());<br></td></tr
><tr
id=sl_svn102_608
...
><td class="source">			//TODO: infight condition until all aggressive conditions has ended<br></td></tr
><tr
id=sl_svn102_611

><td class="source">			result = target-&gt;addCombatCondition(conditionCopy);<br></td></tr
><tr
id=sl_svn102_612
...
><td class="source">bool Combat::CombatDispelFunc(Creature* caster, Creature* target, const CombatParams&amp; params, void* data)<br></td></tr
><tr
id=sl_svn102_619
...
><td class="source">	if(target-&gt;hasCondition(params.dispelType)){<br></td></tr
><tr
id=sl_svn102_621

><td class="source">		target-&gt;removeCondition(caster, params.dispelType);<br></td></tr
><tr
id=sl_svn102_622
...
><td class="source">bool Combat::CombatNullFunc(Creature* caster, Creature* target, const CombatParams&amp; params, void* data)<br></td></tr
><tr
id=sl_svn102_629
...
><td class="source">void Combat::combatTileEffects(const SpectatorVec&amp; list, Creature* caster, Tile* tile, const CombatParams&amp; params)<br></td></tr
><tr
id=sl_svn102_636
...
><td class="source">	if(params.itemId != 0){<br></td></tr
><tr
id=sl_svn102_638

><td class="source">		uint32_t itemId = params.itemId;<br></td></tr
><tr
id=sl_svn102_639

><td class="source">		Player* p_caster = NULL;<br></td></tr
><tr
id=sl_svn102_640
...
><td class="source">			if(caster-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_642

><td class="source">				p_caster = caster-&gt;getPlayer();<br></td></tr
><tr
id=sl_svn102_643
...
><td class="source">			else if(caster-&gt;isSummon()){<br></td></tr
><tr
id=sl_svn102_645

><td class="source">				p_caster = caster-&gt;getMaster()-&gt;getPlayer();<br></td></tr
><tr
id=sl_svn102_646
...
><td class="source">		if(p_caster){<br></td></tr
><tr
id=sl_svn102_649

><td class="source">			if(g_game.getWorldType() == WORLD_TYPE_NO_PVP || tile-&gt;hasFlag(TILESTATE_NOPVPZONE)){<br></td></tr
><tr
id=sl_svn102_650

><td class="source">				if(itemId == ITEM_FIREFIELD_PVP){<br></td></tr
><tr
id=sl_svn102_651

><td class="source">					itemId = ITEM_FIREFIELD_NOPVP;<br></td></tr
><tr
id=sl_svn102_652
...
><td class="source">				else if(itemId == ITEM_POISONFIELD_PVP){<br></td></tr
><tr
id=sl_svn102_654

><td class="source">					itemId = ITEM_POISONFIELD_NOPVP;<br></td></tr
><tr
id=sl_svn102_655
...
><td class="source">				else if(itemId == ITEM_ENERGYFIELD_PVP){<br></td></tr
><tr
id=sl_svn102_657

><td class="source">					itemId = ITEM_ENERGYFIELD_NOPVP;<br></td></tr
><tr
id=sl_svn102_658
...
><td class="source">			else if(params.isAggressive){<br></td></tr
><tr
id=sl_svn102_661

><td class="source">				const ItemType&amp; it = Item::items[itemId];<br></td></tr
><tr
id=sl_svn102_662

><td class="source">				if(!it.blockSolid){<br></td></tr
><tr
id=sl_svn102_663

><td class="source">					p_caster-&gt;addInFightTicks(true);<br></td></tr
><tr
id=sl_svn102_664
...
><td class="source">					p_caster-&gt;addInFightTicks();<br></td></tr
><tr
id=sl_svn102_667
...
><td class="source">		Item* item = Item::CreateItem(itemId);<br></td></tr
><tr
id=sl_svn102_672
...
><td class="source">			item-&gt;setOwner(caster-&gt;getID());<br></td></tr
><tr
id=sl_svn102_675
...
><td class="source">		ReturnValue ret = g_game.internalAddItem(tile, item);<br></td></tr
><tr
id=sl_svn102_678
...
><td class="source">	if(params.tileCallback){<br></td></tr
><tr
id=sl_svn102_687

><td class="source">		params.tileCallback-&gt;onTileCombat(caster, tile);<br></td></tr
><tr
id=sl_svn102_688
...
><td class="source">	if(params.impactEffect != NM_ME_NONE){<br></td></tr
><tr
id=sl_svn102_691

><td class="source">		g_game.addMagicEffect(list, tile-&gt;getPosition(), params.impactEffect);<br></td></tr
><tr
id=sl_svn102_692
...
><td class="source">void Combat::postCombatEffects(Creature* caster, const Position&amp; pos, const CombatParams&amp; params)<br></td></tr
><tr
id=sl_svn102_696
...
><td class="source">	if(caster &amp;&amp; params.distanceEffect != NM_ME_NONE){<br></td></tr
><tr
id=sl_svn102_698

><td class="source">		addDistanceEffect(caster, caster-&gt;getPosition(), pos, params.distanceEffect);<br></td></tr
><tr
id=sl_svn102_699
...
><td class="source">void Combat::addDistanceEffect(Creature* caster, const Position&amp; fromPos, const Position&amp; toPos,<br></td></tr
><tr
id=sl_svn102_703
...
><td class="source">	uint8_t distanceEffect = effect;<br></td></tr
><tr
id=sl_svn102_706
...
><td class="source">	if(caster &amp;&amp; distanceEffect != NM_ME_NONE){<br></td></tr
><tr
id=sl_svn102_708

><td class="source">		g_game.addDistanceEffect(fromPos, toPos, distanceEffect);<br></td></tr
><tr
id=sl_svn102_709
...
><td class="source">void Combat::CombatFunc(Creature* caster, const Position&amp; pos,<br></td></tr
><tr
id=sl_svn102_714
...
><td class="source">	std::list&lt;Tile*&gt; tileList;<br></td></tr
><tr
id=sl_svn102_717
...
><td class="source">		getCombatArea(caster-&gt;getPosition(), pos, area, tileList);<br></td></tr
><tr
id=sl_svn102_720
...
><td class="source">		getCombatArea(pos, pos, area, tileList);<br></td></tr
><tr
id=sl_svn102_723
...
><td class="source">	uint32_t maxX = 0;<br></td></tr
><tr
id=sl_svn102_727

><td class="source">	uint32_t maxY = 0;<br></td></tr
><tr
id=sl_svn102_728

><td class="source">	uint32_t diff;<br></td></tr
><tr
id=sl_svn102_729
...
><td class="source">	//calculate the max viewable range<br></td></tr
><tr
id=sl_svn102_731

><td class="source">	for(std::list&lt;Tile*&gt;::iterator it = tileList.begin(); it != tileList.end(); ++it){<br></td></tr
><tr
id=sl_svn102_732

><td class="source">        diff = std::abs((*it)-&gt;getPosition().x - pos.x);<br></td></tr
><tr
id=sl_svn102_733

><td class="source">        if(diff &gt; maxX){<br></td></tr
><tr
id=sl_svn102_734

><td class="source">            maxX = diff;<br></td></tr
><tr
id=sl_svn102_735
...
><td class="source">        diff = std::abs((*it)-&gt;getPosition().y - pos.y);<br></td></tr
><tr
id=sl_svn102_738

><td class="source">        if(diff &gt; maxY){<br></td></tr
><tr
id=sl_svn102_739

><td class="source">            maxY = diff;<br></td></tr
><tr
id=sl_svn102_740
...
><td class="source">     g_game.getSpectators(list, pos, false, true, maxX + Map::maxViewportX, maxX + Map::maxViewportX,<br></td></tr
><tr
id=sl_svn102_744

><td class="source">        maxY + Map::maxViewportY, maxY + Map::maxViewportY);<br></td></tr
><tr
id=sl_svn102_745
...
><td class="source">		bool bContinue = true;<br></td></tr
><tr
id=sl_svn102_748
...
><td class="source">		if(canDoCombat(caster, *it, params.isAggressive) == RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_750

><td class="source">			for(CreatureVector::iterator cit = (*it)-&gt;creatures.begin(); bContinue &amp;&amp; cit != (*it)-&gt;creatures.end(); ++cit){<br></td></tr
><tr
id=sl_svn102_751

><td class="source">				if(params.targetCasterOrTopMost){<br></td></tr
><tr
id=sl_svn102_752
...
><td class="source">					if(g_config.getBoolean(ConfigManager::UH_TRAP) == false &amp;&amp; <br></td></tr
><tr
id=sl_svn102_754

><td class="source">						(caster &amp;&amp; caster-&gt;getTile() == (*it))){<br></td></tr
><tr
id=sl_svn102_755

><td class="source">							if(*cit == caster){<br></td></tr
><tr
id=sl_svn102_756

><td class="source">								bContinue = false;<br></td></tr
><tr
id=sl_svn102_757
...
><td class="source">					else if(*cit == (*it)-&gt;getTopCreature()){<br></td></tr
><tr
id=sl_svn102_760
...
><td class="source">					if(bContinue){<br></td></tr
><tr
id=sl_svn102_764
...
><td class="source">				if(!params.isAggressive || (caster != *cit &amp;&amp; Combat::canDoCombat(caster, *cit) == RET_NOERROR)){<br></td></tr
><tr
id=sl_svn102_769

><td class="source">					func(caster, *cit, params, data);<br></td></tr
><tr
id=sl_svn102_770
...
><td class="source">					if(params.targetCallback){<br></td></tr
><tr
id=sl_svn102_772

><td class="source">						params.targetCallback-&gt;onTargetCombat(caster, *cit);<br></td></tr
><tr
id=sl_svn102_773
...
><td class="source">			combatTileEffects(list, caster, *it, params);<br></td></tr
><tr
id=sl_svn102_778
...
><td class="source">	postCombatEffects(caster, pos, params);<br></td></tr
><tr
id=sl_svn102_782
...
><td class="source">void Combat::doCombat(Creature* caster, Creature* target) const<br></td></tr
><tr
id=sl_svn102_785
...
><td class="source">	//target combat callback function<br></td></tr
><tr
id=sl_svn102_787
...
><td class="source">	if(params.combatType != COMBAT_NONE){<br></td></tr
><tr
id=sl_svn102_789

><td class="source">		int32_t minChange = 0;<br></td></tr
><tr
id=sl_svn102_790

><td class="source">		int32_t maxChange = 0;<br></td></tr
><tr
id=sl_svn102_791

><td class="source">		getMinMaxValues(caster, target, minChange, maxChange);<br></td></tr
><tr
id=sl_svn102_792
...
><td class="source">		if(params.combatType != COMBAT_MANADRAIN){<br></td></tr
><tr
id=sl_svn102_794

><td class="source">			doCombatHealth(caster, target, minChange, maxChange, params);<br></td></tr
><tr
id=sl_svn102_795
...
><td class="source">			doCombatMana(caster, target, minChange, maxChange, params);<br></td></tr
><tr
id=sl_svn102_798
...
><td class="source">		doCombatDefault(caster, target, params);<br></td></tr
><tr
id=sl_svn102_802
...
><td class="source">void Combat::doCombat(Creature* caster, const Position&amp; pos) const<br></td></tr
><tr
id=sl_svn102_806
...
><td class="source">	//area combat callback function<br></td></tr
><tr
id=sl_svn102_808
...
><td class="source">		getMinMaxValues(caster, NULL, minChange, maxChange);<br></td></tr
><tr
id=sl_svn102_813
...
><td class="source">			doCombatHealth(caster, pos, area, minChange, maxChange, params);<br></td></tr
><tr
id=sl_svn102_816
...
><td class="source">			doCombatMana(caster, pos, area, minChange, maxChange, params);<br></td></tr
><tr
id=sl_svn102_819
...
><td class="source">		CombatFunc(caster, pos, area, params, CombatNullFunc, NULL);<br></td></tr
><tr
id=sl_svn102_823
...
><td class="source">void Combat::doCombatHealth(Creature* caster, Creature* target,<br></td></tr
><tr
id=sl_svn102_827
...
><td class="source">	if(!params.isAggressive || (caster != target &amp;&amp; Combat::canDoCombat(caster, target) == RET_NOERROR)){<br></td></tr
><tr
id=sl_svn102_830

><td class="source">		Combat2Var var;<br></td></tr
><tr
id=sl_svn102_831

><td class="source">		var.minChange = minChange;<br></td></tr
><tr
id=sl_svn102_832

><td class="source">		var.maxChange = maxChange;<br></td></tr
><tr
id=sl_svn102_833

><td class="source">		CombatHealthFunc(caster, target, params, (void*)&amp;var);<br></td></tr
><tr
id=sl_svn102_834
...
><td class="source">			g_game.addMagicEffect(target-&gt;getPosition(), params.impactEffect);<br></td></tr
><tr
id=sl_svn102_837
...
><td class="source">			addDistanceEffect(caster, caster-&gt;getPosition(), target-&gt;getPosition(), params.distanceEffect);<br></td></tr
><tr
id=sl_svn102_841
...
><td class="source">void Combat::doCombatHealth(Creature* caster, const Position&amp; pos,<br></td></tr
><tr
id=sl_svn102_846
...
><td class="source">	CombatFunc(caster, pos, area, params, CombatHealthFunc, (void*)&amp;var);<br></td></tr
><tr
id=sl_svn102_853
...
><td class="source">void Combat::doCombatMana(Creature* caster, Creature* target,<br></td></tr
><tr
id=sl_svn102_856
...
><td class="source">		CombatManaFunc(caster, target, params, (void*)&amp;var);<br></td></tr
><tr
id=sl_svn102_863
...
><td class="source">			params.targetCallback-&gt;onTargetCombat(caster, target);<br></td></tr
><tr
id=sl_svn102_866
...
><td class="source">void Combat::doCombatMana(Creature* caster, const Position&amp; pos,<br></td></tr
><tr
id=sl_svn102_879
...
><td class="source">	CombatFunc(caster, pos, area, params, CombatManaFunc, (void*)&amp;var);<br></td></tr
><tr
id=sl_svn102_886
...
><td class="source">void Combat::doCombatCondition(Creature* caster, const Position&amp; pos, const AreaCombat* area,<br></td></tr
><tr
id=sl_svn102_889
...
><td class="source">	CombatFunc(caster, pos, area, params, CombatConditionFunc, NULL);<br></td></tr
><tr
id=sl_svn102_892
...
><td class="source">void Combat::doCombatCondition(Creature* caster, Creature* target, const CombatParams&amp; params)<br></td></tr
><tr
id=sl_svn102_895
...
><td class="source">void Combat::doCombatDispel(Creature* caster, const Position&amp; pos, const AreaCombat* area,<br></td></tr
><tr
id=sl_svn102_914
...
><td class="source">	CombatFunc(caster, pos, area, params, CombatDispelFunc, NULL);<br></td></tr
><tr
id=sl_svn102_917
...
><td class="source">void Combat::doCombatDispel(Creature* caster, Creature* target, const CombatParams&amp; params)<br></td></tr
><tr
id=sl_svn102_920
...
><td class="source">void Combat::doCombatDefault(Creature* caster, Creature* target, const CombatParams&amp; params)<br></td></tr
><tr
id=sl_svn102_939
...
><td class="source">        const SpectatorVec&amp; list = g_game.getSpectators(target-&gt;getTile()-&gt;getPosition());<br></td></tr
><tr
id=sl_svn102_942

><td class="source">		CombatNullFunc(caster, target, params, NULL);<br></td></tr
><tr
id=sl_svn102_943

><td class="source">		combatTileEffects(list, caster, target-&gt;getTile(), params);<br></td></tr
><tr
id=sl_svn102_944
...
><td class="source">void ValueCallback::getMinMaxValues(Player* player, int32_t&amp; min, int32_t&amp; max, bool useCharges) const<br></td></tr
><tr
id=sl_svn102_962
...
><td class="source">	//&quot;onGetPlayerMinMaxValues&quot;(...)<br></td></tr
><tr
id=sl_svn102_964
...
><td class="source">		if(!env-&gt;setCallbackId(m_scriptId, m_scriptInterface))<br></td></tr
><tr
id=sl_svn102_969
...
><td class="source">		uint32_t cid = env-&gt;addThing(player);<br></td></tr
><tr
id=sl_svn102_972
...
><td class="source">		m_scriptInterface-&gt;pushFunction(m_scriptId);<br></td></tr
><tr
id=sl_svn102_974
...
><td class="source">		int32_t parameters = 1;<br></td></tr
><tr
id=sl_svn102_977
...
><td class="source">				//&quot;onGetPlayerMinMaxValues&quot;(cid, level, maglevel)<br></td></tr
><tr
id=sl_svn102_982

><td class="source">				lua_pushnumber(L, player-&gt;getLevel());<br></td></tr
><tr
id=sl_svn102_983

><td class="source">				lua_pushnumber(L, player-&gt;getMagicLevel());<br></td></tr
><tr
id=sl_svn102_984

><td class="source">				parameters += 2;<br></td></tr
><tr
id=sl_svn102_985
...
><td class="source">				//&quot;onGetPlayerMinMaxValues&quot;(cid, attackSkill, attackValue, attackFactor)<br></td></tr
><tr
id=sl_svn102_991
...
><td class="source">				int32_t attackSkill = player-&gt;getWeaponSkill(tool);<br></td></tr
><tr
id=sl_svn102_993

><td class="source">				int32_t attackValue = 7;<br></td></tr
><tr
id=sl_svn102_994

><td class="source">				if(tool){<br></td></tr
><tr
id=sl_svn102_995

><td class="source">					attackValue = tool-&gt;getAttack();<br></td></tr
><tr
id=sl_svn102_996
...
><td class="source">					if(useCharges &amp;&amp; tool-&gt;hasCharges() &amp;&amp; g_config.getNumber(ConfigManager::REMOVE_WEAPON_CHARGES)){<br></td></tr
><tr
id=sl_svn102_998

><td class="source">						int32_t newCharge = std::max(0, tool-&gt;getCharges() - 1);<br></td></tr
><tr
id=sl_svn102_999
...
><td class="source">				float attackFactor = player-&gt;getAttackFactor();<br></td></tr
><tr
id=sl_svn102_1003
...
><td class="source">				lua_pushnumber(L, attackSkill);<br></td></tr
><tr
id=sl_svn102_1005

><td class="source">				lua_pushnumber(L, attackValue);<br></td></tr
><tr
id=sl_svn102_1006

><td class="source">				lua_pushnumber(L, attackFactor);<br></td></tr
><tr
id=sl_svn102_1007

><td class="source">				parameters += 3;<br></td></tr
><tr
id=sl_svn102_1008
...
><td class="source">				std::cout &lt;&lt; &quot;ValueCallback::getMinMaxValues - unknown callback type&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1013
...
><td class="source">		int size0 = lua_gettop(L);<br></td></tr
><tr
id=sl_svn102_1018

><td class="source">		if(lua_pcall(L, parameters, 2 /*nReturnValues*/, 0) != 0){<br></td></tr
><tr
id=sl_svn102_1019

><td class="source">			LuaScriptInterface::reportError(NULL, std::string(LuaScriptInterface::popString(L)));<br></td></tr
><tr
id=sl_svn102_1020
...
><td class="source">			max = LuaScriptInterface::popNumber(L);<br></td></tr
><tr
id=sl_svn102_1023

><td class="source">			min = LuaScriptInterface::popNumber(L);<br></td></tr
><tr
id=sl_svn102_1024
...
><td class="source">		if((lua_gettop(L) + parameters /*nParams*/  + 1) != size0){<br></td></tr
><tr
id=sl_svn102_1027

><td class="source">			LuaScriptInterface::reportError(NULL, &quot;Stack size changed!&quot;);<br></td></tr
><tr
id=sl_svn102_1028
...
><td class="source">		env-&gt;resetCallback();<br></td></tr
><tr
id=sl_svn102_1031
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. ValueCallback::getMinMaxValues&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1035
...
><td class="source">void TileCallback::onTileCombat(Creature* creature, Tile* tile) const<br></td></tr
><tr
id=sl_svn102_1042
...
><td class="source">	//&quot;onTileCombat&quot;(cid, pos)<br></td></tr
><tr
id=sl_svn102_1044
...
><td class="source">		uint32_t cid = 0;<br></td></tr
><tr
id=sl_svn102_1052
...
><td class="source">			cid = env-&gt;addThing(creature);<br></td></tr
><tr
id=sl_svn102_1055
...
><td class="source">		m_scriptInterface-&gt;pushPosition(L, tile-&gt;getPosition(), 0);<br></td></tr
><tr
id=sl_svn102_1060
...
><td class="source">		m_scriptInterface-&gt;callFunction(2);<br></td></tr
><tr
id=sl_svn102_1062
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. TileCallback::onTileCombat&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1068
...
><td class="source">void TargetCallback::onTargetCombat(Creature* creature, Creature* target) const<br></td></tr
><tr
id=sl_svn102_1075
...
><td class="source">	//&quot;onTargetCombat&quot;(cid, target)<br></td></tr
><tr
id=sl_svn102_1077
...
><td class="source">		uint32_t targetCid = env-&gt;addThing(target);<br></td></tr
><tr
id=sl_svn102_1091
...
><td class="source">		lua_pushnumber(L, targetCid);<br></td></tr
><tr
id=sl_svn102_1095
...
><td class="source">		if(lua_pcall(L, 2, 0 /*nReturnValues*/, 0) != 0){<br></td></tr
><tr
id=sl_svn102_1098
...
><td class="source">		if((lua_gettop(L) + 2 /*nParams*/  + 1) != size0){<br></td></tr
><tr
id=sl_svn102_1102
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. TargetCallback::onTargetCombat&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1110
...
><td class="source">void AreaCombat::clear()<br></td></tr
><tr
id=sl_svn102_1117
...
><td class="source">	for(AreaCombatMap::iterator it = areas.begin(); it != areas.end(); ++it){<br></td></tr
><tr
id=sl_svn102_1119
...
><td class="source">	areas.clear();<br></td></tr
><tr
id=sl_svn102_1123
...
><td class="source">AreaCombat::AreaCombat(const AreaCombat&amp; rhs)<br></td></tr
><tr
id=sl_svn102_1126
...
><td class="source">    hasExtArea = rhs.hasExtArea;<br></td></tr
><tr
id=sl_svn102_1128
...
><td class="source">    for(AreaCombatMap::const_iterator it = rhs.areas.begin(); it != rhs.areas.end(); ++it){<br></td></tr
><tr
id=sl_svn102_1130

><td class="source">        areas[it-&gt;first] = new MatrixArea(*it-&gt;second);<br></td></tr
><tr
id=sl_svn102_1131
...
><td class="source">bool AreaCombat::getList(const Position&amp; centerPos, const Position&amp; targetPos, std::list&lt;Tile*&gt;&amp; list) const<br></td></tr
><tr
id=sl_svn102_1135
...
><td class="source">	const MatrixArea* area = getArea(centerPos, targetPos);<br></td></tr
><tr
id=sl_svn102_1139
...
><td class="source">	Position tmpPos = targetPos;<br></td></tr
><tr
id=sl_svn102_1144
...
><td class="source">	size_t cols = area-&gt;getCols();<br></td></tr
><tr
id=sl_svn102_1146

><td class="source">	size_t rows = area-&gt;getRows();<br></td></tr
><tr
id=sl_svn102_1147
...
><td class="source">	uint32_t centerY, centerX;<br></td></tr
><tr
id=sl_svn102_1149

><td class="source">	area-&gt;getCenter(centerY, centerX);<br></td></tr
><tr
id=sl_svn102_1150
...
><td class="source">	tmpPos.x -= centerX;<br></td></tr
><tr
id=sl_svn102_1152

><td class="source">	tmpPos.y -= centerY;<br></td></tr
><tr
id=sl_svn102_1153
...
><td class="source">	for(size_t y = 0; y &lt; rows; ++y){<br></td></tr
><tr
id=sl_svn102_1155

><td class="source">		for(size_t x = 0; x &lt; cols; ++x){<br></td></tr
><tr
id=sl_svn102_1156
...
><td class="source">			if(area-&gt;getValue(y, x) != 0){<br></td></tr
><tr
id=sl_svn102_1158

><td class="source">				if(tmpPos.x &gt;= 0 &amp;&amp; tmpPos.y &gt;= 0 &amp;&amp; tmpPos.z &gt;= 0 &amp;&amp;<br></td></tr
><tr
id=sl_svn102_1159

><td class="source">					tmpPos.x &lt;= 0xFFFF &amp;&amp; tmpPos.y &lt;= 0xFFFF &amp;&amp; tmpPos.z &lt; MAP_MAX_LAYERS)<br></td></tr
><tr
id=sl_svn102_1160
...
><td class="source">					if(g_game.isSightClear(targetPos, tmpPos, true)){<br></td></tr
><tr
id=sl_svn102_1162

><td class="source">						tile = g_game.getTile(tmpPos.x, tmpPos.y, tmpPos.z);<br></td></tr
><tr
id=sl_svn102_1163
...
><td class="source">							tile = new Tile(tmpPos.x, tmpPos.y, tmpPos.z);<br></td></tr
><tr
id=sl_svn102_1165
...
><td class="source">			tmpPos.x += 1;<br></td></tr
><tr
id=sl_svn102_1173
...
><td class="source">		tmpPos.x -= cols;<br></td></tr
><tr
id=sl_svn102_1176

><td class="source">		tmpPos.y += 1;<br></td></tr
><tr
id=sl_svn102_1177
...
><td class="source">int32_t round(float v)<br></td></tr
><tr
id=sl_svn102_1183
...
><td class="source">	int32_t t = (int32_t)std::floor(v);<br></td></tr
><tr
id=sl_svn102_1185

><td class="source">	if((v - t) &gt; 0.5){<br></td></tr
><tr
id=sl_svn102_1186

><td class="source">		return t + 1;<br></td></tr
><tr
id=sl_svn102_1187
...
><td class="source">void AreaCombat::copyArea(const MatrixArea* input, MatrixArea* output, MatrixOperation_t op) const<br></td></tr
><tr
id=sl_svn102_1194
...
><td class="source">	input-&gt;getCenter(centerY, centerX);<br></td></tr
><tr
id=sl_svn102_1197
...
><td class="source">	if(op == MATRIXOPERATION_COPY){<br></td></tr
><tr
id=sl_svn102_1199

><td class="source">		for(unsigned int y = 0; y &lt; input-&gt;getRows(); ++y){<br></td></tr
><tr
id=sl_svn102_1200

><td class="source">			for(unsigned int x = 0; x &lt; input-&gt;getCols(); ++x){<br></td></tr
><tr
id=sl_svn102_1201

><td class="source">				(*output)[y][x] = (*input)[y][x];<br></td></tr
><tr
id=sl_svn102_1202
...
><td class="source">		output-&gt;setCenter(centerY, centerX);<br></td></tr
><tr
id=sl_svn102_1206
...
><td class="source">	else if(op == MATRIXOPERATION_MIRROR){<br></td></tr
><tr
id=sl_svn102_1208
...
><td class="source">			int rx = 0;<br></td></tr
><tr
id=sl_svn102_1210

><td class="source">			for(int x = input-&gt;getCols() - 1; x &gt;= 0; --x){<br></td></tr
><tr
id=sl_svn102_1211

><td class="source">				(*output)[y][rx++] = (*input)[y][x];<br></td></tr
><tr
id=sl_svn102_1212
...
><td class="source">		output-&gt;setCenter(centerY, (input-&gt;getRows() - 1) - centerX);<br></td></tr
><tr
id=sl_svn102_1216
...
><td class="source">	else if(op == MATRIXOPERATION_FLIP){<br></td></tr
><tr
id=sl_svn102_1218
...
><td class="source">			int ry = 0;<br></td></tr
><tr
id=sl_svn102_1220

><td class="source">			for(int y = input-&gt;getRows() - 1; y &gt;= 0; --y){<br></td></tr
><tr
id=sl_svn102_1221

><td class="source">				(*output)[ry++][x] = (*input)[y][x];<br></td></tr
><tr
id=sl_svn102_1222
...
><td class="source">		output-&gt;setCenter((input-&gt;getCols() - 1) - centerY, centerX);<br></td></tr
><tr
id=sl_svn102_1226
...
><td class="source">	//rotation<br></td></tr
><tr
id=sl_svn102_1228
...
><td class="source">		uint32_t centerX, centerY;<br></td></tr
><tr
id=sl_svn102_1230
...
><td class="source">		int32_t rotateCenterX = (output-&gt;getCols() / 2) - 1;<br></td></tr
><tr
id=sl_svn102_1233

><td class="source">		int32_t rotateCenterY = (output-&gt;getRows() / 2) - 1;<br></td></tr
><tr
id=sl_svn102_1234

><td class="source">		int32_t angle = 0;<br></td></tr
><tr
id=sl_svn102_1235
...
><td class="source">		switch(op){<br></td></tr
><tr
id=sl_svn102_1237

><td class="source">			case MATRIXOPERATION_ROTATE90:<br></td></tr
><tr
id=sl_svn102_1238

><td class="source">				angle = 90;<br></td></tr
><tr
id=sl_svn102_1239
...
><td class="source">			case MATRIXOPERATION_ROTATE180:<br></td></tr
><tr
id=sl_svn102_1242

><td class="source">				angle = 180;<br></td></tr
><tr
id=sl_svn102_1243
...
><td class="source">			case MATRIXOPERATION_ROTATE270:<br></td></tr
><tr
id=sl_svn102_1246

><td class="source">				angle = 270;<br></td></tr
><tr
id=sl_svn102_1247
...
><td class="source">				angle = 0;<br></td></tr
><tr
id=sl_svn102_1251
...
><td class="source">		double angleRad = 3.1416 * angle / 180.0;<br></td></tr
><tr
id=sl_svn102_1254
...
><td class="source">		float a = std::cos(angleRad);<br></td></tr
><tr
id=sl_svn102_1256

><td class="source">		float b = -std::sin(angleRad);<br></td></tr
><tr
id=sl_svn102_1257

><td class="source">		float c = std::sin(angleRad);<br></td></tr
><tr
id=sl_svn102_1258

><td class="source">		float d = std::cos(angleRad);<br></td></tr
><tr
id=sl_svn102_1259
...
><td class="source">		for(int32_t x = 0; x &lt; (int32_t)input-&gt;getCols(); ++x){<br></td></tr
><tr
id=sl_svn102_1261

><td class="source">			for(int32_t y = 0; y &lt; (int32_t)input-&gt;getRows(); ++y){<br></td></tr
><tr
id=sl_svn102_1262

><td class="source">				//calculate new coordinates using rotation center<br></td></tr
><tr
id=sl_svn102_1263

><td class="source">				int32_t newX = x - centerX;<br></td></tr
><tr
id=sl_svn102_1264

><td class="source">				int32_t newY = y - centerY;<br></td></tr
><tr
id=sl_svn102_1265
...
><td class="source">				//perform rotation<br></td></tr
><tr
id=sl_svn102_1267

><td class="source">				int32_t rotatedX = round(newX * a + newY * b);<br></td></tr
><tr
id=sl_svn102_1268

><td class="source">				int32_t rotatedY = round(newX * c + newY * d);<br></td></tr
><tr
id=sl_svn102_1269
...
><td class="source">				//write in the output matrix using rotated coordinates<br></td></tr
><tr
id=sl_svn102_1271

><td class="source">				(*output)[rotatedY + rotateCenterY][rotatedX + rotateCenterX] = (*input)[y][x];<br></td></tr
><tr
id=sl_svn102_1272
...
><td class="source">		output-&gt;setCenter(rotateCenterY, rotateCenterX);<br></td></tr
><tr
id=sl_svn102_1276
...
><td class="source">MatrixArea* AreaCombat::createArea(const std::list&lt;uint32_t&gt;&amp; list, uint32_t rows)<br></td></tr
><tr
id=sl_svn102_1280
...
><td class="source">	unsigned int cols = list.size() / rows;<br></td></tr
><tr
id=sl_svn102_1282

><td class="source">	MatrixArea* area = new MatrixArea(rows, cols);<br></td></tr
><tr
id=sl_svn102_1283
...
><td class="source">	uint32_t x = 0;<br></td></tr
><tr
id=sl_svn102_1285

><td class="source">	uint32_t y = 0;<br></td></tr
><tr
id=sl_svn102_1286
...
><td class="source">	for(std::list&lt;uint32_t&gt;::const_iterator it = list.begin(); it != list.end(); ++it){<br></td></tr
><tr
id=sl_svn102_1288

><td class="source">		if(*it == 1 || *it == 3){<br></td></tr
><tr
id=sl_svn102_1289

><td class="source">			area-&gt;setValue(y, x, true);<br></td></tr
><tr
id=sl_svn102_1290
...
><td class="source">		if(*it == 2 || *it == 3){<br></td></tr
><tr
id=sl_svn102_1293

><td class="source">			area-&gt;setCenter(y, x);<br></td></tr
><tr
id=sl_svn102_1294
...
><td class="source">		if(cols == x){<br></td></tr
><tr
id=sl_svn102_1299
...
><td class="source">	return area;<br></td></tr
><tr
id=sl_svn102_1305
...
><td class="source">void AreaCombat::setupArea(const std::list&lt;uint32_t&gt;&amp; list, uint32_t rows)<br></td></tr
><tr
id=sl_svn102_1308
...
><td class="source">	MatrixArea* area = createArea(list, rows);<br></td></tr
><tr
id=sl_svn102_1310
...
><td class="source">	//NORTH<br></td></tr
><tr
id=sl_svn102_1312

><td class="source">	areas[NORTH] = area;<br></td></tr
><tr
id=sl_svn102_1313
...
><td class="source">	uint32_t maxOutput = std::max(area-&gt;getCols(), area-&gt;getRows()) * 2;<br></td></tr
><tr
id=sl_svn102_1315
...
><td class="source">	//SOUTH<br></td></tr
><tr
id=sl_svn102_1317

><td class="source">	MatrixArea* southArea = new MatrixArea(maxOutput, maxOutput);<br></td></tr
><tr
id=sl_svn102_1318

><td class="source">	copyArea(area, southArea, MATRIXOPERATION_ROTATE180);<br></td></tr
><tr
id=sl_svn102_1319

><td class="source">	areas[SOUTH] = southArea;<br></td></tr
><tr
id=sl_svn102_1320
...
><td class="source">	//EAST<br></td></tr
><tr
id=sl_svn102_1322

><td class="source">	MatrixArea* eastArea = new MatrixArea(maxOutput, maxOutput);<br></td></tr
><tr
id=sl_svn102_1323

><td class="source">	copyArea(area, eastArea, MATRIXOPERATION_ROTATE90);<br></td></tr
><tr
id=sl_svn102_1324

><td class="source">	areas[EAST] = eastArea;<br></td></tr
><tr
id=sl_svn102_1325
...
><td class="source">	//WEST<br></td></tr
><tr
id=sl_svn102_1327

><td class="source">	MatrixArea* westArea = new MatrixArea(maxOutput, maxOutput);<br></td></tr
><tr
id=sl_svn102_1328

><td class="source">	copyArea(area, westArea, MATRIXOPERATION_ROTATE270);<br></td></tr
><tr
id=sl_svn102_1329

><td class="source">	areas[WEST] = westArea;<br></td></tr
><tr
id=sl_svn102_1330
...
><td class="source">void AreaCombat::setupArea(int32_t length, int32_t spread)<br></td></tr
><tr
id=sl_svn102_1333
...
><td class="source">	std::list&lt;uint32_t&gt; list;<br></td></tr
><tr
id=sl_svn102_1335
...
><td class="source">	uint32_t rows = length;<br></td></tr
><tr
id=sl_svn102_1337

><td class="source">	int32_t cols = 1;<br></td></tr
><tr
id=sl_svn102_1338
...
><td class="source">	if(spread != 0){<br></td></tr
><tr
id=sl_svn102_1340

><td class="source">		cols = ((length - length % spread) / spread) * 2 + 1;<br></td></tr
><tr
id=sl_svn102_1341
...
><td class="source">	int32_t colSpread = cols;<br></td></tr
><tr
id=sl_svn102_1344
...
><td class="source">	for(uint32_t y = 1; y &lt;= rows; ++y){<br></td></tr
><tr
id=sl_svn102_1346

><td class="source">		int32_t mincol = cols - colSpread + 1;<br></td></tr
><tr
id=sl_svn102_1347

><td class="source">		int32_t maxcol = cols - (cols - colSpread);<br></td></tr
><tr
id=sl_svn102_1348

><td class="source">		for(int32_t x = 1; x &lt;= cols; ++x){<br></td></tr
><tr
id=sl_svn102_1349

><td class="source">			if(y == rows &amp;&amp; x == ((cols - cols % 2) / 2) + 1){<br></td></tr
><tr
id=sl_svn102_1350

><td class="source">				list.push_back(3);<br></td></tr
><tr
id=sl_svn102_1351
...
><td class="source">			else if(x &gt;= mincol &amp;&amp; x &lt;= maxcol){<br></td></tr
><tr
id=sl_svn102_1353

><td class="source">				list.push_back(1);<br></td></tr
><tr
id=sl_svn102_1354
...
><td class="source">				list.push_back(0);<br></td></tr
><tr
id=sl_svn102_1357
...
><td class="source">		if(spread &gt; 0 &amp;&amp; y % spread == 0){<br></td></tr
><tr
id=sl_svn102_1361

><td class="source">			--colSpread;<br></td></tr
><tr
id=sl_svn102_1362
...
><td class="source">	setupArea(list, rows);<br></td></tr
><tr
id=sl_svn102_1366
...
><td class="source">void AreaCombat::setupArea(int32_t radius)<br></td></tr
><tr
id=sl_svn102_1369
...
><td class="source">	int32_t area[13][13] = {<br></td></tr
><tr
id=sl_svn102_1371

><td class="source">		{0, 0, 0, 0, 0, 0, 8, 0, 0, 0, 0, 0, 0},<br></td></tr
><tr
id=sl_svn102_1372

><td class="source">		{0, 0, 0, 0, 8, 8, 7, 8, 8, 0, 0, 0, 0},<br></td></tr
><tr
id=sl_svn102_1373

><td class="source">		{0, 0, 0, 8, 7, 6, 6, 6, 7, 8, 0, 0, 0},<br></td></tr
><tr
id=sl_svn102_1374

><td class="source">		{0, 0, 8, 7, 6, 5, 5, 5, 6, 7, 8, 0, 0},<br></td></tr
><tr
id=sl_svn102_1375

><td class="source">		{0, 8, 7, 6, 5, 4, 4, 4, 5, 6, 7, 8, 0},<br></td></tr
><tr
id=sl_svn102_1376

><td class="source">		{0, 8, 6, 5, 4, 3, 2, 3, 4, 5, 6, 8, 0},<br></td></tr
><tr
id=sl_svn102_1377

><td class="source">		{8, 7, 6, 5, 4, 2, 1, 2, 4, 5, 6, 7, 8},<br></td></tr
><tr
id=sl_svn102_1378
...
><td class="source">	for(int32_t y = 0; y &lt; 13; ++y){<br></td></tr
><tr
id=sl_svn102_1389

><td class="source">		for(int32_t x = 0; x &lt; 13; ++x){<br></td></tr
><tr
id=sl_svn102_1390

><td class="source">			if(area[y][x] == 1){<br></td></tr
><tr
id=sl_svn102_1391
...
><td class="source">			else if(area[y][x] &gt; 0 &amp;&amp; area[y][x] &lt;= radius){<br></td></tr
><tr
id=sl_svn102_1394
...
><td class="source">	setupArea(list, 13);<br></td></tr
><tr
id=sl_svn102_1403
...
><td class="source">void AreaCombat::setupExtArea(const std::list&lt;uint32_t&gt;&amp; list, uint32_t rows)<br></td></tr
><tr
id=sl_svn102_1406
...
><td class="source">	if(list.empty()){<br></td></tr
><tr
id=sl_svn102_1408
...
><td class="source">	hasExtArea = true;<br></td></tr
><tr
id=sl_svn102_1412
...
><td class="source">	//NORTH-WEST<br></td></tr
><tr
id=sl_svn102_1415

><td class="source">	areas[NORTHWEST] = area;<br></td></tr
><tr
id=sl_svn102_1416
...
><td class="source">	//NORTH-EAST<br></td></tr
><tr
id=sl_svn102_1420

><td class="source">	MatrixArea* neArea = new MatrixArea(maxOutput, maxOutput);<br></td></tr
><tr
id=sl_svn102_1421

><td class="source">	copyArea(area, neArea, MATRIXOPERATION_MIRROR);<br></td></tr
><tr
id=sl_svn102_1422

><td class="source">	areas[NORTHEAST] = neArea;<br></td></tr
><tr
id=sl_svn102_1423
...
><td class="source">	//SOUTH-WEST<br></td></tr
><tr
id=sl_svn102_1425

><td class="source">	MatrixArea* swArea = new MatrixArea(maxOutput, maxOutput);<br></td></tr
><tr
id=sl_svn102_1426

><td class="source">	copyArea(area, swArea, MATRIXOPERATION_FLIP);<br></td></tr
><tr
id=sl_svn102_1427

><td class="source">	areas[SOUTHWEST] = swArea;<br></td></tr
><tr
id=sl_svn102_1428
...
><td class="source">	//SOUTH-EAST<br></td></tr
><tr
id=sl_svn102_1430

><td class="source">	MatrixArea* seArea = new MatrixArea(maxOutput, maxOutput);<br></td></tr
><tr
id=sl_svn102_1431

><td class="source">	copyArea(swArea, seArea, MATRIXOPERATION_MIRROR);<br></td></tr
><tr
id=sl_svn102_1432

><td class="source">	areas[SOUTHEAST] = seArea;<br></td></tr
><tr
id=sl_svn102_1433
...
><td class="source">void MagicField::onStepInField(Creature* creature, bool purposeful/*= true*/)<br></td></tr
><tr
id=sl_svn102_1438
...
><td class="source">	//remove magic walls/wild growth<br></td></tr
><tr
id=sl_svn102_1440

><td class="source">	if(isBlocking()){<br></td></tr
><tr
id=sl_svn102_1441

><td class="source">		g_game.internalRemoveItem(this, 1);<br></td></tr
><tr
id=sl_svn102_1442
...
><td class="source">		if(it.condition){<br></td></tr
><tr
id=sl_svn102_1446

><td class="source">			Condition* conditionCopy = it.condition-&gt;clone();<br></td></tr
><tr
id=sl_svn102_1447

><td class="source">			uint32_t owner = getOwner();<br></td></tr
><tr
id=sl_svn102_1448

><td class="source">			if(owner != 0 &amp;&amp; purposeful){<br></td></tr
><tr
id=sl_svn102_1449

><td class="source">				bool harmfulField = true;<br></td></tr
><tr
id=sl_svn102_1450

><td class="source">				if(g_game.getWorldType() == WORLD_TYPE_NO_PVP || getTile()-&gt;hasFlag(TILESTATE_NOPVPZONE) ){<br></td></tr
><tr
id=sl_svn102_1451

><td class="source">					Creature* creature = g_game.getCreatureByID(owner);<br></td></tr
><tr
id=sl_svn102_1452
...
><td class="source">						if(creature-&gt;getPlayer() || (creature-&gt;isSummon() &amp;&amp; creature-&gt;getMaster()-&gt;getPlayer())){<br></td></tr
><tr
id=sl_svn102_1454

><td class="source">							harmfulField = false;<br></td></tr
><tr
id=sl_svn102_1455
...
><td class="source">				if(   !harmfulField ||<br></td></tr
><tr
id=sl_svn102_1459

><td class="source">					(OTSYS_TIME() - createTime &lt;= g_config.getNumber(ConfigManager::FIELD_OWNERSHIP_DURATION)) ||<br></td></tr
><tr
id=sl_svn102_1460

><td class="source">					creature-&gt;hasBeenAttacked(owner))<br></td></tr
><tr
id=sl_svn102_1461
...
><td class="source">					conditionCopy-&gt;setParam(CONDITIONPARAM_OWNER, owner);<br></td></tr
><tr
id=sl_svn102_1463
...
><td class="source">			creature-&gt;addCondition(conditionCopy);<br></td></tr
><tr
id=sl_svn102_1467
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=96&amp;format=side&amp;path=/trunk/src/combat.cpp&amp;old_path=/trunk/src/combat.cpp&amp;old=95">Diff</a>
 </div>
 <pre>minor fixes</pre>
 </div>
 ...
 var selected_path = '/trunk/src/combat.cpp';
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/combat.cpp&amp;old_path=/trunk/src/combat.cpp&amp;old=52">Diff</a>
 <br>
...
don't recommend using this revision</pre>
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/combat.cpp&amp;old_path=/trunk/src/combat.cpp&amp;old=24">Diff</a>
 <br>
 ...
 by RSXQ66
 on Sep 27, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=24&amp;format=side&amp;path=/trunk/src/combat.cpp&amp;old_path=/trunk/src/combat.cpp&amp;old=8">Diff</a>
 <br>
 <pre class="ifOpened">minor fix for player death storing</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/combat.cpp&start=96">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 38206 bytes,
 1469 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/combat.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/combat.cpp'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAcKISncXVcM_AUobX8PMJLg1uhm-A:1406096384902", "relativeBaseUrl": "", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com"}, '', 'svn102', paths,
