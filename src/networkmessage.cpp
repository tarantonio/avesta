...
<head>
 ...
 var codesite_token = "ABZ6GAeQ5DXh52g2LDleUz0XHeA8ZJTUtQ:1406096611130";
 
 
 var CS_env = {"projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAeQ5DXh52g2LDleUz0XHeA8ZJTUtQ:1406096611130", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fnetworkmessage.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>networkmessage.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/networkmessage.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/networkmessage.cpp?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">int32_t NetworkMessage::decodeHeader()<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">    return (int32_t)(m_MsgBuf[0] | m_MsgBuf[1] &lt;&lt; 8);<br></td></tr
><tr
id=sl_svn102_36
...
><td class="source">std::string NetworkMessage::GetString()<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">	uint16_t stringlen = GetU16();<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	if(stringlen &gt;= (NETWORKMESSAGE_MAXSIZE - m_ReadPos))<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	char* v = (char*)(m_MsgBuf + m_ReadPos);<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	m_ReadPos += stringlen;<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	return std::string(v, stringlen);<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">std::string NetworkMessage::GetRaw()<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">	uint16_t stringlen = m_MsgSize- m_ReadPos;<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">Position NetworkMessage::GetPosition()<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">	pos.x = GetU16();<br></td></tr
><tr
id=sl_svn102_65

><td class="source">	pos.y = GetU16();<br></td></tr
><tr
id=sl_svn102_66

><td class="source">	pos.z = GetByte();<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">	return pos;<br></td></tr
><tr
id=sl_svn102_69
...
><td class="source">void NetworkMessage::AddString(const char* value)<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">	uint32_t stringlen = (uint32_t)strlen(value);<br></td></tr
><tr
id=sl_svn102_75

><td class="source">	if(!canAdd(stringlen+2) || stringlen &gt; 8192)<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">	AddU16(stringlen);<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	strcpy((char*)(m_MsgBuf + m_ReadPos), value);<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">	m_MsgSize += stringlen;<br></td></tr
><tr
id=sl_svn102_82
...
><td class="source">void NetworkMessage::AddBytes(const char* bytes, uint32_t size)<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">	if(!canAdd(size) || size &gt; 8192)<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	memcpy(m_MsgBuf + m_ReadPos, bytes, size);<br></td></tr
><tr
id=sl_svn102_90

><td class="source">	m_ReadPos += size;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	m_MsgSize += size;<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">void NetworkMessage::AddPaddingBytes(uint32_t n)<br></td></tr
><tr
id=sl_svn102_95
...
><td class="source">    if(!canAdd(n))<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">    memset((void*)&amp;m_MsgBuf[m_ReadPos], 0x33, n);<br></td></tr
><tr
id=sl_svn102_100

><td class="source">    m_MsgSize = m_MsgSize + n;<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">void NetworkMessage::AddPosition(const Position&amp; pos)<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	AddU16(pos.x);<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	AddU16(pos.y);<br></td></tr
><tr
id=sl_svn102_107

><td class="source">	AddByte(pos.z);<br></td></tr
><tr
id=sl_svn102_108
...
><td class="source">void NetworkMessage::AddItem(uint16_t id, uint8_t count)<br></td></tr
><tr
id=sl_svn102_111
...
><td class="source">	AddU16(it.clientId);<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">	if(it.stackable || it.isSplash() || it.isFluidContainer())<br></td></tr
><tr
id=sl_svn102_117

><td class="source">		AddByte(count);<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">void NetworkMessage::AddItem(const Item* item)<br></td></tr
><tr
id=sl_svn102_121
...
><td class="source">        AddByte(item-&gt;getSubType());<br></td></tr
><tr
id=sl_svn102_128
...
><td class="source">void NetworkMessage::AddItemId(const Item *item){<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">void NetworkMessage::AddItemId(uint16_t itemId){<br></td></tr
><tr
id=sl_svn102_136
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/networkmessage.cpp&amp;old_path=/trunk/src/networkmessage.cpp&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/networkmessage.cpp';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/networkmessage.cpp&amp;old_path=/trunk/src/networkmessage.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/networkmessage.cpp&start=52">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/networkmessage.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/networkmessage.cpp'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAeQ5DXh52g2LDleUz0XHeA8ZJTUtQ:1406096611130", "domainName": null}, '', 'svn102', paths,
