...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fgame.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>game.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/game.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/game.cpp?r=95" title="Previous">&lsaquo;r95</a></li>
...
><td class="source">#include &quot;tasks.h&quot;<br></td></tr
><tr
id=sl_svn102_25

><td class="source">#include &quot;items.h&quot;<br></td></tr
><tr
id=sl_svn102_26
...
><td class="source">#include &quot;monster.h&quot;<br></td></tr
><tr
id=sl_svn102_30
...
><td class="source">#include &quot;tile.h&quot;<br></td></tr
><tr
id=sl_svn102_32
...
><td class="source">#include &quot;chat.h&quot;<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">#include &quot;server.h&quot;<br></td></tr
><tr
id=sl_svn102_41

><td class="source">#include &quot;party.h&quot;<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">#include &quot;ioaccount.h&quot;<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">#if defined __EXCEPTION_TRACER__<br></td></tr
><tr
id=sl_svn102_50

><td class="source">#include &quot;exception.h&quot;<br></td></tr
><tr
id=sl_svn102_51

><td class="source">extern boost::recursive_mutex maploadlock;<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">#include &lt;boost/config.hpp&gt;<br></td></tr
><tr
id=sl_svn102_60

><td class="source">#include &lt;boost/bind.hpp&gt;<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">extern Server* g_server;<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">extern Commands commands;<br></td></tr
><tr
id=sl_svn102_66
...
><td class="source">extern Chat g_chat;<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">Game::Game()<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	gameState = GAME_STATE_NORMAL;<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	map = NULL;<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	worldType = WORLD_TYPE_PVP;<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">	lastPlayersRecord = 0;<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	last_bucket = 0;<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	int daycycle = 3600;<br></td></tr
><tr
id=sl_svn102_85

><td class="source">	//(1440 minutes/day)/(3600 seconds/day)*10 seconds event interval<br></td></tr
><tr
id=sl_svn102_86

><td class="source">	light_hour_delta = 1440*10/daycycle;<br></td></tr
><tr
id=sl_svn102_87

><td class="source">	/*light_hour = 0;<br></td></tr
><tr
id=sl_svn102_88

><td class="source">	lightlevel = LIGHT_LEVEL_NIGHT;<br></td></tr
><tr
id=sl_svn102_89

><td class="source">	light_state = LIGHT_STATE_NIGHT;*/<br></td></tr
><tr
id=sl_svn102_90

><td class="source">	light_hour = SUNRISE + (SUNSET - SUNRISE)/2;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	lightlevel = LIGHT_LEVEL_DAY;<br></td></tr
><tr
id=sl_svn102_92

><td class="source">	light_state = LIGHT_STATE_DAY;<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">	Scheduler::getScheduler().addEvent(createSchedulerTask(EVENT_LIGHTINTERVAL,<br></td></tr
><tr
id=sl_svn102_95

><td class="source">		boost::bind(&amp;Game::checkLight, this)));<br></td></tr
><tr
id=sl_svn102_96

><td class="source">	checkCreatureLastIndex = 0;<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">	Scheduler::getScheduler().addEvent(createSchedulerTask(EVENT_CREATURE_THINK_INTERVAL,<br></td></tr
><tr
id=sl_svn102_99

><td class="source">		boost::bind(&amp;Game::checkCreatures, this)));<br></td></tr
><tr
id=sl_svn102_100
...
><td class="source">	Scheduler::getScheduler().addEvent(createSchedulerTask(EVENT_DECAYINTERVAL,<br></td></tr
><tr
id=sl_svn102_102

><td class="source">		boost::bind(&amp;Game::checkDecay, this)));<br></td></tr
><tr
id=sl_svn102_103
...
><td class="source">		delete map;<br></td></tr
><tr
id=sl_svn102_109
...
><td class="source">void Game::setWorldType(WorldType_t type)<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">	worldType = type;<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">GameState_t Game::getGameState()<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">	return gameState;<br></td></tr
><tr
id=sl_svn102_120
...
><td class="source">void Game::setGameState(GameState_t newState)<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">	if(gameState == GAME_STATE_SHUTDOWN){<br></td></tr
><tr
id=sl_svn102_125

><td class="source">		//Can&#39;t go back from this state.<br></td></tr
><tr
id=sl_svn102_126
...
><td class="source">	if(gameState != newState){<br></td></tr
><tr
id=sl_svn102_130

><td class="source">		switch(newState){<br></td></tr
><tr
id=sl_svn102_131

><td class="source">			case GAME_STATE_INIT:<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">				Spawns::getInstance()-&gt;startup();<br></td></tr
><tr
id=sl_svn102_134
...
><td class="source">				Raids::getInstance()-&gt;loadFromXml(g_config.getString(<br></td></tr
><tr
id=sl_svn102_136

><td class="source">					ConfigManager::DATA_DIRECTORY) + &quot;/raids/raids.xml&quot;);<br></td></tr
><tr
id=sl_svn102_137
...
><td class="source">				loadGameState();<br></td></tr
><tr
id=sl_svn102_141

><td class="source">				g_globalEvents-&gt;startup();<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">			case GAME_STATE_SHUTDOWN:<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">				g_globalEvents-&gt;execute(GLOBALEVENT_SHUTDOWN);<br></td></tr
><tr
id=sl_svn102_148

><td class="source">				//kick all players that are still online<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">				saveGameState();<br></td></tr
><tr
id=sl_svn102_156
...
><td class="source">					boost::bind(&amp;Game::shutdown, this)));<br></td></tr
><tr
id=sl_svn102_159

><td class="source">				Scheduler::getScheduler().stop();<br></td></tr
><tr
id=sl_svn102_160

><td class="source">				Dispatcher::getDispatcher().stop();<br></td></tr
><tr
id=sl_svn102_161
...
><td class="source">			case GAME_STATE_STARTUP:<br></td></tr
><tr
id=sl_svn102_165

><td class="source">			case GAME_STATE_CLOSED:<br></td></tr
><tr
id=sl_svn102_166

><td class="source">			case GAME_STATE_CLOSING:<br></td></tr
><tr
id=sl_svn102_167

><td class="source">			case GAME_STATE_NORMAL:<br></td></tr
><tr
id=sl_svn102_168
...
><td class="source">		gameState = newState;<br></td></tr
><tr
id=sl_svn102_172
...
><td class="source">void Game::saveGameState()<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">	ScriptEnviroment::saveGameState();<br></td></tr
><tr
id=sl_svn102_178
...
><td class="source">bool Game::saveServer(bool globalSave)<br></td></tr
><tr
id=sl_svn102_181
...
><td class="source">	for(AutoList&lt;Player&gt;::listiterator it = Player::listPlayer.list.begin();<br></td></tr
><tr
id=sl_svn102_185

><td class="source">		it != Player::listPlayer.list.end();<br></td></tr
><tr
id=sl_svn102_186
...
><td class="source">		it-&gt;second-&gt;loginPosition = it-&gt;second-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_189

><td class="source">		IOPlayer::instance()-&gt;savePlayer(it-&gt;second);<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">	if(globalSave){<br></td></tr
><tr
id=sl_svn102_193

><td class="source">		Houses::getInstance().payHouses();<br></td></tr
><tr
id=sl_svn102_194

><td class="source">		g_bans.clearTemporaryBans();<br></td></tr
><tr
id=sl_svn102_195
...
><td class="source">	return map-&gt;saveMap();<br></td></tr
><tr
id=sl_svn102_198
...
><td class="source">void Game::loadGameState()<br></td></tr
><tr
id=sl_svn102_201
...
><td class="source">	ScriptEnviroment::loadGameState();<br></td></tr
><tr
id=sl_svn102_203
...
><td class="source">int Game::loadMap(std::string filename, std::string filekind)<br></td></tr
><tr
id=sl_svn102_206
...
><td class="source">		map = new Map;<br></td></tr
><tr
id=sl_svn102_209
...
><td class="source">	maxPlayers = g_config.getNumber(ConfigManager::MAX_PLAYERS);<br></td></tr
><tr
id=sl_svn102_212

><td class="source">	inFightTicks = g_config.getNumber(ConfigManager::PZ_LOCKED);<br></td></tr
><tr
id=sl_svn102_213

><td class="source">	exhaustionTicks = g_config.getNumber(ConfigManager::EXHAUSTED);<br></td></tr
><tr
id=sl_svn102_214

><td class="source">	fightExhaustionTicks = g_config.getNumber(ConfigManager::FIGHTEXHAUSTED);<br></td></tr
><tr
id=sl_svn102_215

><td class="source">	healExhaustionTicks = g_config.getNumber(ConfigManager::HEALEXHAUSTED);<br></td></tr
><tr
id=sl_svn102_216

><td class="source">	Player::maxMessageBuffer = g_config.getNumber(ConfigManager::MAX_MESSAGEBUFFER);<br></td></tr
><tr
id=sl_svn102_217

><td class="source">	Monster::despawnRange = g_config.getNumber(ConfigManager::DEFAULT_DESPAWNRANGE);<br></td></tr
><tr
id=sl_svn102_218

><td class="source">	Monster::despawnRadius = g_config.getNumber(ConfigManager::DEFAULT_DESPAWNRADIUS);<br></td></tr
><tr
id=sl_svn102_219
...
><td class="source">	return map-&gt;loadMap(filename, filekind);<br></td></tr
><tr
id=sl_svn102_221
...
><td class="source">void Game::refreshMap(Map::TileMap::iterator* map_iter, int clean_max)<br></td></tr
><tr
id=sl_svn102_224
...
><td class="source">	Tile* tile;<br></td></tr
><tr
id=sl_svn102_226

><td class="source">	Item* item;<br></td></tr
><tr
id=sl_svn102_227
...
><td class="source">	Map::TileMap::iterator begin_here = map-&gt;refreshTileMap.begin();<br></td></tr
><tr
id=sl_svn102_229

><td class="source">	if(!map_iter)<br></td></tr
><tr
id=sl_svn102_230

><td class="source">		map_iter = &amp;begin_here;<br></td></tr
><tr
id=sl_svn102_231

><td class="source">	Map::TileMap::iterator end_here = map-&gt;refreshTileMap.end();<br></td></tr
><tr
id=sl_svn102_232
...
><td class="source">	int cleaned = 0;<br></td></tr
><tr
id=sl_svn102_234

><td class="source">	for(; *map_iter != end_here &amp;&amp; (clean_max == 0? true : (cleaned &lt; clean_max)); ++*map_iter, ++cleaned){<br></td></tr
><tr
id=sl_svn102_235

><td class="source">		tile = (*map_iter)-&gt;first;<br></td></tr
><tr
id=sl_svn102_236
...
><td class="source">		//remove garbage<br></td></tr
><tr
id=sl_svn102_238

><td class="source">		int32_t downItemSize = tile-&gt;downItems.size();<br></td></tr
><tr
id=sl_svn102_239

><td class="source">		for(int32_t i = downItemSize - 1; i &gt;= 0; --i){<br></td></tr
><tr
id=sl_svn102_240

><td class="source">			item = tile-&gt;downItems[i];<br></td></tr
><tr
id=sl_svn102_241

><td class="source">			if(item &amp;&amp; item-&gt;isCleanable()){<br></td></tr
><tr
id=sl_svn102_242

><td class="source">#ifndef __DEBUG__<br></td></tr
><tr
id=sl_svn102_243

><td class="source">				// So the compiler doesn&#39;t generates warnings<br></td></tr
><tr
id=sl_svn102_244

><td class="source">				internalRemoveItem(item);<br></td></tr
><tr
id=sl_svn102_245
...
><td class="source">				ReturnValue ret = internalRemoveItem(item);<br></td></tr
><tr
id=sl_svn102_247
...
><td class="source">					std::cout &lt;&lt; &quot;Could not refresh item: &quot; &lt;&lt; item-&gt;getID() &lt;&lt; &quot;pos: &quot; &lt;&lt; tile-&gt;getPosition() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_249
...
><td class="source">		//restore to original state<br></td></tr
><tr
id=sl_svn102_258

><td class="source">		ItemVector list = (*map_iter)-&gt;second.list;<br></td></tr
><tr
id=sl_svn102_259

><td class="source">		for(ItemVector::reverse_iterator it = list.rbegin(); it != list.rend(); ++it){<br></td></tr
><tr
id=sl_svn102_260

><td class="source">			Item* item = (*it)-&gt;clone();<br></td></tr
><tr
id=sl_svn102_261

><td class="source">			ReturnValue ret = internalAddItem(tile, item , INDEX_WHEREEVER, FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_262
...
><td class="source">				if(item-&gt;getUniqueId() != 0){<br></td></tr
><tr
id=sl_svn102_264

><td class="source">					ScriptEnviroment::addUniqueThing(item);<br></td></tr
><tr
id=sl_svn102_265
...
><td class="source">				startDecay(item);<br></td></tr
><tr
id=sl_svn102_267
...
><td class="source">void Game::proceduralRefresh(Map::TileMap::iterator* begin)<br></td></tr
><tr
id=sl_svn102_278
...
><td class="source">	if(!begin){<br></td></tr
><tr
id=sl_svn102_280

><td class="source">		begin = new Map::TileMap::iterator(map-&gt;refreshTileMap.begin());<br></td></tr
><tr
id=sl_svn102_281
...
><td class="source">	// Refresh 250 tiles each cycle<br></td></tr
><tr
id=sl_svn102_284

><td class="source">	refreshMap(begin, 250);<br></td></tr
><tr
id=sl_svn102_285
...
><td class="source">	if(*begin == map-&gt;refreshTileMap.end()){<br></td></tr
><tr
id=sl_svn102_287

><td class="source">		delete begin;<br></td></tr
><tr
id=sl_svn102_288
...
><td class="source">	// Refresh some items every 500 ms until all tiles has been checked<br></td></tr
><tr
id=sl_svn102_292

><td class="source">	// For 100k tiles, this would take 100000/2500 = 40s = half a minute<br></td></tr
><tr
id=sl_svn102_293

><td class="source">	Scheduler::getScheduler().addEvent(createSchedulerTask(100,<br></td></tr
><tr
id=sl_svn102_294

><td class="source">		boost::bind(&amp;Game::proceduralRefresh, this, begin)));<br></td></tr
><tr
id=sl_svn102_295
...
><td class="source">Cylinder* Game::internalGetCylinder(Player* player, const Position&amp; pos)<br></td></tr
><tr
id=sl_svn102_300
...
><td class="source">	if(pos.x != 0xFFFF){<br></td></tr
><tr
id=sl_svn102_302

><td class="source">		return getTile(pos.x, pos.y, pos.z);<br></td></tr
><tr
id=sl_svn102_303
...
><td class="source">		if(pos.y &amp; 0x40){<br></td></tr
><tr
id=sl_svn102_307

><td class="source">			uint8_t from_cid = pos.y &amp; 0x0F;<br></td></tr
><tr
id=sl_svn102_308

><td class="source">			return player-&gt;getContainer(from_cid);<br></td></tr
><tr
id=sl_svn102_309
...
><td class="source">		//inventory<br></td></tr
><tr
id=sl_svn102_311
...
><td class="source">			return player;<br></td></tr
><tr
id=sl_svn102_313
...
><td class="source">Thing* Game::internalGetThing(Player* player, const Position&amp; pos, int32_t index,<br></td></tr
><tr
id=sl_svn102_318
...
><td class="source">		Tile* tile = getTile(pos.x, pos.y, pos.z);<br></td></tr
><tr
id=sl_svn102_322
...
><td class="source">			/*look at*/<br></td></tr
><tr
id=sl_svn102_325

><td class="source">			if(type == STACKPOS_LOOK){<br></td></tr
><tr
id=sl_svn102_326

><td class="source">				return tile-&gt;getTopThing();<br></td></tr
><tr
id=sl_svn102_327
...
><td class="source">			Thing* thing = NULL;<br></td></tr
><tr
id=sl_svn102_330
...
><td class="source">			/*for move operations*/<br></td></tr
><tr
id=sl_svn102_332

><td class="source">			if(type == STACKPOS_MOVE){<br></td></tr
><tr
id=sl_svn102_333

><td class="source">				Item* item = tile-&gt;getTopDownItem();<br></td></tr
><tr
id=sl_svn102_334

><td class="source">				if(item &amp;&amp; !item-&gt;isNotMoveable())<br></td></tr
><tr
id=sl_svn102_335

><td class="source">					thing = item;<br></td></tr
><tr
id=sl_svn102_336
...
><td class="source">					thing = tile-&gt;getTopCreature();<br></td></tr
><tr
id=sl_svn102_338
...
><td class="source">			/*use item*/<br></td></tr
><tr
id=sl_svn102_340

><td class="source">			else if(type == STACKPOS_USE){<br></td></tr
><tr
id=sl_svn102_341

><td class="source">				thing = tile-&gt;getTopDownItem();<br></td></tr
><tr
id=sl_svn102_342
...
><td class="source">			else if(type == STACKPOS_USEITEM){<br></td></tr
><tr
id=sl_svn102_344

><td class="source">				 //First check items with topOrder 2 (ladders, signs, splashes)<br></td></tr
><tr
id=sl_svn102_345
...
><td class="source">				Item* item =  tile-&gt;getItemByTopOrder(2);<br></td></tr
><tr
id=sl_svn102_347
...
><td class="source">				Item* item =  tile-&gt;getItemByTopOrder(1);<br></td></tr
><tr
id=sl_svn102_349
...
><td class="source">				if(item &amp;&amp; g_actions-&gt;hasAction(item)){<br></td></tr
><tr
id=sl_svn102_351
...
><td class="source">					//then down items<br></td></tr
><tr
id=sl_svn102_355
...
><td class="source">					if(thing == NULL){<br></td></tr
><tr
id=sl_svn102_357

><td class="source">						//then last we check items with topOrder 3 (doors etc)<br></td></tr
><tr
id=sl_svn102_358

><td class="source">						thing = tile-&gt;getTopTopItem();<br></td></tr
><tr
id=sl_svn102_359
...
><td class="source">				thing = tile-&gt;__getThing(index);<br></td></tr
><tr
id=sl_svn102_364
...
><td class="source">				//do extra checks here if the thing is accessable<br></td></tr
><tr
id=sl_svn102_368

><td class="source">				if(thing &amp;&amp; thing-&gt;getItem()){<br></td></tr
><tr
id=sl_svn102_369

><td class="source">					if(tile-&gt;hasProperty(ISVERTICAL)){<br></td></tr
><tr
id=sl_svn102_370

><td class="source">						if(player-&gt;getPosition().x + 1 == tile-&gt;getPosition().x){<br></td></tr
><tr
id=sl_svn102_371

><td class="source">							thing = NULL;<br></td></tr
><tr
id=sl_svn102_372
...
><td class="source">					else if(tile-&gt;hasProperty(ISHORIZONTAL)){<br></td></tr
><tr
id=sl_svn102_375

><td class="source">						if(player-&gt;getPosition().y + 1 == tile-&gt;getPosition().y){<br></td></tr
><tr
id=sl_svn102_376
...
><td class="source">			return thing;<br></td></tr
><tr
id=sl_svn102_383
...
><td class="source">			uint8_t fromCid = pos.y &amp; 0x0F;<br></td></tr
><tr
id=sl_svn102_389

><td class="source">			uint8_t slot = pos.z;<br></td></tr
><tr
id=sl_svn102_390
...
><td class="source">			Container* parentcontainer = player-&gt;getContainer(fromCid);<br></td></tr
><tr
id=sl_svn102_392
...
><td class="source">			return parentcontainer-&gt;getItem(slot);<br></td></tr
><tr
id=sl_svn102_396
...
><td class="source">		else if(pos.y == 0 &amp;&amp; pos.z == 0){<br></td></tr
><tr
id=sl_svn102_398

><td class="source">			const ItemType&amp; it = Item::items.getItemIdByClientId(spriteId);<br></td></tr
><tr
id=sl_svn102_399

><td class="source">			if(it.id == 0){<br></td></tr
><tr
id=sl_svn102_400
...
><td class="source">			int32_t subType = -1;<br></td></tr
><tr
id=sl_svn102_404

><td class="source">			if(it.isFluidContainer()){<br></td></tr
><tr
id=sl_svn102_405

><td class="source">				int32_t maxFluidType = sizeof(reverseFluidMap) / sizeof(uint32_t);<br></td></tr
><tr
id=sl_svn102_406

><td class="source">				if(index &lt; maxFluidType){<br></td></tr
><tr
id=sl_svn102_407

><td class="source">					subType = reverseFluidMap[index];<br></td></tr
><tr
id=sl_svn102_408
...
><td class="source">			return findItemOfType(player, it.id, true, subType);<br></td></tr
><tr
id=sl_svn102_412
...
><td class="source">			slots_t slot = (slots_t)static_cast&lt;unsigned char&gt;(pos.y);<br></td></tr
><tr
id=sl_svn102_416

><td class="source">			return player-&gt;getInventoryItem(slot);<br></td></tr
><tr
id=sl_svn102_417
...
><td class="source">void Game::internalGetPosition(Item* item, Position&amp; pos, uint8_t&amp; stackpos)<br></td></tr
><tr
id=sl_svn102_424
...
><td class="source">	stackpos = 0;<br></td></tr
><tr
id=sl_svn102_429
...
><td class="source">	Cylinder* topParent = item-&gt;getTopParent();<br></td></tr
><tr
id=sl_svn102_431

><td class="source">	if(topParent){<br></td></tr
><tr
id=sl_svn102_432

><td class="source">		if(Player* player = dynamic_cast&lt;Player*&gt;(topParent)){<br></td></tr
><tr
id=sl_svn102_433

><td class="source">			pos.x = 0xFFFF;<br></td></tr
><tr
id=sl_svn102_434
...
><td class="source">			Container* container = dynamic_cast&lt;Container*&gt;(item-&gt;getParent());<br></td></tr
><tr
id=sl_svn102_436
...
><td class="source">				pos.y = ((uint16_t) ((uint16_t)0x40) | ((uint16_t)player-&gt;getContainerID(container)) );<br></td></tr
><tr
id=sl_svn102_438

><td class="source">				pos.z = container-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_439

><td class="source">				stackpos = pos.z;<br></td></tr
><tr
id=sl_svn102_440
...
><td class="source">				pos.y = player-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_443

><td class="source">				stackpos = pos.y;<br></td></tr
><tr
id=sl_svn102_444
...
><td class="source">		else if(Tile* tile = topParent-&gt;getTile()){<br></td></tr
><tr
id=sl_svn102_447

><td class="source">			pos = tile-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_448

><td class="source">			stackpos = tile-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_449
...
><td class="source">void Game::setTile(Tile* newtile)<br></td></tr
><tr
id=sl_svn102_454
...
><td class="source">	return map-&gt;setTile(newtile-&gt;getPosition(), newtile);<br></td></tr
><tr
id=sl_svn102_456
...
><td class="source">Tile* Game::getTile(uint32_t x, uint32_t y, uint32_t z)<br></td></tr
><tr
id=sl_svn102_459
...
><td class="source">	return map-&gt;getTile(x, y, z);<br></td></tr
><tr
id=sl_svn102_461
...
><td class="source">QTreeLeafNode* Game::getLeaf(uint32_t x, uint32_t y)<br></td></tr
><tr
id=sl_svn102_464
...
><td class="source">	return map-&gt;getLeaf(x, y);<br></td></tr
><tr
id=sl_svn102_466
...
><td class="source">Creature* Game::getCreatureByID(uint32_t id)<br></td></tr
><tr
id=sl_svn102_469
...
><td class="source">	if(id == 0)<br></td></tr
><tr
id=sl_svn102_471
...
><td class="source">	AutoList&lt;Creature&gt;::listiterator it = listCreature.list.find(id);<br></td></tr
><tr
id=sl_svn102_474

><td class="source">	if(it != listCreature.list.end()){<br></td></tr
><tr
id=sl_svn102_475

><td class="source">		if(!(*it).second-&gt;isRemoved())<br></td></tr
><tr
id=sl_svn102_476
...
><td class="source">	return NULL; //just in case the player doesnt exist<br></td></tr
><tr
id=sl_svn102_480
...
><td class="source">Player* Game::getPlayerByID(uint32_t id)<br></td></tr
><tr
id=sl_svn102_483
...
><td class="source">	AutoList&lt;Player&gt;::listiterator it = Player::listPlayer.list.find(id);<br></td></tr
><tr
id=sl_svn102_488

><td class="source">	if(it != Player::listPlayer.list.end()) {<br></td></tr
><tr
id=sl_svn102_489
...
><td class="source">Creature* Game::getCreatureByName(const std::string&amp; s)<br></td></tr
><tr
id=sl_svn102_497
...
><td class="source">	std::string txt1 = asUpperCaseString(s);<br></td></tr
><tr
id=sl_svn102_499

><td class="source">	for(AutoList&lt;Creature&gt;::listiterator it = listCreature.list.begin(); it != listCreature.list.end(); ++it){<br></td></tr
><tr
id=sl_svn102_500
...
><td class="source">			std::string txt2 = asUpperCaseString((*it).second-&gt;getName());<br></td></tr
><tr
id=sl_svn102_502

><td class="source">			if(txt1 == txt2)<br></td></tr
><tr
id=sl_svn102_503
...
><td class="source">	return NULL; //just in case the creature doesnt exist<br></td></tr
><tr
id=sl_svn102_508
...
><td class="source">Player* Game::getPlayerByName(const std::string&amp; s)<br></td></tr
><tr
id=sl_svn102_511
...
><td class="source">	for(AutoList&lt;Player&gt;::listiterator it = Player::listPlayer.list.begin(); it != Player::listPlayer.list.end(); ++it){<br></td></tr
><tr
id=sl_svn102_514
...
><td class="source">ReturnValue Game::getPlayerByNameWildcard(const std::string&amp; s, Player* &amp;player)<br></td></tr
><tr
id=sl_svn102_525
...
><td class="source">	player = NULL;<br></td></tr
><tr
id=sl_svn102_527
...
><td class="source">	if(s.empty()){<br></td></tr
><tr
id=sl_svn102_529

><td class="source">		return RET_PLAYERWITHTHISNAMEISNOTONLINE;<br></td></tr
><tr
id=sl_svn102_530
...
><td class="source">	if((*s.rbegin()) != &#39;~&#39;){<br></td></tr
><tr
id=sl_svn102_533

><td class="source">		player = getPlayerByName(s);<br></td></tr
><tr
id=sl_svn102_534
...
><td class="source">	Player* lastFound = NULL;<br></td></tr
><tr
id=sl_svn102_541

><td class="source">	std::string txt1 = asUpperCaseString(s.substr(0, s.length()-1));<br></td></tr
><tr
id=sl_svn102_542
...
><td class="source">			if(txt2.substr(0, txt1.length()) == txt1){<br></td></tr
><tr
id=sl_svn102_547

><td class="source">				if(lastFound == NULL)<br></td></tr
><tr
id=sl_svn102_548

><td class="source">					lastFound = (*it).second;<br></td></tr
><tr
id=sl_svn102_549
...
><td class="source">					return RET_NAMEISTOOAMBIGIOUS;<br></td></tr
><tr
id=sl_svn102_551
...
><td class="source">		player = lastFound;<br></td></tr
><tr
id=sl_svn102_557
...
><td class="source">Player* Game::getPlayerByAccount(uint32_t acc)<br></td></tr
><tr
id=sl_svn102_564
...
><td class="source">			if(it-&gt;second-&gt;getAccount() == acc){<br></td></tr
><tr
id=sl_svn102_568
...
><td class="source">PlayerVector Game::getPlayersByAccount(uint32_t acc)<br></td></tr
><tr
id=sl_svn102_577
...
><td class="source">	PlayerVector players;<br></td></tr
><tr
id=sl_svn102_579
...
><td class="source">				players.push_back(it-&gt;second);<br></td></tr
><tr
id=sl_svn102_583
...
><td class="source">	return players;<br></td></tr
><tr
id=sl_svn102_588
...
><td class="source">PlayerVector Game::getPlayersByIP(uint32_t ipadress, uint32_t mask)<br></td></tr
><tr
id=sl_svn102_591
...
><td class="source">			if((it-&gt;second-&gt;getIP() &amp; mask) == (ipadress &amp; mask)){<br></td></tr
><tr
id=sl_svn102_596
...
><td class="source">bool Game::internalPlaceCreature(Creature* creature, const Position&amp; pos, bool extendedPos /*=false*/, bool forced /*= false*/)<br></td></tr
><tr
id=sl_svn102_605
...
><td class="source">	if(creature-&gt;getParent() != NULL){<br></td></tr
><tr
id=sl_svn102_607
...
><td class="source">	if(!map-&gt;placeCreature(pos, creature, extendedPos, forced)){<br></td></tr
><tr
id=sl_svn102_611
...
><td class="source">	//std::cout &lt;&lt; &quot;internalPlaceCreature: &quot; &lt;&lt; creature &lt;&lt; &quot; &quot; &lt;&lt; creature-&gt;getID() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_615
...
><td class="source">	creature-&gt;useThing2();<br></td></tr
><tr
id=sl_svn102_617

><td class="source">	creature-&gt;setID();<br></td></tr
><tr
id=sl_svn102_618

><td class="source">	listCreature.addList(creature);<br></td></tr
><tr
id=sl_svn102_619

><td class="source">	creature-&gt;addList();<br></td></tr
><tr
id=sl_svn102_620
...
><td class="source">bool Game::placeCreature(Creature* creature, const Position&amp; pos, bool extendedPos /*=false*/, bool forced /*= false*/)<br></td></tr
><tr
id=sl_svn102_624
...
><td class="source">	if(!internalPlaceCreature(creature, pos, extendedPos, forced)){<br></td></tr
><tr
id=sl_svn102_626
...
><td class="source">	getSpectators(list, creature-&gt;getPosition(), false, true);<br></td></tr
><tr
id=sl_svn102_632
...
><td class="source">	Player* tmpPlayer = NULL;<br></td></tr
><tr
id=sl_svn102_635
...
><td class="source">		if((tmpPlayer = (*it)-&gt;getPlayer())){<br></td></tr
><tr
id=sl_svn102_637

><td class="source">			tmpPlayer-&gt;sendCreatureAppear(creature, true);<br></td></tr
><tr
id=sl_svn102_638
...
><td class="source">	//event method<br></td></tr
><tr
id=sl_svn102_642
...
><td class="source">		(*it)-&gt;onCreatureAppear(creature, true);<br></td></tr
><tr
id=sl_svn102_644
...
><td class="source">	int32_t newStackPos = creature-&gt;getParent()-&gt;__getIndexOfThing(creature);<br></td></tr
><tr
id=sl_svn102_647

><td class="source">	creature-&gt;getParent()-&gt;postAddNotification(creature, NULL, newStackPos);<br></td></tr
><tr
id=sl_svn102_648
...
><td class="source">	addCreatureCheck(creature);<br></td></tr
><tr
id=sl_svn102_650

><td class="source">	checkPlayersRecord();<br></td></tr
><tr
id=sl_svn102_651
...
><td class="source">	creature-&gt;onPlacedCreature();<br></td></tr
><tr
id=sl_svn102_653
...
><td class="source">bool Game::removeCreature(Creature* creature, bool isLogout /*= true*/)<br></td></tr
><tr
id=sl_svn102_657
...
><td class="source">	if(creature-&gt;isRemoved())<br></td></tr
><tr
id=sl_svn102_659
...
><td class="source">	std::cout &lt;&lt; &quot;removing creature &quot;&lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_663
...
><td class="source">	Cylinder* cylinder = creature-&gt;getTile();<br></td></tr
><tr
id=sl_svn102_666
...
><td class="source">	getSpectators(list, cylinder-&gt;getPosition(), false, true);<br></td></tr
><tr
id=sl_svn102_670
...
><td class="source">	int32_t index = cylinder-&gt;__getIndexOfThing(creature);<br></td></tr
><tr
id=sl_svn102_672

><td class="source">	if(!map-&gt;removeCreature(creature)){<br></td></tr
><tr
id=sl_svn102_673
...
><td class="source">			player-&gt;sendCreatureDisappear(creature, index, isLogout);<br></td></tr
><tr
id=sl_svn102_681
...
><td class="source">		(*it)-&gt;onCreatureDisappear(creature, index, isLogout);<br></td></tr
><tr
id=sl_svn102_687
...
><td class="source">	creature-&gt;getParent()-&gt;postRemoveNotification(creature, NULL, index, true);<br></td></tr
><tr
id=sl_svn102_690
...
><td class="source">	listCreature.removeList(creature-&gt;getID());<br></td></tr
><tr
id=sl_svn102_692

><td class="source">	creature-&gt;removeList();<br></td></tr
><tr
id=sl_svn102_693

><td class="source">	creature-&gt;setRemoved();<br></td></tr
><tr
id=sl_svn102_694

><td class="source">	FreeThing(creature);<br></td></tr
><tr
id=sl_svn102_695
...
><td class="source">	removeCreatureCheck(creature);<br></td></tr
><tr
id=sl_svn102_697
...
><td class="source">	for(std::list&lt;Creature*&gt;::iterator cit = creature-&gt;summons.begin();<br></td></tr
><tr
id=sl_svn102_699

><td class="source">		cit != creature-&gt;summons.end(); ++cit)<br></td></tr
><tr
id=sl_svn102_700
...
><td class="source">		(*cit)-&gt;setLossSkill(false);<br></td></tr
><tr
id=sl_svn102_702

><td class="source">		removeCreature(*cit);<br></td></tr
><tr
id=sl_svn102_703
...
><td class="source">	creature-&gt;onRemovedCreature();<br></td></tr
><tr
id=sl_svn102_706
...
><td class="source">bool Game::playerMoveThing(uint32_t playerId, const Position&amp; fromPos,<br></td></tr
><tr
id=sl_svn102_710
...
><td class="source">	Player* player = getPlayerByID(playerId);<br></td></tr
><tr
id=sl_svn102_713

><td class="source">	if(!player || player-&gt;isRemoved())<br></td></tr
><tr
id=sl_svn102_714
...
><td class="source">	uint8_t fromIndex = 0;<br></td></tr
><tr
id=sl_svn102_717

><td class="source">	if(fromPos.x == 0xFFFF){<br></td></tr
><tr
id=sl_svn102_718

><td class="source">		if(fromPos.y &amp; 0x40){<br></td></tr
><tr
id=sl_svn102_719

><td class="source">			fromIndex = static_cast&lt;uint8_t&gt;(fromPos.z);<br></td></tr
><tr
id=sl_svn102_720
...
><td class="source">			fromIndex = static_cast&lt;uint8_t&gt;(fromPos.y);<br></td></tr
><tr
id=sl_svn102_723
...
><td class="source">		fromIndex = fromStackPos;<br></td></tr
><tr
id=sl_svn102_727
...
><td class="source">	Thing* thing = internalGetThing(player, fromPos, fromIndex, spriteId, STACKPOS_MOVE);<br></td></tr
><tr
id=sl_svn102_729

><td class="source">	Cylinder* toCylinder = internalGetCylinder(player, toPos);<br></td></tr
><tr
id=sl_svn102_730
...
><td class="source">	if(!thing || !toCylinder){<br></td></tr
><tr
id=sl_svn102_732
...
><td class="source">	if(Creature* movingCreature = thing-&gt;getCreature()){<br></td></tr
><tr
id=sl_svn102_737

><td class="source">		if(Position::areInRange&lt;1,1,0&gt;(movingCreature-&gt;getPosition(), player-&gt;getPosition())){<br></td></tr
><tr
id=sl_svn102_738

><td class="source">			SchedulerTask* task = createSchedulerTask(1500,<br></td></tr
><tr
id=sl_svn102_739

><td class="source">				boost::bind(&amp;Game::playerMoveCreature, this, player-&gt;getID(),<br></td></tr
><tr
id=sl_svn102_740

><td class="source">				movingCreature-&gt;getID(), movingCreature-&gt;getPosition(), toCylinder-&gt;getPosition()));<br></td></tr
><tr
id=sl_svn102_741

><td class="source">			player-&gt;setNextActionTask(task);<br></td></tr
><tr
id=sl_svn102_742
...
><td class="source">			playerMoveCreature(playerId, movingCreature-&gt;getID(), movingCreature-&gt;getPosition(),<br></td></tr
><tr
id=sl_svn102_745

><td class="source">				toCylinder-&gt;getPosition());<br></td></tr
><tr
id=sl_svn102_746
...
><td class="source">	else if(thing-&gt;getItem()){<br></td></tr
><tr
id=sl_svn102_749

><td class="source">		playerMoveItem(playerId, fromPos, spriteId, fromStackPos, toPos, count);<br></td></tr
><tr
id=sl_svn102_750
...
><td class="source">bool Game::playerMoveCreature(uint32_t playerId, uint32_t movingCreatureId,<br></td></tr
><tr
id=sl_svn102_756
...
><td class="source">	if(!player-&gt;canDoAction()){<br></td></tr
><tr
id=sl_svn102_763

><td class="source">		uint32_t delay = player-&gt;getNextActionTime();<br></td></tr
><tr
id=sl_svn102_764

><td class="source">		SchedulerTask* task = createSchedulerTask(delay, boost::bind(&amp;Game::playerMoveCreature, this, playerId, movingCreatureId,<br></td></tr
><tr
id=sl_svn102_765

><td class="source">			movingCreatureOrigPos, toPos));<br></td></tr
><tr
id=sl_svn102_766
...
><td class="source">	player-&gt;setNextActionTask(NULL);<br></td></tr
><tr
id=sl_svn102_771
...
><td class="source">	Creature* movingCreature = getCreatureByID(movingCreatureId);<br></td></tr
><tr
id=sl_svn102_773
...
><td class="source">	if(!movingCreature || movingCreature-&gt;isRemoved())<br></td></tr
><tr
id=sl_svn102_775
...
><td class="source">	if(!Position::areInRange&lt;1,1,0&gt;(movingCreatureOrigPos, player-&gt;getPosition())){<br></td></tr
><tr
id=sl_svn102_778

><td class="source">		//need to walk to the creature first before moving it<br></td></tr
><tr
id=sl_svn102_779
...
><td class="source">		if(getPathToEx(player, movingCreatureOrigPos, listDir, 0, 1, true, true)){<br></td></tr
><tr
id=sl_svn102_781

><td class="source">			Dispatcher::getDispatcher().addTask(createTask(boost::bind(&amp;Game::playerAutoWalk,<br></td></tr
><tr
id=sl_svn102_782

><td class="source">				this, player-&gt;getID(), listDir)));<br></td></tr
><tr
id=sl_svn102_783
...
><td class="source">			SchedulerTask* task = createSchedulerTask(1500, boost::bind(&amp;Game::playerMoveCreature, this,<br></td></tr
><tr
id=sl_svn102_785

><td class="source">				playerId, movingCreatureId, movingCreatureOrigPos, toPos));<br></td></tr
><tr
id=sl_svn102_786

><td class="source">			player-&gt;setNextWalkActionTask(task);<br></td></tr
><tr
id=sl_svn102_787
...
><td class="source">			player-&gt;sendCancelMessage(RET_THEREISNOWAY);<br></td></tr
><tr
id=sl_svn102_791
...
><td class="source">	Tile* toTile = map-&gt;getTile(toPos);<br></td></tr
><tr
id=sl_svn102_796

><td class="source">	const Position&amp; movingCreaturePos = movingCreature-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_797
...
><td class="source">	if(!toTile){<br></td></tr
><tr
id=sl_svn102_799
...
><td class="source">    if (toTile-&gt;getHeight() &gt; 1) {<br></td></tr
><tr
id=sl_svn102_804
...
><td class="source">	if(!movingCreature-&gt;isPushable() &amp;&amp; !player-&gt;hasFlag(PlayerFlag_CanPushAllCreatures)){<br></td></tr
><tr
id=sl_svn102_809

><td class="source">		player-&gt;sendCancelMessage(RET_NOTMOVEABLE);<br></td></tr
><tr
id=sl_svn102_810
...
><td class="source">	//check throw distance<br></td></tr
><tr
id=sl_svn102_814

><td class="source">	if((std::abs(movingCreaturePos.x - toPos.x) &gt; movingCreature-&gt;getThrowRange()) ||<br></td></tr
><tr
id=sl_svn102_815

><td class="source">			(std::abs(movingCreaturePos.y - toPos.y) &gt; movingCreature-&gt;getThrowRange()) ||<br></td></tr
><tr
id=sl_svn102_816

><td class="source">			(std::abs(movingCreaturePos.z - toPos.z) * 4 &gt; movingCreature-&gt;getThrowRange())){<br></td></tr
><tr
id=sl_svn102_817

><td class="source">		player-&gt;sendCancelMessage(RET_DESTINATIONOUTOFREACH);<br></td></tr
><tr
id=sl_svn102_818
...
><td class="source">	if(player != movingCreature){<br></td></tr
><tr
id=sl_svn102_822

><td class="source">		if(toTile-&gt;hasProperty(BLOCKPATH)){<br></td></tr
><tr
id=sl_svn102_823
...
><td class="source">		else if(movingCreature-&gt;getZone() == ZONE_PROTECTION &amp;&amp;<br></td></tr
><tr
id=sl_svn102_827

><td class="source">			!toTile-&gt;hasFlag(TILESTATE_PROTECTIONZONE))<br></td></tr
><tr
id=sl_svn102_828
...
><td class="source">		else if(movingCreature-&gt;getNpc() &amp;&amp; !Spawns::getInstance()-&gt;isInZone(<br></td></tr
><tr
id=sl_svn102_833

><td class="source">			movingCreature-&gt;masterPos, movingCreature-&gt;masterRadius, toPos))<br></td></tr
><tr
id=sl_svn102_834
...
><td class="source">	ReturnValue ret = internalMoveCreature(movingCreature, movingCreature-&gt;getTile(), toTile);<br></td></tr
><tr
id=sl_svn102_841
...
><td class="source">ReturnValue Game::internalMoveCreature(Creature* creature, Direction direction, uint32_t flags /*= 0*/)<br></td></tr
><tr
id=sl_svn102_850
...
><td class="source">	Cylinder* fromTile = creature-&gt;getTile();<br></td></tr
><tr
id=sl_svn102_852

><td class="source">	Cylinder* toTile = NULL;<br></td></tr
><tr
id=sl_svn102_853
...
><td class="source">	const Position&amp; currentPos = creature-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_855

><td class="source">	Position destPos = currentPos;<br></td></tr
><tr
id=sl_svn102_856
...
><td class="source">	bool canChangeFloor = true;<br></td></tr
><tr
id=sl_svn102_858

><td class="source">	switch(direction){<br></td></tr
><tr
id=sl_svn102_859
...
><td class="source">			destPos.y -= 1;<br></td></tr
><tr
id=sl_svn102_861
...
><td class="source">			destPos.x -= 1;<br></td></tr
><tr
id=sl_svn102_869
...
><td class="source">		case SOUTHWEST:<br></td></tr
><tr
id=sl_svn102_876
...
><td class="source">			canChangeFloor = false;<br></td></tr
><tr
id=sl_svn102_879
...
><td class="source">		case NORTHWEST:<br></td></tr
><tr
id=sl_svn102_882
...
><td class="source">		case NORTHEAST:<br></td></tr
><tr
id=sl_svn102_888
...
><td class="source">		case SOUTHEAST:<br></td></tr
><tr
id=sl_svn102_894
...
><td class="source">	if(creature-&gt;getPlayer() &amp;&amp; canChangeFloor){<br></td></tr
><tr
id=sl_svn102_901

><td class="source">		//try go up<br></td></tr
><tr
id=sl_svn102_902

><td class="source">		if(currentPos.z != 8 &amp;&amp; creature-&gt;getTile()-&gt;hasHeight(3)){<br></td></tr
><tr
id=sl_svn102_903

><td class="source">			Tile* tmpTile = map-&gt;getTile(currentPos.x, currentPos.y, currentPos.z - 1);<br></td></tr
><tr
id=sl_svn102_904

><td class="source">			if(tmpTile == NULL || (tmpTile-&gt;ground == NULL &amp;&amp; !tmpTile-&gt;hasProperty(BLOCKSOLID))){<br></td></tr
><tr
id=sl_svn102_905

><td class="source">				tmpTile = map-&gt;getTile(destPos.x, destPos.y, destPos.z - 1);<br></td></tr
><tr
id=sl_svn102_906

><td class="source">				if(tmpTile &amp;&amp; tmpTile-&gt;ground &amp;&amp; !tmpTile-&gt;hasProperty(BLOCKSOLID)){<br></td></tr
><tr
id=sl_svn102_907

><td class="source">					flags = flags | FLAG_IGNOREBLOCKITEM | FLAG_IGNOREBLOCKCREATURE;<br></td></tr
><tr
id=sl_svn102_908

><td class="source">					destPos.z -= 1;<br></td></tr
><tr
id=sl_svn102_909
...
><td class="source">			//try go down<br></td></tr
><tr
id=sl_svn102_914

><td class="source">			Tile* tmpTile = map-&gt;getTile(destPos);<br></td></tr
><tr
id=sl_svn102_915

><td class="source">			if(currentPos.z != 7 &amp;&amp; (tmpTile == NULL || (tmpTile-&gt;ground == NULL &amp;&amp; !tmpTile-&gt;hasProperty(BLOCKSOLID)))){<br></td></tr
><tr
id=sl_svn102_916
...
><td class="source">				if(tmpTile &amp;&amp; tmpTile-&gt;hasHeight(3)){<br></td></tr
><tr
id=sl_svn102_919
...
><td class="source">	toTile = map-&gt;getTile(destPos);<br></td></tr
><tr
id=sl_svn102_927
...
><td class="source">	Tile* toPos = getTile(destPos.x, destPos.y, destPos.z);<br></td></tr
><tr
id=sl_svn102_929

><td class="source">	Tile* fromPos = getTile(currentPos.x, currentPos.y, currentPos.z);<br></td></tr
><tr
id=sl_svn102_930
...
><td class="source">	ReturnValue ret = RET_NOTPOSSIBLE;<br></td></tr
><tr
id=sl_svn102_932
...
><td class="source">	if(toTile != NULL){<br></td></tr
><tr
id=sl_svn102_934

><td class="source">#ifndef __PROTOCOL_76__<br></td></tr
><tr
id=sl_svn102_935

><td class="source">		// Can&#39;t walk over items with height &gt;= 2<br></td></tr
><tr
id=sl_svn102_936

><td class="source">		if (currentPos.z &gt; destPos.z &amp;&amp; toPos-&gt;getHeight() &gt; 1);<br></td></tr
><tr
id=sl_svn102_937

><td class="source">			// not possible<br></td></tr
><tr
id=sl_svn102_938

><td class="source">		else if ((((toPos-&gt;getHeight() - fromPos-&gt;getHeight()) &lt; 2)) || <br></td></tr
><tr
id=sl_svn102_939

><td class="source">			(fromPos-&gt;hasHeight(3) &amp;&amp; (currentPos.z == destPos.z)) ||<br></td></tr
><tr
id=sl_svn102_940

><td class="source">			((currentPos.z &lt; destPos.z) &amp;&amp; (toPos-&gt;hasHeight(3) &amp;&amp; (fromPos-&gt;getHeight() &lt; 2))))<br></td></tr
><tr
id=sl_svn102_941
...
><td class="source">			ret = internalMoveCreature(creature, fromTile, toTile, flags);<br></td></tr
><tr
id=sl_svn102_943
...
><td class="source">			player-&gt;sendCancelWalk();<br></td></tr
><tr
id=sl_svn102_949
...
><td class="source">ReturnValue Game::internalMoveCreature(Creature* creature, Cylinder* fromCylinder, Cylinder* toCylinder, uint32_t flags /*= 0*/)<br></td></tr
><tr
id=sl_svn102_956
...
><td class="source">	//check if we can move the creature to the destination<br></td></tr
><tr
id=sl_svn102_958

><td class="source">	ReturnValue ret = toCylinder-&gt;__queryAdd(0, creature, 1, flags);<br></td></tr
><tr
id=sl_svn102_959
...
><td class="source">	fromCylinder-&gt;getTile()-&gt;moveCreature(creature, toCylinder);<br></td></tr
><tr
id=sl_svn102_964
...
><td class="source">	if(creature-&gt;getParent() == toCylinder){<br></td></tr
><tr
id=sl_svn102_966

><td class="source">		int32_t index = 0;<br></td></tr
><tr
id=sl_svn102_967

><td class="source">		Item* toItem = NULL;<br></td></tr
><tr
id=sl_svn102_968

><td class="source">		Cylinder* subCylinder = NULL;<br></td></tr
><tr
id=sl_svn102_969
...
><td class="source">		while((subCylinder = toCylinder-&gt;__queryDestination(index, creature, &amp;toItem, flags)) != toCylinder){<br></td></tr
><tr
id=sl_svn102_972

><td class="source">			toCylinder-&gt;getTile()-&gt;moveCreature(creature, subCylinder);<br></td></tr
><tr
id=sl_svn102_973

><td class="source">			toCylinder = subCylinder;<br></td></tr
><tr
id=sl_svn102_974
...
><td class="source">			//to prevent infinite loop<br></td></tr
><tr
id=sl_svn102_977

><td class="source">			if(++n &gt;= MAP_MAX_LAYERS)<br></td></tr
><tr
id=sl_svn102_978
...
><td class="source">bool Game::playerMoveItem(uint32_t playerId, const Position&amp; fromPos,<br></td></tr
><tr
id=sl_svn102_986
...
><td class="source">		SchedulerTask* task = createSchedulerTask(delay, boost::bind(&amp;Game::playerMoveItem, this,<br></td></tr
><tr
id=sl_svn102_995

><td class="source">			playerId, fromPos, spriteId, fromStackPos, toPos, count));<br></td></tr
><tr
id=sl_svn102_996
...
><td class="source">	Cylinder* fromCylinder = internalGetCylinder(player, fromPos);<br></td></tr
><tr
id=sl_svn102_1003
...
><td class="source">	uint8_t toIndex = 0;<br></td></tr
><tr
id=sl_svn102_1026
...
><td class="source">	if(toPos.x == 0xFFFF){<br></td></tr
><tr
id=sl_svn102_1028

><td class="source">		if(toPos.y &amp; 0x40){<br></td></tr
><tr
id=sl_svn102_1029

><td class="source">			toIndex = static_cast&lt;uint8_t&gt;(toPos.z);<br></td></tr
><tr
id=sl_svn102_1030
...
><td class="source">			toIndex = static_cast&lt;uint8_t&gt;(toPos.y);<br></td></tr
><tr
id=sl_svn102_1033
...
><td class="source">	if(fromCylinder == NULL || toCylinder == NULL || item == NULL || item-&gt;getClientID() != spriteId){<br></td></tr
><tr
id=sl_svn102_1037
...
><td class="source">	if(!item-&gt;isPushable() || item-&gt;getUniqueId() != 0){<br></td></tr
><tr
id=sl_svn102_1042
...
><td class="source">	const Position&amp; playerPos = player-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_1047

><td class="source">	const Position&amp; mapFromPos = fromCylinder-&gt;getTile()-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_1048

><td class="source">	const Position&amp; mapToPos = toCylinder-&gt;getTile()-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_1049
...
><td class="source">	if(playerPos.z &gt; mapFromPos.z){<br></td></tr
><tr
id=sl_svn102_1051

><td class="source">		player-&gt;sendCancelMessage(RET_FIRSTGOUPSTAIRS);<br></td></tr
><tr
id=sl_svn102_1052
...
><td class="source">		player-&gt;sendCancelMessage(RET_FIRSTGODOWNSTAIRS);<br></td></tr
><tr
id=sl_svn102_1057
...
><td class="source">	if(!Position::areInRange&lt;1,1,0&gt;(playerPos, mapFromPos)){<br></td></tr
><tr
id=sl_svn102_1061

><td class="source">		//need to walk to the item first before using it<br></td></tr
><tr
id=sl_svn102_1062
...
><td class="source">		if(getPathToEx(player, item-&gt;getPosition(), listDir, 0, 1, true, true)){<br></td></tr
><tr
id=sl_svn102_1064
...
><td class="source">			SchedulerTask* task = createSchedulerTask(400, boost::bind(&amp;Game::playerMoveItem, this,<br></td></tr
><tr
id=sl_svn102_1068
...
><td class="source">	//hangable item specific code<br></td></tr
><tr
id=sl_svn102_1079

><td class="source">	if(item-&gt;isHangable() &amp;&amp; toCylinder-&gt;getTile()-&gt;hasProperty(SUPPORTHANGABLE)){<br></td></tr
><tr
id=sl_svn102_1080

><td class="source">		//destination supports hangable objects so need to move there first<br></td></tr
><tr
id=sl_svn102_1081
...
><td class="source">		if(toCylinder-&gt;getTile()-&gt;hasProperty(ISVERTICAL)){<br></td></tr
><tr
id=sl_svn102_1083

><td class="source">			if(player-&gt;getPosition().x + 1 == mapToPos.x){<br></td></tr
><tr
id=sl_svn102_1084
...
><td class="source">		else if(toCylinder-&gt;getTile()-&gt;hasProperty(ISHORIZONTAL)){<br></td></tr
><tr
id=sl_svn102_1089

><td class="source">			if(player-&gt;getPosition().y + 1 == mapToPos.y){<br></td></tr
><tr
id=sl_svn102_1090
...
><td class="source">		if(!Position::areInRange&lt;1,1,0&gt;(playerPos, mapToPos)){<br></td></tr
><tr
id=sl_svn102_1096

><td class="source">			Position walkPos = mapToPos;<br></td></tr
><tr
id=sl_svn102_1097
...
><td class="source">				walkPos.x -= -1;<br></td></tr
><tr
id=sl_svn102_1099
...
><td class="source">			if(toCylinder-&gt;getTile()-&gt;hasProperty(ISHORIZONTAL)){<br></td></tr
><tr
id=sl_svn102_1102

><td class="source">				walkPos.y -= -1;<br></td></tr
><tr
id=sl_svn102_1103
...
><td class="source">			Position itemPos = fromPos;<br></td></tr
><tr
id=sl_svn102_1106

><td class="source">			uint8_t itemStackPos = fromStackPos;<br></td></tr
><tr
id=sl_svn102_1107
...
><td class="source">			if(fromPos.x != 0xFFFF &amp;&amp; Position::areInRange&lt;1,1,0&gt;(mapFromPos, player-&gt;getPosition())<br></td></tr
><tr
id=sl_svn102_1109

><td class="source">				&amp;&amp; !Position::areInRange&lt;1,1,0&gt;(mapFromPos, walkPos)){<br></td></tr
><tr
id=sl_svn102_1110

><td class="source">				//need to pickup the item first<br></td></tr
><tr
id=sl_svn102_1111

><td class="source">				Item* moveItem = NULL;<br></td></tr
><tr
id=sl_svn102_1112

><td class="source">				ReturnValue ret = internalMoveItem(fromCylinder, player, INDEX_WHEREEVER, item, count, &amp;moveItem);<br></td></tr
><tr
id=sl_svn102_1113
...
><td class="source">				//changing the position since its now in the inventory of the player<br></td></tr
><tr
id=sl_svn102_1119

><td class="source">				internalGetPosition(moveItem, itemPos, itemStackPos);<br></td></tr
><tr
id=sl_svn102_1120
...
><td class="source">			if(map-&gt;getPathTo(player, walkPos, listDir)){<br></td></tr
><tr
id=sl_svn102_1124
...
><td class="source">					playerId, itemPos, spriteId, itemStackPos, toPos, count));<br></td></tr
><tr
id=sl_svn102_1129
...
><td class="source">	if((std::abs(playerPos.x - mapToPos.x) &gt; item-&gt;getThrowRange()) ||<br></td></tr
><tr
id=sl_svn102_1140

><td class="source">			(std::abs(playerPos.y - mapToPos.y) &gt; item-&gt;getThrowRange()) ||<br></td></tr
><tr
id=sl_svn102_1141

><td class="source">			(std::abs(mapFromPos.z - mapToPos.z) * 4 &gt; item-&gt;getThrowRange()) ){<br></td></tr
><tr
id=sl_svn102_1142
...
><td class="source">	if(!canThrowObjectTo(mapFromPos, mapToPos)){<br></td></tr
><tr
id=sl_svn102_1147

><td class="source">		player-&gt;sendCancelMessage(RET_CANNOTTHROW);<br></td></tr
><tr
id=sl_svn102_1148
...
><td class="source">	ReturnValue ret = internalMoveItem(fromCylinder, toCylinder, toIndex, item, count, NULL);<br></td></tr
><tr
id=sl_svn102_1152
...
><td class="source">ReturnValue Game::internalMoveItem(Cylinder* fromCylinder, Cylinder* toCylinder,<br></td></tr
><tr
id=sl_svn102_1161

><td class="source">	int32_t index, Item* item, uint32_t count, Item** _moveItem, uint32_t flags /*= 0*/)<br></td></tr
><tr
id=sl_svn102_1162
...
><td class="source">	if(!toCylinder){<br></td></tr
><tr
id=sl_svn102_1164
...
><td class="source">	Cylinder* subCylinder;<br></td></tr
><tr
id=sl_svn102_1170

><td class="source">	int floorN = 0;<br></td></tr
><tr
id=sl_svn102_1171

><td class="source">	while((subCylinder = toCylinder-&gt;__queryDestination(index, item, &amp;toItem, flags)) != toCylinder){<br></td></tr
><tr
id=sl_svn102_1172
...
><td class="source">		if(++floorN &gt;= MAP_MAX_LAYERS)<br></td></tr
><tr
id=sl_svn102_1177
...
><td class="source">	//destination is the same as the source?<br></td></tr
><tr
id=sl_svn102_1181

><td class="source">	if(item == toItem){<br></td></tr
><tr
id=sl_svn102_1182

><td class="source">		return RET_NOERROR; //silently ignore move<br></td></tr
><tr
id=sl_svn102_1183
...
><td class="source">	//check if we can add this item<br></td></tr
><tr
id=sl_svn102_1186

><td class="source">	ReturnValue ret = toCylinder-&gt;__queryAdd(index, item, count, flags);<br></td></tr
><tr
id=sl_svn102_1187

><td class="source">	if(ret == RET_NEEDEXCHANGE){<br></td></tr
><tr
id=sl_svn102_1188

><td class="source">		//check if we can add it to source cylinder<br></td></tr
><tr
id=sl_svn102_1189

><td class="source">		int32_t fromIndex = fromCylinder-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_1190
...
><td class="source">		ret = fromCylinder-&gt;__queryAdd(fromIndex, toItem, toItem-&gt;getItemCount(), 0);<br></td></tr
><tr
id=sl_svn102_1192
...
><td class="source">			//check how much we can move<br></td></tr
><tr
id=sl_svn102_1194

><td class="source">			uint32_t maxExchangeQueryCount = 0;<br></td></tr
><tr
id=sl_svn102_1195

><td class="source">			ReturnValue retExchangeMaxCount = fromCylinder-&gt;__queryMaxCount(-1, toItem, toItem-&gt;getItemCount(), maxExchangeQueryCount, 0);<br></td></tr
><tr
id=sl_svn102_1196
...
><td class="source">			if(retExchangeMaxCount != RET_NOERROR &amp;&amp; maxExchangeQueryCount == 0){<br></td></tr
><tr
id=sl_svn102_1198

><td class="source">				return retExchangeMaxCount;<br></td></tr
><tr
id=sl_svn102_1199
...
><td class="source">			if((toCylinder-&gt;__queryRemove(toItem, toItem-&gt;getItemCount(), flags) == RET_NOERROR) &amp;&amp; ret == RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_1202

><td class="source">				int32_t oldToItemIndex = toCylinder-&gt;__getIndexOfThing(toItem);<br></td></tr
><tr
id=sl_svn102_1203

><td class="source">				toCylinder-&gt;__removeThing(toItem, toItem-&gt;getItemCount());<br></td></tr
><tr
id=sl_svn102_1204

><td class="source">				fromCylinder-&gt;__addThing(toItem);<br></td></tr
><tr
id=sl_svn102_1205
...
><td class="source">				if(oldToItemIndex != -1){<br></td></tr
><tr
id=sl_svn102_1207

><td class="source">					toCylinder-&gt;postRemoveNotification(toItem, fromCylinder, oldToItemIndex, true);<br></td></tr
><tr
id=sl_svn102_1208
...
><td class="source">				int32_t newToItemIndex = fromCylinder-&gt;__getIndexOfThing(toItem);<br></td></tr
><tr
id=sl_svn102_1211

><td class="source">				if(newToItemIndex != -1){<br></td></tr
><tr
id=sl_svn102_1212

><td class="source">					fromCylinder-&gt;postAddNotification(toItem, toCylinder, newToItemIndex);<br></td></tr
><tr
id=sl_svn102_1213
...
><td class="source">				ret = toCylinder-&gt;__queryAdd(index, item, count, flags);<br></td></tr
><tr
id=sl_svn102_1216

><td class="source">				toItem = NULL;<br></td></tr
><tr
id=sl_svn102_1217
...
><td class="source">	uint32_t maxQueryCount = 0;<br></td></tr
><tr
id=sl_svn102_1227

><td class="source">	ReturnValue retMaxCount = toCylinder-&gt;__queryMaxCount(index, item, count, maxQueryCount, flags);<br></td></tr
><tr
id=sl_svn102_1228
...
><td class="source">	if(retMaxCount != RET_NOERROR &amp;&amp; maxQueryCount == 0){<br></td></tr
><tr
id=sl_svn102_1230

><td class="source">		return retMaxCount;<br></td></tr
><tr
id=sl_svn102_1231
...
><td class="source">	uint32_t m = 0;<br></td></tr
><tr
id=sl_svn102_1234
...
><td class="source">		m = std::min((uint32_t)count, maxQueryCount);<br></td></tr
><tr
id=sl_svn102_1238
...
><td class="source">		m = maxQueryCount;<br></td></tr
><tr
id=sl_svn102_1241
...
><td class="source">	Item* moveItem = item;<br></td></tr
><tr
id=sl_svn102_1243
...
><td class="source">	//check if we can remove this item<br></td></tr
><tr
id=sl_svn102_1245

><td class="source">	ret = fromCylinder-&gt;__queryRemove(item, m, flags);<br></td></tr
><tr
id=sl_svn102_1246
...
><td class="source">	//remove the item<br></td></tr
><tr
id=sl_svn102_1251

><td class="source">	int32_t itemIndex = fromCylinder-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_1252

><td class="source">	Item* updateItem = NULL;<br></td></tr
><tr
id=sl_svn102_1253

><td class="source">	fromCylinder-&gt;__removeThing(item, m);<br></td></tr
><tr
id=sl_svn102_1254

><td class="source">	bool isCompleteRemoval = item-&gt;isRemoved();<br></td></tr
><tr
id=sl_svn102_1255
...
><td class="source">	//update item(s)<br></td></tr
><tr
id=sl_svn102_1257
...
><td class="source">		if(toItem &amp;&amp; toItem-&gt;getID() == item-&gt;getID()){<br></td></tr
><tr
id=sl_svn102_1259

><td class="source">			n = std::min((uint32_t)100 - toItem-&gt;getItemCount(), m);<br></td></tr
><tr
id=sl_svn102_1260

><td class="source">			toCylinder-&gt;__updateThing(toItem, toItem-&gt;getID(), toItem-&gt;getItemCount() + n);<br></td></tr
><tr
id=sl_svn102_1261

><td class="source">			updateItem = toItem;<br></td></tr
><tr
id=sl_svn102_1262
...
><td class="source">		if(m - n &gt; 0){<br></td></tr
><tr
id=sl_svn102_1265

><td class="source">			moveItem = Item::CreateItem(item-&gt;getID(), m - n);<br></td></tr
><tr
id=sl_svn102_1266
...
><td class="source">			moveItem = NULL;<br></td></tr
><tr
id=sl_svn102_1269
...
><td class="source">		if(item-&gt;isRemoved()){<br></td></tr
><tr
id=sl_svn102_1272

><td class="source">			FreeThing(item);<br></td></tr
><tr
id=sl_svn102_1273
...
><td class="source">	//add item<br></td></tr
><tr
id=sl_svn102_1277

><td class="source">	if(moveItem /*m - n &gt; 0*/){<br></td></tr
><tr
id=sl_svn102_1278

><td class="source">		toCylinder-&gt;__addThing(index, moveItem);<br></td></tr
><tr
id=sl_svn102_1279
...
><td class="source">	if(itemIndex != -1){<br></td></tr
><tr
id=sl_svn102_1282

><td class="source">		fromCylinder-&gt;postRemoveNotification(item, toCylinder, itemIndex, isCompleteRemoval);<br></td></tr
><tr
id=sl_svn102_1283
...
><td class="source">	if(moveItem){<br></td></tr
><tr
id=sl_svn102_1286

><td class="source">		int32_t moveItemIndex = toCylinder-&gt;__getIndexOfThing(moveItem);<br></td></tr
><tr
id=sl_svn102_1287

><td class="source">		if(moveItemIndex != -1){<br></td></tr
><tr
id=sl_svn102_1288

><td class="source">			toCylinder-&gt;postAddNotification(moveItem, fromCylinder, moveItemIndex);<br></td></tr
><tr
id=sl_svn102_1289
...
><td class="source">	if(updateItem){<br></td></tr
><tr
id=sl_svn102_1293

><td class="source">		int32_t updateItemIndex = toCylinder-&gt;__getIndexOfThing(updateItem);<br></td></tr
><tr
id=sl_svn102_1294

><td class="source">		if(updateItemIndex != -1){<br></td></tr
><tr
id=sl_svn102_1295

><td class="source">			toCylinder-&gt;postAddNotification(updateItem, fromCylinder, updateItemIndex);<br></td></tr
><tr
id=sl_svn102_1296
...
><td class="source">	if(_moveItem){<br></td></tr
><tr
id=sl_svn102_1300
...
><td class="source">			*_moveItem = moveItem;<br></td></tr
><tr
id=sl_svn102_1302
...
><td class="source">			*_moveItem = item;<br></td></tr
><tr
id=sl_svn102_1305
...
><td class="source">	//we could not move all, inform the player<br></td></tr
><tr
id=sl_svn102_1309

><td class="source">	if(item-&gt;isStackable() &amp;&amp; maxQueryCount &lt; count){<br></td></tr
><tr
id=sl_svn102_1310
...
><td class="source">ReturnValue Game::internalAddItem(Cylinder* toCylinder, Item* item, int32_t index /*= INDEX_WHEREEVER*/,<br></td></tr
><tr
id=sl_svn102_1317
...
><td class="source">	if(toCylinder == NULL || item == NULL){<br></td></tr
><tr
id=sl_svn102_1320
...
><td class="source">	toCylinder = toCylinder-&gt;__queryDestination(index, item, &amp;toItem, flags);<br></td></tr
><tr
id=sl_svn102_1325
...
><td class="source">	ReturnValue ret = toCylinder-&gt;__queryAdd(index, item, item-&gt;getItemCount(), flags);<br></td></tr
><tr
id=sl_svn102_1328
...
><td class="source">	ret = toCylinder-&gt;__queryMaxCount(index, item, item-&gt;getItemCount(), maxQueryCount, flags);<br></td></tr
><tr
id=sl_svn102_1335
...
><td class="source">		m = std::min((uint32_t)item-&gt;getItemCount(), maxQueryCount);<br></td></tr
><tr
id=sl_svn102_1345
...
><td class="source">				if(m - n != item-&gt;getItemCount()){<br></td></tr
><tr
id=sl_svn102_1361
...
><td class="source">				toCylinder-&gt;postAddNotification(moveItem, NULL, moveItemIndex);<br></td></tr
><tr
id=sl_svn102_1376
...
><td class="source">			int32_t itemIndex = toCylinder-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_1380
...
><td class="source">				toCylinder-&gt;postAddNotification(item, NULL, itemIndex);<br></td></tr
><tr
id=sl_svn102_1383
...
><td class="source">ReturnValue Game::internalRemoveItem(Item* item, int32_t count /*= -1*/,  bool test /*= false*/, uint32_t flags /*= 0*/)<br></td></tr
><tr
id=sl_svn102_1391
...
><td class="source">	Cylinder* cylinder = item-&gt;getParent();<br></td></tr
><tr
id=sl_svn102_1393

><td class="source">	if(cylinder == NULL){<br></td></tr
><tr
id=sl_svn102_1394
...
><td class="source">	ReturnValue ret = cylinder-&gt;__queryRemove(item, count, flags | FLAG_IGNORENOTMOVEABLE);<br></td></tr
><tr
id=sl_svn102_1403
...
><td class="source">	if(!item-&gt;canRemove()){<br></td></tr
><tr
id=sl_svn102_1408
...
><td class="source">		int32_t index = cylinder-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_1413
...
><td class="source">		cylinder-&gt;__removeThing(item, count);<br></td></tr
><tr
id=sl_svn102_1416

><td class="source">		bool isCompleteRemoval = false;<br></td></tr
><tr
id=sl_svn102_1417
...
><td class="source">			isCompleteRemoval = true;<br></td></tr
><tr
id=sl_svn102_1420
...
><td class="source">		cylinder-&gt;postRemoveNotification(item, NULL, index, isCompleteRemoval);<br></td></tr
><tr
id=sl_svn102_1424
...
><td class="source">	item-&gt;onRemoved();<br></td></tr
><tr
id=sl_svn102_1427
...
><td class="source">ReturnValue Game::internalPlayerAddItem(Player* player, Item* item, bool dropOnMap /*= true*/)<br></td></tr
><tr
id=sl_svn102_1432
...
><td class="source">	ReturnValue ret = internalAddItem(player, item);<br></td></tr
><tr
id=sl_svn102_1434
...
><td class="source">	if(ret != RET_NOERROR &amp;&amp; dropOnMap){<br></td></tr
><tr
id=sl_svn102_1436

><td class="source">		ret = internalAddItem(player-&gt;getTile(), item, INDEX_WHEREEVER, FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_1437
...
><td class="source">Item* Game::findItemOfType(Cylinder* cylinder, uint16_t itemId,<br></td></tr
><tr
id=sl_svn102_1443
...
><td class="source">	std::list&lt;Container*&gt; listContainer;<br></td></tr
><tr
id=sl_svn102_1450

><td class="source">	Container* tmpContainer = NULL;<br></td></tr
><tr
id=sl_svn102_1451
...
><td class="source">	for(int i = cylinder-&gt;__getFirstIndex(); i &lt; cylinder-&gt;__getLastIndex();){<br></td></tr
><tr
id=sl_svn102_1455
...
><td class="source">		if((thing = cylinder-&gt;__getThing(i)) &amp;&amp; (item = thing-&gt;getItem())){<br></td></tr
><tr
id=sl_svn102_1457
...
><td class="source">				return item;<br></td></tr
><tr
id=sl_svn102_1459
...
><td class="source">				if(depthSearch &amp;&amp; (tmpContainer = item-&gt;getContainer())){<br></td></tr
><tr
id=sl_svn102_1464

><td class="source">					listContainer.push_back(tmpContainer);<br></td></tr
><tr
id=sl_svn102_1465
...
><td class="source">	while(listContainer.size() &gt; 0){<br></td></tr
><tr
id=sl_svn102_1474

><td class="source">		Container* container = listContainer.front();<br></td></tr
><tr
id=sl_svn102_1475

><td class="source">		listContainer.pop_front();<br></td></tr
><tr
id=sl_svn102_1476
...
><td class="source">		for(int i = 0; i &lt; (int32_t)container-&gt;size();){<br></td></tr
><tr
id=sl_svn102_1478

><td class="source">			Item* item = container-&gt;getItem(i);<br></td></tr
><tr
id=sl_svn102_1479
...
><td class="source">				if((tmpContainer = item-&gt;getContainer())){<br></td></tr
><tr
id=sl_svn102_1486
...
><td class="source">bool Game::removeItemOfType(Cylinder* cylinder, uint16_t itemId, int32_t count, int32_t subType /*= -1*/)<br></td></tr
><tr
id=sl_svn102_1496
...
><td class="source">	if(cylinder == NULL || ((int32_t)cylinder-&gt;__getItemTypeCount(itemId, subType) &lt; count) ){<br></td></tr
><tr
id=sl_svn102_1498
...
><td class="source">	for(int i = cylinder-&gt;__getFirstIndex(); i &lt; cylinder-&gt;__getLastIndex() &amp;&amp; count &gt; 0;){<br></td></tr
><tr
id=sl_svn102_1511
...
><td class="source">			if(item-&gt;getID() == itemId){<br></td></tr
><tr
id=sl_svn102_1514
...
><td class="source">					if(item-&gt;getItemCount() &gt; count){<br></td></tr
><tr
id=sl_svn102_1516

><td class="source">						internalRemoveItem(item, count);<br></td></tr
><tr
id=sl_svn102_1517

><td class="source">						count = 0;<br></td></tr
><tr
id=sl_svn102_1518
...
><td class="source">				else if(subType == -1 || subType == item-&gt;getSubType()){<br></td></tr
><tr
id=sl_svn102_1525
...
><td class="source">				else //Item has subtype but not the required one.<br></td></tr
><tr
id=sl_svn102_1529
...
><td class="source">	while(listContainer.size() &gt; 0 &amp;&amp; count &gt; 0){<br></td></tr
><tr
id=sl_svn102_1545
...
><td class="source">		for(int i = 0; i &lt; (int32_t)container-&gt;size() &amp;&amp; count &gt; 0;){<br></td></tr
><tr
id=sl_svn102_1549
...
><td class="source">	return (count == 0);<br></td></tr
><tr
id=sl_svn102_1579
...
><td class="source">uint32_t Game::getMoney(const Cylinder* cylinder)<br></td></tr
><tr
id=sl_svn102_1582
...
><td class="source">	ItemList::const_iterator it;<br></td></tr
><tr
id=sl_svn102_1589
...
><td class="source">	uint32_t moneyCount = 0;<br></td></tr
><tr
id=sl_svn102_1595
...
><td class="source">	for(int i = cylinder-&gt;__getFirstIndex(); i &lt; cylinder-&gt;__getLastIndex(); ++i){<br></td></tr
><tr
id=sl_svn102_1597

><td class="source">		if(!(thing = cylinder-&gt;__getThing(i)))<br></td></tr
><tr
id=sl_svn102_1598
...
><td class="source">		if(!(item = thing-&gt;getItem()))<br></td></tr
><tr
id=sl_svn102_1601
...
><td class="source">			if(item-&gt;getWorth() != 0){<br></td></tr
><tr
id=sl_svn102_1608

><td class="source">				moneyCount+= item-&gt;getWorth();<br></td></tr
><tr
id=sl_svn102_1609
...
><td class="source">		for(it = container-&gt;getItems(); it != container-&gt;getEnd(); ++it){<br></td></tr
><tr
id=sl_svn102_1618

><td class="source">			Item* item = *it;<br></td></tr
><tr
id=sl_svn102_1619
...
><td class="source">			else if(item-&gt;getWorth() != 0){<br></td></tr
><tr
id=sl_svn102_1624
...
><td class="source">	return moneyCount;<br></td></tr
><tr
id=sl_svn102_1630
...
><td class="source">bool Game::removeMoney(Cylinder* cylinder, int32_t money, uint32_t flags /*= 0*/)<br></td></tr
><tr
id=sl_svn102_1633
...
><td class="source">	if(money &lt;= 0){<br></td></tr
><tr
id=sl_svn102_1638
...
><td class="source">	typedef std::multimap&lt;int, Item*, std::less&lt;int&gt; &gt; MoneyMap;<br></td></tr
><tr
id=sl_svn102_1645

><td class="source">	typedef MoneyMap::value_type moneymap_pair;<br></td></tr
><tr
id=sl_svn102_1646

><td class="source">	MoneyMap moneyMap;<br></td></tr
><tr
id=sl_svn102_1647
...
><td class="source">	int32_t moneyCount = 0;<br></td></tr
><tr
id=sl_svn102_1651
...
><td class="source">	for(int i = cylinder-&gt;__getFirstIndex(); i &lt; cylinder-&gt;__getLastIndex() &amp;&amp; money &gt; 0; ++i){<br></td></tr
><tr
id=sl_svn102_1653
...
><td class="source">				moneyMap.insert(moneymap_pair(item-&gt;getWorth(), item));<br></td></tr
><tr
id=sl_svn102_1666
...
><td class="source">	while(listContainer.size() &gt; 0 &amp;&amp; money &gt; 0){<br></td></tr
><tr
id=sl_svn102_1671
...
><td class="source">		for(int i = 0; i &lt; (int32_t)container-&gt;size() &amp;&amp; money &gt; 0; i++){<br></td></tr
><tr
id=sl_svn102_1675
...
><td class="source">	if(moneyCount &lt; money){<br></td></tr
><tr
id=sl_svn102_1688

><td class="source">		/*not enough money*/<br></td></tr
><tr
id=sl_svn102_1689
...
><td class="source">	MoneyMap::iterator it2;<br></td></tr
><tr
id=sl_svn102_1693

><td class="source">	for(it2 = moneyMap.begin(); it2 != moneyMap.end() &amp;&amp; money &gt; 0; it2++){<br></td></tr
><tr
id=sl_svn102_1694

><td class="source">		Item* item = it2-&gt;second;<br></td></tr
><tr
id=sl_svn102_1695
...
><td class="source">		if(it2-&gt;first &lt;= money){<br></td></tr
><tr
id=sl_svn102_1698

><td class="source">			money = money - it2-&gt;first;<br></td></tr
><tr
id=sl_svn102_1699
...
><td class="source">			/* Remove a monetary value from an item*/<br></td></tr
><tr
id=sl_svn102_1702

><td class="source">			int remaind = item-&gt;getWorth() - money;<br></td></tr
><tr
id=sl_svn102_1703

><td class="source">			addMoney(cylinder, remaind, flags);<br></td></tr
><tr
id=sl_svn102_1704

><td class="source">			money = 0;<br></td></tr
><tr
id=sl_svn102_1705
...
><td class="source">		it2-&gt;second = NULL;<br></td></tr
><tr
id=sl_svn102_1708
...
><td class="source">	moneyMap.clear();<br></td></tr
><tr
id=sl_svn102_1711
...
><td class="source">	return (money == 0);<br></td></tr
><tr
id=sl_svn102_1713
...
><td class="source">bool Game::addMoney(Cylinder* cylinder, int32_t money, uint32_t flags /*= 0*/)<br></td></tr
><tr
id=sl_svn102_1716
...
><td class="source">	int crys = money / 10000;<br></td></tr
><tr
id=sl_svn102_1718

><td class="source">	money -= crys * 10000;<br></td></tr
><tr
id=sl_svn102_1719

><td class="source">	int plat = money / 100;<br></td></tr
><tr
id=sl_svn102_1720

><td class="source">	money -= plat * 100;<br></td></tr
><tr
id=sl_svn102_1721

><td class="source">	int gold = money;<br></td></tr
><tr
id=sl_svn102_1722
...
><td class="source">	while(crys &gt; 0){<br></td></tr
><tr
id=sl_svn102_1724

><td class="source">		Item* remaindItem = Item::CreateItem(ITEM_COINS_CRYSTAL, std::min(100, crys));<br></td></tr
><tr
id=sl_svn102_1725
...
><td class="source">		ReturnValue ret = internalAddItem(cylinder, remaindItem, INDEX_WHEREEVER, flags);<br></td></tr
><tr
id=sl_svn102_1727
...
><td class="source">			internalAddItem(cylinder-&gt;getTile(), remaindItem, INDEX_WHEREEVER, FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_1729
...
><td class="source">		crys -= std::min(100, crys);<br></td></tr
><tr
id=sl_svn102_1731
...
><td class="source">	if(plat != 0){<br></td></tr
><tr
id=sl_svn102_1734

><td class="source">		Item* remaindItem = Item::CreateItem(ITEM_COINS_PLATINUM, plat);<br></td></tr
><tr
id=sl_svn102_1735
...
><td class="source">	if(gold != 0){<br></td></tr
><tr
id=sl_svn102_1743

><td class="source">		Item* remaindItem = Item::CreateItem(ITEM_COINS_GOLD, gold);<br></td></tr
><tr
id=sl_svn102_1744
...
><td class="source">Item* Game::transformItem(Item* item, uint16_t newId, int32_t newCount /*= -1*/)<br></td></tr
><tr
id=sl_svn102_1754
...
><td class="source">	if(item-&gt;getID() == newId &amp;&amp; (newCount == -1 || newCount == item-&gt;getSubType()))<br></td></tr
><tr
id=sl_svn102_1756
...
><td class="source">	int32_t itemIndex = cylinder-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_1764
...
><td class="source">		std::cout &lt;&lt; &quot;Error: transformItem, itemIndex == -1&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1768
...
><td class="source">	if(!item-&gt;canTransform()){<br></td></tr
><tr
id=sl_svn102_1773
...
><td class="source">	const ItemType&amp; curType = Item::items[item-&gt;getID()];<br></td></tr
><tr
id=sl_svn102_1777

><td class="source">	const ItemType&amp; newType = Item::items[newId];<br></td></tr
><tr
id=sl_svn102_1778
...
><td class="source">	if(curType.alwaysOnTop != newType.alwaysOnTop){<br></td></tr
><tr
id=sl_svn102_1780

><td class="source">		//This only occurs when you transform items on tiles from a downItem to a topItem (or vice versa)<br></td></tr
><tr
id=sl_svn102_1781

><td class="source">		//Remove the old, and add the new<br></td></tr
><tr
id=sl_svn102_1782
...
><td class="source">		Item* newItem = NULL;<br></td></tr
><tr
id=sl_svn102_1789

><td class="source">		if(newCount == -1){<br></td></tr
><tr
id=sl_svn102_1790

><td class="source">			newItem = Item::CreateItem(newId);<br></td></tr
><tr
id=sl_svn102_1791
...
><td class="source">			newItem = Item::CreateItem(newId, newCount);<br></td></tr
><tr
id=sl_svn102_1794
...
><td class="source">		newItem-&gt;copyAttributes(item);<br></td></tr
><tr
id=sl_svn102_1797
...
><td class="source">		ret = internalAddItem(cylinder, newItem, INDEX_WHEREEVER, FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_1799
...
><td class="source">		return newItem;<br></td></tr
><tr
id=sl_svn102_1805
...
><td class="source">	if(curType.type == newType.type){<br></td></tr
><tr
id=sl_svn102_1808

><td class="source">		//Both items has the same type so we can safely change id/subtype<br></td></tr
><tr
id=sl_svn102_1809
...
><td class="source">		if(newCount == 0 &amp;&amp; (item-&gt;isStackable() || item-&gt;hasCharges())){<br></td></tr
><tr
id=sl_svn102_1811
...
><td class="source">				int32_t newItemId = newId;<br></td></tr
><tr
id=sl_svn102_1817

><td class="source">				if(curType.id == newType.id){<br></td></tr
><tr
id=sl_svn102_1818

><td class="source">					newItemId = curType.decayTo;<br></td></tr
><tr
id=sl_svn102_1819
...
><td class="source">				if(newItemId != -1){<br></td></tr
><tr
id=sl_svn102_1822

><td class="source">					item = transformItem(item, newItemId);<br></td></tr
><tr
id=sl_svn102_1823
...
><td class="source">			cylinder-&gt;postRemoveNotification(item, cylinder, itemIndex, false);<br></td></tr
><tr
id=sl_svn102_1833

><td class="source">			uint16_t itemId = item-&gt;getID();<br></td></tr
><tr
id=sl_svn102_1834

><td class="source">			int32_t count = item-&gt;getSubType();<br></td></tr
><tr
id=sl_svn102_1835
...
><td class="source">				if(newType.group != curType.group){<br></td></tr
><tr
id=sl_svn102_1838

><td class="source">					item-&gt;setDefaultSubtype();<br></td></tr
><tr
id=sl_svn102_1839
...
><td class="source">				itemId = newId;<br></td></tr
><tr
id=sl_svn102_1842
...
><td class="source">			if(newCount != -1 &amp;&amp; newType.hasSubType()){<br></td></tr
><tr
id=sl_svn102_1845

><td class="source">				count = newCount;<br></td></tr
><tr
id=sl_svn102_1846
...
><td class="source">			cylinder-&gt;__updateThing(item, itemId, count);<br></td></tr
><tr
id=sl_svn102_1849

><td class="source">			cylinder-&gt;postAddNotification(item, cylinder, itemIndex);<br></td></tr
><tr
id=sl_svn102_1850
...
><td class="source">		//Replacing the the old item with the new while maintaining the old position<br></td></tr
><tr
id=sl_svn102_1855
...
><td class="source">		if(newItem == NULL) {<br></td></tr
><tr
id=sl_svn102_1863

><td class="source">			// Decaying into deprecated item?<br></td></tr
><tr
id=sl_svn102_1864
...
><td class="source">			std::cout &lt;&lt; &quot;Error: [Game::transformItem] Item of type &quot; &lt;&lt; item-&gt;getID() &lt;&lt; &quot; transforming into invalid type &quot; &lt;&lt; newId &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1866
...
><td class="source">		cylinder-&gt;__replaceThing(itemIndex, newItem);<br></td></tr
><tr
id=sl_svn102_1871

><td class="source">		cylinder-&gt;postAddNotification(newItem, cylinder, itemIndex);<br></td></tr
><tr
id=sl_svn102_1872
...
><td class="source">		cylinder-&gt;postRemoveNotification(item, cylinder, itemIndex, true);<br></td></tr
><tr
id=sl_svn102_1875
...
><td class="source">ReturnValue Game::internalTeleport(Thing* thing, const Position&amp; newPos, uint32_t flags /*= 0*/)<br></td></tr
><tr
id=sl_svn102_1884
...
><td class="source">	if(newPos == thing-&gt;getPosition()) {<br></td></tr
><tr
id=sl_svn102_1886
...
><td class="source">	else if(thing-&gt;isRemoved()) {<br></td></tr
><tr
id=sl_svn102_1889
...
><td class="source">	Tile* toTile = getTile(newPos.x, newPos.y, newPos.z);<br></td></tr
><tr
id=sl_svn102_1893
...
><td class="source">		if(Creature* creature = thing-&gt;getCreature()){<br></td></tr
><tr
id=sl_svn102_1895

><td class="source">			// checks if player is being teleported to a house: if yes and if he doesn&#39;t have<br></td></tr
><tr
id=sl_svn102_1896

><td class="source">			// the necessary flag and is not the owner of the house returns error<br></td></tr
><tr
id=sl_svn102_1897
...
><td class="source">					House* house = houseTile-&gt;getHouse();<br></td></tr
><tr
id=sl_svn102_1901

><td class="source">					if(house &amp;&amp; !house-&gt;isInvited(player)){<br></td></tr
><tr
id=sl_svn102_1902
...
><td class="source">			creature-&gt;getTile()-&gt;moveCreature(creature, toTile, true);<br></td></tr
><tr
id=sl_svn102_1908
...
><td class="source">		else if(Item* item = thing-&gt;getItem()){<br></td></tr
><tr
id=sl_svn102_1911

><td class="source">			return internalMoveItem(<br></td></tr
><tr
id=sl_svn102_1912

><td class="source">				item-&gt;getParent(), toTile, INDEX_WHEREEVER, item, item-&gt;getItemCount(), NULL, flags);<br></td></tr
><tr
id=sl_svn102_1913
...
><td class="source">bool Game::anonymousBroadcastMessage(MessageClasses type, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_1920
...
><td class="source">		(*it).second-&gt;sendTextMessage(type, text.c_str());<br></td></tr
><tr
id=sl_svn102_1923
...
><td class="source">bool Game::playerMove(uint32_t playerId, Direction dir)<br></td></tr
><tr
id=sl_svn102_1930
...
><td class="source">	player-&gt;stopWalk();<br></td></tr
><tr
id=sl_svn102_1936

><td class="source">	int32_t delay = player-&gt;getWalkDelay(dir);<br></td></tr
><tr
id=sl_svn102_1937
...
><td class="source">	if(delay &gt; 0){<br></td></tr
><tr
id=sl_svn102_1939

><td class="source">		player-&gt;setNextAction(OTSYS_TIME() + player-&gt;getStepDuration(dir) - 1);<br></td></tr
><tr
id=sl_svn102_1940

><td class="source">		SchedulerTask* task = createSchedulerTask( ((uint32_t)delay), boost::bind(&amp;Game::playerMove, this,<br></td></tr
><tr
id=sl_svn102_1941

><td class="source">			playerId, dir));<br></td></tr
><tr
id=sl_svn102_1942

><td class="source">		player-&gt;setNextWalkTask(task);<br></td></tr
><tr
id=sl_svn102_1943
...
><td class="source">	player-&gt;onWalk(dir);<br></td></tr
><tr
id=sl_svn102_1947

><td class="source">	return (internalMoveCreature(player, dir) == RET_NOERROR);<br></td></tr
><tr
id=sl_svn102_1948
...
><td class="source">bool Game::internalBroadcastMessage(Player* player, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_1951
...
><td class="source">	if(!player-&gt;hasFlag(PlayerFlag_CanBroadcast))<br></td></tr
><tr
id=sl_svn102_1953
...
><td class="source">		(*it).second-&gt;sendCreatureSay(player, SPEAK_BROADCAST, text);<br></td></tr
><tr
id=sl_svn102_1957
...
><td class="source">bool Game::playerCreatePrivateChannel(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_1963
...
><td class="source">	ChatChannel* channel = g_chat.createChannel(player, CHANNEL_PRIVATE);<br></td></tr
><tr
id=sl_svn102_1969
...
><td class="source">	if(!channel-&gt;addUser(player)){<br></td></tr
><tr
id=sl_svn102_1975
...
><td class="source">	player-&gt;sendCreatePrivateChannel(channel-&gt;getId(), channel-&gt;getName());<br></td></tr
><tr
id=sl_svn102_1979
...
><td class="source">bool Game::playerChannelInvite(uint32_t playerId, const std::string&amp; name)<br></td></tr
><tr
id=sl_svn102_1983
...
><td class="source">	PrivateChatChannel* channel = g_chat.getPrivateChannel(player);<br></td></tr
><tr
id=sl_svn102_1989
...
><td class="source">	Player* invitePlayer = getPlayerByName(name);<br></td></tr
><tr
id=sl_svn102_1995
...
><td class="source">	if(!invitePlayer){<br></td></tr
><tr
id=sl_svn102_1997
...
><td class="source">	channel-&gt;invitePlayer(player, invitePlayer);<br></td></tr
><tr
id=sl_svn102_2001
...
><td class="source">bool Game::playerChannelExclude(uint32_t playerId, const std::string&amp; name)<br></td></tr
><tr
id=sl_svn102_2005
...
><td class="source">	Player* excludePlayer = getPlayerByName(name);<br></td></tr
><tr
id=sl_svn102_2017
...
><td class="source">	if(!excludePlayer){<br></td></tr
><tr
id=sl_svn102_2019
...
><td class="source">	channel-&gt;excludePlayer(player, excludePlayer);<br></td></tr
><tr
id=sl_svn102_2023
...
><td class="source">bool Game::playerRequestChannels(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_2027
...
><td class="source">	player-&gt;sendChannelsDialog();<br></td></tr
><tr
id=sl_svn102_2033
...
><td class="source">bool Game::playerOpenChannel(uint32_t playerId, uint16_t channelId)<br></td></tr
><tr
id=sl_svn102_2037
...
><td class="source">	if(!g_chat.addUserToChannel(player, channelId)){<br></td></tr
><tr
id=sl_svn102_2043
...
><td class="source">	ChatChannel* channel = g_chat.getChannel(player, channelId);<br></td></tr
><tr
id=sl_svn102_2047
...
><td class="source">	if(channel-&gt;getId() != CHANNEL_RULE_REP){<br></td></tr
><tr
id=sl_svn102_2052

><td class="source">		player-&gt;sendChannel(channel-&gt;getId(), channel-&gt;getName());<br></td></tr
><tr
id=sl_svn102_2053
...
><td class="source">		player-&gt;sendRuleViolationsChannel(channel-&gt;getId());<br></td></tr
><tr
id=sl_svn102_2056
...
><td class="source">bool Game::playerCloseChannel(uint32_t playerId, uint16_t channelId)<br></td></tr
><tr
id=sl_svn102_2062
...
><td class="source">	g_chat.removeUserFromChannel(player, channelId);<br></td></tr
><tr
id=sl_svn102_2068
...
><td class="source">bool Game::playerOpenPrivateChannel(uint32_t playerId, const std::string&amp; receiver)<br></td></tr
><tr
id=sl_svn102_2072
...
><td class="source">	std::string receiverName = receiver;<br></td></tr
><tr
id=sl_svn102_2079

><td class="source">	if(IOPlayer::instance()-&gt;getGuidByName(guid, receiverName))<br></td></tr
><tr
id=sl_svn102_2080

><td class="source">		player-&gt;sendOpenPrivateChannel(receiverName);<br></td></tr
><tr
id=sl_svn102_2081
...
><td class="source">		player-&gt;sendCancel(&quot;A player with this name does not exist.&quot;);<br></td></tr
><tr
id=sl_svn102_2083
...
><td class="source">bool Game::playerProcessRuleViolation(uint32_t playerId, const std::string&amp; name)<br></td></tr
><tr
id=sl_svn102_2088
...
><td class="source">	if(!player-&gt;hasFlag(PlayerFlag_CanAnswerRuleViolations))<br></td></tr
><tr
id=sl_svn102_2094
...
><td class="source">	Player* reporter = getPlayerByName(name);<br></td></tr
><tr
id=sl_svn102_2097

><td class="source">	if(!reporter){<br></td></tr
><tr
id=sl_svn102_2098
...
><td class="source">	RuleViolationsMap::iterator it = ruleViolations.find(reporter-&gt;getID());<br></td></tr
><tr
id=sl_svn102_2102

><td class="source">	if(it == ruleViolations.end()){<br></td></tr
><tr
id=sl_svn102_2103
...
><td class="source">	RuleViolation&amp; rvr = *it-&gt;second;<br></td></tr
><tr
id=sl_svn102_2107
...
><td class="source">	if(!rvr.isOpen){<br></td></tr
><tr
id=sl_svn102_2109
...
><td class="source">	rvr.isOpen = false;<br></td></tr
><tr
id=sl_svn102_2113

><td class="source">	rvr.gamemaster = player;<br></td></tr
><tr
id=sl_svn102_2114
...
><td class="source">	ChatChannel* channel = g_chat.getChannelById(CHANNEL_RULE_REP);<br></td></tr
><tr
id=sl_svn102_2116
...
><td class="source">		for(UsersMap::const_iterator it = channel-&gt;getUsers().begin();<br></td></tr
><tr
id=sl_svn102_2118

><td class="source">			it != channel-&gt;getUsers().end(); ++it)<br></td></tr
><tr
id=sl_svn102_2119
...
><td class="source">			if(it-&gt;second){<br></td></tr
><tr
id=sl_svn102_2121

><td class="source">				it-&gt;second-&gt;sendRemoveReport(reporter-&gt;getName());<br></td></tr
><tr
id=sl_svn102_2122
...
><td class="source">bool Game::playerCloseRuleViolation(uint32_t playerId, const std::string&amp; name)<br></td></tr
><tr
id=sl_svn102_2130
...
><td class="source">	return closeRuleViolation(reporter);<br></td></tr
><tr
id=sl_svn102_2141
...
><td class="source">bool Game::playerCancelRuleViolation(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_2144
...
><td class="source">	return cancelRuleViolation(player);<br></td></tr
><tr
id=sl_svn102_2151
...
><td class="source">bool Game::playerReceivePing(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_2154
...
><td class="source">	player-&gt;receivePing();<br></td></tr
><tr
id=sl_svn102_2160
...
><td class="source">bool Game::playerAutoWalk(uint32_t playerId, std::list&lt;Direction&gt;&amp; listDir)<br></td></tr
><tr
id=sl_svn102_2164
...
><td class="source">	player-&gt;resetIdle();<br></td></tr
><tr
id=sl_svn102_2170

><td class="source">	player-&gt;setNextWalkTask(NULL);<br></td></tr
><tr
id=sl_svn102_2171

><td class="source">	return player-&gt;startAutoWalk(listDir);<br></td></tr
><tr
id=sl_svn102_2172
...
><td class="source">bool Game::playerStopAutoWalk(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_2175
...
><td class="source">bool Game::playerUseItemEx(uint32_t playerId, const Position&amp; fromPos, uint8_t fromStackPos, uint16_t fromSpriteId,<br></td></tr
><tr
id=sl_svn102_2185

><td class="source">	const Position&amp; toPos, uint8_t toStackPos, uint16_t toSpriteId)<br></td></tr
><tr
id=sl_svn102_2186
...
><td class="source">	Thing* thing = internalGetThing(player, fromPos, fromStackPos, fromSpriteId, STACKPOS_USEITEM);<br></td></tr
><tr
id=sl_svn102_2192

><td class="source">	if(!thing){<br></td></tr
><tr
id=sl_svn102_2193
...
><td class="source">	if(!item || !item-&gt;isUseable()){<br></td></tr
><tr
id=sl_svn102_2199

><td class="source">		player-&gt;sendCancelMessage(RET_CANNOTUSETHISOBJECT);<br></td></tr
><tr
id=sl_svn102_2200
...
><td class="source">	Position walkToPos = fromPos;<br></td></tr
><tr
id=sl_svn102_2204

><td class="source">	ReturnValue ret = g_actions-&gt;canUse(player, fromPos);<br></td></tr
><tr
id=sl_svn102_2205
...
><td class="source">		ret = g_actions-&gt;canUse(player, toPos, item);<br></td></tr
><tr
id=sl_svn102_2207

><td class="source">		if(ret == RET_TOOFARAWAY){<br></td></tr
><tr
id=sl_svn102_2208

><td class="source">			walkToPos = toPos;<br></td></tr
><tr
id=sl_svn102_2209
...
><td class="source">			if(fromPos.x != 0xFFFF &amp;&amp; toPos.x != 0xFFFF &amp;&amp; Position::areInRange&lt;1,1,0&gt;(fromPos, player-&gt;getPosition()) &amp;&amp;<br></td></tr
><tr
id=sl_svn102_2217

><td class="source">				!Position::areInRange&lt;1,1,0&gt;(fromPos, toPos)){<br></td></tr
><tr
id=sl_svn102_2218
...
><td class="source">				ReturnValue ret = internalMoveItem(item-&gt;getParent(), player, INDEX_WHEREEVER,<br></td></tr
><tr
id=sl_svn102_2221

><td class="source">					item, item-&gt;getItemCount(), &amp;moveItem);<br></td></tr
><tr
id=sl_svn102_2222
...
><td class="source">			if(getPathToEx(player, walkToPos, listDir, 0, 1, true, true, 10)){<br></td></tr
><tr
id=sl_svn102_2233
...
><td class="source">				SchedulerTask* task = createSchedulerTask(400, boost::bind(&amp;Game::playerUseItemEx, this,<br></td></tr
><tr
id=sl_svn102_2237

><td class="source">					playerId, itemPos, itemStackPos, fromSpriteId, toPos, toStackPos, toSpriteId));<br></td></tr
><tr
id=sl_svn102_2238
...
><td class="source">		SchedulerTask* task = createSchedulerTask(delay, boost::bind(&amp;Game::playerUseItemEx, this,<br></td></tr
><tr
id=sl_svn102_2256

><td class="source">			playerId, fromPos, fromStackPos, fromSpriteId, toPos, toStackPos, toSpriteId));<br></td></tr
><tr
id=sl_svn102_2257
...
><td class="source">	return g_actions-&gt;useItemEx(player, fromPos, toPos, toStackPos, item);<br></td></tr
><tr
id=sl_svn102_2264
...
><td class="source">bool Game::playerUseItem(uint32_t playerId, const Position&amp; pos, uint8_t stackPos,<br></td></tr
><tr
id=sl_svn102_2267
...
><td class="source">	Thing* thing = internalGetThing(player, pos, stackPos, spriteId, STACKPOS_USEITEM);<br></td></tr
><tr
id=sl_svn102_2274
...
><td class="source">	ReturnValue ret = g_actions-&gt;canUse(player, pos);<br></td></tr
><tr
id=sl_svn102_2286
...
><td class="source">			if(getPathToEx(player, pos, listDir, 0, 1, true, true)){<br></td></tr
><tr
id=sl_svn102_2290
...
><td class="source">				SchedulerTask* task = createSchedulerTask(400, boost::bind(&amp;Game::playerUseItem, this,<br></td></tr
><tr
id=sl_svn102_2294

><td class="source">					playerId, pos, stackPos, index, spriteId));<br></td></tr
><tr
id=sl_svn102_2295
...
><td class="source">			ret = RET_THEREISNOWAY;<br></td></tr
><tr
id=sl_svn102_2300
...
><td class="source">		SchedulerTask* task = createSchedulerTask(delay, boost::bind(&amp;Game::playerUseItem, this,<br></td></tr
><tr
id=sl_svn102_2311
...
><td class="source">	g_actions-&gt;useItem(player, pos, index, item);<br></td></tr
><tr
id=sl_svn102_2319
...
><td class="source">bool Game::playerUseBattleWindow(uint32_t playerId, const Position&amp; fromPos, uint8_t fromStackPos,<br></td></tr
><tr
id=sl_svn102_2323

><td class="source">	uint32_t creatureId, uint16_t spriteId)<br></td></tr
><tr
id=sl_svn102_2324
...
><td class="source">	Creature* creature = getCreatureByID(creatureId);<br></td></tr
><tr
id=sl_svn102_2330
...
><td class="source">	if(!Position::areInRange&lt;7,5,0&gt;(creature-&gt;getPosition(), player-&gt;getPosition())){<br></td></tr
><tr
id=sl_svn102_2335
...
><td class="source">	if(creature-&gt;getPlayer()){<br></td></tr
><tr
id=sl_svn102_2339

><td class="source">		player-&gt;sendCancelMessage(RET_DIRECTPLAYERSHOOT);<br></td></tr
><tr
id=sl_svn102_2340
...
><td class="source">	Thing* thing = internalGetThing(player, fromPos, fromStackPos, spriteId, STACKPOS_USE);<br></td></tr
><tr
id=sl_svn102_2344
...
><td class="source">	if(!item || item-&gt;getClientID() != spriteId){<br></td></tr
><tr
id=sl_svn102_2351
...
><td class="source">				SchedulerTask* task = createSchedulerTask(400, boost::bind(&amp;Game::playerUseBattleWindow, this,<br></td></tr
><tr
id=sl_svn102_2364

><td class="source">					playerId, fromPos, fromStackPos, creatureId, spriteId));<br></td></tr
><tr
id=sl_svn102_2365
...
><td class="source">		SchedulerTask* task = createSchedulerTask(delay, boost::bind(&amp;Game::playerUseBattleWindow, this,<br></td></tr
><tr
id=sl_svn102_2381
...
><td class="source">	return g_actions-&gt;useItemEx(player, fromPos, creature-&gt;getPosition(), creature-&gt;getParent()-&gt;__getIndexOfThing(creature), item, creatureId);<br></td></tr
><tr
id=sl_svn102_2389
...
><td class="source">bool Game::playerCloseContainer(uint32_t playerId, uint8_t cid)<br></td></tr
><tr
id=sl_svn102_2392
...
><td class="source">	player-&gt;closeContainer(cid);<br></td></tr
><tr
id=sl_svn102_2398

><td class="source">	player-&gt;sendCloseContainer(cid);<br></td></tr
><tr
id=sl_svn102_2399
...
><td class="source">bool Game::playerMoveUpContainer(uint32_t playerId, uint8_t cid)<br></td></tr
><tr
id=sl_svn102_2403
...
><td class="source">	Container* container = player-&gt;getContainer(cid);<br></td></tr
><tr
id=sl_svn102_2409
...
><td class="source">	Container* parentContainer = dynamic_cast&lt;Container*&gt;(container-&gt;getParent());<br></td></tr
><tr
id=sl_svn102_2414
...
><td class="source">	bool hasParent = (dynamic_cast&lt;const Container*&gt;(parentContainer-&gt;getParent()) != NULL);<br></td></tr
><tr
id=sl_svn102_2419

><td class="source">	player-&gt;addContainer(cid, parentContainer);<br></td></tr
><tr
id=sl_svn102_2420

><td class="source">	player-&gt;sendContainer(cid, parentContainer, hasParent);<br></td></tr
><tr
id=sl_svn102_2421
...
><td class="source">bool Game::playerUpdateTile(uint32_t playerId, const Position&amp; pos)<br></td></tr
><tr
id=sl_svn102_2426
...
><td class="source">	if(player-&gt;canSee(pos)){<br></td></tr
><tr
id=sl_svn102_2432
...
><td class="source">		player-&gt;sendUpdateTile(tile, pos);<br></td></tr
><tr
id=sl_svn102_2434
...
><td class="source">bool Game::playerUpdateContainer(uint32_t playerId, uint8_t cid)<br></td></tr
><tr
id=sl_svn102_2440
...
><td class="source">	bool hasParent = (dynamic_cast&lt;const Container*&gt;(container-&gt;getParent()) != NULL);<br></td></tr
><tr
id=sl_svn102_2451

><td class="source">	player-&gt;sendContainer(cid, container, hasParent);<br></td></tr
><tr
id=sl_svn102_2452
...
><td class="source">bool Game::playerRotateItem(uint32_t playerId, const Position&amp; pos, uint8_t stackPos, const uint16_t spriteId)<br></td></tr
><tr
id=sl_svn102_2457
...
><td class="source">	Thing* thing = internalGetThing(player, pos, stackPos);<br></td></tr
><tr
id=sl_svn102_2463
...
><td class="source">	if(!item || item-&gt;getClientID() != spriteId || !item-&gt;isRoteable() || item-&gt;getUniqueId() != 0){<br></td></tr
><tr
id=sl_svn102_2469
...
><td class="source">	if(pos.x != 0xFFFF &amp;&amp; !Position::areInRange&lt;1,1,0&gt;(pos, player-&gt;getPosition())){<br></td></tr
><tr
id=sl_svn102_2474
...
><td class="source">			SchedulerTask* task = createSchedulerTask(400, boost::bind(&amp;Game::playerRotateItem, this,<br></td></tr
><tr
id=sl_svn102_2480

><td class="source">				playerId, pos, stackPos, spriteId));<br></td></tr
><tr
id=sl_svn102_2481
...
><td class="source">	uint16_t newId = Item::items[item-&gt;getID()].rotateTo;<br></td></tr
><tr
id=sl_svn102_2491

><td class="source">	if(newId != 0){<br></td></tr
><tr
id=sl_svn102_2492

><td class="source">		transformItem(item, newId);<br></td></tr
><tr
id=sl_svn102_2493
...
><td class="source">bool Game::playerWriteItem(uint32_t playerId, uint32_t windowTextId, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_2499
...
><td class="source">	uint16_t maxTextLength = 0;<br></td></tr
><tr
id=sl_svn102_2505

><td class="source">	uint32_t internalWindowTextId = 0;<br></td></tr
><tr
id=sl_svn102_2506

><td class="source">	Item* writeItem = player-&gt;getWriteItem(internalWindowTextId, maxTextLength);<br></td></tr
><tr
id=sl_svn102_2507
...
><td class="source">	if(text.length() &gt; maxTextLength || windowTextId != internalWindowTextId){<br></td></tr
><tr
id=sl_svn102_2509
...
><td class="source">	if(!writeItem || writeItem-&gt;isRemoved()){<br></td></tr
><tr
id=sl_svn102_2513
...
><td class="source">	Cylinder* topParent = writeItem-&gt;getTopParent();<br></td></tr
><tr
id=sl_svn102_2518

><td class="source">	Player* owner = dynamic_cast&lt;Player*&gt;(topParent);<br></td></tr
><tr
id=sl_svn102_2519

><td class="source">	if(owner &amp;&amp; owner != player){<br></td></tr
><tr
id=sl_svn102_2520
...
><td class="source">	if(!Position::areInRange&lt;1,1,0&gt;(writeItem-&gt;getPosition(), player-&gt;getPosition())){<br></td></tr
><tr
id=sl_svn102_2525
...
><td class="source">	if(!text.empty()){<br></td></tr
><tr
id=sl_svn102_2530

><td class="source">		if(writeItem-&gt;getText() != text){<br></td></tr
><tr
id=sl_svn102_2531

><td class="source">			writeItem-&gt;setText(text);<br></td></tr
><tr
id=sl_svn102_2532

><td class="source">			writeItem-&gt;setWriter(player-&gt;getName());<br></td></tr
><tr
id=sl_svn102_2533
...
><td class="source">		writeItem-&gt;resetText();<br></td></tr
><tr
id=sl_svn102_2537

><td class="source">		writeItem-&gt;resetWriter();<br></td></tr
><tr
id=sl_svn102_2538
...
><td class="source">	uint16_t newId = Item::items[writeItem-&gt;getID()].writeOnceItemId;<br></td></tr
><tr
id=sl_svn102_2541
...
><td class="source">		transformItem(writeItem, newId);<br></td></tr
><tr
id=sl_svn102_2543
...
><td class="source">	player-&gt;setWriteItem(NULL);<br></td></tr
><tr
id=sl_svn102_2546
...
><td class="source">bool Game::playerUpdateHouseWindow(uint32_t playerId, uint8_t listId, uint32_t windowTextId, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_2550
...
><td class="source">	uint32_t internalWindowTextId;<br></td></tr
><tr
id=sl_svn102_2556

><td class="source">	uint32_t internalListId;<br></td></tr
><tr
id=sl_svn102_2557

><td class="source">	House* house = player-&gt;getEditHouse(internalWindowTextId, internalListId);<br></td></tr
><tr
id=sl_svn102_2558
...
><td class="source">	if(house &amp;&amp; internalWindowTextId == windowTextId &amp;&amp; listId == 0){<br></td></tr
><tr
id=sl_svn102_2560

><td class="source">		house-&gt;setAccessList(internalListId, text);<br></td></tr
><tr
id=sl_svn102_2561

><td class="source">		player-&gt;setEditHouse(NULL);<br></td></tr
><tr
id=sl_svn102_2562
...
><td class="source">bool Game::playerRequestTrade(uint32_t playerId, const Position&amp; pos, uint8_t stackPos,<br></td></tr
><tr
id=sl_svn102_2568
...
><td class="source">	Player* tradePartner = getPlayerByID(tradePlayerId);<br></td></tr
><tr
id=sl_svn102_2575
...
><td class="source">		player-&gt;sendTextMessage(MSG_INFO_DESCR, &quot;Sorry, not possible.&quot;);<br></td></tr
><tr
id=sl_svn102_2577
...
><td class="source">		std::stringstream ss;<br></td></tr
><tr
id=sl_svn102_2582

><td class="source">		ss &lt;&lt; tradePartner-&gt;getName() &lt;&lt; &quot; tells you to move closer.&quot;;<br></td></tr
><tr
id=sl_svn102_2583

><td class="source">		player-&gt;sendTextMessage(MSG_INFO_DESCR, ss.str());<br></td></tr
><tr
id=sl_svn102_2584
...
><td class="source">	Item* tradeItem = dynamic_cast&lt;Item*&gt;(internalGetThing(<br></td></tr
><tr
id=sl_svn102_2588

><td class="source">		player, pos, stackPos, spriteId, STACKPOS_USE));<br></td></tr
><tr
id=sl_svn102_2589

><td class="source">	if(!tradeItem || tradeItem-&gt;getClientID() != spriteId ||<br></td></tr
><tr
id=sl_svn102_2590

><td class="source">		!tradeItem-&gt;isPickupable() || tradeItem-&gt;getUniqueId() != 0) <br></td></tr
><tr
id=sl_svn102_2591
...
><td class="source">	else if(player-&gt;getPosition().z &gt; tradeItem-&gt;getPosition().z){<br></td></tr
><tr
id=sl_svn102_2596
...
><td class="source">	else if(!Position::areInRange&lt;1,1,0&gt;(tradeItem-&gt;getPosition(), player-&gt;getPosition())){<br></td></tr
><tr
id=sl_svn102_2604
...
><td class="source">			SchedulerTask* task = createSchedulerTask(400, boost::bind(&amp;Game::playerRequestTrade, this,<br></td></tr
><tr
id=sl_svn102_2610

><td class="source">				playerId, pos, stackPos, tradePlayerId, spriteId));<br></td></tr
><tr
id=sl_svn102_2611
...
><td class="source">	std::map&lt;Item*, uint32_t&gt;::const_iterator it;<br></td></tr
><tr
id=sl_svn102_2621

><td class="source">	const Container* container = NULL;<br></td></tr
><tr
id=sl_svn102_2622

><td class="source">	for(it = tradeItems.begin(); it != tradeItems.end(); it++) {<br></td></tr
><tr
id=sl_svn102_2623

><td class="source">		if(tradeItem == it-&gt;first ||<br></td></tr
><tr
id=sl_svn102_2624

><td class="source">			((container = dynamic_cast&lt;const Container*&gt;(tradeItem)) &amp;&amp; container-&gt;isHoldingItem(it-&gt;first)) ||<br></td></tr
><tr
id=sl_svn102_2625

><td class="source">			((container = dynamic_cast&lt;const Container*&gt;(it-&gt;first)) &amp;&amp; container-&gt;isHoldingItem(tradeItem)))<br></td></tr
><tr
id=sl_svn102_2626
...
><td class="source">			player-&gt;sendTextMessage(MSG_INFO_DESCR, &quot;This item is already being traded.&quot;);<br></td></tr
><tr
id=sl_svn102_2628
...
><td class="source">	Container* tradeContainer = tradeItem-&gt;getContainer();<br></td></tr
><tr
id=sl_svn102_2633

><td class="source">	if(tradeContainer &amp;&amp; tradeContainer-&gt;getItemHoldingCount() + 1 &gt; 100){<br></td></tr
><tr
id=sl_svn102_2634

><td class="source">		player-&gt;sendTextMessage(MSG_INFO_DESCR, &quot;You can not trade more than 100 items.&quot;);<br></td></tr
><tr
id=sl_svn102_2635
...
><td class="source">	return internalStartTrade(player, tradePartner, tradeItem);<br></td></tr
><tr
id=sl_svn102_2639
...
><td class="source">bool Game::internalStartTrade(Player* player, Player* tradePartner, Item* tradeItem)<br></td></tr
><tr
id=sl_svn102_2642
...
><td class="source">	if(player-&gt;tradeState != TRADE_NONE &amp;&amp; !(player-&gt;tradeState == TRADE_ACKNOWLEDGE &amp;&amp; player-&gt;tradePartner == tradePartner)) {<br></td></tr
><tr
id=sl_svn102_2644

><td class="source">		player-&gt;sendCancelMessage(RET_YOUAREALREADYTRADING);<br></td></tr
><tr
id=sl_svn102_2645
...
><td class="source">	else if(tradePartner-&gt;tradeState != TRADE_NONE &amp;&amp; tradePartner-&gt;tradePartner != player) {<br></td></tr
><tr
id=sl_svn102_2648

><td class="source">		player-&gt;sendCancelMessage(RET_THISPLAYERISALREADYTRADING);<br></td></tr
><tr
id=sl_svn102_2649
...
><td class="source">	player-&gt;tradePartner = tradePartner;<br></td></tr
><tr
id=sl_svn102_2653

><td class="source">	player-&gt;tradeItem = tradeItem;<br></td></tr
><tr
id=sl_svn102_2654

><td class="source">	player-&gt;tradeState = TRADE_INITIATED;<br></td></tr
><tr
id=sl_svn102_2655

><td class="source">	tradeItem-&gt;useThing2();<br></td></tr
><tr
id=sl_svn102_2656

><td class="source">	tradeItems[tradeItem] = player-&gt;getID();<br></td></tr
><tr
id=sl_svn102_2657
...
><td class="source">	player-&gt;sendTradeItemRequest(player, tradeItem, true);<br></td></tr
><tr
id=sl_svn102_2659
...
><td class="source">	if(tradePartner-&gt;tradeState == TRADE_NONE){<br></td></tr
><tr
id=sl_svn102_2661

><td class="source">		std::stringstream trademsg;<br></td></tr
><tr
id=sl_svn102_2662

><td class="source">		trademsg &lt;&lt; player-&gt;getName() &lt;&lt;&quot; wants to trade with you.&quot;;<br></td></tr
><tr
id=sl_svn102_2663

><td class="source">		tradePartner-&gt;sendTextMessage(MSG_INFO_DESCR, trademsg.str());<br></td></tr
><tr
id=sl_svn102_2664

><td class="source">		tradePartner-&gt;tradeState = TRADE_ACKNOWLEDGE;<br></td></tr
><tr
id=sl_svn102_2665

><td class="source">		tradePartner-&gt;tradePartner = player;<br></td></tr
><tr
id=sl_svn102_2666
...
><td class="source">		Item* counterOfferItem = tradePartner-&gt;tradeItem;<br></td></tr
><tr
id=sl_svn102_2669

><td class="source">		player-&gt;sendTradeItemRequest(tradePartner, counterOfferItem, false);<br></td></tr
><tr
id=sl_svn102_2670

><td class="source">		tradePartner-&gt;sendTradeItemRequest(player, tradeItem, false);<br></td></tr
><tr
id=sl_svn102_2671
...
><td class="source">bool Game::playerAcceptTrade(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_2678
...
><td class="source">	if(!(player-&gt;getTradeState() == TRADE_ACKNOWLEDGE || player-&gt;getTradeState() == TRADE_INITIATED)){<br></td></tr
><tr
id=sl_svn102_2684
...
><td class="source">	player-&gt;setTradeState(TRADE_ACCEPT);<br></td></tr
><tr
id=sl_svn102_2688

><td class="source">	Player* tradePartner = player-&gt;tradePartner;<br></td></tr
><tr
id=sl_svn102_2689

><td class="source">	if(tradePartner &amp;&amp; tradePartner-&gt;getTradeState() == TRADE_ACCEPT){<br></td></tr
><tr
id=sl_svn102_2690
...
><td class="source">		Item* tradeItem1 = player-&gt;tradeItem;<br></td></tr
><tr
id=sl_svn102_2692

><td class="source">		Item* tradeItem2 = tradePartner-&gt;tradeItem;<br></td></tr
><tr
id=sl_svn102_2693
...
><td class="source">		player-&gt;setTradeState(TRADE_TRANSFER);<br></td></tr
><tr
id=sl_svn102_2695

><td class="source">		tradePartner-&gt;setTradeState(TRADE_TRANSFER);<br></td></tr
><tr
id=sl_svn102_2696
...
><td class="source">		std::map&lt;Item*, uint32_t&gt;::iterator it;<br></td></tr
><tr
id=sl_svn102_2698
...
><td class="source">		it = tradeItems.find(tradeItem1);<br></td></tr
><tr
id=sl_svn102_2700

><td class="source">		if(it != tradeItems.end()) {<br></td></tr
><tr
id=sl_svn102_2701

><td class="source">			FreeThing(it-&gt;first);<br></td></tr
><tr
id=sl_svn102_2702

><td class="source">			tradeItems.erase(it);<br></td></tr
><tr
id=sl_svn102_2703
...
><td class="source">		it = tradeItems.find(tradeItem2);<br></td></tr
><tr
id=sl_svn102_2706
...
><td class="source">		bool isSuccess = false;<br></td></tr
><tr
id=sl_svn102_2712
...
><td class="source">		ReturnValue ret1 = internalAddItem(tradePartner, tradeItem1, INDEX_WHEREEVER, 0, true);<br></td></tr
><tr
id=sl_svn102_2714

><td class="source">		ReturnValue ret2 = internalAddItem(player, tradeItem2, INDEX_WHEREEVER, 0, true);<br></td></tr
><tr
id=sl_svn102_2715
...
><td class="source">		if(ret1 == RET_NOERROR &amp;&amp; ret2 == RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_2717

><td class="source">			ret1 = internalRemoveItem(tradeItem1, tradeItem1-&gt;getItemCount(), true);<br></td></tr
><tr
id=sl_svn102_2718

><td class="source">			ret2 = internalRemoveItem(tradeItem2, tradeItem2-&gt;getItemCount(), true);<br></td></tr
><tr
id=sl_svn102_2719
...
><td class="source">				Cylinder* cylinder1 = tradeItem1-&gt;getParent();<br></td></tr
><tr
id=sl_svn102_2722

><td class="source">				Cylinder* cylinder2 = tradeItem2-&gt;getParent();<br></td></tr
><tr
id=sl_svn102_2723
...
><td class="source">				internalMoveItem(cylinder1, tradePartner, INDEX_WHEREEVER, tradeItem1, tradeItem1-&gt;getItemCount(), NULL);<br></td></tr
><tr
id=sl_svn102_2725

><td class="source">				internalMoveItem(cylinder2, player, INDEX_WHEREEVER, tradeItem2, tradeItem2-&gt;getItemCount(), NULL);<br></td></tr
><tr
id=sl_svn102_2726
...
><td class="source">				tradeItem1-&gt;onTradeEvent(ON_TRADE_TRANSFER, tradePartner);<br></td></tr
><tr
id=sl_svn102_2728

><td class="source">				tradeItem2-&gt;onTradeEvent(ON_TRADE_TRANSFER, player);<br></td></tr
><tr
id=sl_svn102_2729
...
><td class="source">				isSuccess = true;<br></td></tr
><tr
id=sl_svn102_2731
...
><td class="source">		if(!isSuccess){<br></td></tr
><tr
id=sl_svn102_2735

><td class="source">			std::string errorDescription = getTradeErrorDescription(ret1, tradeItem1);<br></td></tr
><tr
id=sl_svn102_2736

><td class="source">			tradePartner-&gt;sendTextMessage(MSG_INFO_DESCR, errorDescription);<br></td></tr
><tr
id=sl_svn102_2737

><td class="source">			tradePartner-&gt;tradeItem-&gt;onTradeEvent(ON_TRADE_CANCEL, tradePartner);<br></td></tr
><tr
id=sl_svn102_2738
...
><td class="source">			errorDescription = getTradeErrorDescription(ret2, tradeItem2);<br></td></tr
><tr
id=sl_svn102_2740

><td class="source">			player-&gt;sendTextMessage(MSG_INFO_DESCR, errorDescription);<br></td></tr
><tr
id=sl_svn102_2741

><td class="source">			player-&gt;tradeItem-&gt;onTradeEvent(ON_TRADE_CANCEL, player);<br></td></tr
><tr
id=sl_svn102_2742
...
><td class="source">		player-&gt;setTradeState(TRADE_NONE);<br></td></tr
><tr
id=sl_svn102_2745

><td class="source">		player-&gt;tradeItem = NULL;<br></td></tr
><tr
id=sl_svn102_2746

><td class="source">		player-&gt;tradePartner = NULL;<br></td></tr
><tr
id=sl_svn102_2747

><td class="source">		player-&gt;sendTradeClose();<br></td></tr
><tr
id=sl_svn102_2748
...
><td class="source">		tradePartner-&gt;setTradeState(TRADE_NONE);<br></td></tr
><tr
id=sl_svn102_2750

><td class="source">		tradePartner-&gt;tradeItem = NULL;<br></td></tr
><tr
id=sl_svn102_2751

><td class="source">		tradePartner-&gt;tradePartner = NULL;<br></td></tr
><tr
id=sl_svn102_2752

><td class="source">		tradePartner-&gt;sendTradeClose();<br></td></tr
><tr
id=sl_svn102_2753
...
><td class="source">		return isSuccess;<br></td></tr
><tr
id=sl_svn102_2755
...
><td class="source">std::string Game::getTradeErrorDescription(ReturnValue ret, Item* item)<br></td></tr
><tr
id=sl_svn102_2761
...
><td class="source">	if(ret == RET_NOTENOUGHCAPACITY){<br></td></tr
><tr
id=sl_svn102_2764

><td class="source">		ss &lt;&lt; &quot;You do not have enough capacity to carry&quot;;<br></td></tr
><tr
id=sl_svn102_2765

><td class="source">		if(item-&gt;isStackable() &amp;&amp; item-&gt;getItemCount() &gt; 1){<br></td></tr
><tr
id=sl_svn102_2766

><td class="source">			ss &lt;&lt; &quot; these objects.&quot;;<br></td></tr
><tr
id=sl_svn102_2767
...
><td class="source">			ss &lt;&lt; &quot; this object.&quot; ;<br></td></tr
><tr
id=sl_svn102_2770
...
><td class="source">		ss &lt;&lt; std::endl &lt;&lt; &quot; &quot; &lt;&lt; item-&gt;getWeightDescription();<br></td></tr
><tr
id=sl_svn102_2772
...
><td class="source">	else if(ret == RET_NOTENOUGHROOM || ret == RET_CONTAINERNOTENOUGHROOM){<br></td></tr
><tr
id=sl_svn102_2774

><td class="source">		ss &lt;&lt; &quot;You do not have enough room to carry&quot;;<br></td></tr
><tr
id=sl_svn102_2775
...
><td class="source">		ss &lt;&lt; &quot;Trade could not be completed.&quot;;<br></td></tr
><tr
id=sl_svn102_2784
...
><td class="source">	return ss.str().c_str();<br></td></tr
><tr
id=sl_svn102_2786
...
><td class="source">bool Game::playerLookInTrade(uint32_t playerId, bool lookAtCounterOffer, int index)<br></td></tr
><tr
id=sl_svn102_2789
...
><td class="source">	if(!tradePartner)<br></td></tr
><tr
id=sl_svn102_2796
...
><td class="source">	Item* tradeItem = NULL;<br></td></tr
><tr
id=sl_svn102_2799
...
><td class="source">	if(lookAtCounterOffer)<br></td></tr
><tr
id=sl_svn102_2801

><td class="source">		tradeItem = tradePartner-&gt;getTradeItem();<br></td></tr
><tr
id=sl_svn102_2802
...
><td class="source">		tradeItem = player-&gt;getTradeItem();<br></td></tr
><tr
id=sl_svn102_2804
...
><td class="source">	if(!tradeItem)<br></td></tr
><tr
id=sl_svn102_2806
...
><td class="source">	int32_t lookDistance = std::max(std::abs(player-&gt;getPosition().x - tradeItem-&gt;getPosition().x),<br></td></tr
><tr
id=sl_svn102_2809

><td class="source">		std::abs(player-&gt;getPosition().y - tradeItem-&gt;getPosition().y));<br></td></tr
><tr
id=sl_svn102_2810
...
><td class="source">	if(index == 0){<br></td></tr
><tr
id=sl_svn102_2812

><td class="source">		if(player-&gt;onLookEvent(tradeItem, tradeItem-&gt;getID())){<br></td></tr
><tr
id=sl_svn102_2813
...
><td class="source">			ss &lt;&lt; &quot;You see &quot; &lt;&lt; tradeItem-&gt;getDescription(lookDistance);<br></td></tr
><tr
id=sl_svn102_2815
...
><td class="source">	if(!tradeContainer || index &gt; (int)tradeContainer-&gt;getItemHoldingCount())<br></td></tr
><tr
id=sl_svn102_2822
...
><td class="source">	bool foundItem = false;<br></td></tr
><tr
id=sl_svn102_2825

><td class="source">	std::list&lt;const Container*&gt; listContainer;<br></td></tr
><tr
id=sl_svn102_2826
...
><td class="source">	listContainer.push_back(tradeContainer);<br></td></tr
><tr
id=sl_svn102_2830
...
><td class="source">	while(!foundItem &amp;&amp; listContainer.size() &gt; 0){<br></td></tr
><tr
id=sl_svn102_2832

><td class="source">		const Container* container = listContainer.front();<br></td></tr
><tr
id=sl_svn102_2833
...
><td class="source">			if((tmpContainer = (*it)-&gt;getContainer())){<br></td></tr
><tr
id=sl_svn102_2837
...
><td class="source">				tradeItem = *it;<br></td></tr
><tr
id=sl_svn102_2843

><td class="source">				foundItem = true;<br></td></tr
><tr
id=sl_svn102_2844
...
><td class="source">	if(foundItem){<br></td></tr
><tr
id=sl_svn102_2850
...
><td class="source">	return foundItem;<br></td></tr
><tr
id=sl_svn102_2858
...
><td class="source">bool Game::playerCloseTrade(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_2861
...
><td class="source">	return internalCloseTrade(player);<br></td></tr
><tr
id=sl_svn102_2867
...
><td class="source">bool Game::internalCloseTrade(Player* player)<br></td></tr
><tr
id=sl_svn102_2870
...
><td class="source">	if((tradePartner &amp;&amp; tradePartner-&gt;getTradeState() == TRADE_TRANSFER) ||<br></td></tr
><tr
id=sl_svn102_2873

><td class="source">		  player-&gt;getTradeState() == TRADE_TRANSFER){<br></td></tr
><tr
id=sl_svn102_2874

><td class="source">  		std::cout &lt;&lt; &quot;Warning: [Game::playerCloseTrade] TradeState == TRADE_TRANSFER. &quot; &lt;&lt;<br></td></tr
><tr
id=sl_svn102_2875

><td class="source">		  	player-&gt;getName() &lt;&lt; &quot; &quot; &lt;&lt; player-&gt;getTradeState() &lt;&lt; &quot; , &quot; &lt;&lt;<br></td></tr
><tr
id=sl_svn102_2876

><td class="source">		  	tradePartner-&gt;getName() &lt;&lt; &quot; &quot; &lt;&lt; tradePartner-&gt;getTradeState() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_2877
...
><td class="source">	std::vector&lt;Item*&gt;::iterator it;<br></td></tr
><tr
id=sl_svn102_2881

><td class="source">	if(player-&gt;getTradeItem()){<br></td></tr
><tr
id=sl_svn102_2882

><td class="source">		std::map&lt;Item*, uint32_t&gt;::iterator it = tradeItems.find(player-&gt;getTradeItem());<br></td></tr
><tr
id=sl_svn102_2883
...
><td class="source">	player-&gt;sendTextMessage(MSG_STATUS_SMALL, &quot;Trade cancelled.&quot;);<br></td></tr
><tr
id=sl_svn102_2896
...
><td class="source">		if(tradePartner-&gt;getTradeItem()){<br></td></tr
><tr
id=sl_svn102_2900

><td class="source">			std::map&lt;Item*, uint32_t&gt;::iterator it = tradeItems.find(tradePartner-&gt;getTradeItem());<br></td></tr
><tr
id=sl_svn102_2901
...
><td class="source">		tradePartner-&gt;sendTextMessage(MSG_STATUS_SMALL, &quot;Trade cancelled.&quot;);<br></td></tr
><tr
id=sl_svn102_2914
...
><td class="source">bool Game::playerLookAt(uint32_t playerId, const Position&amp; pos, uint16_t spriteId, uint8_t stackPos)<br></td></tr
><tr
id=sl_svn102_2921
...
><td class="source">	Thing* thing = internalGetThing(player, pos, stackPos, spriteId, STACKPOS_LOOK);<br></td></tr
><tr
id=sl_svn102_2927
...
><td class="source">	Position thingPos = thing-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_2933

><td class="source">	if(!player-&gt;canSee(thingPos)){<br></td></tr
><tr
id=sl_svn102_2934
...
><td class="source">	Position playerPos = player-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_2939
...
><td class="source">	int32_t lookDistance = 0;<br></td></tr
><tr
id=sl_svn102_2941

><td class="source">	if(thing == player)<br></td></tr
><tr
id=sl_svn102_2942

><td class="source">		lookDistance = -1;<br></td></tr
><tr
id=sl_svn102_2943
...
><td class="source">		lookDistance = std::max(std::abs(playerPos.x - thingPos.x), std::abs(playerPos.y - thingPos.y));<br></td></tr
><tr
id=sl_svn102_2945

><td class="source">		if(playerPos.z != thingPos.z)<br></td></tr
><tr
id=sl_svn102_2946

><td class="source">			lookDistance = lookDistance + 9 + 6;<br></td></tr
><tr
id=sl_svn102_2947
...
><td class="source">	uint16_t itemId = 0;<br></td></tr
><tr
id=sl_svn102_2950

><td class="source">	if(thing-&gt;getItem())<br></td></tr
><tr
id=sl_svn102_2951

><td class="source">		itemId = thing-&gt;getItem()-&gt;getID();<br></td></tr
><tr
id=sl_svn102_2952

><td class="source">	if(!player-&gt;onLookEvent(thing, itemId))<br></td></tr
><tr
id=sl_svn102_2953
...
><td class="source">	ss &lt;&lt; &quot;You see &quot; &lt;&lt; thing-&gt;getDescription(lookDistance);<br></td></tr
><tr
id=sl_svn102_2957
...
><td class="source">	//x-ray (special description)<br></td></tr
><tr
id=sl_svn102_2959

><td class="source">	if(player-&gt;hasFlag(PlayerFlag_CanSeeSpecialDescription)){<br></td></tr
><tr
id=sl_svn102_2960

><td class="source">		ss &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_2961

><td class="source">		ss &lt;&lt; thing-&gt;getXRayDescription();<br></td></tr
><tr
id=sl_svn102_2962
...
><td class="source">bool Game::playerCancelAttackAndFollow(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_2969
...
><td class="source">	playerSetAttackedCreature(playerId, 0);<br></td></tr
><tr
id=sl_svn102_2975

><td class="source">	playerFollowCreature(playerId, 0);<br></td></tr
><tr
id=sl_svn102_2976
...
><td class="source">	player-&gt;lastStepCost = 2;<br></td></tr
><tr
id=sl_svn102_2978
...
><td class="source">bool Game::playerSetAttackedCreature(uint32_t playerId, uint32_t creatureId)<br></td></tr
><tr
id=sl_svn102_2982
...
><td class="source">	if(player-&gt;getAttackedCreature() &amp;&amp; creatureId == 0){<br></td></tr
><tr
id=sl_svn102_2988

><td class="source">		player-&gt;setAttackedCreature(NULL);<br></td></tr
><tr
id=sl_svn102_2989

><td class="source">		player-&gt;sendCancelTarget();<br></td></tr
><tr
id=sl_svn102_2990
...
><td class="source">	Creature* attackCreature = getCreatureByID(creatureId);<br></td></tr
><tr
id=sl_svn102_2994

><td class="source">	if(!attackCreature){<br></td></tr
><tr
id=sl_svn102_2995
...
><td class="source">	ReturnValue ret = Combat::canTargetCreature(player, attackCreature);<br></td></tr
><tr
id=sl_svn102_3001
...
><td class="source">	player-&gt;setAttackedCreature(attackCreature);<br></td></tr
><tr
id=sl_svn102_3009
...
><td class="source">bool Game::playerFollowCreature(uint32_t playerId, uint32_t creatureId)<br></td></tr
><tr
id=sl_svn102_3013
...
><td class="source">	Creature* followCreature = NULL;<br></td></tr
><tr
id=sl_svn102_3020
...
><td class="source">	if(creatureId != 0){<br></td></tr
><tr
id=sl_svn102_3022

><td class="source">		followCreature = getCreatureByID(creatureId);<br></td></tr
><tr
id=sl_svn102_3023
...
><td class="source">	return player-&gt;setFollowCreature(followCreature);<br></td></tr
><tr
id=sl_svn102_3026
...
><td class="source">bool Game::playerInviteToParty(uint32_t playerId, uint32_t invitedId)<br></td></tr
><tr
id=sl_svn102_3029
...
><td class="source">	Player* invitedPlayer = getPlayerByID(invitedId);<br></td></tr
><tr
id=sl_svn102_3036

><td class="source">	if(!invitedPlayer || invitedPlayer-&gt;isRemoved() || invitedPlayer-&gt;isInviting(player)){<br></td></tr
><tr
id=sl_svn102_3037
...
><td class="source">	if(invitedPlayer-&gt;getParty()){<br></td></tr
><tr
id=sl_svn102_3041
...
><td class="source">		ss &lt;&lt; invitedPlayer-&gt;getName() &lt;&lt; &quot; is already in a party.&quot;;<br></td></tr
><tr
id=sl_svn102_3043
...
><td class="source">	Party* party = player-&gt;getParty();<br></td></tr
><tr
id=sl_svn102_3048

><td class="source">	if(!party){<br></td></tr
><tr
id=sl_svn102_3049

><td class="source">		party = new Party(player);<br></td></tr
><tr
id=sl_svn102_3050
...
><td class="source">	else if(party-&gt;getLeader() != player){<br></td></tr
><tr
id=sl_svn102_3052
...
><td class="source">	return party-&gt;invitePlayer(invitedPlayer);<br></td></tr
><tr
id=sl_svn102_3056
...
><td class="source">bool Game::playerJoinParty(uint32_t playerId, uint32_t leaderId)<br></td></tr
><tr
id=sl_svn102_3059
...
><td class="source">	Player* leader = getPlayerByID(leaderId);<br></td></tr
><tr
id=sl_svn102_3066

><td class="source">	if(!leader || leader-&gt;isRemoved() || !leader-&gt;isInviting(player)){<br></td></tr
><tr
id=sl_svn102_3067
...
><td class="source">	if(!leader-&gt;getParty() || leader-&gt;getParty()-&gt;getLeader() != leader){<br></td></tr
><tr
id=sl_svn102_3071
...
><td class="source">	if(player-&gt;getParty()){<br></td></tr
><tr
id=sl_svn102_3075

><td class="source">		player-&gt;sendTextMessage(MSG_INFO_DESCR, &quot;You are already in a party.&quot;);<br></td></tr
><tr
id=sl_svn102_3076
...
><td class="source">	return leader-&gt;getParty()-&gt;joinParty(player);<br></td></tr
><tr
id=sl_svn102_3080
...
><td class="source">bool Game::playerRevokePartyInvitation(uint32_t playerId, uint32_t invitedId)<br></td></tr
><tr
id=sl_svn102_3083
...
><td class="source">	if(!player || player-&gt;isRemoved() || !player-&gt;getParty() || player-&gt;getParty()-&gt;getLeader() != player){<br></td></tr
><tr
id=sl_svn102_3086
...
><td class="source">	if(!invitedPlayer || invitedPlayer-&gt;isRemoved() || !player-&gt;isInviting(invitedPlayer)){<br></td></tr
><tr
id=sl_svn102_3091
...
><td class="source">	return player-&gt;getParty()-&gt;revokeInvitation(invitedPlayer);<br></td></tr
><tr
id=sl_svn102_3095
...
><td class="source">bool Game::playerPassPartyLeadership(uint32_t playerId, uint32_t newLeaderId)<br></td></tr
><tr
id=sl_svn102_3098
...
><td class="source">	Player* newLeader = getPlayerByID(newLeaderId);<br></td></tr
><tr
id=sl_svn102_3105

><td class="source">	if(!newLeader || newLeader-&gt;isRemoved() || !player-&gt;isPartner(newLeader)){<br></td></tr
><tr
id=sl_svn102_3106
...
><td class="source">	return player-&gt;getParty()-&gt;passPartyLeadership(newLeader);<br></td></tr
><tr
id=sl_svn102_3110
...
><td class="source">bool Game::playerLeaveParty(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_3113
...
><td class="source">	if(!player-&gt;getParty() || player-&gt;hasCondition(CONDITION_INFIGHT)){<br></td></tr
><tr
id=sl_svn102_3120
...
><td class="source">	return player-&gt;getParty()-&gt;leaveParty(player);<br></td></tr
><tr
id=sl_svn102_3124
...
><td class="source">bool Game::playerSetFightModes(uint32_t playerId, fightMode_t fightMode, chaseMode_t chaseMode, bool safeMode)<br></td></tr
><tr
id=sl_svn102_3127
...
><td class="source">	player-&gt;setFightMode(fightMode);<br></td></tr
><tr
id=sl_svn102_3133

><td class="source">	player-&gt;setChaseMode(chaseMode);<br></td></tr
><tr
id=sl_svn102_3134

><td class="source">	player-&gt;setSafeMode(safeMode);<br></td></tr
><tr
id=sl_svn102_3135
...
><td class="source">bool Game::playerRequestAddVip(uint32_t playerId, const std::string&amp; vip_name)<br></td></tr
><tr
id=sl_svn102_3139
...
><td class="source">	std::string real_name;<br></td></tr
><tr
id=sl_svn102_3145

><td class="source">	real_name = vip_name;<br></td></tr
><tr
id=sl_svn102_3146
...
><td class="source">	bool specialVip;<br></td></tr
><tr
id=sl_svn102_3148
...
><td class="source">	if(!IOPlayer::instance()-&gt;getGuidByNameEx(guid, specialVip, real_name)){<br></td></tr
><tr
id=sl_svn102_3150

><td class="source">		player-&gt;sendTextMessage(MSG_STATUS_SMALL, &quot;A player with that name does not exist.&quot;);<br></td></tr
><tr
id=sl_svn102_3151
...
><td class="source">	if(specialVip &amp;&amp; !player-&gt;hasFlag(PlayerFlag_SpecialVIP)){<br></td></tr
><tr
id=sl_svn102_3154

><td class="source">		player-&gt;sendTextMessage(MSG_STATUS_SMALL, &quot;You can not add this player.&quot;);<br></td></tr
><tr
id=sl_svn102_3155
...
><td class="source">	bool online = (getPlayerByName(real_name) != NULL);<br></td></tr
><tr
id=sl_svn102_3159

><td class="source">	return player-&gt;addVIP(guid, real_name, online);<br></td></tr
><tr
id=sl_svn102_3160
...
><td class="source">bool Game::playerRequestRemoveVip(uint32_t playerId, uint32_t guid)<br></td></tr
><tr
id=sl_svn102_3163
...
><td class="source">	player-&gt;removeVIP(guid);<br></td></tr
><tr
id=sl_svn102_3169
...
><td class="source">bool Game::playerTurn(uint32_t playerId, Direction dir)<br></td></tr
><tr
id=sl_svn102_3173
...
><td class="source">	return internalCreatureTurn(player, dir);<br></td></tr
><tr
id=sl_svn102_3180
...
><td class="source">bool Game::playerRequestOutfit(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_3183
...
><td class="source">	if(!player || player-&gt;isRemoved() || player-&gt;hasFlag(PlayerFlag_CantChangeOutfit))<br></td></tr
><tr
id=sl_svn102_3186
...
><td class="source">	player-&gt;sendOutfitWindow(player);<br></td></tr
><tr
id=sl_svn102_3189
...
><td class="source">bool Game::playerChangeOutfit(uint32_t playerId, Outfit_t outfit)<br></td></tr
><tr
id=sl_svn102_3193
...
><td class="source">	player-&gt;defaultOutfit = outfit;<br></td></tr
><tr
id=sl_svn102_3199
...
><td class="source">	if(player-&gt;hasCondition(CONDITION_OUTFIT)){<br></td></tr
><tr
id=sl_svn102_3201
...
><td class="source">	internalCreatureChangeOutfit(player, outfit);<br></td></tr
><tr
id=sl_svn102_3205
...
><td class="source">bool Game::playerSay(uint32_t playerId, uint16_t channelId, SpeakClasses type,<br></td></tr
><tr
id=sl_svn102_3209
...
><td class="source">	bool isMuteableChannel = g_chat.isMuteableChannel(channelId, type);<br></td></tr
><tr
id=sl_svn102_3216

><td class="source">	uint32_t muteTime = player-&gt;isMuted();<br></td></tr
><tr
id=sl_svn102_3217
...
><td class="source">	if(isMuteableChannel &amp;&amp; muteTime &gt; 0){<br></td></tr
><tr
id=sl_svn102_3220
...
><td class="source">		ss &lt;&lt; &quot;You are still muted for &quot; &lt;&lt; muteTime &lt;&lt; &quot; seconds.&quot;;<br></td></tr
><tr
id=sl_svn102_3222

><td class="source">		player-&gt;sendTextMessage(MSG_STATUS_SMALL, ss.str());<br></td></tr
><tr
id=sl_svn102_3223
...
><td class="source">	TalkActionResult_t result;<br></td></tr
><tr
id=sl_svn102_3227

><td class="source">	result = g_talkactions-&gt;onPlayerSpeak(player, type, text);<br></td></tr
><tr
id=sl_svn102_3228

><td class="source">	if(result == TALKACTION_BREAK){<br></td></tr
><tr
id=sl_svn102_3229
...
><td class="source">	if(playerSayCommand(player, type, text)){<br></td></tr
><tr
id=sl_svn102_3233
...
><td class="source">		if(playerSaySpell(player, type, text)){<br></td></tr
><tr
id=sl_svn102_3238
...
><td class="source">	if(isMuteableChannel){<br></td></tr
><tr
id=sl_svn102_3243

><td class="source">		player-&gt;removeMessageBuffer();<br></td></tr
><tr
id=sl_svn102_3244
...
><td class="source">		case SPEAK_SAY:<br></td></tr
><tr
id=sl_svn102_3248

><td class="source">			return internalCreatureSay(player, SPEAK_SAY, text);<br></td></tr
><tr
id=sl_svn102_3249

><td class="source">		case SPEAK_WHISPER:<br></td></tr
><tr
id=sl_svn102_3250

><td class="source">			return playerWhisper(player, text);<br></td></tr
><tr
id=sl_svn102_3251

><td class="source">		case SPEAK_YELL:<br></td></tr
><tr
id=sl_svn102_3252

><td class="source">			return playerYell(player, text);<br></td></tr
><tr
id=sl_svn102_3253

><td class="source">		case SPEAK_PRIVATE:<br></td></tr
><tr
id=sl_svn102_3254

><td class="source">		case SPEAK_PRIVATE_RED:<br></td></tr
><tr
id=sl_svn102_3255

><td class="source">		case SPEAK_RVR_ANSWER:<br></td></tr
><tr
id=sl_svn102_3256

><td class="source">			return playerSpeakTo(player, type, receiver, text);<br></td></tr
><tr
id=sl_svn102_3257

><td class="source">		case SPEAK_CHANNEL_Y:<br></td></tr
><tr
id=sl_svn102_3258

><td class="source">		case SPEAK_CHANNEL_R1:<br></td></tr
><tr
id=sl_svn102_3259

><td class="source">		case SPEAK_CHANNEL_R2:<br></td></tr
><tr
id=sl_svn102_3260

><td class="source">			return playerTalkToChannel(player, type, text, channelId);<br></td></tr
><tr
id=sl_svn102_3261

><td class="source">		case SPEAK_BROADCAST:<br></td></tr
><tr
id=sl_svn102_3262

><td class="source">			return internalBroadcastMessage(player, text);<br></td></tr
><tr
id=sl_svn102_3263

><td class="source">		case SPEAK_RVR_CHANNEL:<br></td></tr
><tr
id=sl_svn102_3264

><td class="source">			return playerReportRuleViolation(player, text);<br></td></tr
><tr
id=sl_svn102_3265

><td class="source">		case SPEAK_RVR_CONTINUE:<br></td></tr
><tr
id=sl_svn102_3266

><td class="source">			return playerContinueReport(player, text);<br></td></tr
><tr
id=sl_svn102_3267
...
><td class="source">bool Game::playerSayCommand(Player* player, SpeakClasses type, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_3275
...
><td class="source">	//First, check if this was a command<br></td></tr
><tr
id=sl_svn102_3277

><td class="source">	for(uint32_t i = 0; i &lt; commandTags.size(); i++){<br></td></tr
><tr
id=sl_svn102_3278

><td class="source">		if(commandTags[i] == text.substr(0,1)){<br></td></tr
><tr
id=sl_svn102_3279

><td class="source">			if(commands.exeCommand(player, text)){<br></td></tr
><tr
id=sl_svn102_3280
...
><td class="source">bool Game::playerSaySpell(Player* player, SpeakClasses type, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_3289
...
><td class="source">	result = g_spells-&gt;playerSaySpell(player, type, text);<br></td></tr
><tr
id=sl_svn102_3292
...
><td class="source">	else if(result == TALKACTION_FAILED){<br></td></tr
><tr
id=sl_svn102_3296
...
><td class="source">bool Game::playerWhisper(Player* player, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_3303
...
><td class="source">	getSpectators(list, player-&gt;getPosition(), false, false,<br></td></tr
><tr
id=sl_svn102_3307

><td class="source">		Map::maxClientViewportX, Map::maxClientViewportX,<br></td></tr
><tr
id=sl_svn102_3308

><td class="source">		Map::maxClientViewportY, Map::maxClientViewportY);<br></td></tr
><tr
id=sl_svn102_3309
...
><td class="source">			if(!Position::areInRange&lt;1,1,0&gt;(player-&gt;getPosition(), (*it)-&gt;getPosition())){<br></td></tr
><tr
id=sl_svn102_3315

><td class="source">				tmpPlayer-&gt;sendCreatureSay(player, SPEAK_WHISPER, &quot;pspsps&quot;);<br></td></tr
><tr
id=sl_svn102_3316
...
><td class="source">				tmpPlayer-&gt;sendCreatureSay(player, SPEAK_WHISPER, text);<br></td></tr
><tr
id=sl_svn102_3319
...
><td class="source">		(*it)-&gt;onCreatureSay(player, SPEAK_WHISPER, text);<br></td></tr
><tr
id=sl_svn102_3326
...
><td class="source">bool Game::playerYell(Player* player, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_3332
...
><td class="source">	if(player-&gt;getLevel() &lt; 2){<br></td></tr
><tr
id=sl_svn102_3334

><td class="source">		player-&gt;sendCancel(&quot;You may not yell as long as you are on level 1.&quot;);<br></td></tr
><tr
id=sl_svn102_3335
...
><td class="source">	int32_t addExhaustion = 0;<br></td></tr
><tr
id=sl_svn102_3339

><td class="source">	bool isExhausted = false;<br></td></tr
><tr
id=sl_svn102_3340

><td class="source">	if(!player-&gt;hasCondition(CONDITION_YELL)){<br></td></tr
><tr
id=sl_svn102_3341

><td class="source">		addExhaustion = g_config.getNumber(ConfigManager::EXHAUSTED);<br></td></tr
><tr
id=sl_svn102_3342

><td class="source">		internalCreatureSay(player, SPEAK_YELL, asUpperCaseString(text));<br></td></tr
><tr
id=sl_svn102_3343
...
><td class="source">		isExhausted = true;<br></td></tr
><tr
id=sl_svn102_3346

><td class="source">		addExhaustion = g_config.getNumber(ConfigManager::EXHAUSTED_ADD);<br></td></tr
><tr
id=sl_svn102_3347

><td class="source">		player-&gt;sendCancelMessage(RET_YOUAREEXHAUSTED);<br></td></tr
><tr
id=sl_svn102_3348
...
><td class="source">	if(addExhaustion &gt; 0){<br></td></tr
><tr
id=sl_svn102_3351

><td class="source">		Condition* condition = Condition::createCondition(CONDITIONID_DEFAULT, CONDITION_YELL, addExhaustion, 0);<br></td></tr
><tr
id=sl_svn102_3352

><td class="source">		player-&gt;addCondition(condition);<br></td></tr
><tr
id=sl_svn102_3353
...
><td class="source">	return !isExhausted;<br></td></tr
><tr
id=sl_svn102_3356
...
><td class="source">bool Game::playerSpeakTo(Player* player, SpeakClasses type, const std::string&amp; receiver,<br></td></tr
><tr
id=sl_svn102_3359
...
><td class="source">	Player* toPlayer = getPlayerByName(receiver);<br></td></tr
><tr
id=sl_svn102_3362

><td class="source">	if(!toPlayer || player-&gt;isRemoved()) {<br></td></tr
><tr
id=sl_svn102_3363

><td class="source">		player-&gt;sendTextMessage(MSG_STATUS_SMALL, &quot;A player with this name is not online.&quot;);<br></td></tr
><tr
id=sl_svn102_3364
...
><td class="source">	if(type == SPEAK_PRIVATE_RED &amp;&amp; !player-&gt;hasFlag(PlayerFlag_CanTalkRedPrivate)){<br></td></tr
><tr
id=sl_svn102_3368

><td class="source">		type = SPEAK_PRIVATE;<br></td></tr
><tr
id=sl_svn102_3369
...
><td class="source">	toPlayer-&gt;sendCreatureSay(player, type, text);<br></td></tr
><tr
id=sl_svn102_3372

><td class="source">	toPlayer-&gt;onCreatureSay(player, type, text);<br></td></tr
><tr
id=sl_svn102_3373
...
><td class="source">	ss &lt;&lt; &quot;Message sent to &quot; &lt;&lt; toPlayer-&gt;getName() &lt;&lt; &quot;.&quot;;<br></td></tr
><tr
id=sl_svn102_3376
...
><td class="source">bool Game::playerTalkToChannel(Player* player, SpeakClasses type,<br></td></tr
><tr
id=sl_svn102_3381

><td class="source">	const std::string&amp; text, unsigned short channelId)<br></td></tr
><tr
id=sl_svn102_3382
...
><td class="source">	if(type == SPEAK_CHANNEL_R1 &amp;&amp; !player-&gt;hasFlag(PlayerFlag_CanTalkRedChannel)){<br></td></tr
><tr
id=sl_svn102_3384

><td class="source">		type = SPEAK_CHANNEL_Y;<br></td></tr
><tr
id=sl_svn102_3385
...
><td class="source">	else if(type == SPEAK_CHANNEL_R2 &amp;&amp; !player-&gt;hasFlag(PlayerFlag_CanTalkRedChannelAnonymous)){<br></td></tr
><tr
id=sl_svn102_3387
...
><td class="source">	return g_chat.talkToChannel(player, type, text, channelId);<br></td></tr
><tr
id=sl_svn102_3391
...
><td class="source">bool Game::playerReportRuleViolation(Player* player, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_3394
...
><td class="source">	// Do not allow reports on multiclones worlds<br></td></tr
><tr
id=sl_svn102_3396

><td class="source">	// Since reports are name-based<br></td></tr
><tr
id=sl_svn102_3397

><td class="source">	if(g_config.getBoolean(ConfigManager::ALLOW_CLONES)){<br></td></tr
><tr
id=sl_svn102_3398

><td class="source">		player-&gt;sendTextMessage(MSG_INFO_DESCR, &quot;Rule violations reports are disabled.&quot;);<br></td></tr
><tr
id=sl_svn102_3399
...
><td class="source">	cancelRuleViolation(player);<br></td></tr
><tr
id=sl_svn102_3403
...
><td class="source">	shared_ptr&lt;RuleViolation&gt; rvr(new RuleViolation(<br></td></tr
><tr
id=sl_svn102_3405

><td class="source">		player,<br></td></tr
><tr
id=sl_svn102_3406
...
><td class="source">		std::time(NULL)<br></td></tr
><tr
id=sl_svn102_3408
...
><td class="source">	ruleViolations[player-&gt;getID()] = rvr;<br></td></tr
><tr
id=sl_svn102_3411
...
><td class="source">				it-&gt;second-&gt;sendToChannel(player, SPEAK_RVR_CHANNEL, text, CHANNEL_RULE_REP, rvr-&gt;time);<br></td></tr
><tr
id=sl_svn102_3419
...
><td class="source">bool Game::playerContinueReport(Player* player, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_3427
...
><td class="source">	RuleViolationsMap::iterator it = ruleViolations.find(player-&gt;getID());<br></td></tr
><tr
id=sl_svn102_3429
...
><td class="source">	Player* toPlayer = rvr.gamemaster;<br></td></tr
><tr
id=sl_svn102_3435

><td class="source">	if(!toPlayer){<br></td></tr
><tr
id=sl_svn102_3436
...
><td class="source">	toPlayer-&gt;sendCreatureSay(player, SPEAK_RVR_CONTINUE, text);<br></td></tr
><tr
id=sl_svn102_3440
...
><td class="source">	player-&gt;sendTextMessage(MSG_STATUS_SMALL, &quot;Message sent to Gamemaster.&quot;);<br></td></tr
><tr
id=sl_svn102_3442
...
><td class="source">bool Game::kickPlayer(uint32_t playerId)<br></td></tr
><tr
id=sl_svn102_3446
...
><td class="source">	player-&gt;kickPlayer();<br></td></tr
><tr
id=sl_svn102_3452
...
><td class="source">bool Game::canThrowObjectTo(const Position&amp; fromPos, const Position&amp; toPos, bool checkLineOfSight /*= true*/,<br></td></tr
><tr
id=sl_svn102_3457
...
><td class="source">	return map-&gt;canThrowObjectTo(fromPos, toPos, checkLineOfSight, rangex, rangey);<br></td></tr
><tr
id=sl_svn102_3460
...
><td class="source">bool Game::isSightClear(const Position&amp; fromPos, const Position&amp; toPos, bool floorCheck)<br></td></tr
><tr
id=sl_svn102_3463
...
><td class="source">	return map-&gt;isSightClear(fromPos, toPos, floorCheck);<br></td></tr
><tr
id=sl_svn102_3465
...
><td class="source">bool Game::internalCreatureTurn(Creature* creature, Direction dir)<br></td></tr
><tr
id=sl_svn102_3468
...
><td class="source">	if(creature-&gt;getDirection() != dir){<br></td></tr
><tr
id=sl_svn102_3470

><td class="source">		creature-&gt;setDirection(dir);<br></td></tr
><tr
id=sl_svn102_3471
...
><td class="source">		int32_t stackpos = creature-&gt;getParent()-&gt;__getIndexOfThing(creature);<br></td></tr
><tr
id=sl_svn102_3473
...
><td class="source">		const SpectatorVec&amp; list = getSpectators(creature-&gt;getPosition());<br></td></tr
><tr
id=sl_svn102_3475

><td class="source">		SpectatorVec::const_iterator it;<br></td></tr
><tr
id=sl_svn102_3476
...
><td class="source">				tmpPlayer-&gt;sendCreatureTurn(creature, stackpos);<br></td></tr
><tr
id=sl_svn102_3482
...
><td class="source">			(*it)-&gt;onCreatureTurn(creature, stackpos);<br></td></tr
><tr
id=sl_svn102_3488
...
><td class="source">bool Game::internalCreatureSay(Creature* creature, SpeakClasses type, const std::string&amp; text)<br></td></tr
><tr
id=sl_svn102_3497
...
><td class="source">	// This somewhat complex construct ensures that the cached SpectatorVec<br></td></tr
><tr
id=sl_svn102_3499

><td class="source">	// is used if available and if it can be used, else a local vector is<br></td></tr
><tr
id=sl_svn102_3500

><td class="source">	// used. (Hopefully the compiler will optimize away the construction of<br></td></tr
><tr
id=sl_svn102_3501

><td class="source">	// the temporary when it&#39;s not used.<br></td></tr
><tr
id=sl_svn102_3502
...
><td class="source">	if(type == SPEAK_YELL || type == SPEAK_MONSTER_YELL){<br></td></tr
><tr
id=sl_svn102_3506

><td class="source">		getSpectators(list, creature-&gt;getPosition(), false, true, 18, 18, 14, 14);<br></td></tr
><tr
id=sl_svn102_3507
...
><td class="source">		getSpectators(list, creature-&gt;getPosition(), false, false,<br></td></tr
><tr
id=sl_svn102_3510
...
><td class="source">			tmpPlayer-&gt;sendCreatureSay(creature, type, text);<br></td></tr
><tr
id=sl_svn102_3519
...
><td class="source">		(*it)-&gt;onCreatureSay(creature, type, text);<br></td></tr
><tr
id=sl_svn102_3525
...
><td class="source">bool Game::getPathTo(const Creature* creature, const Position&amp; destPos,<br></td></tr
><tr
id=sl_svn102_3531
...
><td class="source">	return map-&gt;getPathTo(creature, destPos, listDir, maxSearchDist);<br></td></tr
><tr
id=sl_svn102_3534
...
><td class="source">bool Game::getPathToEx(const Creature* creature, const Position&amp; targetPos,<br></td></tr
><tr
id=sl_svn102_3537

><td class="source">	std::list&lt;Direction&gt;&amp; dirList, const FindPathParams&amp; fpp)<br></td></tr
><tr
id=sl_svn102_3538
...
><td class="source">	return map-&gt;getPathMatching(creature, dirList, FrozenPathingConditionCall(targetPos), fpp);<br></td></tr
><tr
id=sl_svn102_3540
...
><td class="source">bool Game::getPathToEx(const Creature* creature, const Position&amp; targetPos, std::list&lt;Direction&gt;&amp; dirList,<br></td></tr
><tr
id=sl_svn102_3543
...
><td class="source">	FindPathParams fpp;<br></td></tr
><tr
id=sl_svn102_3547

><td class="source">	fpp.fullPathSearch = fullPathSearch;<br></td></tr
><tr
id=sl_svn102_3548

><td class="source">	fpp.maxSearchDist = maxSearchDist;<br></td></tr
><tr
id=sl_svn102_3549

><td class="source">	fpp.clearSight = clearSight;<br></td></tr
><tr
id=sl_svn102_3550

><td class="source">	fpp.minTargetDist = minTargetDist;<br></td></tr
><tr
id=sl_svn102_3551

><td class="source">	fpp.maxTargetDist = maxTargetDist;<br></td></tr
><tr
id=sl_svn102_3552
...
><td class="source">	return getPathToEx(creature, targetPos, dirList, fpp);<br></td></tr
><tr
id=sl_svn102_3554
...
><td class="source">void Game::checkCreatureWalk(uint32_t creatureId)<br></td></tr
><tr
id=sl_svn102_3557
...
><td class="source">	if(creature &amp;&amp; creature-&gt;getHealth() &gt; 0){<br></td></tr
><tr
id=sl_svn102_3560

><td class="source">		creature-&gt;onWalk();<br></td></tr
><tr
id=sl_svn102_3561
...
><td class="source">void Game::updateCreatureWalk(uint32_t creatureId)<br></td></tr
><tr
id=sl_svn102_3566
...
><td class="source">		creature-&gt;getPathToFollowCreature();<br></td></tr
><tr
id=sl_svn102_3570
...
><td class="source">void Game::checkCreatureAttack(uint32_t creatureId)<br></td></tr
><tr
id=sl_svn102_3574
...
><td class="source">		creature-&gt;onAttacking(0);<br></td></tr
><tr
id=sl_svn102_3578
...
><td class="source">void Game::addCreatureCheck(Creature* creature)<br></td></tr
><tr
id=sl_svn102_3582
...
><td class="source">	if(creature-&gt;checkCreatureVectorIndex != 0) {<br></td></tr
><tr
id=sl_svn102_3584

><td class="source">		// Already in a vector<br></td></tr
><tr
id=sl_svn102_3585
...
><td class="source">	int next_vector = (checkCreatureLastIndex + 1) % EVENT_CREATURECOUNT;<br></td></tr
><tr
id=sl_svn102_3588

><td class="source">	checkCreatureVectors[next_vector].push_back(creature);<br></td></tr
><tr
id=sl_svn102_3589

><td class="source">	creature-&gt;checkCreatureVectorIndex = next_vector + 1;<br></td></tr
><tr
id=sl_svn102_3590
...
><td class="source">void Game::removeCreatureCheck(Creature* creature)<br></td></tr
><tr
id=sl_svn102_3593
...
><td class="source">		// Not in any vector<br></td></tr
><tr
id=sl_svn102_3596
...
><td class="source">	std::vector&lt;Creature*&gt;&amp; checkCreatureVector = checkCreatureVectors[creature-&gt;checkCreatureVectorIndex - 1];<br></td></tr
><tr
id=sl_svn102_3599
...
><td class="source">	std::vector&lt;Creature*&gt;::iterator cit = std::find(checkCreatureVector.begin(),<br></td></tr
><tr
id=sl_svn102_3601

><td class="source">	checkCreatureVector.end(), creature);<br></td></tr
><tr
id=sl_svn102_3602

><td class="source">	if(cit != checkCreatureVector.end()) {<br></td></tr
><tr
id=sl_svn102_3603

><td class="source">		// Swap &amp; pop is more effective than erase<br></td></tr
><tr
id=sl_svn102_3604

><td class="source">		std::swap(*cit, checkCreatureVector.back());<br></td></tr
><tr
id=sl_svn102_3605

><td class="source">		checkCreatureVector.pop_back();<br></td></tr
><tr
id=sl_svn102_3606
...
><td class="source">	creature-&gt;checkCreatureVectorIndex = 0;<br></td></tr
><tr
id=sl_svn102_3608
...
><td class="source">void Game::checkCreatures()<br></td></tr
><tr
id=sl_svn102_3611
...
><td class="source">		EVENT_CHECK_CREATURE_INTERVAL, boost::bind(&amp;Game::checkCreatures, this)));<br></td></tr
><tr
id=sl_svn102_3614
...
><td class="source">	checkCreatureLastIndex++;<br></td></tr
><tr
id=sl_svn102_3616

><td class="source">	if(checkCreatureLastIndex == EVENT_CREATURECOUNT) {<br></td></tr
><tr
id=sl_svn102_3617
...
><td class="source">	std::vector&lt;Creature*&gt;&amp; checkCreatureVector = checkCreatureVectors[checkCreatureLastIndex];<br></td></tr
><tr
id=sl_svn102_3621
...
><td class="source">	Creature* creature;<br></td></tr
><tr
id=sl_svn102_3623

><td class="source">	for(uint32_t i = 0; i &lt; checkCreatureVector.size(); ++i){<br></td></tr
><tr
id=sl_svn102_3624

><td class="source">		creature = checkCreatureVector[i];<br></td></tr
><tr
id=sl_svn102_3625

><td class="source">		if(creature-&gt;getHealth() &gt; 0){<br></td></tr
><tr
id=sl_svn102_3626

><td class="source">			creature-&gt;onThink(EVENT_CREATURE_THINK_INTERVAL);<br></td></tr
><tr
id=sl_svn102_3627

><td class="source">			creature-&gt;onAttacking(EVENT_CREATURE_THINK_INTERVAL);<br></td></tr
><tr
id=sl_svn102_3628

><td class="source">			creature-&gt;executeConditions(EVENT_CREATURE_THINK_INTERVAL);<br></td></tr
><tr
id=sl_svn102_3629
...
><td class="source">		else if(!creature-&gt;isDying){<br></td></tr
><tr
id=sl_svn102_3631

><td class="source">			creature-&gt;isDying = true;<br></td></tr
><tr
id=sl_svn102_3632

><td class="source">			int random = random_range(100, 200);<br></td></tr
><tr
id=sl_svn102_3633
...
><td class="source">				random, boost::bind(&amp;Game::doDeathDelay, this, creature)));<br></td></tr
><tr
id=sl_svn102_3635
...
><td class="source">void Game::changeSpeed(Creature* creature, int32_t varSpeedDelta)<br></td></tr
><tr
id=sl_svn102_3642
...
><td class="source">	int32_t varSpeed = creature-&gt;getSpeed() - creature-&gt;getBaseSpeed();<br></td></tr
><tr
id=sl_svn102_3644

><td class="source">	varSpeed += varSpeedDelta;<br></td></tr
><tr
id=sl_svn102_3645
...
><td class="source">	creature-&gt;setSpeed(varSpeed);<br></td></tr
><tr
id=sl_svn102_3647
...
><td class="source">			tmpPlayer-&gt;sendChangeSpeed(creature, creature-&gt;getStepSpeed());<br></td></tr
><tr
id=sl_svn102_3656
...
><td class="source">void Game::internalCreatureChangeOutfit(Creature* creature, const Outfit_t&amp; outfit)<br></td></tr
><tr
id=sl_svn102_3661
...
><td class="source">	creature-&gt;setCurrentOutfit(outfit);<br></td></tr
><tr
id=sl_svn102_3663
...
><td class="source">		getSpectators(list, creature-&gt;getPosition(), true);<br></td></tr
><tr
id=sl_svn102_3668
...
><td class="source">				tmpPlayer-&gt;sendCreatureChangeOutfit(creature, outfit);<br></td></tr
><tr
id=sl_svn102_3674
...
><td class="source">			(*it)-&gt;onCreatureChangeOutfit(creature, outfit);<br></td></tr
><tr
id=sl_svn102_3680
...
><td class="source">void Game::internalCreatureChangeVisible(Creature* creature, bool visible)<br></td></tr
><tr
id=sl_svn102_3685
...
><td class="source">			tmpPlayer-&gt;sendCreatureChangeVisible(creature, visible);<br></td></tr
><tr
id=sl_svn102_3694
...
><td class="source">		(*it)-&gt;onCreatureChangeVisible(creature, visible);<br></td></tr
><tr
id=sl_svn102_3700
...
><td class="source">void Game::changeLight(const Creature* creature)<br></td></tr
><tr
id=sl_svn102_3704
...
><td class="source">	for(SpectatorVec::const_iterator it = list.begin(); it != list.end(); ++it){<br></td></tr
><tr
id=sl_svn102_3710
...
><td class="source">			tmpPlayer-&gt;sendCreatureLight(creature);<br></td></tr
><tr
id=sl_svn102_3712
...
><td class="source">bool Game::combatBlockHit(CombatType_t combatType, Creature* attacker, Creature* target,<br></td></tr
><tr
id=sl_svn102_3717
...
><td class="source">	if(healthChange &gt; 0){<br></td></tr
><tr
id=sl_svn102_3720
...
><td class="source">	const Position&amp; targetPos = target-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_3724
...
><td class="source">	const SpectatorVec&amp; list = getSpectators(targetPos);<br></td></tr
><tr
id=sl_svn102_3726
...
><td class="source">	if(!target-&gt;isAttackable() || Combat::canDoCombat(attacker, target) != RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_3728

><td class="source">		addMagicEffect(list, targetPos, NM_ME_PUFF);<br></td></tr
><tr
id=sl_svn102_3729
...
><td class="source">	int32_t damage = -healthChange;<br></td></tr
><tr
id=sl_svn102_3733

><td class="source">	BlockType_t blockType = target-&gt;blockHit(attacker, combatType, damage, checkDefense, checkArmor);<br></td></tr
><tr
id=sl_svn102_3734

><td class="source">	healthChange = -damage;<br></td></tr
><tr
id=sl_svn102_3735
...
><td class="source">	if(blockType == BLOCK_DEFENSE){<br></td></tr
><tr
id=sl_svn102_3737
...
><td class="source">	else if(blockType == BLOCK_ARMOR){<br></td></tr
><tr
id=sl_svn102_3741

><td class="source">		addMagicEffect(list, targetPos, NM_ME_BLOCKHIT);<br></td></tr
><tr
id=sl_svn102_3742
...
><td class="source">	else if(blockType == BLOCK_IMMUNITY){<br></td></tr
><tr
id=sl_svn102_3745

><td class="source">		uint8_t hitEffect = 0;<br></td></tr
><tr
id=sl_svn102_3746
...
><td class="source">		switch(combatType){<br></td></tr
><tr
id=sl_svn102_3748

><td class="source">			case COMBAT_UNDEFINEDDAMAGE:<br></td></tr
><tr
id=sl_svn102_3749
...
><td class="source">			case COMBAT_ENERGYDAMAGE:<br></td></tr
><tr
id=sl_svn102_3752

><td class="source">			case COMBAT_FIREDAMAGE:<br></td></tr
><tr
id=sl_svn102_3753

><td class="source">			case COMBAT_PHYSICALDAMAGE:<br></td></tr
><tr
id=sl_svn102_3754
...
><td class="source">				hitEffect = NM_ME_BLOCKHIT;<br></td></tr
><tr
id=sl_svn102_3756
...
><td class="source">			case COMBAT_POISONDAMAGE:<br></td></tr
><tr
id=sl_svn102_3760
...
><td class="source">				hitEffect = NM_ME_POISON_RINGS;<br></td></tr
><tr
id=sl_svn102_3762
...
><td class="source">				hitEffect = NM_ME_PUFF;<br></td></tr
><tr
id=sl_svn102_3768
...
><td class="source">		addMagicEffect(list, targetPos, hitEffect);<br></td></tr
><tr
id=sl_svn102_3772
...
><td class="source">bool Game::combatChangeHealth(CombatType_t combatType, Creature* attacker, Creature* target, int32_t healthChange)<br></td></tr
><tr
id=sl_svn102_3780
...
><td class="source">	return combatChangeHealth(combatType, NM_ME_UNK, TEXTCOLOR_UNK, attacker, target, healthChange);<br></td></tr
><tr
id=sl_svn102_3782
...
><td class="source">bool Game::combatChangeHealth(CombatType_t combatType, MagicEffectClasses customHitEffect, <br></td></tr
><tr
id=sl_svn102_3785
...
><td class="source">		if(target-&gt;getHealth() &lt;= 0){<br></td></tr
><tr
id=sl_svn102_3791
...
><td class="source">		target-&gt;gainHealth(attacker, healthChange);<br></td></tr
><tr
id=sl_svn102_3795
...
><td class="source">		if(damage != 0){<br></td></tr
><tr
id=sl_svn102_3806

><td class="source">			if(target-&gt;hasCondition(CONDITION_MANASHIELD) &amp;&amp; combatType != COMBAT_UNDEFINEDDAMAGE){<br></td></tr
><tr
id=sl_svn102_3807

><td class="source">				int32_t manaDamage = std::min(target-&gt;getMana(), damage);<br></td></tr
><tr
id=sl_svn102_3808

><td class="source">				damage = std::max((int32_t)0, damage - manaDamage);<br></td></tr
><tr
id=sl_svn102_3809
...
><td class="source">				if(manaDamage != 0){<br></td></tr
><tr
id=sl_svn102_3811

><td class="source">					target-&gt;drainMana(attacker, manaDamage);<br></td></tr
><tr
id=sl_svn102_3812
...
><td class="source">					ss &lt;&lt; manaDamage;<br></td></tr
><tr
id=sl_svn102_3815

><td class="source">					addMagicEffect(list, targetPos, NM_ME_LOSE_ENERGY);<br></td></tr
><tr
id=sl_svn102_3816

><td class="source">					addAnimatedText(list, targetPos, TEXTCOLOR_BLUE, ss.str());<br></td></tr
><tr
id=sl_svn102_3817
...
><td class="source">			damage = std::min(target-&gt;getHealth(), damage);<br></td></tr
><tr
id=sl_svn102_3821
...
><td class="source">				target-&gt;drainHealth(attacker, combatType, damage);<br></td></tr
><tr
id=sl_svn102_3823

><td class="source">				addCreatureHealth(list, target);<br></td></tr
><tr
id=sl_svn102_3824

><td class="source">				if(Player* player = target-&gt;getPlayer()) {<br></td></tr
><tr
id=sl_svn102_3825

><td class="source">					if(player-&gt;getHealth() &lt;= 0)<br></td></tr
><tr
id=sl_svn102_3826

><td class="source">						player-&gt;sendTextMessage(MSG_EVENT_ADVANCE, &quot;You are dead.&quot;);<br></td></tr
><tr
id=sl_svn102_3827
...
><td class="source">				TextColor_t textColor = TEXTCOLOR_NONE;<br></td></tr
><tr
id=sl_svn102_3830
...
><td class="source">						Item* splash = NULL;<br></td></tr
><tr
id=sl_svn102_3836

><td class="source">						switch(target-&gt;getRace()){<br></td></tr
><tr
id=sl_svn102_3837

><td class="source">							case RACE_VENOM:<br></td></tr
><tr
id=sl_svn102_3838

><td class="source">								textColor = TEXTCOLOR_LIGHTGREEN;<br></td></tr
><tr
id=sl_svn102_3839

><td class="source">								hitEffect = NM_ME_POISON;<br></td></tr
><tr
id=sl_svn102_3840

><td class="source">								splash = Item::CreateItem(ITEM_SMALLSPLASH, FLUID_GREEN);<br></td></tr
><tr
id=sl_svn102_3841
...
><td class="source">							case RACE_BLOOD:<br></td></tr
><tr
id=sl_svn102_3844

><td class="source">								textColor = TEXTCOLOR_RED;<br></td></tr
><tr
id=sl_svn102_3845

><td class="source">								hitEffect = NM_ME_DRAW_BLOOD;<br></td></tr
><tr
id=sl_svn102_3846

><td class="source">								splash = Item::CreateItem(ITEM_SMALLSPLASH, FLUID_BLOOD);<br></td></tr
><tr
id=sl_svn102_3847
...
><td class="source">							case RACE_UNDEAD:<br></td></tr
><tr
id=sl_svn102_3850

><td class="source">								textColor = TEXTCOLOR_LIGHTGREY;<br></td></tr
><tr
id=sl_svn102_3851

><td class="source">								hitEffect = NM_ME_HIT_AREA;<br></td></tr
><tr
id=sl_svn102_3852
...
><td class="source">							case RACE_FIRE:<br></td></tr
><tr
id=sl_svn102_3855

><td class="source">								textColor = TEXTCOLOR_ORANGE;<br></td></tr
><tr
id=sl_svn102_3856
...
><td class="source">						if(splash){<br></td></tr
><tr
id=sl_svn102_3864

><td class="source">							internalAddItem(target-&gt;getTile(), splash, INDEX_WHEREEVER, FLAG_NOLIMIT);<br></td></tr
><tr
id=sl_svn102_3865

><td class="source">							startDecay(splash);<br></td></tr
><tr
id=sl_svn102_3866
...
><td class="source">						textColor = TEXTCOLOR_LIGHTBLUE;<br></td></tr
><tr
id=sl_svn102_3874

><td class="source">						hitEffect = NM_ME_ENERGY_DAMAGE;<br></td></tr
><tr
id=sl_svn102_3875
...
><td class="source">						hitEffect = NM_ME_HITBY_FIRE;<br></td></tr
><tr
id=sl_svn102_3889
...
><td class="source">					case COMBAT_LIFEDRAIN:<br></td></tr
><tr
id=sl_svn102_3893
...
><td class="source">						hitEffect = NM_ME_MAGIC_BLOOD;<br></td></tr
><tr
id=sl_svn102_3896
...
><td class="source">				if(customHitEffect != NM_ME_UNK)<br></td></tr
><tr
id=sl_svn102_3904

><td class="source">					hitEffect = customHitEffect;<br></td></tr
><tr
id=sl_svn102_3905
...
><td class="source">				if(customTextColor != TEXTCOLOR_UNK)<br></td></tr
><tr
id=sl_svn102_3907

><td class="source">					textColor = customTextColor;<br></td></tr
><tr
id=sl_svn102_3908
...
><td class="source">				if(textColor != TEXTCOLOR_NONE){<br></td></tr
><tr
id=sl_svn102_3910
...
><td class="source">					ss &lt;&lt; damage;<br></td></tr
><tr
id=sl_svn102_3912
...
><td class="source">					addAnimatedText(list, targetPos, textColor, ss.str());<br></td></tr
><tr
id=sl_svn102_3914
...
><td class="source">bool Game::combatChangeMana(Creature* attacker, Creature* target, int32_t manaChange)<br></td></tr
><tr
id=sl_svn102_3923
...
><td class="source">	if(manaChange &gt; 0){<br></td></tr
><tr
id=sl_svn102_3929

><td class="source">		target-&gt;changeMana(manaChange);<br></td></tr
><tr
id=sl_svn102_3930
...
><td class="source">		int32_t manaLoss = std::min(target-&gt;getMana(), -manaChange);<br></td></tr
><tr
id=sl_svn102_3938

><td class="source">		BlockType_t blockType = target-&gt;blockHit(attacker, COMBAT_MANADRAIN, manaLoss);<br></td></tr
><tr
id=sl_svn102_3939
...
><td class="source">		if(blockType != BLOCK_NONE){<br></td></tr
><tr
id=sl_svn102_3941
...
><td class="source">		if(manaLoss &gt; 0){<br></td></tr
><tr
id=sl_svn102_3946

><td class="source">			target-&gt;drainMana(attacker, manaLoss);<br></td></tr
><tr
id=sl_svn102_3947
...
><td class="source">			ss &lt;&lt; manaLoss;<br></td></tr
><tr
id=sl_svn102_3950
...
><td class="source">void Game::addCreatureHealth(const Creature* target)<br></td></tr
><tr
id=sl_svn102_3958
...
><td class="source">	const SpectatorVec&amp; list = getSpectators(target-&gt;getPosition());<br></td></tr
><tr
id=sl_svn102_3960
...
><td class="source">void Game::addCreatureHealth(const SpectatorVec&amp; list, const Creature* target)<br></td></tr
><tr
id=sl_svn102_3964
...
><td class="source">			player-&gt;sendCreatureHealth(target);<br></td></tr
><tr
id=sl_svn102_3969
...
><td class="source">void Game::addAnimatedText(const Position&amp; pos, uint8_t textColor,<br></td></tr
><tr
id=sl_svn102_3974
...
><td class="source">	const SpectatorVec&amp; list = getSpectators(pos);<br></td></tr
><tr
id=sl_svn102_3977
...
><td class="source">	addAnimatedText(list, pos, textColor, text);<br></td></tr
><tr
id=sl_svn102_3979
...
><td class="source">void Game::addAnimatedText(const SpectatorVec&amp; list, const Position&amp; pos, uint8_t textColor,<br></td></tr
><tr
id=sl_svn102_3982
...
><td class="source">			player-&gt;sendAnimatedText(pos, textColor, text);<br></td></tr
><tr
id=sl_svn102_3988
...
><td class="source">void Game::addMagicEffect(const Position&amp; pos, uint8_t effect)<br></td></tr
><tr
id=sl_svn102_3993
...
><td class="source">	addMagicEffect(list, pos, effect);<br></td></tr
><tr
id=sl_svn102_3997
...
><td class="source">void Game::addMagicEffect(const SpectatorVec&amp; list, const Position&amp; pos, uint8_t effect)<br></td></tr
><tr
id=sl_svn102_4000
...
><td class="source">			player-&gt;sendMagicEffect(pos, effect);<br></td></tr
><tr
id=sl_svn102_4005
...
><td class="source">void Game::addDistanceEffect(const Position&amp; fromPos, const Position&amp; toPos,<br></td></tr
><tr
id=sl_svn102_4010
...
><td class="source">	getSpectators(list, fromPos, false);<br></td></tr
><tr
id=sl_svn102_4014

><td class="source">	getSpectators(list, toPos, true);<br></td></tr
><tr
id=sl_svn102_4015
...
><td class="source">			tmpPlayer-&gt;sendDistanceShoot(fromPos, toPos, effect);<br></td></tr
><tr
id=sl_svn102_4021
...
><td class="source">void Game::updateCreatureSkull(Player* player)<br></td></tr
><tr
id=sl_svn102_4027
...
><td class="source">	const SpectatorVec&amp; list = getSpectators(player-&gt;getPosition());<br></td></tr
><tr
id=sl_svn102_4029
...
><td class="source">			tmpPlayer-&gt;sendCreatureSkull(player);<br></td></tr
><tr
id=sl_svn102_4035
...
><td class="source">void Game::startDecay(Item* item)<br></td></tr
><tr
id=sl_svn102_4042
...
><td class="source">	if(item &amp;&amp; item-&gt;canDecay()){<br></td></tr
><tr
id=sl_svn102_4044

><td class="source">		uint32_t decayState = item-&gt;getDecaying();<br></td></tr
><tr
id=sl_svn102_4045

><td class="source">		if(decayState == DECAYING_TRUE){<br></td></tr
><tr
id=sl_svn102_4046

><td class="source">			//already decaying<br></td></tr
><tr
id=sl_svn102_4047
...
><td class="source">		int32_t dur = item-&gt;getDuration();<br></td></tr
><tr
id=sl_svn102_4051

><td class="source">		if(dur &gt; 0){<br></td></tr
><tr
id=sl_svn102_4052

><td class="source">			item-&gt;useThing2();<br></td></tr
><tr
id=sl_svn102_4053

><td class="source">			item-&gt;setDecaying(DECAYING_TRUE);<br></td></tr
><tr
id=sl_svn102_4054

><td class="source">			toDecayItems.push_back(item);<br></td></tr
><tr
id=sl_svn102_4055
...
><td class="source">			internalDecayItem(item);<br></td></tr
><tr
id=sl_svn102_4058
...
><td class="source">void Game::internalDecayItem(Item* item)<br></td></tr
><tr
id=sl_svn102_4063
...
><td class="source">	if(it.decayTo != 0){<br></td></tr
><tr
id=sl_svn102_4067

><td class="source">		Item* newItem = transformItem(item, it.decayTo);<br></td></tr
><tr
id=sl_svn102_4068

><td class="source">		startDecay(newItem);<br></td></tr
><tr
id=sl_svn102_4069
...
><td class="source">			std::cout &lt;&lt; &quot;DEBUG, internalDecayItem failed, error code: &quot; &lt;&lt; (int) ret &lt;&lt; &quot;item id: &quot; &lt;&lt; item-&gt;getID() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_4075
...
><td class="source">void Game::checkDecay()<br></td></tr
><tr
id=sl_svn102_4080
...
><td class="source">	size_t bucket = (last_bucket + 1) % EVENT_DECAY_BUCKETS;<br></td></tr
><tr
id=sl_svn102_4085
...
><td class="source">	for(DecayList::iterator it = decayItems[bucket].begin(); it != decayItems[bucket].end();){<br></td></tr
><tr
id=sl_svn102_4087
...
><td class="source">		int32_t decreaseTime = EVENT_DECAYINTERVAL*EVENT_DECAY_BUCKETS;<br></td></tr
><tr
id=sl_svn102_4089

><td class="source">		if(item-&gt;getDuration() - decreaseTime &lt; 0){<br></td></tr
><tr
id=sl_svn102_4090

><td class="source">			decreaseTime = item-&gt;getDuration();<br></td></tr
><tr
id=sl_svn102_4091
...
><td class="source">		item-&gt;decreaseDuration(decreaseTime);<br></td></tr
><tr
id=sl_svn102_4093

><td class="source">		//std::cout &lt;&lt; &quot;checkDecay: &quot; &lt;&lt; item &lt;&lt; &quot;, id:&quot; &lt;&lt; item-&gt;getID() &lt;&lt; &quot;, name: &quot; &lt;&lt; item-&gt;getName() &lt;&lt; &quot;, duration: &quot; &lt;&lt; item-&gt;getDuration() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_4094
...
><td class="source">		if(!item-&gt;canDecay()){<br></td></tr
><tr
id=sl_svn102_4096

><td class="source">			item-&gt;setDecaying(DECAYING_FALSE);<br></td></tr
><tr
id=sl_svn102_4097
...
><td class="source">			it = decayItems[bucket].erase(it);<br></td></tr
><tr
id=sl_svn102_4099
...
><td class="source">		else if(dur &lt; EVENT_DECAYINTERVAL*EVENT_DECAY_BUCKETS)<br></td></tr
><tr
id=sl_svn102_4110
...
><td class="source">			size_t new_bucket = (bucket + ((dur + EVENT_DECAYINTERVAL/2) / 1000)) % EVENT_DECAY_BUCKETS;<br></td></tr
><tr
id=sl_svn102_4113

><td class="source">			if(new_bucket == bucket) {<br></td></tr
><tr
id=sl_svn102_4114
...
><td class="source">				decayItems[new_bucket].push_back(item);<br></td></tr
><tr
id=sl_svn102_4118
...
><td class="source">	last_bucket = bucket;<br></td></tr
><tr
id=sl_svn102_4126
...
><td class="source">void Game::checkLight()<br></td></tr
><tr
id=sl_svn102_4131
...
><td class="source">	light_hour = light_hour + light_hour_delta;<br></td></tr
><tr
id=sl_svn102_4136

><td class="source">	if(light_hour &gt; 1440)<br></td></tr
><tr
id=sl_svn102_4137

><td class="source">		light_hour = light_hour - 1440;<br></td></tr
><tr
id=sl_svn102_4138
...
><td class="source">	if(std::abs(light_hour - SUNRISE) &lt; 2*light_hour_delta){<br></td></tr
><tr
id=sl_svn102_4140

><td class="source">		light_state = LIGHT_STATE_SUNRISE;<br></td></tr
><tr
id=sl_svn102_4141
...
><td class="source">	else if(std::abs(light_hour - SUNSET) &lt; 2*light_hour_delta){<br></td></tr
><tr
id=sl_svn102_4143

><td class="source">		light_state = LIGHT_STATE_SUNSET;<br></td></tr
><tr
id=sl_svn102_4144
...
><td class="source">	int newlightlevel = lightlevel;<br></td></tr
><tr
id=sl_svn102_4147

><td class="source">	bool lightChange = false;<br></td></tr
><tr
id=sl_svn102_4148

><td class="source">	switch(light_state){<br></td></tr
><tr
id=sl_svn102_4149

><td class="source">	case LIGHT_STATE_SUNRISE:<br></td></tr
><tr
id=sl_svn102_4150

><td class="source">		newlightlevel += (LIGHT_LEVEL_DAY - LIGHT_LEVEL_NIGHT)/30;<br></td></tr
><tr
id=sl_svn102_4151

><td class="source">		lightChange = true;<br></td></tr
><tr
id=sl_svn102_4152
...
><td class="source">	case LIGHT_STATE_SUNSET:<br></td></tr
><tr
id=sl_svn102_4154
...
><td class="source">	if(newlightlevel &lt;= LIGHT_LEVEL_NIGHT){<br></td></tr
><tr
id=sl_svn102_4162
...
><td class="source">	else if(newlightlevel &gt;= LIGHT_LEVEL_DAY){<br></td></tr
><tr
id=sl_svn102_4166
...
><td class="source">		lightlevel = newlightlevel;<br></td></tr
><tr
id=sl_svn102_4171
...
><td class="source">	if(lightChange){<br></td></tr
><tr
id=sl_svn102_4174
...
><td class="source">		getWorldLightInfo(lightInfo);<br></td></tr
><tr
id=sl_svn102_4176
...
><td class="source">			(*it).second-&gt;sendWorldLight(lightInfo);<br></td></tr
><tr
id=sl_svn102_4178
...
><td class="source">void Game::getWorldLightInfo(LightInfo&amp; lightInfo)<br></td></tr
><tr
id=sl_svn102_4183
...
><td class="source">	lightInfo.level = lightlevel;<br></td></tr
><tr
id=sl_svn102_4185

><td class="source">	lightInfo.color = 0xD7;<br></td></tr
><tr
id=sl_svn102_4186
...
><td class="source">bool Game::cancelRuleViolation(Player* player)<br></td></tr
><tr
id=sl_svn102_4189
...
><td class="source">	Player* gamemaster = it-&gt;second-&gt;gamemaster;<br></td></tr
><tr
id=sl_svn102_4196

><td class="source">	if(!it-&gt;second-&gt;isOpen &amp;&amp; gamemaster){<br></td></tr
><tr
id=sl_svn102_4197

><td class="source">		// Send to the responder<br></td></tr
><tr
id=sl_svn102_4198

><td class="source">		gamemaster-&gt;sendRuleViolationCancel(player-&gt;getName());<br></td></tr
><tr
id=sl_svn102_4199
...
><td class="source">		// Send to channel<br></td></tr
><tr
id=sl_svn102_4202
...
><td class="source">			for(UsersMap::const_iterator ut = channel-&gt;getUsers().begin();<br></td></tr
><tr
id=sl_svn102_4205

><td class="source">				ut != channel-&gt;getUsers().end(); ++ut)<br></td></tr
><tr
id=sl_svn102_4206
...
><td class="source">				if(ut-&gt;second){<br></td></tr
><tr
id=sl_svn102_4208

><td class="source">					ut-&gt;second-&gt;sendRemoveReport(player-&gt;getName());<br></td></tr
><tr
id=sl_svn102_4209
...
><td class="source">	// Now erase it<br></td></tr
><tr
id=sl_svn102_4215

><td class="source">	ruleViolations.erase(it);<br></td></tr
><tr
id=sl_svn102_4216
...
><td class="source">bool Game::closeRuleViolation(Player* player)<br></td></tr
><tr
id=sl_svn102_4220
...
><td class="source">	player-&gt;sendLockRuleViolation();<br></td></tr
><tr
id=sl_svn102_4228
...
><td class="source">void Game::addCommandTag(std::string tag)<br></td></tr
><tr
id=sl_svn102_4244
...
><td class="source">	bool found = false;<br></td></tr
><tr
id=sl_svn102_4246
...
><td class="source">		if(commandTags[i] == tag){<br></td></tr
><tr
id=sl_svn102_4248
...
><td class="source">		commandTags.push_back(tag);<br></td></tr
><tr
id=sl_svn102_4255
...
><td class="source">void Game::resetCommandTag()<br></td></tr
><tr
id=sl_svn102_4259
...
><td class="source">	commandTags.clear();<br></td></tr
><tr
id=sl_svn102_4261
...
><td class="source">void Game::shutdown()<br></td></tr
><tr
id=sl_svn102_4264
...
><td class="source">	std::cout &lt;&lt; &quot;Shutting down server...&quot;;<br></td></tr
><tr
id=sl_svn102_4266
...
><td class="source">	Scheduler::getScheduler().shutdown();<br></td></tr
><tr
id=sl_svn102_4268

><td class="source">	Dispatcher::getDispatcher().shutdown();<br></td></tr
><tr
id=sl_svn102_4269

><td class="source">	Spawns::getInstance()-&gt;clear();<br></td></tr
><tr
id=sl_svn102_4270
...
><td class="source">	if(g_server){<br></td></tr
><tr
id=sl_svn102_4275

><td class="source">		g_server-&gt;stop();<br></td></tr
><tr
id=sl_svn102_4276
...
><td class="source">void Game::cleanup()<br></td></tr
><tr
id=sl_svn102_4281
...
><td class="source">	//free memory<br></td></tr
><tr
id=sl_svn102_4283

><td class="source">	for(std::vector&lt;Thing*&gt;::iterator it = ToReleaseThings.begin(); it != ToReleaseThings.end(); ++it){<br></td></tr
><tr
id=sl_svn102_4284

><td class="source">		(*it)-&gt;releaseThing2();<br></td></tr
><tr
id=sl_svn102_4285
...
><td class="source">	ToReleaseThings.clear();<br></td></tr
><tr
id=sl_svn102_4288
...
><td class="source">	for(DecayList::iterator it = toDecayItems.begin(); it != toDecayItems.end(); ++it){<br></td></tr
><tr
id=sl_svn102_4290

><td class="source">		int32_t dur = (*it)-&gt;getDuration();<br></td></tr
><tr
id=sl_svn102_4291

><td class="source">		if(dur &gt;= EVENT_DECAYINTERVAL * EVENT_DECAY_BUCKETS) {<br></td></tr
><tr
id=sl_svn102_4292

><td class="source">			decayItems[last_bucket].push_back(*it);<br></td></tr
><tr
id=sl_svn102_4293
...
><td class="source">			decayItems[(last_bucket + 1 + (*it)-&gt;getDuration() / 1000) % EVENT_DECAY_BUCKETS].push_back(*it);<br></td></tr
><tr
id=sl_svn102_4295
...
><td class="source">	toDecayItems.clear();<br></td></tr
><tr
id=sl_svn102_4299
...
><td class="source">void Game::FreeThing(Thing* thing)<br></td></tr
><tr
id=sl_svn102_4302
...
><td class="source">	//std::cout &lt;&lt; &quot;freeThing() &quot; &lt;&lt; thing &lt;&lt;std::endl;<br></td></tr
><tr
id=sl_svn102_4304

><td class="source">	ToReleaseThings.push_back(thing);<br></td></tr
><tr
id=sl_svn102_4305
...
><td class="source">void Game::checkPlayersRecord()<br></td></tr
><tr
id=sl_svn102_4309
...
><td class="source">	if(getPlayersOnline() &gt; lastPlayersRecord){<br></td></tr
><tr
id=sl_svn102_4311
...
><td class="source">		lastPlayersRecord = getPlayersOnline();<br></td></tr
><tr
id=sl_svn102_4315

><td class="source">		query &lt;&lt; &quot;UPDATE `server_record` SET `record` = &quot; &lt;&lt; lastPlayersRecord &lt;&lt; &quot;;&quot;;<br></td></tr
><tr
id=sl_svn102_4316

><td class="source">		db-&gt;executeQuery(query.str());<br></td></tr
><tr
id=sl_svn102_4317
...
><td class="source">		char buffer[50];<br></td></tr
><tr
id=sl_svn102_4320

><td class="source">		sprintf(buffer, &quot;New record of players online is: %d&quot;, lastPlayersRecord);<br></td></tr
><tr
id=sl_svn102_4321
...
><td class="source">            (*it).second-&gt;sendTextMessage(MSG_EVENT_ADVANCE, buffer);<br></td></tr
><tr
id=sl_svn102_4324
...
><td class="source">void Game::loadPlayersRecord()<br></td></tr
><tr
id=sl_svn102_4330
...
><td class="source">	if(!(result = db-&gt;storeQuery(&quot;SELECT `record` FROM `server_record`&quot;))){<br></td></tr
><tr
id=sl_svn102_4335

><td class="source">		std::cout &lt;&lt; &quot;&gt; ERROR: Failed to load online record!&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_4336
...
><td class="source">	lastPlayersRecord = result-&gt;getDataInt(&quot;record&quot;);<br></td></tr
><tr
id=sl_svn102_4340
...
><td class="source">void Game::doDeathDelay(Creature* creature)<br></td></tr
><tr
id=sl_svn102_4345
...
><td class="source">    if (!creature || creature-&gt;isRemoved())<br></td></tr
><tr
id=sl_svn102_4347
...
><td class="source">    creature-&gt;onDie();<br></td></tr
><tr
id=sl_svn102_4350

><td class="source">    removeCreature(creature, false);<br></td></tr
><tr
id=sl_svn102_4351
...
><td class="source">bool Game::bugReport(uint32_t playerId, std::string report)<br></td></tr
><tr
id=sl_svn102_4354
...
><td class="source">    if(report == &quot; &quot; || report == &quot;&quot;){<br></td></tr
><tr
id=sl_svn102_4360

><td class="source">        player-&gt;sendTextMessage(MSG_STATUS_CONSOLE_BLUE, &quot;Please enter a text you want to send.&quot;);<br></td></tr
><tr
id=sl_svn102_4361
...
><td class="source">    std::string filename;<br></td></tr
><tr
id=sl_svn102_4365

><td class="source">    filename = g_config.getString(ConfigManager::DATA_DIRECTORY) + &quot;reports/&quot; + player-&gt;getName() + &quot;.txt&quot;;<br></td></tr
><tr
id=sl_svn102_4366

><td class="source">    std::ofstream reportFile(filename.c_str(),std::ios::app);<br></td></tr
><tr
id=sl_svn102_4367

><td class="source">    reportFile &lt;&lt; &quot;------------------------------------------------------\n&quot;;<br></td></tr
><tr
id=sl_svn102_4368

><td class="source">    reportFile &lt;&lt; &quot;Name: &quot; &lt;&lt; player-&gt;getName() &lt;&lt; &quot; - Level: &quot; &lt;&lt; player-&gt;getLevel() &lt;&lt; &quot; - Access: &quot; &lt;&lt; player-&gt;getAccessLevel() &lt;&lt; &quot;\n&quot;;<br></td></tr
><tr
id=sl_svn102_4369

><td class="source">    reportFile &lt;&lt; &quot;Position: &quot; &lt;&lt; player-&gt;getPosition().x &lt;&lt; &quot; &quot; &lt;&lt; player-&gt;getPosition().y &lt;&lt; &quot; &quot; &lt;&lt; player-&gt;getPosition().z &lt;&lt; &quot; - Skull: &quot; &lt;&lt; player-&gt;getSkull() &lt;&lt; &quot;\n&quot;;<br></td></tr
><tr
id=sl_svn102_4370

><td class="source">    reportFile &lt;&lt; &quot;Report: &quot; &lt;&lt; report &lt;&lt; &quot;\n&quot;;<br></td></tr
><tr
id=sl_svn102_4371
...
><td class="source">    reportFile.close();<br></td></tr
><tr
id=sl_svn102_4373
...
><td class="source">    player-&gt;sendTextMessage(MSG_STATUS_CONSOLE_RED, &quot;Your report has been sent.&quot;);<br></td></tr
><tr
id=sl_svn102_4375
...
><td class="source">bool Game::violationWindow(uint32_t playerId, std::string name, uint8_t reason, std::string comment, uint8_t action, bool IPBanishment)<br></td></tr
><tr
id=sl_svn102_4379
...
><td class="source">	bool playerExists = IOPlayer::instance()-&gt;playerExists(name);<br></td></tr
><tr
id=sl_svn102_4386

><td class="source">	if (!playerExists) {<br></td></tr
><tr
id=sl_svn102_4387
...
><td class="source">	Account account;<br></td></tr
><tr
id=sl_svn102_4392

><td class="source">	uint32_t guid, ip;<br></td></tr
><tr
id=sl_svn102_4393

><td class="source">	Player* targetPlayer = getPlayerByName(name);<br></td></tr
><tr
id=sl_svn102_4394

><td class="source">	if (targetPlayer) {<br></td></tr
><tr
id=sl_svn102_4395

><td class="source">		if (targetPlayer-&gt;hasFlag(PlayerFlag_CannotBeBanned)) {<br></td></tr
><tr
id=sl_svn102_4396

><td class="source">			player-&gt;sendCancel(&quot;You do not have authorization for this action.&quot;);<br></td></tr
><tr
id=sl_svn102_4397
...
><td class="source">		account = IOAccount::instance()-&gt;loadAccount(targetPlayer-&gt;getAccount());<br></td></tr
><tr
id=sl_svn102_4401

><td class="source">		guid = targetPlayer-&gt;getGUID();<br></td></tr
><tr
id=sl_svn102_4402

><td class="source">		ip = targetPlayer-&gt;lastip;<br></td></tr
><tr
id=sl_svn102_4403
...
><td class="source">		if (IOPlayer::instance()-&gt;hasFlag(name, PlayerFlag_CannotBeBanned)) {<br></td></tr
><tr
id=sl_svn102_4406
...
><td class="source">		account = IOAccount::instance()-&gt;loadAccount(IOPlayer::instance()-&gt;getAccountIdByName(name));<br></td></tr
><tr
id=sl_svn102_4411

><td class="source">		ip = IOPlayer::instance()-&gt;getLastIP(name);<br></td></tr
><tr
id=sl_svn102_4412
...
><td class="source">	if (IOPlayer::instance()-&gt;getAccessByName(name) &gt;= (uint32_t)player-&gt;getAccessLevel()) {<br></td></tr
><tr
id=sl_svn102_4415
...
><td class="source">	std::string banReason;<br></td></tr
><tr
id=sl_svn102_4420
...
><td class="source">	switch(reason)<br></td></tr
><tr
id=sl_svn102_4422
...
><td class="source">			banReason = &quot;offensive name&quot;;<br></td></tr
><tr
id=sl_svn102_4425
...
><td class="source">			banReason = &quot;name containing part of sentence&quot;;<br></td></tr
><tr
id=sl_svn102_4428
...
><td class="source">			banReason = &quot;name with nonsensical letter combo&quot;;<br></td></tr
><tr
id=sl_svn102_4431
...
><td class="source">			banReason = &quot;invalid name format&quot;;<br></td></tr
><tr
id=sl_svn102_4434
...
><td class="source">			banReason = &quot;name not describing person&quot;;<br></td></tr
><tr
id=sl_svn102_4437
...
><td class="source">		case 5:<br></td></tr
><tr
id=sl_svn102_4439

><td class="source">			banReason = &quot;name of celebrity&quot;;<br></td></tr
><tr
id=sl_svn102_4440
...
><td class="source">		case 6:<br></td></tr
><tr
id=sl_svn102_4442

><td class="source">			banReason = &quot;name referring to country&quot;;<br></td></tr
><tr
id=sl_svn102_4443
...
><td class="source">		case 7:<br></td></tr
><tr
id=sl_svn102_4445

><td class="source">			banReason = &quot;namefaking player identity&quot;;<br></td></tr
><tr
id=sl_svn102_4446
...
><td class="source">		case 8:<br></td></tr
><tr
id=sl_svn102_4448

><td class="source">			banReason = &quot;namefaking official position&quot;;<br></td></tr
><tr
id=sl_svn102_4449
...
><td class="source">		case 9:<br></td></tr
><tr
id=sl_svn102_4451

><td class="source">			banReason = &quot;offensive statement&quot;;<br></td></tr
><tr
id=sl_svn102_4452
...
><td class="source">			banReason = &quot;spamming&quot;;<br></td></tr
><tr
id=sl_svn102_4455
...
><td class="source">			banReason = &quot;advertisement not related to game&quot;;<br></td></tr
><tr
id=sl_svn102_4458
...
><td class="source">			banReason = &quot;real money advertisement&quot;;<br></td></tr
><tr
id=sl_svn102_4461
...
><td class="source">		case 13:<br></td></tr
><tr
id=sl_svn102_4463

><td class="source">			banReason = &quot;Non-English public statement&quot;;<br></td></tr
><tr
id=sl_svn102_4464
...
><td class="source">		case 14:<br></td></tr
><tr
id=sl_svn102_4466

><td class="source">			banReason = &quot;off-topic public statement&quot;;<br></td></tr
><tr
id=sl_svn102_4467
...
><td class="source">		case 15:<br></td></tr
><tr
id=sl_svn102_4469

><td class="source">			banReason = &quot;inciting rule violation&quot;;<br></td></tr
><tr
id=sl_svn102_4470
...
><td class="source">	    case 16:<br></td></tr
><tr
id=sl_svn102_4472

><td class="source">			banReason = &quot;bug abuse&quot;;<br></td></tr
><tr
id=sl_svn102_4473
...
><td class="source">		case 17:<br></td></tr
><tr
id=sl_svn102_4475

><td class="source">			banReason = &quot;game weakness abuse&quot;;<br></td></tr
><tr
id=sl_svn102_4476
...
><td class="source">		case 18:<br></td></tr
><tr
id=sl_svn102_4478

><td class="source">			banReason = &quot;using macro&quot;;<br></td></tr
><tr
id=sl_svn102_4479
...
><td class="source">		case 19:<br></td></tr
><tr
id=sl_svn102_4481

><td class="source">			banReason = &quot;using unofficial software to play&quot;;<br></td></tr
><tr
id=sl_svn102_4482
...
><td class="source">		case 20:<br></td></tr
><tr
id=sl_svn102_4484

><td class="source">			banReason = &quot;hacking&quot;;<br></td></tr
><tr
id=sl_svn102_4485
...
><td class="source">			banReason = &quot;multi-clienting&quot;;<br></td></tr
><tr
id=sl_svn102_4488
...
><td class="source">		case 22:<br></td></tr
><tr
id=sl_svn102_4490

><td class="source">			banReason = &quot;account trading&quot;;<br></td></tr
><tr
id=sl_svn102_4491
...
><td class="source">		case 23:<br></td></tr
><tr
id=sl_svn102_4493

><td class="source">			banReason = &quot;account sharing&quot;;<br></td></tr
><tr
id=sl_svn102_4494
...
><td class="source">		case 24:<br></td></tr
><tr
id=sl_svn102_4496

><td class="source">			banReason = &quot;threatening gamemaster&quot;;<br></td></tr
><tr
id=sl_svn102_4497
...
><td class="source">		case 25:<br></td></tr
><tr
id=sl_svn102_4499

><td class="source">			banReason = &quot;pretending to have official position&quot;;<br></td></tr
><tr
id=sl_svn102_4500
...
><td class="source">		case 26:<br></td></tr
><tr
id=sl_svn102_4502

><td class="source">			banReason = &quot;pretending to have influence on gamemaster&quot;;<br></td></tr
><tr
id=sl_svn102_4503
...
><td class="source">		case 27:<br></td></tr
><tr
id=sl_svn102_4505

><td class="source">			banReason = &quot;false report to gamemaster&quot;;<br></td></tr
><tr
id=sl_svn102_4506
...
><td class="source">		case 28:<br></td></tr
><tr
id=sl_svn102_4508

><td class="source">			banReason = &quot;excessive unjustifed player killing&quot;;<br></td></tr
><tr
id=sl_svn102_4509
...
><td class="source">		case 29:<br></td></tr
><tr
id=sl_svn102_4511

><td class="source">			banReason = &quot;destructive behaviour&quot;;<br></td></tr
><tr
id=sl_svn102_4512
...
><td class="source">		case 30:<br></td></tr
><tr
id=sl_svn102_4514

><td class="source">			banReason = &quot;spoiling auction&quot;;<br></td></tr
><tr
id=sl_svn102_4515
...
><td class="source">		case 31:<br></td></tr
><tr
id=sl_svn102_4517

><td class="source">			banReason = &quot;invalid payment&quot;;<br></td></tr
><tr
id=sl_svn102_4518
...
><td class="source">			banReason = &quot;nothing&quot;;<br></td></tr
><tr
id=sl_svn102_4521
...
><td class="source">	bool notation = false;<br></td></tr
><tr
id=sl_svn102_4525

><td class="source">	switch(action)<br></td></tr
><tr
id=sl_svn102_4526
...
><td class="source">		// Notation<br></td></tr
><tr
id=sl_svn102_4528
...
><td class="source">			g_bans.addNotation(name, player-&gt;getGUID(), banReason, comment);<br></td></tr
><tr
id=sl_svn102_4531

><td class="source">			if (g_bans.getNotationsCount(account.accnumber &gt;= (uint32_t)g_config.getNumber(ConfigManager::NOTATIONS_TO_BAN))) {<br></td></tr
><tr
id=sl_svn102_4532

><td class="source">				account.warnings++;<br></td></tr
><tr
id=sl_svn102_4533

><td class="source">				if (account.warnings &gt;= (g_config.getNumber(ConfigManager::WARNINGS_TO_DELETION))) {<br></td></tr
><tr
id=sl_svn102_4534

><td class="source">					g_bans.addDeletion(name, player-&gt;getGUID(), banReason, comment);<br></td></tr
><tr
id=sl_svn102_4535
...
><td class="source">				else if(account.warnings &gt;= g_config.getNumber(ConfigManager::WARNINGS_TO_FINALBAN)) {<br></td></tr
><tr
id=sl_svn102_4537

><td class="source">					g_bans.addBanishment(name, (std::time(NULL) + g_config.getNumber(ConfigManager::FINALBAN_LENGTH)), player-&gt;getGUID(), banReason, comment);<br></td></tr
><tr
id=sl_svn102_4538
...
><td class="source">					g_bans.addBanishment(name, (std::time(NULL) + g_config.getNumber(ConfigManager::BAN_LENGTH)), player-&gt;getGUID(), banReason, comment);<br></td></tr
><tr
id=sl_svn102_4541
...
><td class="source">				notation = true;<br></td></tr
><tr
id=sl_svn102_4545
...
><td class="source">		// Namelock<br></td></tr
><tr
id=sl_svn102_4549
...
><td class="source">			g_bans.addNamelock(name, player-&gt;getGUID(), banReason, comment);<br></td></tr
><tr
id=sl_svn102_4552
...
><td class="source">		// AccountBan<br></td></tr
><tr
id=sl_svn102_4555
...
><td class="source">				if(account.warnings &gt;= g_config.getNumber(ConfigManager::WARNINGS_TO_FINALBAN)) {<br></td></tr
><tr
id=sl_svn102_4563
...
><td class="source">		// Namelock/AccountBan<br></td></tr
><tr
id=sl_svn102_4572
...
><td class="source">		// AccountBan + Final Warning<br></td></tr
><tr
id=sl_svn102_4591
...
><td class="source">				account.warnings = g_config.getNumber(ConfigManager::WARNINGS_TO_DELETION);<br></td></tr
><tr
id=sl_svn102_4595
...
><td class="source">		// Namelock/AccountBan + Final Warning<br></td></tr
><tr
id=sl_svn102_4603
...
><td class="source">	if(IPBanishment &amp;&amp; ip &gt; 0) {<br></td></tr
><tr
id=sl_svn102_4634

><td class="source">		g_bans.addIpBanishment(ip, (std::time(NULL) + g_config.getNumber(ConfigManager::IPBANISHMENT_LENGTH)), player-&gt;getGUID(), banReason, comment);<br></td></tr
><tr
id=sl_svn102_4635
...
><td class="source">	if(targetPlayer &amp;&amp; !notation){<br></td></tr
><tr
id=sl_svn102_4638

><td class="source">		addMagicEffect(targetPlayer-&gt;getPosition(), NM_ME_MAGIC_POISON);<br></td></tr
><tr
id=sl_svn102_4639

><td class="source">		Scheduler::getScheduler().addEvent(createSchedulerTask(1000, boost::bind(&amp;Player::kickPlayer, targetPlayer)));<br></td></tr
><tr
id=sl_svn102_4640
...
><td class="source">	IOAccount::instance()-&gt;saveAccount(account);<br></td></tr
><tr
id=sl_svn102_4643
...
><td class="source">void Game::reloadInfo(ReloadTypes_t info)<br></td></tr
><tr
id=sl_svn102_4647
...
><td class="source">	switch(info){<br></td></tr
><tr
id=sl_svn102_4649

><td class="source">		case RELOAD_TYPE_ACTIONS:<br></td></tr
><tr
id=sl_svn102_4650
...
><td class="source">		case RELOAD_TYPE_MONSTERS:<br></td></tr
><tr
id=sl_svn102_4653
...
><td class="source">		case RELOAD_TYPE_NPCS:<br></td></tr
><tr
id=sl_svn102_4656
...
><td class="source">		case RELOAD_TYPE_CONFIG:<br></td></tr
><tr
id=sl_svn102_4659
...
><td class="source">		case RELOAD_TYPE_TALKACTIONS:<br></td></tr
><tr
id=sl_svn102_4662
...
><td class="source">		case RELOAD_TYPE_MOVEMENTS:<br></td></tr
><tr
id=sl_svn102_4665
...
><td class="source">		case RELOAD_TYPE_SPELLS:<br></td></tr
><tr
id=sl_svn102_4668
...
><td class="source">		case RELOAD_TYPE_RAIDS:<br></td></tr
><tr
id=sl_svn102_4672
...
><td class="source">		case RELOAD_TYPE_CREATURESCRIPTS:<br></td></tr
><tr
id=sl_svn102_4676
...
><td class="source">		case RELOAD_TYPE_ITEMS:<br></td></tr
><tr
id=sl_svn102_4679
...
><td class="source">		case RELOAD_TYPE_GLOBALEVENTS:<br></td></tr
><tr
id=sl_svn102_4682
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 29, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=97&amp;format=side&amp;path=/trunk/src/game.cpp&amp;old_path=/trunk/src/game.cpp&amp;old=95">Diff</a>
 </div>
 <pre>more fixes</pre>
 </div>
 ...
 var selected_path = '/trunk/src/game.cpp';
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/game.cpp&amp;old_path=/trunk/src/game.cpp&amp;old=92">Diff</a>
 <br>
...
don't recommend using this revision</pre>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/avesta74/source/detail?spec=svn102&r=92">r92</a>
 by r...@ymail.com
 on Sep 15, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=92&amp;format=side&amp;path=/trunk/src/game.cpp&amp;old_path=/trunk/src/game.cpp&amp;old=91">Diff</a>
 <br>
 <pre class="ifOpened">*fix for 76/77 where certain items
have different top order
*fix for 77 where players tried
logging with client that doesnt
support encryption</pre>
 </div>
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/game.cpp&amp;old_path=/trunk/src/game.cpp&amp;old=81">Diff</a>
 <br>
 <pre class="ifOpened">compilation fix and some minor changes</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/game.cpp&start=97">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 126299 bytes,
 4685 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/game.cpp">View raw file</a></div>
 </div>
