...
<head>
 ...
 var codesite_token = "ABZ6GAdc94ql7_uBsl7f7kdXK4VjGf_OJQ:1406096624607";
 
 
 var CS_env = {"projectHomeUrl": "/p/avesta74", "token": "ABZ6GAdc94ql7_uBsl7f7kdXK4VjGf_OJQ:1406096624607", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fotserv.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>otserv.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/otserv.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/otserv.cpp?r=52" title="Previous">&lsaquo;r52</a></li>
...
><td class="source">// otserv main. The only place where things get instantiated.<br></td></tr
><tr
id=sl_svn102_5
...
><td class="source">#include &lt;boost/asio.hpp&gt;<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">#if !defined(__WINDOWS__)<br></td></tr
><tr
id=sl_svn102_39

><td class="source">    #include &lt;unistd.h&gt; // for access()<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">    #define OTSERV_ACCESS(file,mode) access(file,mode)<br></td></tr
><tr
id=sl_svn102_44
...
><td class="source">    #define OTSERV_ACCESS(file,mode) _access(file,mode)<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">#include &quot;scriptmanager.h&quot;<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">#ifdef __PROTOCOL_77__<br></td></tr
><tr
id=sl_svn102_60

><td class="source">#include &quot;rsa.h&quot;<br></td></tr
><tr
id=sl_svn102_61

><td class="source">#endif // __PROTOCOL_77__<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">#ifdef __OTSERV_ALLOCATOR__<br></td></tr
><tr
id=sl_svn102_64

><td class="source">#include &quot;allocator.h&quot;<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	#include &lt;exception&gt;<br></td></tr
><tr
id=sl_svn102_69

><td class="source">	void boost::throw_exception(std::exception const &amp; e){<br></td></tr
><tr
id=sl_svn102_70

><td class="source">		std::cout &lt;&lt; &quot;Boost exception: &quot; &lt;&lt; e.what() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">IPList serverIPs;<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">ConfigManager g_config;<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">Game g_game;<br></td></tr
><tr
id=sl_svn102_79
...
><td class="source">Npcs g_npcs;<br></td></tr
><tr
id=sl_svn102_81

><td class="source">Monsters g_monsters;<br></td></tr
><tr
id=sl_svn102_82

><td class="source">BanManager g_bans;<br></td></tr
><tr
id=sl_svn102_83

><td class="source">Vocations g_vocations;<br></td></tr
><tr
id=sl_svn102_84

><td class="source">Server* g_server = NULL;<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">RSA* g_otservRSA = NULL;<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">boost::mutex g_loaderLock;<br></td></tr
><tr
id=sl_svn102_90

><td class="source">boost::condition_variable g_loaderSignal;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">boost::unique_lock&lt;boost::mutex&gt; g_loaderUniqueLock(g_loaderLock);<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">#include &quot;networkmessage.h&quot;<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">time_t start_time;<br></td></tr
><tr
id=sl_svn102_100
...
><td class="source">void ErrorMessage(const char* message) {<br></td></tr
><tr
id=sl_svn102_103

><td class="source">	std::cout &lt;&lt; std::endl &lt;&lt; std::endl &lt;&lt; &quot;Error: &quot; &lt;&lt; message &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	std::string s;<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	std::cin &gt;&gt; s;<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">void ErrorMessage(std::string m){<br></td></tr
><tr
id=sl_svn102_110

><td class="source">	ErrorMessage(m.c_str());<br></td></tr
><tr
id=sl_svn102_111
...
><td class="source">struct CommandLineOptions{<br></td></tr
><tr
id=sl_svn102_114

><td class="source">	std::string configfile;<br></td></tr
><tr
id=sl_svn102_115

><td class="source">	bool truncate_log;<br></td></tr
><tr
id=sl_svn102_116

><td class="source">	std::string logfile;<br></td></tr
><tr
id=sl_svn102_117

><td class="source">	std::string errfile;<br></td></tr
><tr
id=sl_svn102_118

><td class="source">	std::string runfile;<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">CommandLineOptions g_command_opts;<br></td></tr
><tr
id=sl_svn102_122
...
><td class="source">bool parseCommandLine(CommandLineOptions&amp; opts, std::vector&lt;std::string&gt; args);<br></td></tr
><tr
id=sl_svn102_124

><td class="source">void mainLoader(const CommandLineOptions&amp; command_opts);<br></td></tr
><tr
id=sl_svn102_125
...
><td class="source">// Runfile, for running OT as daemon in the background. If the server is shutdown by internal<br></td></tr
><tr
id=sl_svn102_128

><td class="source">// means, we need to clear the file to notify the daemon manager of our change in status.<br></td></tr
><tr
id=sl_svn102_129

><td class="source">// Note that if the server crashes, this will not happend. :|<br></td></tr
><tr
id=sl_svn102_130

><td class="source">void closeRunfile(void)<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">	std::ofstream runfile(g_command_opts.runfile.c_str(), std::ios::trunc | std::ios::out);<br></td></tr
><tr
id=sl_svn102_133

><td class="source">	runfile.close(); // Truncate file<br></td></tr
><tr
id=sl_svn102_134
...
><td class="source">	if(parseCommandLine(g_command_opts, std::vector&lt;std::string&gt;(argv, argv + argc)) == false){<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">	if(g_command_opts.runfile != &quot;&quot;){<br></td></tr
><tr
id=sl_svn102_145

><td class="source">		std::ofstream f(g_command_opts.runfile.c_str(), std::ios::trunc | std::ios::out);<br></td></tr
><tr
id=sl_svn102_146

><td class="source">		f &lt;&lt; getpid();<br></td></tr
><tr
id=sl_svn102_147
...
><td class="source">		atexit(closeRunfile);<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">	boost::shared_ptr&lt;std::ofstream&gt; logfile;<br></td></tr
><tr
id=sl_svn102_153

><td class="source">	boost::shared_ptr&lt;std::ofstream&gt; errfile;<br></td></tr
><tr
id=sl_svn102_154

><td class="source">	if(g_command_opts.logfile != &quot;&quot;){<br></td></tr
><tr
id=sl_svn102_155

><td class="source">		logfile.reset(new std::ofstream(g_command_opts.logfile.c_str(),<br></td></tr
><tr
id=sl_svn102_156

><td class="source">			(g_command_opts.truncate_log? std::ios::trunc : std::ios::app) | std::ios::out)<br></td></tr
><tr
id=sl_svn102_157
...
><td class="source">		if(!logfile-&gt;is_open()){<br></td></tr
><tr
id=sl_svn102_159

><td class="source">			ErrorMessage(&quot;Could not open standard log file for writing!&quot;);<br></td></tr
><tr
id=sl_svn102_160
...
><td class="source">		std::cout.rdbuf(logfile-&gt;rdbuf());<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">	if(g_command_opts.errfile != &quot;&quot;){<br></td></tr
><tr
id=sl_svn102_164

><td class="source">		errfile.reset(new std::ofstream(g_command_opts.errfile.c_str(),<br></td></tr
><tr
id=sl_svn102_165
...
><td class="source">		if(!errfile-&gt;is_open()){<br></td></tr
><tr
id=sl_svn102_168

><td class="source">			ErrorMessage(&quot;Could not open error log file for writing!&quot;);<br></td></tr
><tr
id=sl_svn102_169
...
><td class="source">		std::cerr.rdbuf(errfile-&gt;rdbuf());<br></td></tr
><tr
id=sl_svn102_171
...
><td class="source">	// TODO: find something better than this hack. :|<br></td></tr
><tr
id=sl_svn102_175

><td class="source">	time(&amp;start_time);<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">#ifdef __OTSERV_ALLOCATOR_STATS__<br></td></tr
><tr
id=sl_svn102_179

><td class="source">	boost::thread(boost::bind(&amp;allocatorStatsThread, (void*)NULL));<br></td></tr
><tr
id=sl_svn102_180
...
><td class="source">	ExceptionHandler mainExceptionHandler;<br></td></tr
><tr
id=sl_svn102_184

><td class="source">	mainExceptionHandler.InstallHandler();<br></td></tr
><tr
id=sl_svn102_185
...
><td class="source">	std::cout &lt;&lt; &quot;:: &quot; OTSERV_NAME &quot; Version &quot; OTSERV_VERSION &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_188

><td class="source">	std::cout &lt;&lt; &quot;:: Compilation date: &quot; __DATE__ &quot; &quot; __TIME__ &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_189
...
><td class="source">#if defined __DEBUG__MOVESYS__ || defined __DEBUG_HOUSES__ || defined __DEBUG_MAILBOX__ \<br></td></tr
><tr
id=sl_svn102_193

><td class="source">	|| defined __DEBUG_LUASCRIPTS__ || defined __DEBUG_RAID__ || defined __DEBUG_NET__ \<br></td></tr
><tr
id=sl_svn102_194

><td class="source">    || defined __DEBUG_SQL__<br></td></tr
><tr
id=sl_svn102_195
...
><td class="source">	std::cout &lt;&lt; &quot;:: Debugging:&quot;;<br></td></tr
><tr
id=sl_svn102_197
...
><td class="source">	std::cout &lt;&lt; &quot; MOVESYS&quot;;<br></td></tr
><tr
id=sl_svn102_199
...
><td class="source">	#ifdef __DEBUG_MAILBOX__<br></td></tr
><tr
id=sl_svn102_201

><td class="source">	std::cout &lt;&lt; &quot; MAILBOX&quot;;<br></td></tr
><tr
id=sl_svn102_202
...
><td class="source">	std::cout &lt;&lt; &quot; HOUSES&quot;;<br></td></tr
><tr
id=sl_svn102_205
...
><td class="source">	std::cout &lt;&lt; &quot; LUA-SCRIPTS&quot;;<br></td></tr
><tr
id=sl_svn102_208
...
><td class="source">	#ifdef __DEBUG_RAID__<br></td></tr
><tr
id=sl_svn102_210

><td class="source">	std::cout &lt;&lt; &quot; RAIDS&quot;;<br></td></tr
><tr
id=sl_svn102_211
...
><td class="source">	#ifdef __DEBUG_NET__<br></td></tr
><tr
id=sl_svn102_213

><td class="source">	std::cout &lt;&lt; &quot; NET-ASIO&quot;;<br></td></tr
><tr
id=sl_svn102_214
...
><td class="source">	std::cout &lt;&lt; &quot; SQL&quot;;<br></td></tr
><tr
id=sl_svn102_217
...
><td class="source">#if !defined(WIN32) &amp;&amp; !defined(__ROOT_PERMISSION__)<br></td></tr
><tr
id=sl_svn102_222

><td class="source">	if( getuid() == 0 || geteuid() == 0 ){<br></td></tr
><tr
id=sl_svn102_223

><td class="source">		std::cout &lt;&lt; std::endl &lt;&lt; &quot;OTServ executed as root user, please login with a normal user.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_224
...
><td class="source">#if defined __WINDOWS__ || defined WIN32<br></td></tr
><tr
id=sl_svn102_230

><td class="source">	//nothing yet<br></td></tr
><tr
id=sl_svn102_231
...
><td class="source">	// ignore sigpipe...<br></td></tr
><tr
id=sl_svn102_233

><td class="source">	struct sigaction sigh;<br></td></tr
><tr
id=sl_svn102_234

><td class="source">	sigh.sa_handler = SIG_IGN;<br></td></tr
><tr
id=sl_svn102_235

><td class="source">	sigh.sa_flags = 0;<br></td></tr
><tr
id=sl_svn102_236

><td class="source">	sigemptyset(&amp;sigh.sa_mask);<br></td></tr
><tr
id=sl_svn102_237

><td class="source">	sigaction(SIGPIPE, &amp;sigh, NULL);<br></td></tr
><tr
id=sl_svn102_238
...
><td class="source">    Dispatcher::getDispatcher().addTask(createTask(boost::bind(mainLoader, g_command_opts)));<br></td></tr
><tr
id=sl_svn102_241
...
><td class="source">    g_loaderSignal.wait(g_loaderUniqueLock);<br></td></tr
><tr
id=sl_svn102_243
...
><td class="source">    int port = g_config.getNumber(ConfigManager::PORT);<br></td></tr
><tr
id=sl_svn102_245
...
><td class="source">	Server server(INADDR_ANY, port);<br></td></tr
><tr
id=sl_svn102_247

><td class="source">	std::cout &lt;&lt; &quot;[done]&quot; &lt;&lt; std::endl &lt;&lt; &quot;:: OpenTibia Server Running...&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_248

><td class="source">	g_server = &amp;server;<br></td></tr
><tr
id=sl_svn102_249

><td class="source">	server.run();<br></td></tr
><tr
id=sl_svn102_250
...
><td class="source">    mainExceptionHandler.RemoveHandler();<br></td></tr
><tr
id=sl_svn102_253
...
><td class="source">	std::vector&lt;std::string&gt;::iterator argi = args.begin();<br></td></tr
><tr
id=sl_svn102_259

><td class="source">	opts.truncate_log = false;<br></td></tr
><tr
id=sl_svn102_260
...
><td class="source">	if(argi != args.end()){<br></td></tr
><tr
id=sl_svn102_262

><td class="source">		++argi;<br></td></tr
><tr
id=sl_svn102_263
...
><td class="source">	while(argi != args.end()){<br></td></tr
><tr
id=sl_svn102_266

><td class="source">		std::string arg = *argi;<br></td></tr
><tr
id=sl_svn102_267

><td class="source">		if(arg == &quot;-p&quot; || arg == &quot;--port&quot;){<br></td></tr
><tr
id=sl_svn102_268
...
><td class="source">				std::cout &lt;&lt; &quot;Missing parameter for &#39;&quot; &lt;&lt; arg &lt;&lt; &quot;&#39;&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_270
...
><td class="source">			g_config.setNumber(ConfigManager::PORT, atoi(argi-&gt;c_str()));<br></td></tr
><tr
id=sl_svn102_273
...
><td class="source">		else if(arg == &quot;-r&quot; || arg == &quot;--runfile&quot;){<br></td></tr
><tr
id=sl_svn102_275
...
><td class="source">			opts.runfile = *argi;<br></td></tr
><tr
id=sl_svn102_280
...
><td class="source">		else if(arg == &quot;-i&quot; || arg == &quot;--ip&quot;){<br></td></tr
><tr
id=sl_svn102_282
...
><td class="source">			g_config.setString(ConfigManager::IP, *argi);<br></td></tr
><tr
id=sl_svn102_287
...
><td class="source">		else if(arg == &quot;-c&quot; || arg == &quot;--config&quot;){<br></td></tr
><tr
id=sl_svn102_289
...
><td class="source">			opts.configfile = *argi;<br></td></tr
><tr
id=sl_svn102_294
...
><td class="source">		else if(arg == &quot;--truncate-log&quot;){<br></td></tr
><tr
id=sl_svn102_296

><td class="source">			opts.truncate_log = true;<br></td></tr
><tr
id=sl_svn102_297
...
><td class="source">		else if(arg == &quot;-l&quot; || arg == &quot;--log-file&quot;){<br></td></tr
><tr
id=sl_svn102_299
...
><td class="source">				std::cout &lt;&lt; &quot;Missing parameter 1 for &#39;&quot; &lt;&lt; arg &lt;&lt; &quot;&#39;&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_301
...
><td class="source">			opts.logfile = *argi;<br></td></tr
><tr
id=sl_svn102_304
...
><td class="source">				std::cout &lt;&lt; &quot;Missing parameter 2 for &#39;&quot; &lt;&lt; arg &lt;&lt; &quot;&#39;&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_306
...
><td class="source">			opts.errfile = *argi;<br></td></tr
><tr
id=sl_svn102_309
...
><td class="source">		else if(arg == &quot;--help&quot;){ <br></td></tr
><tr
id=sl_svn102_311

><td class="source">			std::cout &lt;&lt; <br></td></tr
><tr
id=sl_svn102_312

><td class="source">			&quot;Usage: otserv {-i|-p|-c|-r|-l}\n&quot; <br></td></tr
><tr
id=sl_svn102_313
...
><td class="source">			&quot;\t-i, --ip $1\t\tIP of gameworld server. Should be equal to the \n&quot; <br></td></tr
><tr
id=sl_svn102_315

><td class="source">			&quot;\t\t\t\tglobal IP.\n&quot; <br></td></tr
><tr
id=sl_svn102_316

><td class="source">			&quot;\t-p, --port $1\t\tPort for server to listen on.\n&quot; <br></td></tr
><tr
id=sl_svn102_317

><td class="source">			&quot;\t-c, --config $1\t\tAlternate config file path.\n&quot; <br></td></tr
><tr
id=sl_svn102_318

><td class="source">			&quot;\t-l, --log-file $1 $2\tAll standard output will be logged to the $1\n&quot;<br></td></tr
><tr
id=sl_svn102_319

><td class="source">			&quot;\t\t\t\tfile, all errors will be logged to $2.\n&quot;<br></td></tr
><tr
id=sl_svn102_320
...
><td class="source">			&quot;\t-r, --run-file $1\tSpecifies a runfile. Will contain the pid\n&quot;<br></td></tr
><tr
id=sl_svn102_322

><td class="source">			&quot;\t\t\t\tof the server process as long as it is running \n\t\t\t\t(UNIX).\n&quot;<br></td></tr
><tr
id=sl_svn102_323
...
><td class="source">			&quot;\t--truncate-log\t\tReset log file each time the server is \n&quot; <br></td></tr
><tr
id=sl_svn102_325

><td class="source">			&quot;\t\t\t\tstarted.\n&quot;; <br></td></tr
><tr
id=sl_svn102_326
...
><td class="source">			std::cout &lt;&lt; &quot;Unrecognized command line argument &#39;&quot; &lt;&lt; arg &lt;&lt; &quot;&#39;\n&quot;<br></td></tr
><tr
id=sl_svn102_330
...
><td class="source">	//dispatcher thread<br></td></tr
><tr
id=sl_svn102_341

><td class="source">	g_game.setGameState(GAME_STATE_STARTUP);<br></td></tr
><tr
id=sl_svn102_342
...
><td class="source">	// random numbers generator<br></td></tr
><tr
id=sl_svn102_344

><td class="source">	std::cout &lt;&lt; &quot;:: Initializing the random numbers... &quot; &lt;&lt; std::flush;<br></td></tr
><tr
id=sl_svn102_345

><td class="source">	srand((unsigned int)OTSYS_TIME());<br></td></tr
><tr
id=sl_svn102_346
...
><td class="source">#if defined LUA_CONFIGFILE<br></td></tr
><tr
id=sl_svn102_349

><td class="source">	const char* configname = LUA_CONFIGFILE;<br></td></tr
><tr
id=sl_svn102_350

><td class="source">#elif defined __LUA_NAME_ALTER__<br></td></tr
><tr
id=sl_svn102_351

><td class="source">	const char* configname = &quot;otserv.lua&quot;;<br></td></tr
><tr
id=sl_svn102_352
...
><td class="source">	const char* configname = &quot;config.lua&quot;;<br></td></tr
><tr
id=sl_svn102_354
...
><td class="source">	if(command_opts.configfile != &quot;&quot;){<br></td></tr
><tr
id=sl_svn102_357

><td class="source">		configname = command_opts.configfile.c_str();<br></td></tr
><tr
id=sl_svn102_358
...
><td class="source">	// read global config<br></td></tr
><tr
id=sl_svn102_361

><td class="source">	std::cout &lt;&lt; &quot;:: Loading lua script &quot; &lt;&lt; configname &lt;&lt; &quot;... &quot; &lt;&lt; std::flush;<br></td></tr
><tr
id=sl_svn102_362
...
><td class="source">#ifdef SYSCONFDIR<br></td></tr
><tr
id=sl_svn102_364

><td class="source">	std::string sysconfpath;<br></td></tr
><tr
id=sl_svn102_365

><td class="source">	sysconfpath = SYSCONFDIR;<br></td></tr
><tr
id=sl_svn102_366

><td class="source">	sysconfpath += &quot;/otserv/&quot;;<br></td></tr
><tr
id=sl_svn102_367

><td class="source">	sysconfpath += configname;<br></td></tr
><tr
id=sl_svn102_368
...
><td class="source">#if !defined(WIN32) &amp;&amp; !defined(__NO_HOMEDIR_CONF__)<br></td></tr
><tr
id=sl_svn102_371
...
><td class="source">	configpath = getenv(&quot;HOME&quot;);<br></td></tr
><tr
id=sl_svn102_373

><td class="source">	configpath += &quot;/.otserv/&quot;;<br></td></tr
><tr
id=sl_svn102_374

><td class="source">	configpath += configname;<br></td></tr
><tr
id=sl_svn102_375
...
><td class="source">	if (!g_config.loadFile(configname) &amp;&amp; !g_config.loadFile(configpath) &amp;&amp; !g_config.loadFile(sysconfpath))<br></td></tr
><tr
id=sl_svn102_377
...
><td class="source">	if (!g_config.loadFile(configname) &amp;&amp; !g_config.loadFile(configpath))<br></td></tr
><tr
id=sl_svn102_379
...
><td class="source">	if (!g_config.loadFile(configname) &amp;&amp; !g_config.loadFile(sysconfpath))<br></td></tr
><tr
id=sl_svn102_383
...
><td class="source">	if (!g_config.loadFile(configname))<br></td></tr
><tr
id=sl_svn102_385
...
><td class="source">		std::ostringstream os;<br></td></tr
><tr
id=sl_svn102_389
...
><td class="source">		os &lt;&lt; &quot;Unable to load &quot; &lt;&lt; configname &lt;&lt; &quot; or &quot; &lt;&lt; configpath;<br></td></tr
><tr
id=sl_svn102_391
...
><td class="source">		os &lt;&lt; &quot;Unable to load &quot; &lt;&lt; configname;<br></td></tr
><tr
id=sl_svn102_393
...
><td class="source">		ErrorMessage(os.str());<br></td></tr
><tr
id=sl_svn102_395
...
><td class="source">#if defined(PKGDATADIR) &amp;&amp; !defined(__WINDOWS__) // i dont care enough to port this to win32, prolly not needed<br></td></tr
><tr
id=sl_svn102_400

><td class="source">    // let&#39;s fix the datadir, if necessary...<br></td></tr
><tr
id=sl_svn102_401

><td class="source">    if (access(g_config.getString(ConfigManager::DATA_DIRECTORY).c_str(), F_OK)) { // check if datadir exists<br></td></tr
><tr
id=sl_svn102_402

><td class="source">        // if not then try replacing it with &quot;global&quot; datadir<br></td></tr
><tr
id=sl_svn102_403

><td class="source">        std::cout &lt;&lt; &quot;:: No datadir &#39;&quot; &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY).c_str() &lt;&lt; &quot;&#39;, using a system-wide one&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_404
...
><td class="source">        std::string dd = PKGDATADIR;<br></td></tr
><tr
id=sl_svn102_406

><td class="source">        dd += &quot;/&quot;;<br></td></tr
><tr
id=sl_svn102_407

><td class="source">        dd += g_config.getString(ConfigManager::DATA_DIRECTORY);<br></td></tr
><tr
id=sl_svn102_408

><td class="source">        g_config.setString(ConfigManager::DATA_DIRECTORY, dd);<br></td></tr
><tr
id=sl_svn102_409
...
><td class="source">	if (access(g_config.getString(ConfigManager::DATA_DIRECTORY).c_str(), F_OK)) { // check if this new one exists<br></td></tr
><tr
id=sl_svn102_411

><td class="source">		// if not lets try using the &quot;raw&quot; datadir<br></td></tr
><tr
id=sl_svn102_412

><td class="source">		// (without configmanager&#39;s datadir var)<br></td></tr
><tr
id=sl_svn102_413
...
><td class="source">		dd = PKGDATADIR;<br></td></tr
><tr
id=sl_svn102_415
...
><td class="source">    std::cout &lt;&lt; &quot;:: Using data directory &quot; &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY).c_str() &lt;&lt; &quot;... &quot; &lt;&lt; std::flush;<br></td></tr
><tr
id=sl_svn102_422

><td class="source">	/* Won&#39;t compile! access is not standard<br></td></tr
><tr
id=sl_svn102_423
...
><td class="source">        ErrorMessage(&quot;Data directory does not exist!&quot;);<br></td></tr
><tr
id=sl_svn102_425
...
><td class="source">	std::cout &lt;&lt; &quot;:: Checking Database Connection... &quot;;<br></td></tr
><tr
id=sl_svn102_431
...
><td class="source">	if(db == NULL || !db-&gt;isConnected())<br></td></tr
><tr
id=sl_svn102_433
...
><td class="source">		ErrorMessage(&quot;Database Connection Failed!&quot;);<br></td></tr
><tr
id=sl_svn102_435
...
><td class="source">	std::stringstream filename;<br></td></tr
><tr
id=sl_svn102_440
...
><td class="source">	//load RSA key<br></td></tr
><tr
id=sl_svn102_444

><td class="source">	std::cout &lt;&lt; &quot;:: Loading RSA key...&quot; &lt;&lt; std::flush;<br></td></tr
><tr
id=sl_svn102_445

><td class="source">	const char* p(&quot;14299623962416399520070177382898895550795403345466153217470516082934737582776038882967213386204600674145392845853859217990626450972452084065728686565928113&quot;);<br></td></tr
><tr
id=sl_svn102_446

><td class="source">	const char* q(&quot;7630979195970404721891201847792002125535401292779123937207447574596692788513647179235335529307251350570728407373705564708871762033017096809910315212884101&quot;);<br></td></tr
><tr
id=sl_svn102_447

><td class="source">	const char* d(&quot;&quot;);<br></td></tr
><tr
id=sl_svn102_448

><td class="source">	g_otservRSA = new RSA();<br></td></tr
><tr
id=sl_svn102_449

><td class="source">	g_otservRSA-&gt;setKey(p, q, d);<br></td></tr
><tr
id=sl_svn102_450
...
><td class="source">	//load vocations<br></td></tr
><tr
id=sl_svn102_455

><td class="source">	filename.str(&quot;&quot;);<br></td></tr
><tr
id=sl_svn102_456

><td class="source">	filename &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY) &lt;&lt; &quot;vocations.xml&quot;;<br></td></tr
><tr
id=sl_svn102_457

><td class="source">	std::cout &lt;&lt; &quot;:: Loading &quot; &lt;&lt; filename.str() &lt;&lt; &quot;... &quot; &lt;&lt; std::flush;<br></td></tr
><tr
id=sl_svn102_458

><td class="source">	if(!g_vocations.loadFromXml(g_config.getString(ConfigManager::DATA_DIRECTORY))){<br></td></tr
><tr
id=sl_svn102_459

><td class="source">		ErrorMessage(&quot;Unable to load vocations!&quot;);<br></td></tr
><tr
id=sl_svn102_460
...
><td class="source">	//load commands<br></td></tr
><tr
id=sl_svn102_465
...
><td class="source">	filename &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY) &lt;&lt; &quot;commands.xml&quot;;<br></td></tr
><tr
id=sl_svn102_467
...
><td class="source">	if(!commands.loadXml(g_config.getString(ConfigManager::DATA_DIRECTORY))){<br></td></tr
><tr
id=sl_svn102_469

><td class="source">		std::stringstream errormsg;<br></td></tr
><tr
id=sl_svn102_470

><td class="source">		errormsg &lt;&lt; &quot;Unable to load &quot; &lt;&lt; filename.str() &lt;&lt; &quot;!&quot;;<br></td></tr
><tr
id=sl_svn102_471

><td class="source">		ErrorMessage(errormsg.str().c_str());<br></td></tr
><tr
id=sl_svn102_472
...
><td class="source">	// load item data<br></td></tr
><tr
id=sl_svn102_477
...
><td class="source">	filename &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY) &lt;&lt; &quot;items/items.otb&quot;;<br></td></tr
><tr
id=sl_svn102_479
...
><td class="source">	if(Item::items.loadFromOtb(filename.str())){<br></td></tr
><tr
id=sl_svn102_481
...
><td class="source">	filename &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY) &lt;&lt; &quot;items/items.xml&quot;;<br></td></tr
><tr
id=sl_svn102_490
...
><td class="source">	if(!Item::items.loadFromXml(g_config.getString(ConfigManager::DATA_DIRECTORY))){<br></td></tr
><tr
id=sl_svn102_492
...
><td class="source">	//load scripts<br></td></tr
><tr
id=sl_svn102_500

><td class="source">	if(ScriptingManager::getInstance()-&gt;loadScriptSystems() == false){<br></td></tr
><tr
id=sl_svn102_501
...
><td class="source">	// load monster data<br></td></tr
><tr
id=sl_svn102_505
...
><td class="source">	filename &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY) &lt;&lt; &quot;monsters/monsters.xml&quot;;<br></td></tr
><tr
id=sl_svn102_507
...
><td class="source">	if(!g_monsters.loadFromXml(g_config.getString(ConfigManager::DATA_DIRECTORY))){<br></td></tr
><tr
id=sl_svn102_509
...
><td class="source">	std::string worldType = g_config.getString(ConfigManager::WORLD_TYPE);<br></td></tr
><tr
id=sl_svn102_517
...
><td class="source">	if(asLowerCaseString(worldType) == &quot;pvp&quot;)<br></td></tr
><tr
id=sl_svn102_519

><td class="source">		g_game.setWorldType(WORLD_TYPE_PVP);<br></td></tr
><tr
id=sl_svn102_520

><td class="source">	else if(asLowerCaseString(worldType) == &quot;no-pvp&quot;)<br></td></tr
><tr
id=sl_svn102_521

><td class="source">		g_game.setWorldType(WORLD_TYPE_NO_PVP);<br></td></tr
><tr
id=sl_svn102_522

><td class="source">	else if(asLowerCaseString(worldType) == &quot;pvp-enforced&quot;)<br></td></tr
><tr
id=sl_svn102_523

><td class="source">		g_game.setWorldType(WORLD_TYPE_PVP_ENFORCED);<br></td></tr
><tr
id=sl_svn102_524
...
><td class="source">		ErrorMessage(&quot;Unknown world type!&quot;);<br></td></tr
><tr
id=sl_svn102_526
...
><td class="source">	std::cout &lt;&lt; &quot;:: Worldtype: &quot; &lt;&lt; asUpperCaseString(worldType) &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_530
...
><td class="source">	std::cout &lt;&lt; &quot;:: Skulls enabled&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_533
...
><td class="source">	std::string passwordType = g_config.getString(ConfigManager::PASSWORD_TYPE_STR);<br></td></tr
><tr
id=sl_svn102_536

><td class="source">	if(passwordType.empty() || asLowerCaseString(passwordType) == &quot;plain&quot;){<br></td></tr
><tr
id=sl_svn102_537

><td class="source">		g_config.setNumber(ConfigManager::PASSWORD_TYPE, PASSWORD_TYPE_PLAIN);<br></td></tr
><tr
id=sl_svn102_538

><td class="source">		std::cout &lt;&lt; &quot;:: Use plain passwords&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_539
...
><td class="source">	else if(asLowerCaseString(passwordType) == &quot;md5&quot;){<br></td></tr
><tr
id=sl_svn102_541

><td class="source">		g_config.setNumber(ConfigManager::PASSWORD_TYPE, PASSWORD_TYPE_MD5);<br></td></tr
><tr
id=sl_svn102_542

><td class="source">		std::cout &lt;&lt; &quot;:: Use MD5 passwords&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_543
...
><td class="source">	else if(asLowerCaseString(passwordType) == &quot;sha1&quot;){<br></td></tr
><tr
id=sl_svn102_545

><td class="source">		g_config.setNumber(ConfigManager::PASSWORD_TYPE, PASSWORD_TYPE_SHA1);<br></td></tr
><tr
id=sl_svn102_546

><td class="source">		std::cout &lt;&lt; &quot;:: Use SHA1 passwords&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_547
...
><td class="source">		ErrorMessage(&quot;Unknown password type!&quot;);<br></td></tr
><tr
id=sl_svn102_550
...
><td class="source">    if(!g_game.loadMap(g_config.getString(ConfigManager::MAP_FILE),<br></td></tr
><tr
id=sl_svn102_554

><td class="source">    	g_config.getString(ConfigManager::MAP_KIND)))<br></td></tr
><tr
id=sl_svn102_555
...
><td class="source">        // ok ... so we didn&#39;t succeed in laoding the map.<br></td></tr
><tr
id=sl_svn102_557

><td class="source">        // perhaps the path to map didn&#39;t include path to data directory?<br></td></tr
><tr
id=sl_svn102_558

><td class="source">        // let&#39;s try to prepend path to datadir before bailing out miserably.<br></td></tr
><tr
id=sl_svn102_559
...
><td class="source">        filename &lt;&lt; g_config.getString(ConfigManager::DATA_DIRECTORY) &lt;&lt; g_config.getString(ConfigManager::MAP_FILE);<br></td></tr
><tr
id=sl_svn102_561
...
><td class="source">        if(!g_game.loadMap(filename.str(),<br></td></tr
><tr
id=sl_svn102_563
...
><td class="source">				ErrorMessage(&quot;Couldn&#39;t load map&quot;);<br></td></tr
><tr
id=sl_svn102_566
...
><td class="source">	g_game.setGameState(GAME_STATE_INIT);<br></td></tr
><tr
id=sl_svn102_571

><td class="source">	g_game.loadPlayersRecord();<br></td></tr
><tr
id=sl_svn102_572
...
><td class="source">	std::pair&lt;uint32_t, uint32_t&gt; IpNetMask;<br></td></tr
><tr
id=sl_svn102_574

><td class="source">	IpNetMask.first  = inet_addr(&quot;127.0.0.1&quot;);<br></td></tr
><tr
id=sl_svn102_575

><td class="source">	IpNetMask.second = 0xFFFFFFFF;<br></td></tr
><tr
id=sl_svn102_576

><td class="source">	serverIPs.push_back(IpNetMask);<br></td></tr
><tr
id=sl_svn102_577
...
><td class="source">	char szHostName[128];<br></td></tr
><tr
id=sl_svn102_579

><td class="source">	if(gethostname(szHostName, 128) == 0){<br></td></tr
><tr
id=sl_svn102_580

><td class="source">		std::cout &lt;&lt; &quot;::&quot; &lt;&lt; std::endl &lt;&lt; &quot;:: Running on host &quot; &lt;&lt; szHostName &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_581
...
><td class="source">		hostent *he = gethostbyname(szHostName);<br></td></tr
><tr
id=sl_svn102_583
...
><td class="source">		if(he){<br></td></tr
><tr
id=sl_svn102_585

><td class="source">			std::cout &lt;&lt; &quot;:: Local IP address(es):  &quot;;<br></td></tr
><tr
id=sl_svn102_586

><td class="source">			unsigned char** addr = (unsigned char**)he-&gt;h_addr_list;<br></td></tr
><tr
id=sl_svn102_587
...
><td class="source">			while (addr[0] != NULL){<br></td></tr
><tr
id=sl_svn102_589

><td class="source">				std::cout &lt;&lt; (unsigned int)(addr[0][0]) &lt;&lt; &quot;.&quot;<br></td></tr
><tr
id=sl_svn102_590

><td class="source">				&lt;&lt; (unsigned int)(addr[0][1]) &lt;&lt; &quot;.&quot;<br></td></tr
><tr
id=sl_svn102_591

><td class="source">				&lt;&lt; (unsigned int)(addr[0][2]) &lt;&lt; &quot;.&quot;<br></td></tr
><tr
id=sl_svn102_592

><td class="source">				&lt;&lt; (unsigned int)(addr[0][3]) &lt;&lt; &quot;  &quot;;<br></td></tr
><tr
id=sl_svn102_593
...
><td class="source">				IpNetMask.first  = *(uint32_t*)(*addr);<br></td></tr
><tr
id=sl_svn102_595

><td class="source">				IpNetMask.second = 0x0000FFFF;<br></td></tr
><tr
id=sl_svn102_596
...
><td class="source">	std::cout &lt;&lt; &quot;:: Local port:            &quot;;<br></td></tr
><tr
id=sl_svn102_606
...
><td class="source">	std::cout &lt;&lt; port &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_608
...
><td class="source">	std::cout &lt;&lt; &quot;:: Global IP address:     &quot;;<br></td></tr
><tr
id=sl_svn102_610

><td class="source">	std::string ip = g_config.getString(ConfigManager::IP);<br></td></tr
><tr
id=sl_svn102_611
...
><td class="source">	uint32_t resolvedIp = inet_addr(ip.c_str());<br></td></tr
><tr
id=sl_svn102_613

><td class="source">	if(resolvedIp == INADDR_NONE){<br></td></tr
><tr
id=sl_svn102_614

><td class="source">		struct hostent* he = gethostbyname(ip.c_str());<br></td></tr
><tr
id=sl_svn102_615

><td class="source">		if(he != 0){<br></td></tr
><tr
id=sl_svn102_616

><td class="source">			resolvedIp = *(uint32_t*)he-&gt;h_addr;<br></td></tr
><tr
id=sl_svn102_617
...
><td class="source">			std::string error_msg = &quot;Can&#39;t resolve: &quot; + ip;<br></td></tr
><tr
id=sl_svn102_620

><td class="source">			ErrorMessage(error_msg.c_str());<br></td></tr
><tr
id=sl_svn102_621
...
><td class="source">	char resolvedIpstr[32];<br></td></tr
><tr
id=sl_svn102_626

><td class="source">	formatIP(resolvedIp, resolvedIpstr);<br></td></tr
><tr
id=sl_svn102_627

><td class="source">	std::cout &lt;&lt; resolvedIpstr &lt;&lt; std::endl &lt;&lt; &quot;::&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_628
...
><td class="source">	IpNetMask.first  = resolvedIp;<br></td></tr
><tr
id=sl_svn102_630

><td class="source">	IpNetMask.second = 0;<br></td></tr
><tr
id=sl_svn102_631
...
><td class="source">	std::cout &lt;&lt; &quot;:: Starting Server... &quot;;<br></td></tr
><tr
id=sl_svn102_633
...
><td class="source">	Status* status = Status::instance();<br></td></tr
><tr
id=sl_svn102_635

><td class="source">	status-&gt;setMaxPlayersOnline(g_config.getNumber(ConfigManager::MAX_PLAYERS));<br></td></tr
><tr
id=sl_svn102_636
...
><td class="source">	g_loaderSignal.notify_all();<br></td></tr
><tr
id=sl_svn102_639
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/otserv.cpp&amp;old_path=/trunk/src/otserv.cpp&amp;old=52">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/otserv.cpp';
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/otserv.cpp&amp;old_path=/trunk/src/otserv.cpp&amp;old=20">Diff</a>
 <br>
 ...
 by RSXQ66
 on Aug 19, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=20&amp;format=side&amp;path=/trunk/src/otserv.cpp&amp;old_path=/trunk/src/otserv.cpp&amp;old=7">Diff</a>
 <br>
...
server for 76 (__76__ def)</pre>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/otserv.cpp&amp;old_path=/trunk/src/otserv.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/otserv.cpp&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 20179 bytes,
 639 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/otserv.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/otserv.cpp'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/avesta74", "token": "ABZ6GAdc94ql7_uBsl7f7kdXK4VjGf_OJQ:1406096624607", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006"}, '', 'svn102', paths,
