...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Foutfit.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>outfit.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/outfit.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/outfit.h?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#ifndef __OTSERV_OUTFIT_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_OUTFIT_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">struct Outfit{<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">typedef std::list&lt;Outfit*&gt; OutfitListType;<br></td></tr
><tr
id=sl_svn102_38
...
><td class="source">class OutfitList<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">	OutfitList();<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	void addOutfit(const Outfit&amp; outfit);<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	bool remOutfit(const Outfit&amp; outfit);<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	const OutfitListType&amp; getOutfits() const {return m_list;}<br></td></tr
><tr
id=sl_svn102_48

><td class="source">	bool isInList(uint32_t looktype, bool playerPremium) const;<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	OutfitListType m_list;<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">class Outfits<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">	~Outfits();<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	static Outfits* getInstance(){<br></td></tr
><tr
id=sl_svn102_60

><td class="source">		static Outfits instance;<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	const OutfitListType&amp; getOutfits(uint32_t type){<br></td></tr
><tr
id=sl_svn102_66

><td class="source">		return getOutfitList(type).getOutfits();<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">	const OutfitList&amp; getOutfitList(uint32_t type){<br></td></tr
><tr
id=sl_svn102_70

><td class="source">		if(type &lt; m_list.size()){<br></td></tr
><tr
id=sl_svn102_71

><td class="source">			return *m_list[type];<br></td></tr
><tr
id=sl_svn102_72
...
><td class="source">			if(type == PLAYERSEX_FEMALE)<br></td></tr
><tr
id=sl_svn102_75

><td class="source">				return m_female_list;<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">				return m_male_list;<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	const std::string&amp; getOutfitName(uint32_t looktype) const{<br></td></tr
><tr
id=sl_svn102_82

><td class="source">		std::map&lt;uint32_t, std::string&gt;::const_iterator it;<br></td></tr
><tr
id=sl_svn102_83

><td class="source">		it = outfitNamesMap.find(looktype);<br></td></tr
><tr
id=sl_svn102_84

><td class="source">		if(it != outfitNamesMap.end()){<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">			static const std::string d = &quot;Outfit&quot;;<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	typedef std::vector&lt;OutfitList*&gt; OutfitsListVector;<br></td></tr
><tr
id=sl_svn102_96

><td class="source">	OutfitsListVector m_list;<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">	std::map&lt;uint32_t, std::string&gt; outfitNamesMap;<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">	OutfitList m_female_list;<br></td></tr
><tr
id=sl_svn102_101

><td class="source">	OutfitList m_male_list;<br></td></tr
><tr
id=sl_svn102_102
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/outfit.h&amp;old_path=/trunk/src/outfit.h&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/outfit.h';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/outfit.h&amp;old_path=/trunk/src/outfit.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/outfit.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/outfit.h">View raw file</a></div>
 </div>
