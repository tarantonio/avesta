...
<head>
 ...
 var codesite_token = "ABZ6GAdkcewFr96t6p2F1m1Ogf4OgS1vNw:1406096592765";
 
 
 var CS_env = {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAdkcewFr96t6p2F1m1Ogf4OgS1vNw:1406096592765", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectHomeUrl": "/p/avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fmd5.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>md5.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/md5.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/md5.cpp?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#include &quot;md5.h&quot;<br></td></tr
><tr
id=sl_svn102_7
...
><td class="source">/* Padding */<br></td></tr
><tr
id=sl_svn102_9

><td class="source">static unsigned char MD5_PADDING[64] = {<br></td></tr
><tr
id=sl_svn102_10

><td class="source">	0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,<br></td></tr
><tr
id=sl_svn102_11

><td class="source">	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,<br></td></tr
><tr
id=sl_svn102_12
...
><td class="source">/* MD5_F, MD5_G and MD5_H are basic MD5 functions: selection, majority, parity */<br></td></tr
><tr
id=sl_svn102_21

><td class="source">#define MD5_F(x, y, z) (((x) &amp; (y)) | ((~x) &amp; (z)))<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define MD5_G(x, y, z) (((x) &amp; (z)) | ((y) &amp; (~z)))<br></td></tr
><tr
id=sl_svn102_23

><td class="source">#define MD5_H(x, y, z) ((x) ^ (y) ^ (z))<br></td></tr
><tr
id=sl_svn102_24

><td class="source">#define MD5_I(x, y, z) ((y) ^ ((x) | (~z)))<br></td></tr
><tr
id=sl_svn102_25
...
><td class="source">/* ROTATE_LEFT rotates x left n bits */<br></td></tr
><tr
id=sl_svn102_27

><td class="source">#ifndef ROTATE_LEFT<br></td></tr
><tr
id=sl_svn102_28

><td class="source">#define ROTATE_LEFT(x, n) ((((x) &lt;&lt; (n)) &amp; 0xffffffffU) | ((x) &gt;&gt; (32-(n))))<br></td></tr
><tr
id=sl_svn102_29
...
><td class="source">/* MD5_FF, MD5_GG, MD5_HH, and MD5_II transformations for rounds 1, 2, 3, and 4 */<br></td></tr
><tr
id=sl_svn102_32

><td class="source">/* Rotation is separate from addition to prevent recomputation */<br></td></tr
><tr
id=sl_svn102_33

><td class="source">#define MD5_FF(a, b, c, d, x, s, ac) {(a) += MD5_F ((b), (c), (d)) + (x) + (UINT4)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }<br></td></tr
><tr
id=sl_svn102_34

><td class="source">#define MD5_GG(a, b, c, d, x, s, ac) {(a) += MD5_G ((b), (c), (d)) + (x) + (UINT4)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }<br></td></tr
><tr
id=sl_svn102_35

><td class="source">#define MD5_HH(a, b, c, d, x, s, ac) {(a) += MD5_H ((b), (c), (d)) + (x) + (UINT4)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }<br></td></tr
><tr
id=sl_svn102_36

><td class="source">#define MD5_II(a, b, c, d, x, s, ac) {(a) += MD5_I ((b), (c), (d)) + (x) + (UINT4)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">/* Constants for transformation */<br></td></tr
><tr
id=sl_svn102_39

><td class="source">#define MD5_S11 7  /* Round 1 */<br></td></tr
><tr
id=sl_svn102_40

><td class="source">#define MD5_S12 12<br></td></tr
><tr
id=sl_svn102_41

><td class="source">#define MD5_S13 17<br></td></tr
><tr
id=sl_svn102_42

><td class="source">#define MD5_S14 22<br></td></tr
><tr
id=sl_svn102_43

><td class="source">#define MD5_S21 5  /* Round 2 */<br></td></tr
><tr
id=sl_svn102_44

><td class="source">#define MD5_S22 9<br></td></tr
><tr
id=sl_svn102_45

><td class="source">#define MD5_S23 14<br></td></tr
><tr
id=sl_svn102_46

><td class="source">#define MD5_S24 20<br></td></tr
><tr
id=sl_svn102_47

><td class="source">#define MD5_S31 4  /* Round 3 */<br></td></tr
><tr
id=sl_svn102_48

><td class="source">#define MD5_S32 11<br></td></tr
><tr
id=sl_svn102_49

><td class="source">#define MD5_S33 16<br></td></tr
><tr
id=sl_svn102_50

><td class="source">#define MD5_S34 23<br></td></tr
><tr
id=sl_svn102_51

><td class="source">#define MD5_S41 6  /* Round 4 */<br></td></tr
><tr
id=sl_svn102_52

><td class="source">#define MD5_S42 10<br></td></tr
><tr
id=sl_svn102_53

><td class="source">#define MD5_S43 15<br></td></tr
><tr
id=sl_svn102_54

><td class="source">#define MD5_S44 21<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">/* Basic MD5 step. MD5_Transform buf based on in */<br></td></tr
><tr
id=sl_svn102_57

><td class="source">void MD5_Transform (UINT4 *buf, UINT4 *in)<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	UINT4 a = buf[0], b = buf[1], c = buf[2], d = buf[3];<br></td></tr
><tr
id=sl_svn102_60
...
><td class="source">	/* Round 1 */<br></td></tr
><tr
id=sl_svn102_62

><td class="source">	MD5_FF ( a, b, c, d, in[ 0], MD5_S11, (UINT4) 3614090360u); /* 1 */<br></td></tr
><tr
id=sl_svn102_63

><td class="source">	MD5_FF ( d, a, b, c, in[ 1], MD5_S12, (UINT4) 3905402710u); /* 2 */<br></td></tr
><tr
id=sl_svn102_64

><td class="source">	MD5_FF ( c, d, a, b, in[ 2], MD5_S13, (UINT4)  606105819u); /* 3 */<br></td></tr
><tr
id=sl_svn102_65

><td class="source">	MD5_FF ( b, c, d, a, in[ 3], MD5_S14, (UINT4) 3250441966u); /* 4 */<br></td></tr
><tr
id=sl_svn102_66

><td class="source">	MD5_FF ( a, b, c, d, in[ 4], MD5_S11, (UINT4) 4118548399u); /* 5 */<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	MD5_FF ( d, a, b, c, in[ 5], MD5_S12, (UINT4) 1200080426u); /* 6 */<br></td></tr
><tr
id=sl_svn102_68

><td class="source">	MD5_FF ( c, d, a, b, in[ 6], MD5_S13, (UINT4) 2821735955u); /* 7 */<br></td></tr
><tr
id=sl_svn102_69

><td class="source">	MD5_FF ( b, c, d, a, in[ 7], MD5_S14, (UINT4) 4249261313u); /* 8 */<br></td></tr
><tr
id=sl_svn102_70

><td class="source">	MD5_FF ( a, b, c, d, in[ 8], MD5_S11, (UINT4) 1770035416u); /* 9 */<br></td></tr
><tr
id=sl_svn102_71

><td class="source">	MD5_FF ( d, a, b, c, in[ 9], MD5_S12, (UINT4) 2336552879u); /* 10 */<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	MD5_FF ( c, d, a, b, in[10], MD5_S13, (UINT4) 4294925233u); /* 11 */<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	MD5_FF ( b, c, d, a, in[11], MD5_S14, (UINT4) 2304563134u); /* 12 */<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	MD5_FF ( a, b, c, d, in[12], MD5_S11, (UINT4) 1804603682u); /* 13 */<br></td></tr
><tr
id=sl_svn102_75

><td class="source">	MD5_FF ( d, a, b, c, in[13], MD5_S12, (UINT4) 4254626195u); /* 14 */<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	MD5_FF ( c, d, a, b, in[14], MD5_S13, (UINT4) 2792965006u); /* 15 */<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	MD5_FF ( b, c, d, a, in[15], MD5_S14, (UINT4) 1236535329u); /* 16 */<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	/* Round 2 */<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	MD5_GG ( a, b, c, d, in[ 1], MD5_S21, (UINT4) 4129170786u); /* 17 */<br></td></tr
><tr
id=sl_svn102_81

><td class="source">	MD5_GG ( d, a, b, c, in[ 6], MD5_S22, (UINT4) 3225465664u); /* 18 */<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	MD5_GG ( c, d, a, b, in[11], MD5_S23, (UINT4)  643717713u); /* 19 */<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	MD5_GG ( b, c, d, a, in[ 0], MD5_S24, (UINT4) 3921069994u); /* 20 */<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	MD5_GG ( a, b, c, d, in[ 5], MD5_S21, (UINT4) 3593408605u); /* 21 */<br></td></tr
><tr
id=sl_svn102_85

><td class="source">	MD5_GG ( d, a, b, c, in[10], MD5_S22, (UINT4)   38016083u); /* 22 */<br></td></tr
><tr
id=sl_svn102_86

><td class="source">	MD5_GG ( c, d, a, b, in[15], MD5_S23, (UINT4) 3634488961u); /* 23 */<br></td></tr
><tr
id=sl_svn102_87

><td class="source">	MD5_GG ( b, c, d, a, in[ 4], MD5_S24, (UINT4) 3889429448u); /* 24 */<br></td></tr
><tr
id=sl_svn102_88

><td class="source">	MD5_GG ( a, b, c, d, in[ 9], MD5_S21, (UINT4)  568446438u); /* 25 */<br></td></tr
><tr
id=sl_svn102_89

><td class="source">	MD5_GG ( d, a, b, c, in[14], MD5_S22, (UINT4) 3275163606u); /* 26 */<br></td></tr
><tr
id=sl_svn102_90

><td class="source">	MD5_GG ( c, d, a, b, in[ 3], MD5_S23, (UINT4) 4107603335u); /* 27 */<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	MD5_GG ( b, c, d, a, in[ 8], MD5_S24, (UINT4) 1163531501u); /* 28 */<br></td></tr
><tr
id=sl_svn102_92

><td class="source">	MD5_GG ( a, b, c, d, in[13], MD5_S21, (UINT4) 2850285829u); /* 29 */<br></td></tr
><tr
id=sl_svn102_93

><td class="source">	MD5_GG ( d, a, b, c, in[ 2], MD5_S22, (UINT4) 4243563512u); /* 30 */<br></td></tr
><tr
id=sl_svn102_94

><td class="source">	MD5_GG ( c, d, a, b, in[ 7], MD5_S23, (UINT4) 1735328473u); /* 31 */<br></td></tr
><tr
id=sl_svn102_95

><td class="source">	MD5_GG ( b, c, d, a, in[12], MD5_S24, (UINT4) 2368359562u); /* 32 */<br></td></tr
><tr
id=sl_svn102_96
...
><td class="source">	/* Round 3 */<br></td></tr
><tr
id=sl_svn102_98

><td class="source">	MD5_HH ( a, b, c, d, in[ 5], MD5_S31, (UINT4) 4294588738u); /* 33 */<br></td></tr
><tr
id=sl_svn102_99

><td class="source">	MD5_HH ( d, a, b, c, in[ 8], MD5_S32, (UINT4) 2272392833u); /* 34 */<br></td></tr
><tr
id=sl_svn102_100

><td class="source">	MD5_HH ( c, d, a, b, in[11], MD5_S33, (UINT4) 1839030562u); /* 35 */<br></td></tr
><tr
id=sl_svn102_101

><td class="source">	MD5_HH ( b, c, d, a, in[14], MD5_S34, (UINT4) 4259657740u); /* 36 */<br></td></tr
><tr
id=sl_svn102_102

><td class="source">	MD5_HH ( a, b, c, d, in[ 1], MD5_S31, (UINT4) 2763975236u); /* 37 */<br></td></tr
><tr
id=sl_svn102_103

><td class="source">	MD5_HH ( d, a, b, c, in[ 4], MD5_S32, (UINT4) 1272893353u); /* 38 */<br></td></tr
><tr
id=sl_svn102_104

><td class="source">	MD5_HH ( c, d, a, b, in[ 7], MD5_S33, (UINT4) 4139469664u); /* 39 */<br></td></tr
><tr
id=sl_svn102_105

><td class="source">	MD5_HH ( b, c, d, a, in[10], MD5_S34, (UINT4) 3200236656u); /* 40 */<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	MD5_HH ( a, b, c, d, in[13], MD5_S31, (UINT4)  681279174u); /* 41 */<br></td></tr
><tr
id=sl_svn102_107

><td class="source">	MD5_HH ( d, a, b, c, in[ 0], MD5_S32, (UINT4) 3936430074u); /* 42 */<br></td></tr
><tr
id=sl_svn102_108

><td class="source">	MD5_HH ( c, d, a, b, in[ 3], MD5_S33, (UINT4) 3572445317u); /* 43 */<br></td></tr
><tr
id=sl_svn102_109

><td class="source">	MD5_HH ( b, c, d, a, in[ 6], MD5_S34, (UINT4)   76029189u); /* 44 */<br></td></tr
><tr
id=sl_svn102_110

><td class="source">	MD5_HH ( a, b, c, d, in[ 9], MD5_S31, (UINT4) 3654602809u); /* 45 */<br></td></tr
><tr
id=sl_svn102_111

><td class="source">	MD5_HH ( d, a, b, c, in[12], MD5_S32, (UINT4) 3873151461u); /* 46 */<br></td></tr
><tr
id=sl_svn102_112

><td class="source">	MD5_HH ( c, d, a, b, in[15], MD5_S33, (UINT4)  530742520u); /* 47 */<br></td></tr
><tr
id=sl_svn102_113

><td class="source">	MD5_HH ( b, c, d, a, in[ 2], MD5_S34, (UINT4) 3299628645u); /* 48 */<br></td></tr
><tr
id=sl_svn102_114
...
><td class="source">	/* Round 4 */<br></td></tr
><tr
id=sl_svn102_116

><td class="source">	MD5_II ( a, b, c, d, in[ 0], MD5_S41, (UINT4) 4096336452u); /* 49 */<br></td></tr
><tr
id=sl_svn102_117

><td class="source">	MD5_II ( d, a, b, c, in[ 7], MD5_S42, (UINT4) 1126891415u); /* 50 */<br></td></tr
><tr
id=sl_svn102_118

><td class="source">	MD5_II ( c, d, a, b, in[14], MD5_S43, (UINT4) 2878612391u); /* 51 */<br></td></tr
><tr
id=sl_svn102_119

><td class="source">	MD5_II ( b, c, d, a, in[ 5], MD5_S44, (UINT4) 4237533241u); /* 52 */<br></td></tr
><tr
id=sl_svn102_120

><td class="source">	MD5_II ( a, b, c, d, in[12], MD5_S41, (UINT4) 1700485571u); /* 53 */<br></td></tr
><tr
id=sl_svn102_121

><td class="source">	MD5_II ( d, a, b, c, in[ 3], MD5_S42, (UINT4) 2399980690u); /* 54 */<br></td></tr
><tr
id=sl_svn102_122

><td class="source">	MD5_II ( c, d, a, b, in[10], MD5_S43, (UINT4) 4293915773u); /* 55 */<br></td></tr
><tr
id=sl_svn102_123

><td class="source">	MD5_II ( b, c, d, a, in[ 1], MD5_S44, (UINT4) 2240044497u); /* 56 */<br></td></tr
><tr
id=sl_svn102_124

><td class="source">	MD5_II ( a, b, c, d, in[ 8], MD5_S41, (UINT4) 1873313359u); /* 57 */<br></td></tr
><tr
id=sl_svn102_125

><td class="source">	MD5_II ( d, a, b, c, in[15], MD5_S42, (UINT4) 4264355552u); /* 58 */<br></td></tr
><tr
id=sl_svn102_126

><td class="source">	MD5_II ( c, d, a, b, in[ 6], MD5_S43, (UINT4) 2734768916u); /* 59 */<br></td></tr
><tr
id=sl_svn102_127

><td class="source">	MD5_II ( b, c, d, a, in[13], MD5_S44, (UINT4) 1309151649u); /* 60 */<br></td></tr
><tr
id=sl_svn102_128

><td class="source">	MD5_II ( a, b, c, d, in[ 4], MD5_S41, (UINT4) 4149444226u); /* 61 */<br></td></tr
><tr
id=sl_svn102_129

><td class="source">	MD5_II ( d, a, b, c, in[11], MD5_S42, (UINT4) 3174756917u); /* 62 */<br></td></tr
><tr
id=sl_svn102_130

><td class="source">	MD5_II ( c, d, a, b, in[ 2], MD5_S43, (UINT4)  718787259u); /* 63 */<br></td></tr
><tr
id=sl_svn102_131

><td class="source">	MD5_II ( b, c, d, a, in[ 9], MD5_S44, (UINT4) 3951481745u); /* 64 */<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	buf[0] += a;<br></td></tr
><tr
id=sl_svn102_134

><td class="source">	buf[1] += b;<br></td></tr
><tr
id=sl_svn102_135

><td class="source">	buf[2] += c;<br></td></tr
><tr
id=sl_svn102_136

><td class="source">	buf[3] += d;<br></td></tr
><tr
id=sl_svn102_137
...
><td class="source">// Set pseudoRandomNumber to zero for RFC MD5 implementation<br></td></tr
><tr
id=sl_svn102_140

><td class="source">void MD5Init (MD5_CTX *mdContext, unsigned long pseudoRandomNumber)<br></td></tr
><tr
id=sl_svn102_141
...
><td class="source">	mdContext-&gt;i[0] = mdContext-&gt;i[1] = (UINT4)0;<br></td></tr
><tr
id=sl_svn102_143
...
><td class="source">	/* Load magic initialization constants */<br></td></tr
><tr
id=sl_svn102_145

><td class="source">	mdContext-&gt;buf[0] = (UINT4)0x67452301 + (pseudoRandomNumber * 11);<br></td></tr
><tr
id=sl_svn102_146

><td class="source">	mdContext-&gt;buf[1] = (UINT4)0xefcdab89 + (pseudoRandomNumber * 71);<br></td></tr
><tr
id=sl_svn102_147

><td class="source">	mdContext-&gt;buf[2] = (UINT4)0x98badcfe + (pseudoRandomNumber * 37);<br></td></tr
><tr
id=sl_svn102_148

><td class="source">	mdContext-&gt;buf[3] = (UINT4)0x10325476 + (pseudoRandomNumber * 97);<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">void MD5Update (MD5_CTX *mdContext, const unsigned char *inBuf, unsigned int inLen)<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">	UINT4 in[16];<br></td></tr
><tr
id=sl_svn102_154

><td class="source">	int mdi = 0;<br></td></tr
><tr
id=sl_svn102_155

><td class="source">	unsigned int i = 0, ii = 0;<br></td></tr
><tr
id=sl_svn102_156
...
><td class="source">	/* Compute number of bytes mod 64 */<br></td></tr
><tr
id=sl_svn102_158

><td class="source">	mdi = (int)((mdContext-&gt;i[0] &gt;&gt; 3) &amp; 0x3F);<br></td></tr
><tr
id=sl_svn102_159
...
><td class="source">	/* Update number of bits */<br></td></tr
><tr
id=sl_svn102_161

><td class="source">	if ((mdContext-&gt;i[0] + ((UINT4)inLen &lt;&lt; 3)) &lt; mdContext-&gt;i[0])<br></td></tr
><tr
id=sl_svn102_162

><td class="source">		mdContext-&gt;i[1]++;<br></td></tr
><tr
id=sl_svn102_163

><td class="source">	mdContext-&gt;i[0] += ((UINT4)inLen &lt;&lt; 3);<br></td></tr
><tr
id=sl_svn102_164

><td class="source">	mdContext-&gt;i[1] += ((UINT4)inLen &gt;&gt; 29);<br></td></tr
><tr
id=sl_svn102_165
...
><td class="source">	while (inLen--)<br></td></tr
><tr
id=sl_svn102_167
...
><td class="source">		/* Add new character to buffer, increment mdi */<br></td></tr
><tr
id=sl_svn102_169

><td class="source">		mdContext-&gt;in[mdi++] = *inBuf++;<br></td></tr
><tr
id=sl_svn102_170
...
><td class="source">		/* Transform if necessary */<br></td></tr
><tr
id=sl_svn102_172

><td class="source">		if (mdi == 0x40)<br></td></tr
><tr
id=sl_svn102_173
...
><td class="source">			for (i = 0, ii = 0; i &lt; 16; i++, ii += 4)<br></td></tr
><tr
id=sl_svn102_175

><td class="source">				in[i] = (((UINT4)mdContext-&gt;in[ii+3]) &lt;&lt; 24) |<br></td></tr
><tr
id=sl_svn102_176

><td class="source">					(((UINT4)mdContext-&gt;in[ii+2]) &lt;&lt; 16) |<br></td></tr
><tr
id=sl_svn102_177

><td class="source">					(((UINT4)mdContext-&gt;in[ii+1]) &lt;&lt; 8) |<br></td></tr
><tr
id=sl_svn102_178

><td class="source">					((UINT4)mdContext-&gt;in[ii]);<br></td></tr
><tr
id=sl_svn102_179
...
><td class="source">			MD5_Transform (mdContext-&gt;buf, in);<br></td></tr
><tr
id=sl_svn102_181

><td class="source">			mdi = 0;<br></td></tr
><tr
id=sl_svn102_182
...
><td class="source">void MD5Final (MD5_CTX *mdContext)<br></td></tr
><tr
id=sl_svn102_187
...
><td class="source">	unsigned int i = 0, ii = 0, padLen = 0;<br></td></tr
><tr
id=sl_svn102_191
...
><td class="source">	/* Save number of bits */<br></td></tr
><tr
id=sl_svn102_193

><td class="source">	in[14] = mdContext-&gt;i[0];<br></td></tr
><tr
id=sl_svn102_194

><td class="source">	in[15] = mdContext-&gt;i[1];<br></td></tr
><tr
id=sl_svn102_195
...
><td class="source">	/* Pad out to 56 mod 64 */<br></td></tr
><tr
id=sl_svn102_200

><td class="source">	padLen = (mdi &lt; 56) ? (56 - mdi) : (120 - mdi);<br></td></tr
><tr
id=sl_svn102_201

><td class="source">	MD5Update (mdContext, MD5_PADDING, padLen);<br></td></tr
><tr
id=sl_svn102_202
...
><td class="source">	/* Append length in bits and transform */<br></td></tr
><tr
id=sl_svn102_204

><td class="source">	for (i = 0, ii = 0; i &lt; 14; i++, ii += 4)<br></td></tr
><tr
id=sl_svn102_205
...
><td class="source">	/* Store buffer in digest */<br></td></tr
><tr
id=sl_svn102_212

><td class="source">	for (i = 0, ii = 0; i &lt; 4; i++, ii += 4)<br></td></tr
><tr
id=sl_svn102_213
...
><td class="source">		mdContext-&gt;digest[ii]   = (unsigned char)( mdContext-&gt;buf[i]        &amp; 0xFF);<br></td></tr
><tr
id=sl_svn102_215

><td class="source">		mdContext-&gt;digest[ii+1] = (unsigned char)((mdContext-&gt;buf[i] &gt;&gt;  8) &amp; 0xFF);<br></td></tr
><tr
id=sl_svn102_216

><td class="source">		mdContext-&gt;digest[ii+2] = (unsigned char)((mdContext-&gt;buf[i] &gt;&gt; 16) &amp; 0xFF);<br></td></tr
><tr
id=sl_svn102_217

><td class="source">		mdContext-&gt;digest[ii+3] = (unsigned char)((mdContext-&gt;buf[i] &gt;&gt; 24) &amp; 0xFF);<br></td></tr
><tr
id=sl_svn102_218
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/md5.cpp&amp;old_path=/trunk/src/md5.cpp&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/md5.cpp';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/md5.cpp&amp;old_path=/trunk/src/md5.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/md5.cpp&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/md5.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/md5.cpp'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAdkcewFr96t6p2F1m1Ogf4OgS1vNw:1406096592765", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectHomeUrl": "/p/avesta74"}, '', 'svn102', paths,
