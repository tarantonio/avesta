...
<head>
 ...
 var codesite_token = "ABZ6GAdWvsGKWbP9GccL0bfFzwuv7HJ7kg:1406096229860";
 
 
 var CS_env = {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdWvsGKWbP9GccL0bfFzwuv7HJ7kg:1406096229860", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fbaseevents.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>baseevents.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/baseevents.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/baseevents.h?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#ifndef __BASEEVENTS_H__<br></td></tr
><tr
id=sl_svn102_23

><td class="source">#define __BASEEVENTS_H__<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">class Event;<br></td></tr
><tr
id=sl_svn102_31
...
><td class="source">class BaseEvents<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">	BaseEvents();<br></td></tr
><tr
id=sl_svn102_36

><td class="source">	virtual ~BaseEvents();<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">	bool isLoaded(){return m_loaded;}<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	virtual LuaScriptInterface&amp; getScriptInterface() = 0;<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	virtual std::string getScriptBaseName() = 0;<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	virtual Event* getEvent(const std::string&amp; nodeName) = 0;<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	virtual bool registerEvent(Event* event, xmlNodePtr p) = 0;<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	virtual void clear() = 0;<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">	Event(LuaScriptInterface* _interface);<br></td></tr
><tr
id=sl_svn102_57

><td class="source">	virtual ~Event();<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	virtual bool configureEvent(xmlNodePtr p) = 0;<br></td></tr
><tr
id=sl_svn102_60
...
><td class="source">	bool loadScript(const std::string&amp; scriptFile);<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">	virtual std::string getScriptEventName() = 0;<br></td></tr
><tr
id=sl_svn102_66
...
><td class="source">	bool m_scripted;<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">class CallBack{<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">	virtual ~CallBack();<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	bool loadCallBack(LuaScriptInterface* _interface, std::string name);<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">	std::string m_callbackName;<br></td></tr
><tr
id=sl_svn102_88
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/baseevents.h&amp;old_path=/trunk/src/baseevents.h&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/baseevents.h';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/baseevents.h&amp;old_path=/trunk/src/baseevents.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/baseevents.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/baseevents.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/baseevents.h'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdWvsGKWbP9GccL0bfFzwuv7HJ7kg:1406096229860", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null}, '', 'svn102', paths,
