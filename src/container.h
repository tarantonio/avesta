...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fcontainer.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>container.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/container.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/container.h?r=91" title="Previous">&lsaquo;r91</a></li>
...
><td class="source">#ifndef __OTSERV_CONTAINER_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_CONTAINER_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">#include &quot;cylinder.h&quot;<br></td></tr
><tr
id=sl_svn102_26
...
><td class="source">class ContainerIterator<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">	ContainerIterator();<br></td></tr
><tr
id=sl_svn102_37

><td class="source">	ContainerIterator(const ContainerIterator&amp; rhs);<br></td></tr
><tr
id=sl_svn102_38
...
><td class="source">	ContainerIterator&amp; operator=(const ContainerIterator&amp; rhs);<br></td></tr
><tr
id=sl_svn102_41

><td class="source">	bool operator==(const ContainerIterator&amp; rhs);<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">	ContainerIterator&amp; operator++();<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	ContainerIterator operator++(int);<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	Item* operator*();<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">	ContainerIterator(Container* super);<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	Container* super;<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	std::queue&lt;Container*&gt; over;<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	ItemList::iterator cur;<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">	friend class Container;<br></td></tr
><tr
id=sl_svn102_56
...
><td class="source">class Container : public Item, public Cylinder<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	Container(uint16_t _type);<br></td></tr
><tr
id=sl_svn102_62

><td class="source">	virtual ~Container();<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">	virtual Container* getContainer() {return this;}<br></td></tr
><tr
id=sl_svn102_66

><td class="source">	virtual const Container* getContainer() const {return this;}<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	virtual Depot* getDepot() {return NULL;}<br></td></tr
><tr
id=sl_svn102_68

><td class="source">	virtual const Depot* getDepot() const {return NULL;}<br></td></tr
><tr
id=sl_svn102_69
...
><td class="source">	Attr_ReadValue readAttr(AttrTypes_t attr, PropStream&amp; propStream);<br></td></tr
><tr
id=sl_svn102_71

><td class="source">	bool unserializeItemNode(FileLoader&amp; f, NODE node, PropStream&amp; propStream);<br></td></tr
><tr
id=sl_svn102_72
...
><td class="source">	uint32_t size() const {return (uint32_t)itemlist.size();}<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	bool empty() const {return itemlist.empty();}<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">	ContainerIterator begin();<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	ContainerIterator end();<br></td></tr
><tr
id=sl_svn102_78

><td class="source">	ContainerIterator begin() const;<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	ContainerIterator end() const;<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">	ItemList::const_iterator getItems() const {return itemlist.begin();}<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	ItemList::const_iterator getEnd() const {return itemlist.end();}<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	ItemList::const_reverse_iterator getReversedItems() const {return itemlist.rbegin();}<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	ItemList::const_reverse_iterator getReversedEnd() const {return itemlist.rend();}<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">    void addItem(Item* item);<br></td></tr
><tr
id=sl_svn102_87

><td class="source">	Item* getItem(uint32_t index);<br></td></tr
><tr
id=sl_svn102_88

><td class="source">	bool isHoldingItem(const Item* item) const;<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	uint32_t capacity() const {return maxSize;}<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	uint32_t getItemHoldingCount() const;<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">	//cylinder implementations<br></td></tr
><tr
id=sl_svn102_95
...
><td class="source">	virtual ReturnValue __queryRemove(const Thing* thing, uint32_t count, uint32_t flags) const;<br></td></tr
><tr
id=sl_svn102_100
...
><td class="source">	virtual void postRemoveNotification(Thing* thing,  const Cylinder* newParent, int32_t index, bool isCompleteRemoval, cylinderlink_t link = LINK_OWNER);<br></td></tr
><tr
id=sl_svn102_120
...
><td class="source">	void onAddContainerItem(Item* item);<br></td></tr
><tr
id=sl_svn102_127

><td class="source">	void onUpdateContainerItem(uint32_t index, Item* oldItem, const ItemType&amp; oldType,<br></td></tr
><tr
id=sl_svn102_128
...
><td class="source">	void onRemoveContainerItem(uint32_t index, Item* item);<br></td></tr
><tr
id=sl_svn102_130
...
><td class="source">	Container* getParentContainer();<br></td></tr
><tr
id=sl_svn102_132

><td class="source">	void updateItemWeight(double diff);<br></td></tr
><tr
id=sl_svn102_133
...
><td class="source">	uint32_t maxSize;<br></td></tr
><tr
id=sl_svn102_136

><td class="source">	double total_weight;<br></td></tr
><tr
id=sl_svn102_137

><td class="source">	ItemList itemlist;<br></td></tr
><tr
id=sl_svn102_138

><td class="source">	uint32_t serializationCount;<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">	friend class ContainerIterator;<br></td></tr
><tr
id=sl_svn102_141
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/container.h&amp;old_path=/trunk/src/container.h&amp;old=91">Diff</a>
 </div>
...
don't recommend using this revision</pre>
 ...
 var selected_path = '/trunk/src/container.h';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/container.h&amp;old_path=/trunk/src/container.h&amp;old=86">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=86&amp;format=side&amp;path=/trunk/src/container.h&amp;old_path=/trunk/src/container.h&amp;old=52">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/container.h&amp;old_path=/trunk/src/container.h&amp;old=7">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/container.h&start=95">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/container.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/container.h'}
