...
<head>
 ...
 var codesite_token = "ABZ6GAfaKODQnG8gD13eYB5iFRTomiF64A:1406096402251";
 
 
 var CS_env = {"projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAfaKODQnG8gD13eYB5iFRTomiF64A:1406096402251", "relativeBaseUrl": "", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fcommands.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>commands.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/commands.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/commands.h?r=20" title="Previous">&lsaquo;r20</a></li>
...
><td class="source">#ifndef __OTSERV_COMMANDS_H__<br></td></tr
><tr
id=sl_svn102_23

><td class="source">#define __OTSERV_COMMANDS_H__<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">struct Command;<br></td></tr
><tr
id=sl_svn102_32

><td class="source">struct s_defcommands;<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">	//Commands():game(NULL),loaded(false){};<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">	bool loadXml(const std::string&amp; _datadir);	<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">	bool exeCommand(Creature* creature, const std::string&amp; cmd);<br></td></tr
><tr
id=sl_svn102_44
...
><td class="source">	bool placeNpc(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_51

><td class="source">	bool placeMonster(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_52

><td class="source">	bool placeSummon(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	bool broadcastMessage(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_54

><td class="source">	bool banPlayer(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_55

><td class="source">	bool teleportMasterPos(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_56

><td class="source">	bool teleportHere(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_57

><td class="source">	bool teleportToTown(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_58

><td class="source">	bool teleportTo(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_59

><td class="source">	bool createItemById(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_60

><td class="source">	bool createItemByName(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_61

><td class="source">	bool subtractMoney(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_62

><td class="source">	bool reloadInfo(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_63

><td class="source">	bool testCommand(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_64

><td class="source">	bool getInfo(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_65

><td class="source">	bool saveServer(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_66

><td class="source">	bool closeServer(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	bool openServer(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_68

><td class="source">	bool onlineList(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_69

><td class="source">	bool teleportNTiles(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_70

><td class="source">	bool kickPlayer(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_71

><td class="source">	bool setHouseOwner(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	bool sellHouse(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	bool buyHouse(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	bool getHouse(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_75

><td class="source">	//bool bansManager(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	bool serverInfo(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	bool forceRaid(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_78

><td class="source">	bool whoIsOnline(Creature* creature, const std::string &amp;cmd, const std::string &amp;param);<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	bool goUp(Creature* creature, const std::string &amp;cmd, const std::string &amp;param);<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	bool goDown(Creature* creature, const std::string &amp;cmd, const std::string &amp;param);<br></td></tr
><tr
id=sl_svn102_81

><td class="source">	bool playerKills(Creature* creature, const std::string &amp;cmd, const std::string &amp;param);<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	bool refreshMap(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">	bool serverDiag(Creature* creature, const std::string&amp; cmd, const std::string&amp; param);<br></td></tr
><tr
id=sl_svn102_86
...
><td class="source">	static s_defcommands defined_commands[];<br></td></tr
><tr
id=sl_svn102_90
...
><td class="source">	typedef std::map&lt;std::string,Command*&gt; CommandMap;<br></td></tr
><tr
id=sl_svn102_92

><td class="source">	CommandMap commandMap;<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">typedef  bool (Commands::*CommandFunc)(Creature*,const std::string&amp;,const std::string&amp;);<br></td></tr
><tr
id=sl_svn102_96
...
><td class="source">	CommandFunc f;<br></td></tr
><tr
id=sl_svn102_99

><td class="source">	int32_t accesslevel;<br></td></tr
><tr
id=sl_svn102_100
...
><td class="source">	const char *name;<br></td></tr
><tr
id=sl_svn102_105
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/commands.h&amp;old_path=/trunk/src/commands.h&amp;old=20">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/commands.h';
 ...
 by RSXQ66
 on Aug 19, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=20&amp;format=side&amp;path=/trunk/src/commands.h&amp;old_path=/trunk/src/commands.h&amp;old=7">Diff</a>
 <br>
...
server for 76 (__76__ def)</pre>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/commands.h&amp;old_path=/trunk/src/commands.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/commands.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/commands.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/commands.h'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAfaKODQnG8gD13eYB5iFRTomiF64A:1406096402251", "relativeBaseUrl": "", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com"}, '', 'svn102', paths,
