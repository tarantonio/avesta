...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAcq4wVwk-OI4PksdXoqmXjsRUAjQg:1406096455414";
 
 
 var CS_env = {"projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAcq4wVwk-OI4PksdXoqmXjsRUAjQg:1406096455414", "relativeBaseUrl": "", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fdatabase.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>database.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/database.cpp?edit=1"
...
><td class="source">#ifdef __USE_ODBC__<br></td></tr
><tr
id=sl_svn102_32
...
><td class="source">#ifdef __USE_PGSQL__<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">#if defined MULTI_SQL_DRIVERS<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">boost::recursive_mutex DBQuery::database_lock;<br></td></tr
><tr
id=sl_svn102_44
...
><td class="source">Database* _Database::_instance = NULL;<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">Database* _Database::instance(){<br></td></tr
><tr
id=sl_svn102_48

><td class="source">	if(!_instance){<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">		if(g_config.getString(ConfigManager::SQL_TYPE) == &quot;mysql&quot;)<br></td></tr
><tr
id=sl_svn102_52

><td class="source">			_instance = new DatabaseMySQL;<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">		if(g_config.getString(ConfigManager::SQL_TYPE) == &quot;odbc&quot;)<br></td></tr
><tr
id=sl_svn102_56

><td class="source">			_instance = new DatabaseODBC;<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">		if(g_config.getString(ConfigManager::SQL_TYPE) == &quot;sqlite&quot;)<br></td></tr
><tr
id=sl_svn102_60

><td class="source">			_instance = new DatabaseSQLite;<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">		if(g_config.getString(ConfigManager::SQL_TYPE) == &quot;pgsql&quot;)<br></td></tr
><tr
id=sl_svn102_64

><td class="source">			_instance = new DatabasePgSQL;<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">		_instance = new Database;<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	return _instance;<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">DBResult* _Database::verifyResult(DBResult* result)<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">	if(!result-&gt;next()){<br></td></tr
><tr
id=sl_svn102_76

><td class="source">		_instance-&gt;freeResult(result);<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">DBQuery::DBQuery()<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">	database_lock.lock();<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	database_lock.unlock();<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">DBInsert::DBInsert(Database* db)<br></td></tr
><tr
id=sl_svn102_95
...
><td class="source">	m_db = db;<br></td></tr
><tr
id=sl_svn102_97

><td class="source">	m_rows = 0;<br></td></tr
><tr
id=sl_svn102_98
...
><td class="source">	// checks if current database engine supports multiline INSERTs<br></td></tr
><tr
id=sl_svn102_100

><td class="source">	m_multiLine = m_db-&gt;getParam(DBPARAM_MULTIINSERT) != 0;<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">void DBInsert::setQuery(const std::string&amp; query)<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	m_query = query;<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	m_buf = &quot;&quot;;<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">bool DBInsert::addRow(const std::string&amp; row)<br></td></tr
><tr
id=sl_svn102_111
...
><td class="source">	if(m_multiLine){<br></td></tr
><tr
id=sl_svn102_113

><td class="source">        m_rows++;<br></td></tr
><tr
id=sl_svn102_114

><td class="source">		size_t size = m_buf.length();<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">		// adds new row to buffer<br></td></tr
><tr
id=sl_svn102_117
...
><td class="source">			m_buf = &quot;(&quot; + row + &quot;)&quot;;<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">		else if(size &gt; 8192){<br></td></tr
><tr
id=sl_svn102_121

><td class="source">			if(!execute())<br></td></tr
><tr
id=sl_svn102_122
...
><td class="source">		// executes INSERT for current row<br></td></tr
><tr
id=sl_svn102_134

><td class="source">		return m_db-&gt;executeQuery(m_query + &quot;(&quot; + row + &quot;)&quot; );<br></td></tr
><tr
id=sl_svn102_135
...
><td class="source">bool DBInsert::addRow(std::stringstream&amp; row)<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">	bool ret = addRow(row.str());<br></td></tr
><tr
id=sl_svn102_141

><td class="source">	row.str(&quot;&quot;);<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">bool DBInsert::execute()<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">	if(m_multiLine &amp;&amp; m_buf.length() &gt; 0){<br></td></tr
><tr
id=sl_svn102_148

><td class="source">        if(m_rows == 0){<br></td></tr
><tr
id=sl_svn102_149

><td class="source">            //no rows to execute<br></td></tr
><tr
id=sl_svn102_150
...
><td class="source">		// executes buffer<br></td></tr
><tr
id=sl_svn102_156

><td class="source">		bool res = m_db-&gt;executeQuery(m_query + m_buf);<br></td></tr
><tr
id=sl_svn102_157
...
><td class="source">		// INSERTs were executed on-fly<br></td></tr
><tr
id=sl_svn102_162
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/database.cpp&amp;old_path=/trunk/src/database.cpp&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/database.cpp';
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/database.cpp&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/database.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/database.cpp'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAcq4wVwk-OI4PksdXoqmXjsRUAjQg:1406096455414", "relativeBaseUrl": "", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com"}, '', 'svn102', paths,
