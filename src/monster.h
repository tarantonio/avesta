...
<head>
 ...
 var codesite_token = "ABZ6GAczv-WWqlw4AsZweZWU1BwWJdDkWQ:1406096599417";
 
 
 var CS_env = {"loggedInUserEmail": "jose.guitian@coremain.com", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "token": "ABZ6GAczv-WWqlw4AsZweZWU1BwWJdDkWQ:1406096599417", "domainName": null, "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fmonster.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>monster.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/monster.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/monster.h?r=91" title="Previous">&lsaquo;r91</a></li>
...
><td class="source">#ifndef __OTSERV_MONSTER_H__<br></td></tr
><tr
id=sl_svn102_23

><td class="source">#define __OTSERV_MONSTER_H__<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">class Spawn;<br></td></tr
><tr
id=sl_svn102_32
...
><td class="source">typedef std::list&lt;Creature*&gt; CreatureList;<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">enum TargetSearchType_t{<br></td></tr
><tr
id=sl_svn102_36

><td class="source">    TARGETSEARCH_DEFAULT,<br></td></tr
><tr
id=sl_svn102_37

><td class="source">    TARGETSEARCH_RANDOM,<br></td></tr
><tr
id=sl_svn102_38

><td class="source">    TARGETSEARCH_ATTACKRANGE<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">class Monster : public Creature<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">	Monster(MonsterType* mtype);<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	//const Monster&amp; operator=(const Monster&amp; rhs);<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">	static uint32_t monsterCount;<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	static Monster* createMonster(MonsterType* mType);<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	static Monster* createMonster(const std::string&amp; name);<br></td></tr
><tr
id=sl_svn102_54

><td class="source">	static int32_t despawnRange;<br></td></tr
><tr
id=sl_svn102_55

><td class="source">	static int32_t despawnRadius;<br></td></tr
><tr
id=sl_svn102_56
...
><td class="source">	virtual ~Monster();<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	virtual Monster* getMonster() {return this;}<br></td></tr
><tr
id=sl_svn102_60

><td class="source">	virtual const Monster* getMonster() const {return this;}<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	virtual uint32_t idRange(){ return 0x40000000;}<br></td></tr
><tr
id=sl_svn102_63

><td class="source">	static AutoList&lt;Monster&gt; listMonster;<br></td></tr
><tr
id=sl_svn102_64

><td class="source">	void removeList() {listMonster.removeList(getID());}<br></td></tr
><tr
id=sl_svn102_65

><td class="source">	void addList() {listMonster.addList(this);}<br></td></tr
><tr
id=sl_svn102_66
...
><td class="source">	virtual const std::string&amp; getName() const {return mType-&gt;name;}<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	virtual const std::string&amp; getNameDescription() const {return mType-&gt;nameDescription;}<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	virtual std::string getDescription(int32_t lookDistance) const {return strDescription + &#39;.&#39;;}<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">	virtual RaceType_t getRace() const { return mType-&gt;race; }<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	virtual int32_t getArmor() const { return mType-&gt;armor; }<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	virtual int32_t getDefense() const { return mType-&gt;defense; }<br></td></tr
><tr
id=sl_svn102_78

><td class="source">	virtual bool isPushable() const { return mType-&gt;pushable &amp;&amp; (baseSpeed &gt; 0); }<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	virtual bool isAttackable() const { return mType-&gt;isAttackable;}<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">	bool canPushItems() const {return mType-&gt;canPushItems;}<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	bool canPushCreatures() const {return mType-&gt;canPushCreatures;}<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	bool isHostile() const { return mType-&gt;isHostile;}<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	virtual bool canSeeInvisibility() const { return isImmune(CONDITION_INVISIBLE);}<br></td></tr
><tr
id=sl_svn102_85

><td class="source">	uint32_t getManaCost() const {return mType-&gt;manaCost;}	<br></td></tr
><tr
id=sl_svn102_86

><td class="source">	void setSpawn(Spawn* _spawn) {spawn = _spawn;}<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	virtual bool challengeCreature(Creature* creature);<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	virtual bool convinceCreature(Creature* creature);<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">	virtual bool getCombatValues(int32_t&amp; min, int32_t&amp; max);<br></td></tr
><tr
id=sl_svn102_110
...
><td class="source">	virtual bool hasExtraSwing() {return extraMeleeAttack;}<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">	bool searchTarget(TargetSearchType_t searchType = TARGETSEARCH_DEFAULT);<br></td></tr
><tr
id=sl_svn102_115

><td class="source">	bool selectTarget(Creature* creature);<br></td></tr
><tr
id=sl_svn102_116
...
><td class="source">	const CreatureList&amp; getTargetList() {return targetList;}<br></td></tr
><tr
id=sl_svn102_118

><td class="source">	const CreatureList&amp; getFriendList() {return friendList;}<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">	bool isTarget(Creature* creature);<br></td></tr
><tr
id=sl_svn102_121

><td class="source">	bool isFleeing() const {return getHealth() &lt;= mType-&gt;runAwayHealth;}<br></td></tr
><tr
id=sl_svn102_122
...
><td class="source">	BlockType_t blockHit(Creature* attacker, CombatType_t combatType, int32_t&amp; damage,<br></td></tr
><tr
id=sl_svn102_124
...
><td class="source">	CreatureList targetList;<br></td></tr
><tr
id=sl_svn102_128

><td class="source">	CreatureList friendList;<br></td></tr
><tr
id=sl_svn102_129
...
><td class="source">	MonsterType* mType;<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">	int32_t minCombatValue;<br></td></tr
><tr
id=sl_svn102_133

><td class="source">	int32_t maxCombatValue;<br></td></tr
><tr
id=sl_svn102_134

><td class="source">	uint32_t attackTicks;<br></td></tr
><tr
id=sl_svn102_135

><td class="source">	uint32_t targetTicks;<br></td></tr
><tr
id=sl_svn102_136

><td class="source">	uint32_t targetChangeTicks;<br></td></tr
><tr
id=sl_svn102_137

><td class="source">	uint32_t defenseTicks;<br></td></tr
><tr
id=sl_svn102_138

><td class="source">	uint32_t yellTicks;<br></td></tr
><tr
id=sl_svn102_139

><td class="source">	int32_t targetChangeCooldown;<br></td></tr
><tr
id=sl_svn102_140

><td class="source">	bool resetTicks;<br></td></tr
><tr
id=sl_svn102_141

><td class="source">	bool isActivated;<br></td></tr
><tr
id=sl_svn102_142

><td class="source">	bool extraMeleeAttack;<br></td></tr
><tr
id=sl_svn102_143
...
><td class="source">	Spawn* spawn;<br></td></tr
><tr
id=sl_svn102_145

><td class="source">	bool isMasterInRange;<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">	std::string strDescription;<br></td></tr
><tr
id=sl_svn102_148
...
><td class="source">	virtual void onCreatureEnter(Creature* creature);<br></td></tr
><tr
id=sl_svn102_150

><td class="source">	virtual void onCreatureLeave(Creature* creature);<br></td></tr
><tr
id=sl_svn102_151

><td class="source">	void onCreatureFound(Creature* creature, bool pushFront = false);<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">	void updateLookDirection();<br></td></tr
><tr
id=sl_svn102_154
...
><td class="source">	void updateTargetList();<br></td></tr
><tr
id=sl_svn102_156

><td class="source">	void clearTargetList();<br></td></tr
><tr
id=sl_svn102_157

><td class="source">	void clearFriendList();<br></td></tr
><tr
id=sl_svn102_158
...
><td class="source">	void die();<br></td></tr
><tr
id=sl_svn102_160

><td class="source">	Item* getCorpse();<br></td></tr
><tr
id=sl_svn102_161

><td class="source">	bool despawn();<br></td></tr
><tr
id=sl_svn102_162

><td class="source">	bool inDespawnRange(const Position&amp; pos);<br></td></tr
><tr
id=sl_svn102_163
...
><td class="source">	bool activate(bool forced = false);<br></td></tr
><tr
id=sl_svn102_165

><td class="source">	bool deactivate(bool forced = false);<br></td></tr
><tr
id=sl_svn102_166
...
><td class="source">	bool canUseAttack(const Position&amp; pos, const Creature* target) const;<br></td></tr
><tr
id=sl_svn102_172

><td class="source">	bool canUseSpell(const Position&amp; pos, const Position&amp; targetPos,<br></td></tr
><tr
id=sl_svn102_173
...
><td class="source">	bool getRandomStep(const Position&amp; creaturePos, Direction&amp; dir);<br></td></tr
><tr
id=sl_svn102_175

><td class="source">	bool getDanceStep(const Position&amp; creaturePos, Direction&amp; dir,<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">	bool isInSpawnRange(const Position&amp; toPos);<br></td></tr
><tr
id=sl_svn102_178

><td class="source">	bool canWalkTo(Position pos, Direction dir);<br></td></tr
><tr
id=sl_svn102_179
...
><td class="source">	bool pushItem(Item* item, int32_t radius);<br></td></tr
><tr
id=sl_svn102_181

><td class="source">	void pushItems(Tile* tile);<br></td></tr
><tr
id=sl_svn102_182

><td class="source">	bool pushCreature(Creature* creature);<br></td></tr
><tr
id=sl_svn102_183

><td class="source">	void pushCreatures(Tile* tile);<br></td></tr
><tr
id=sl_svn102_184
...
><td class="source">	void onThinkTarget(uint32_t interval);<br></td></tr
><tr
id=sl_svn102_186

><td class="source">	void onThinkYell(uint32_t interval);<br></td></tr
><tr
id=sl_svn102_187

><td class="source">	void onThinkDefense(uint32_t interval);<br></td></tr
><tr
id=sl_svn102_188
...
><td class="source">	bool isFriend(const Creature* creature);<br></td></tr
><tr
id=sl_svn102_190

><td class="source">	bool isOpponent(const Creature* creature);<br></td></tr
><tr
id=sl_svn102_191
...
><td class="source">	virtual uint64_t getLostExperience() const { return ((skillLoss ? mType-&gt;experience : 0)); }<br></td></tr
><tr
id=sl_svn102_193

><td class="source">	virtual uint16_t getLookCorpse() { return mType-&gt;lookCorpse; }<br></td></tr
><tr
id=sl_svn102_194
...
><td class="source">	virtual uint32_t getDamageImmunities() const { return mType-&gt;damageImmunities; }<br></td></tr
><tr
id=sl_svn102_196

><td class="source">	virtual uint32_t getConditionImmunities() const { return mType-&gt;conditionImmunities; }<br></td></tr
><tr
id=sl_svn102_197

><td class="source">	virtual uint16_t getLookCorpse() const { return mType-&gt;lookCorpse; }<br></td></tr
><tr
id=sl_svn102_198
...
><td class="source">	virtual bool useCacheMap() const {return true;}<br></td></tr
><tr
id=sl_svn102_200
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/monster.h&amp;old_path=/trunk/src/monster.h&amp;old=91">Diff</a>
 </div>
...
don't recommend using this revision</pre>
 ...
 var selected_path = '/trunk/src/monster.h';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/monster.h&amp;old_path=/trunk/src/monster.h&amp;old=71">Diff</a>
 <br>
 ...
 by r...@ymail.com
 on Jul 11, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=71&amp;format=side&amp;path=/trunk/src/monster.h&amp;old_path=/trunk/src/monster.h&amp;old=28">Diff</a>
 <br>
...
target on same floor</pre>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/avesta74/source/detail?spec=svn102&r=28">r28</a>
 by r...@ymail.com
 on Sep 24, 2011
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=28&amp;format=side&amp;path=/trunk/src/monster.h&amp;old_path=/trunk/src/monster.h&amp;old=7">Diff</a>
 <br>
 <pre class="ifOpened">monsters shouldn't now move when no
target on the same floor</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/monster.h&start=95">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/monster.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/monster.h'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": "jose.guitian@coremain.com", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "token": "ABZ6GAczv-WWqlw4AsZweZWU1BwWJdDkWQ:1406096599417", "domainName": null, "projectName": "avesta74"}, '', 'svn102', paths,
