...
<head>
 ...
 var codesite_token = "ABZ6GAdd0tlVm4T1FacN6FB_CM6_Opr3eA:1406096508885";
 
 
 var CS_env = {"projectHomeUrl": "/p/avesta74", "token": "ABZ6GAdd0tlVm4T1FacN6FB_CM6_Opr3eA:1406096508885", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fioaccount.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>ioaccount.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/ioaccount.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/ioaccount.cpp?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">Account IOAccount::loadAccount(uint32_t accno)<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">	query &lt;&lt; &quot;SELECT `id`, `password`, `premend`, `warnings` FROM `accounts` WHERE `id` = &quot; &lt;&lt; accno;<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">		acc.accnumber = result-&gt;getDataInt(&quot;id&quot;);<br></td></tr
><tr
id=sl_svn102_45

><td class="source">		acc.password = result-&gt;getDataString(&quot;password&quot;);<br></td></tr
><tr
id=sl_svn102_46

><td class="source">		acc.premEnd = result-&gt;getDataInt(&quot;premend&quot;);<br></td></tr
><tr
id=sl_svn102_47

><td class="source">		acc.warnings = result-&gt;getDataInt(&quot;warnings&quot;);<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">		query &lt;&lt; &quot;SELECT `name` FROM `players` WHERE `account_id` = &quot; &lt;&lt; accno;<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">				std::string ss = result-&gt;getDataString(&quot;name&quot;);<br></td></tr
><tr
id=sl_svn102_55

><td class="source">				acc.charList.push_back(ss.c_str());<br></td></tr
><tr
id=sl_svn102_56
...
><td class="source">			acc.charList.sort();<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	return acc;<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">bool IOAccount::saveAccount(Account acc)<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">	if (acc.premEnd &gt; 0 &amp;&amp; acc.premEnd &lt; std::time(NULL)) {<br></td></tr
><tr
id=sl_svn102_72

><td class="source">		acc.premEnd = 0;<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">	query &lt;&lt; &quot;UPDATE `accounts` SET `warnings` = &quot; &lt;&lt; acc.warnings &lt;&lt; &quot;, premend = &quot; &lt;&lt; acc.premEnd &lt;&lt; &quot; WHERE `id` = &quot; &lt;&lt; acc.accnumber;<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">bool IOAccount::getPassword(uint32_t accno, const std::string &amp;name, std::string &amp;password)<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">	query &lt;&lt; &quot;SELECT `accounts`.`password` AS `password` FROM `accounts`, `players` WHERE `accounts`.`id` = &quot; &lt;&lt; accno &lt;&lt; &quot; AND `accounts`.`id` = `players`.`account_id` AND `players`.`name` = &quot; &lt;&lt; db-&gt;escapeString(name);<br></td></tr
><tr
id=sl_svn102_86
...
><td class="source">		password = result-&gt;getDataString(&quot;password&quot;);<br></td></tr
><tr
id=sl_svn102_88
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/ioaccount.cpp&amp;old_path=/trunk/src/ioaccount.cpp&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/ioaccount.cpp';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/ioaccount.cpp&amp;old_path=/trunk/src/ioaccount.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/ioaccount.cpp&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/ioaccount.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/ioaccount.cpp'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/avesta74", "token": "ABZ6GAdd0tlVm4T1FacN6FB_CM6_Opr3eA:1406096508885", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006"}, '', 'svn102', paths,
