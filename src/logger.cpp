...
<head>
 ...
 var codesite_token = "ABZ6GAelxhZMd9NvOJuoXuvI_WE4KgajFQ:1406096565457";
 
 
 var CS_env = {"token": "ABZ6GAelxhZMd9NvOJuoXuvI_WE4KgajFQ:1406096565457", "profileUrl": "/u/108692122734644646415/", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": ""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Flogger.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>logger.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/logger.cpp?edit=1"
...
><td class="source">#include &quot;logger.h&quot;<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">void Logger::logMessage(std::string channel, eLogType type, int level,<br></td></tr
><tr
id=sl_svn102_28
...
><td class="source">	std::string sType;<br></td></tr
><tr
id=sl_svn102_32
...
><td class="source">	case LOGTYPE_ERROR:<br></td></tr
><tr
id=sl_svn102_34

><td class="source">			sType = &quot;error&quot;;<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">	case LOGTYPE_EVENT:<br></td></tr
><tr
id=sl_svn102_37

><td class="source">			sType = &quot;event&quot;;<br></td></tr
><tr
id=sl_svn102_38
...
><td class="source">	case LOGTYPE_WARNING:<br></td></tr
><tr
id=sl_svn102_40

><td class="source">			sType = &quot;warning&quot;;<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	std::cout &lt;&lt; &quot;Channel: &quot; &lt;&lt; channel &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_43

><td class="source">	std::cout &lt;&lt; &quot;Type: &quot; &lt;&lt; sType &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	std::cout &lt;&lt; &quot;Level: &quot; &lt;&lt; level &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	std::cout &lt;&lt; &quot;Message: &quot; &lt;&lt; message &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	std::cout &lt;&lt; &quot;Func: &quot; &lt;&lt; func &lt;&lt; std::endl; <br></td></tr
><tr
id=sl_svn102_47

><td class="source">	std::cout &lt;&lt; &quot;Line: &quot; &lt;&lt; line &lt;&lt; std::endl; <br></td></tr
><tr
id=sl_svn102_48

><td class="source">	std::cout &lt;&lt; &quot;File: &quot; &lt;&lt; file &lt;&lt; std::endl; <br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">Logger::Logger()<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">	m_file = fopen(&quot;otlog.txt&quot;, &quot;a&quot;);<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">void Logger::logMessage(const char* channel, eLogType type, int level, std::string message, const char* func)<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	//TODO: decide if should be saved or not depending on channel type and level<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	// if should be save decide where and how<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	//write timestamp of the event<br></td></tr
><tr
id=sl_svn102_70
...
><td class="source">	time_t tmp = time(NULL);<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	formatDate(tmp, buffer);<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	fprintf(m_file, &quot;%s&quot;, buffer);<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	//write channel generating the message<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">		fprintf(m_file, &quot; [%s] &quot;, channel);<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	//write message type<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	const char* type_str;<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">		type_str = &quot;event&quot;;<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">		type_str = &quot;warning&quot;;<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">		type_str = &quot;ERROR&quot;;<br></td></tr
><tr
id=sl_svn102_90
...
><td class="source">		type_str = &quot;???&quot;;<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">	fprintf(m_file, &quot; %s:&quot;, type_str);<br></td></tr
><tr
id=sl_svn102_96

><td class="source">	//write the message<br></td></tr
><tr
id=sl_svn102_97

><td class="source">	fprintf(m_file, &quot; %s\n&quot;, message.c_str());<br></td></tr
><tr
id=sl_svn102_98
...
><td class="source">	fflush(m_file);<br></td></tr
><tr
id=sl_svn102_100
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/logger.cpp&amp;old_path=/trunk/src/logger.cpp&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/logger.cpp';
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/logger.cpp&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/logger.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/logger.cpp'}
 codereviews = CR_controller.setup(
 {"token": "ABZ6GAelxhZMd9NvOJuoXuvI_WE4KgajFQ:1406096565457", "profileUrl": "/u/108692122734644646415/", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": ""}, '', 'svn102', paths,
