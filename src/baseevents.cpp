...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAd6iZiuy84OrQJ2DuQ9oZ9hSEJ3Tw:1406096224729";
 
 
 var CS_env = {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAd6iZiuy84OrQJ2DuQ9oZ9hSEJ3Tw:1406096224729", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectHomeUrl": "/p/avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fbaseevents.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>baseevents.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/baseevents.cpp?edit=1"
...
><td class="source">BaseEvents::BaseEvents()<br></td></tr
><tr
id=sl_svn102_29
...
><td class="source">bool BaseEvents::loadFromXml(const std::string&amp; datadir)<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">	if(m_loaded){<br></td></tr
><tr
id=sl_svn102_41

><td class="source">		std::cout &lt;&lt; &quot;Error: [BaseEvents::loadFromXml] loaded == true&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">	Event* event = NULL;<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">	std::string scriptsName = getScriptBaseName();<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	if(getScriptInterface().loadFile(std::string(m_datadir + scriptsName + &quot;/lib/&quot; + scriptsName + &quot;.lua&quot;)) == -1){<br></td></tr
><tr
id=sl_svn102_51

><td class="source">		std::cout &lt;&lt; &quot;Warning: [BaseEvents::loadFromXml] Can not load &quot; &lt;&lt; scriptsName &lt;&lt; &quot; lib/&quot; &lt;&lt; scriptsName &lt;&lt; &quot;.lua&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">	std::string filename = m_datadir + scriptsName + &quot;/&quot; + scriptsName + &quot;.xml&quot;;<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">		if(xmlStrcmp(root-&gt;name,(const xmlChar*)scriptsName.c_str()) != 0){<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">			if(p-&gt;name){<br></td></tr
><tr
id=sl_svn102_70

><td class="source">				std::string nodeName = (const char*)p-&gt;name;<br></td></tr
><tr
id=sl_svn102_71

><td class="source">				if((event = getEvent(nodeName))){<br></td></tr
><tr
id=sl_svn102_72

><td class="source">					if(event-&gt;configureEvent(p)){<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">						if(readXMLString(p, &quot;script&quot;, scriptfile)){<br></td></tr
><tr
id=sl_svn102_76

><td class="source">							if(!event-&gt;loadScript(m_datadir + scriptsName + &quot;/scripts/&quot; + scriptfile)){<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">						else if(readXMLString(p, &quot;function&quot;, scriptfile)){<br></td></tr
><tr
id=sl_svn102_81

><td class="source">							if(!event-&gt;loadFunction(scriptfile)){<br></td></tr
><tr
id=sl_svn102_82
...
><td class="source">							if(!registerEvent(event, p)){<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">								delete event;<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">						std::cout &lt;&lt; &quot;Warning: [BaseEvents::loadFromXml] Can not configure event&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">					event = NULL;<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">		std::cout &lt;&lt; &quot;Warning: [BaseEvents::loadFromXml] Can not open &quot; &lt;&lt; scriptsName &lt;&lt; &quot;.xml&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">bool BaseEvents::reload()<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">Event::Event(LuaScriptInterface* _interface)<br></td></tr
><tr
id=sl_svn102_127
...
><td class="source">	m_scriptInterface = _interface;<br></td></tr
><tr
id=sl_svn102_129

><td class="source">	m_scriptId = 0;<br></td></tr
><tr
id=sl_svn102_130
...
><td class="source">Event::~Event()<br></td></tr
><tr
id=sl_svn102_134
...
><td class="source">bool Event::loadScript(const std::string&amp; scriptFile)<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">	if(!m_scriptInterface || m_scriptId != 0){<br></td></tr
><tr
id=sl_svn102_141

><td class="source">		std::cout &lt;&lt; &quot;Failure: [Event::loadScript] m_scriptInterface == NULL. scriptid = &quot; &lt;&lt; m_scriptId &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">	if(m_scriptInterface-&gt;loadFile(scriptFile) == -1){<br></td></tr
><tr
id=sl_svn102_146

><td class="source">		std::cout &lt;&lt; &quot;Warning: [Event::loadScript] Can not load script. &quot; &lt;&lt; scriptFile &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_147
...
><td class="source">	int32_t id = m_scriptInterface-&gt;getEvent(getScriptEventName());<br></td></tr
><tr
id=sl_svn102_151

><td class="source">	if(id == -1){<br></td></tr
><tr
id=sl_svn102_152

><td class="source">		std::cout &lt;&lt; &quot;Warning: [Event::loadScript] Event &quot; &lt;&lt; getScriptEventName() &lt;&lt; &quot; not found. &quot; &lt;&lt; scriptFile &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_153
...
><td class="source">	m_scripted = true;<br></td></tr
><tr
id=sl_svn102_157

><td class="source">	m_scriptId = id;<br></td></tr
><tr
id=sl_svn102_158
...
><td class="source">bool Event::loadFunction(const std::string&amp; functionName)<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">	m_scriptInterface = NULL;<br></td></tr
><tr
id=sl_svn102_170
...
><td class="source">bool CallBack::loadCallBack(LuaScriptInterface* _interface, std::string name)<br></td></tr
><tr
id=sl_svn102_179
...
><td class="source">	if(!_interface){<br></td></tr
><tr
id=sl_svn102_181

><td class="source">		std::cout &lt;&lt; &quot;Failure: [CallBack::loadCallBack] m_scriptInterface == NULL&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_182
...
><td class="source">	int32_t id = m_scriptInterface-&gt;getEvent(name);<br></td></tr
><tr
id=sl_svn102_188
...
><td class="source">		std::cout &lt;&lt; &quot;Warning: [CallBack::loadCallBack] Event &quot; &lt;&lt; name &lt;&lt; &quot; not found.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">	m_callbackName = name;<br></td></tr
><tr
id=sl_svn102_194
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/baseevents.cpp&amp;old_path=/trunk/src/baseevents.cpp&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/baseevents.cpp';
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/baseevents.cpp&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/baseevents.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/baseevents.cpp'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAd6iZiuy84OrQJ2DuQ9oZ9hSEJ3Tw:1406096224729", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectHomeUrl": "/p/avesta74"}, '', 'svn102', paths,
