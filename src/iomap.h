...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAd4bWCwLMD-U5Saki9rsdtvferCJw:1406096520304";
 
 
 var CS_env = {"projectHomeUrl": "/p/avesta74", "token": "ABZ6GAd4bWCwLMD-U5Saki9rsdtvferCJw:1406096520304", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fiomap.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>iomap.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/iomap.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/iomap.h?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">// Base class for the Map Loader/Saver<br></td></tr
><tr
id=sl_svn102_5
...
><td class="source">#ifndef __IOMAP_H<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __IOMAP_H<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">	IOMap() {}<br></td></tr
><tr
id=sl_svn102_35

><td class="source">	virtual ~IOMap() {}<br></td></tr
><tr
id=sl_svn102_36
...
><td class="source">	/** Get a textual description of what source is used<br></td></tr
><tr
id=sl_svn102_38

><td class="source">	* \return Name of the source<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">	virtual const char* getSourceDescription() = 0;<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	  * \param identifier is the mapfile/database to open<br></td></tr
><tr
id=sl_svn102_45
...
><td class="source">	virtual bool loadMap(Map* map, const std::string&amp; identifier) = 0;<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">	/** Load the spawns<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	  * \return Returns true if the spawns were loaded successfully<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">	bool loadSpawns(Map* map)<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">        if(!map-&gt;spawnfile.empty()){<br></td></tr
><tr
id=sl_svn102_56

><td class="source">            if(!Spawns::getInstance()-&gt;loadFromXml(map-&gt;spawnfile)) return false;<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">	/** Load the houses (not house tile-data)<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">	  * \return Returns true if the houses were loaded successfully<br></td></tr
><tr
id=sl_svn102_66
...
><td class="source">	bool loadHouses(Map* map)<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">        if(!map-&gt;housefile.empty()){<br></td></tr
><tr
id=sl_svn102_70

><td class="source">            return Houses::getInstance().loadHousesXML(map-&gt;housefile);<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">	const std::string&amp; getLastErrorString() const<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">		return errorString;<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	void setLastErrorString(const std::string&amp; _errorString)<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">		errorString = _errorString;<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">	std::string errorString;<br></td></tr
><tr
id=sl_svn102_87
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/iomap.h&amp;old_path=/trunk/src/iomap.h&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/iomap.h';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/iomap.h&amp;old_path=/trunk/src/iomap.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/iomap.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/iomap.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/iomap.h'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/avesta74", "token": "ABZ6GAd4bWCwLMD-U5Saki9rsdtvferCJw:1406096520304", "projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006"}, '', 'svn102', paths,
