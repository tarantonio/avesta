...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fmap.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>map.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/map.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/map.cpp?r=86" title="Previous">&lsaquo;r86</a></li>
...
><td class="source">// the map of OpenTibia<br></td></tr
><tr
id=sl_svn102_5
...
><td class="source">#include &quot;iomap.h&quot;<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">	mapWidth = 0;<br></td></tr
><tr
id=sl_svn102_50

><td class="source">	mapHeight = 0;<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">bool Map::loadMap(const std::string&amp; identifier, const std::string&amp; type)<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	IOMap* loader;<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	if(type == &quot;XML&quot;){<br></td></tr
><tr
id=sl_svn102_63

><td class="source">		loader = new IOMapXML();<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">	else if(type == &quot;OTBM&quot;){<br></td></tr
><tr
id=sl_svn102_66

><td class="source">		loader = new IOMapOTBM();<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">		std::cout &lt;&lt; &quot;FATAL: Could not determine the map format!&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_70
...
><td class="source">	std::cout &lt;&lt; &quot;:: Loading map from: &quot; &lt;&lt; identifier &lt;&lt; &quot; &quot; &lt;&lt; loader-&gt;getSourceDescription() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">	if(!loader-&gt;loadMap(this, identifier)){<br></td></tr
><tr
id=sl_svn102_76

><td class="source">        std::cout &lt;&lt; &quot;FATAL: [OTBM loader] &quot; &lt;&lt; loader-&gt;getLastErrorString() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	if(!loader-&gt;loadSpawns(this)){<br></td></tr
><tr
id=sl_svn102_81

><td class="source">		std::cout &lt;&lt; &quot;WARNING: could not load spawn data.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_82
...
><td class="source">	if(!loader-&gt;loadHouses(this)){<br></td></tr
><tr
id=sl_svn102_85

><td class="source">		std::cout &lt;&lt; &quot;WARNING: could not load house data.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_86
...
><td class="source">	delete loader;<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	IOMapSerialize* IOMapSerialize = IOMapSerialize::getInstance();<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	IOMapSerialize-&gt;loadHouseInfo(this);<br></td></tr
><tr
id=sl_svn102_92

><td class="source">	IOMapSerialize-&gt;loadMap(this);<br></td></tr
><tr
id=sl_svn102_93
...
><td class="source">bool Map::saveMap()<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">	bool saved = false;<br></td></tr
><tr
id=sl_svn102_102

><td class="source">	for(uint32_t tries = 0; tries &lt; 3; tries++){<br></td></tr
><tr
id=sl_svn102_103

><td class="source">		if(IOMapSerialize-&gt;saveMap(this)){<br></td></tr
><tr
id=sl_svn102_104

><td class="source">			saved = true;<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">	if(!saved)<br></td></tr
><tr
id=sl_svn102_110
...
><td class="source">	saved = false;<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">		if(IOMapSerialize-&gt;saveHouseInfo(this)){<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">	return saved;<br></td></tr
><tr
id=sl_svn102_120
...
><td class="source">Tile* Map::getTile(uint16_t x, uint16_t y, uint16_t z)<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">	if(z &lt; MAP_MAX_LAYERS){<br></td></tr
><tr
id=sl_svn102_125

><td class="source">		//QTreeLeafNode* leaf = getLeaf(x, y);<br></td></tr
><tr
id=sl_svn102_126

><td class="source">		QTreeLeafNode* leaf = QTreeNode::getLeafStatic(&amp;root, x, y);<br></td></tr
><tr
id=sl_svn102_127

><td class="source">		if(leaf){<br></td></tr
><tr
id=sl_svn102_128

><td class="source">			Floor* floor = leaf-&gt;getFloor(z);<br></td></tr
><tr
id=sl_svn102_129

><td class="source">			if(floor){<br></td></tr
><tr
id=sl_svn102_130

><td class="source">				return floor-&gt;tiles[x &amp; FLOOR_MASK][y &amp; FLOOR_MASK];<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">Tile* Map::getTile(const Position&amp; pos)<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">void Map::setTile(uint16_t x, uint16_t y, uint16_t z, Tile* newtile)<br></td></tr
><tr
id=sl_svn102_151
...
><td class="source">		std::cout &lt;&lt; &quot;ERROR: Attempt to set tile on invalid Z coordinate &quot; &lt;&lt; int(z) &lt;&lt; &quot;!&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_154
...
><td class="source">	QTreeLeafNode::newLeaf = false;<br></td></tr
><tr
id=sl_svn102_158

><td class="source">	QTreeLeafNode* leaf = root.createLeaf(x, y, 15);<br></td></tr
><tr
id=sl_svn102_159

><td class="source">	if(QTreeLeafNode::newLeaf){<br></td></tr
><tr
id=sl_svn102_160

><td class="source">		//update north<br></td></tr
><tr
id=sl_svn102_161

><td class="source">		QTreeLeafNode* northLeaf = root.getLeaf(x, y - FLOOR_SIZE);<br></td></tr
><tr
id=sl_svn102_162

><td class="source">		if(northLeaf){<br></td></tr
><tr
id=sl_svn102_163

><td class="source">			northLeaf-&gt;m_leafS = leaf;<br></td></tr
><tr
id=sl_svn102_164
...
><td class="source">		//update west leaf<br></td></tr
><tr
id=sl_svn102_167

><td class="source">		QTreeLeafNode* westLeaf = root.getLeaf(x - FLOOR_SIZE, y);<br></td></tr
><tr
id=sl_svn102_168

><td class="source">		if(westLeaf){<br></td></tr
><tr
id=sl_svn102_169

><td class="source">			westLeaf-&gt;m_leafE = leaf;<br></td></tr
><tr
id=sl_svn102_170
...
><td class="source">		//update south<br></td></tr
><tr
id=sl_svn102_173

><td class="source">		QTreeLeafNode* southLeaf = root.getLeaf(x, y + FLOOR_SIZE);<br></td></tr
><tr
id=sl_svn102_174

><td class="source">		if(southLeaf){<br></td></tr
><tr
id=sl_svn102_175

><td class="source">			leaf-&gt;m_leafS = southLeaf;<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">		//update east<br></td></tr
><tr
id=sl_svn102_179

><td class="source">		QTreeLeafNode* eastLeaf = root.getLeaf(x + FLOOR_SIZE, y);<br></td></tr
><tr
id=sl_svn102_180

><td class="source">		if(eastLeaf){<br></td></tr
><tr
id=sl_svn102_181

><td class="source">			leaf-&gt;m_leafE = eastLeaf;<br></td></tr
><tr
id=sl_svn102_182
...
><td class="source">	Floor* floor = leaf-&gt;createFloor(z);<br></td></tr
><tr
id=sl_svn102_186

><td class="source">	uint32_t offsetX = x &amp; FLOOR_MASK;<br></td></tr
><tr
id=sl_svn102_187

><td class="source">	uint32_t offsetY = y &amp; FLOOR_MASK;<br></td></tr
><tr
id=sl_svn102_188

><td class="source">	if(!floor-&gt;tiles[offsetX][offsetY]){<br></td></tr
><tr
id=sl_svn102_189

><td class="source">		floor-&gt;tiles[offsetX][offsetY] = newtile;<br></td></tr
><tr
id=sl_svn102_190

><td class="source">		newtile-&gt;qt_node = leaf;<br></td></tr
><tr
id=sl_svn102_191
...
><td class="source">		std::cout &lt;&lt; &quot;Error: Map::setTile() already exists.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_194
...
><td class="source">	//if(newtile-&gt;hasFlag(TILESTATE_REFRESH)){<br></td></tr
><tr
id=sl_svn102_197

><td class="source">        RefreshBlock_t rb;<br></td></tr
><tr
id=sl_svn102_198

><td class="source">        rb.lastRefresh = OTSYS_TIME();<br></td></tr
><tr
id=sl_svn102_199

><td class="source">        for(ItemVector::iterator it = newtile-&gt;downItems.begin(); it != newtile-&gt;downItems.end(); ++it){<br></td></tr
><tr
id=sl_svn102_200

><td class="source">            rb.list.push_back((*it)-&gt;clone());<br></td></tr
><tr
id=sl_svn102_201
...
><td class="source">        refreshTileMap[newtile] = rb;<br></td></tr
><tr
id=sl_svn102_203
...
><td class="source">bool Map::placeCreature(const Position&amp; centerPos, Creature* creature, bool extendedPos /*=false*/, bool forceLogin /*=false*/)<br></td></tr
><tr
id=sl_svn102_207
...
><td class="source">	Tile* tile = getTile(centerPos);<br></td></tr
><tr
id=sl_svn102_209
...
><td class="source">	bool foundTile = false;<br></td></tr
><tr
id=sl_svn102_211

><td class="source">	bool placeInPZ = false;<br></td></tr
><tr
id=sl_svn102_212
...
><td class="source">		placeInPZ = tile-&gt;hasFlag(TILESTATE_PROTECTIONZONE);<br></td></tr
><tr
id=sl_svn102_215
...
><td class="source">		ReturnValue ret = tile-&gt;__queryAdd(0, creature, 1, FLAG_IGNOREBLOCKITEM);<br></td></tr
><tr
id=sl_svn102_217

><td class="source">		if(forceLogin || ret == RET_NOERROR || ret == RET_PLAYERISNOTINVITED){<br></td></tr
><tr
id=sl_svn102_218

><td class="source">			foundTile = true;<br></td></tr
><tr
id=sl_svn102_219
...
><td class="source">	// Extended pos is used when summoning.<br></td></tr
><tr
id=sl_svn102_225

><td class="source">	// X is player, 1 is first choice, 2 is second choice<br></td></tr
><tr
id=sl_svn102_226
...
><td class="source">	// -222-<br></td></tr
><tr
id=sl_svn102_228

><td class="source">	// 12X21<br></td></tr
><tr
id=sl_svn102_229
...
><td class="source">	if(extendedPos) {<br></td></tr
><tr
id=sl_svn102_232

><td class="source">		relList.push_back(relPair(0, -2));<br></td></tr
><tr
id=sl_svn102_233

><td class="source">		relList.push_back(relPair(-2, 0));<br></td></tr
><tr
id=sl_svn102_234
...
><td class="source">	std::random_shuffle(relList.begin() + (extendedPos? 4 : 0), relList.end());<br></td></tr
><tr
id=sl_svn102_248

><td class="source">	uint32_t radius = 1;<br></td></tr
><tr
id=sl_svn102_249
...
><td class="source">	for(uint32_t n = 1; n &lt;= radius &amp;&amp; !foundTile; ++n){<br></td></tr
><tr
id=sl_svn102_252

><td class="source">		for(std::vector&lt;relPair&gt;::iterator it = relList.begin(); it != relList.end() &amp;&amp; !foundTile; ++it){<br></td></tr
><tr
id=sl_svn102_253
...
><td class="source">			tile = getTile(tryPos);<br></td></tr
><tr
id=sl_svn102_261

><td class="source">			if(!tile || (placeInPZ &amp;&amp; !tile-&gt;hasFlag(TILESTATE_PROTECTIONZONE)) || tile-&gt;hasProperty(BLOCKSOLID))<br></td></tr
><tr
id=sl_svn102_262
...
><td class="source">			if(tile-&gt;__queryAdd(0, creature, 1, 0) == RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_265
...
><td class="source">					if(isSightClear(centerPos, tryPos, false)) {<br></td></tr
><tr
id=sl_svn102_267
...
><td class="source">	if(foundTile){<br></td></tr
><tr
id=sl_svn102_279
...
><td class="source">		uint32_t flags = 0;<br></td></tr
><tr
id=sl_svn102_282

><td class="source">		Cylinder* toCylinder = tile-&gt;__queryDestination(index, creature, &amp;toItem, flags);<br></td></tr
><tr
id=sl_svn102_283

><td class="source">		toCylinder-&gt;__internalAddThing(creature);<br></td></tr
><tr
id=sl_svn102_284

><td class="source">		Tile* toTile = toCylinder-&gt;getTile();<br></td></tr
><tr
id=sl_svn102_285

><td class="source">		toTile-&gt;qt_node-&gt;addCreature(creature);<br></td></tr
><tr
id=sl_svn102_286
...
><td class="source">	std::cout &lt;&lt; &quot;Failed to place creature onto map!&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_291
...
><td class="source">bool Map::removeCreature(Creature* creature)<br></td></tr
><tr
id=sl_svn102_297
...
><td class="source">	Tile* tile = creature-&gt;getTile();<br></td></tr
><tr
id=sl_svn102_299
...
><td class="source">		tile-&gt;qt_node-&gt;removeCreature(creature);<br></td></tr
><tr
id=sl_svn102_301

><td class="source">		tile-&gt;__removeThing(creature, 0);<br></td></tr
><tr
id=sl_svn102_302
...
><td class="source">void Map::getSpectatorsInternal(SpectatorVec&amp; list, const Position&amp; centerPos, bool checkforduplicate,<br></td></tr
><tr
id=sl_svn102_309

><td class="source">	int32_t minRangeX, int32_t maxRangeX,<br></td></tr
><tr
id=sl_svn102_310

><td class="source">	int32_t minRangeY, int32_t maxRangeY,<br></td></tr
><tr
id=sl_svn102_311

><td class="source">	int32_t minRangeZ, int32_t maxRangeZ)<br></td></tr
><tr
id=sl_svn102_312
...
><td class="source">	int32_t minoffset = centerPos.z - maxRangeZ;<br></td></tr
><tr
id=sl_svn102_314

><td class="source">	int32_t x1 = std::min((int32_t)0xFFFF, std::max((int32_t)0, (centerPos.x + minRangeX + minoffset  )));<br></td></tr
><tr
id=sl_svn102_315

><td class="source">	int32_t y1 = std::min((int32_t)0xFFFF, std::max((int32_t)0, (centerPos.y + minRangeY + minoffset )));<br></td></tr
><tr
id=sl_svn102_316
...
><td class="source">	int32_t maxoffset = centerPos.z - minRangeZ;<br></td></tr
><tr
id=sl_svn102_318

><td class="source">	int32_t x2 = std::min((int32_t)0xFFFF, std::max((int32_t)0, (centerPos.x + maxRangeX + maxoffset )));<br></td></tr
><tr
id=sl_svn102_319

><td class="source">	int32_t y2 = std::min((int32_t)0xFFFF, std::max((int32_t)0, (centerPos.y + maxRangeY + maxoffset )));<br></td></tr
><tr
id=sl_svn102_320
...
><td class="source">	int32_t startx1 = x1 - (x1 % FLOOR_SIZE);<br></td></tr
><tr
id=sl_svn102_322

><td class="source">	int32_t starty1 = y1 - (y1 % FLOOR_SIZE);<br></td></tr
><tr
id=sl_svn102_323

><td class="source">	int32_t endx2 = x2 - (x2 % FLOOR_SIZE);<br></td></tr
><tr
id=sl_svn102_324

><td class="source">	int32_t endy2 = y2 - (y2 % FLOOR_SIZE);<br></td></tr
><tr
id=sl_svn102_325
...
><td class="source">	QTreeLeafNode* startLeaf;<br></td></tr
><tr
id=sl_svn102_327

><td class="source">	QTreeLeafNode* leafE;<br></td></tr
><tr
id=sl_svn102_328

><td class="source">	QTreeLeafNode* leafS;<br></td></tr
><tr
id=sl_svn102_329
...
><td class="source">	startLeaf = getLeaf(startx1, starty1);<br></td></tr
><tr
id=sl_svn102_331

><td class="source">	leafS = startLeaf;<br></td></tr
><tr
id=sl_svn102_332
...
><td class="source">	for(int32_t ny = starty1; ny &lt;= endy2; ny += FLOOR_SIZE){<br></td></tr
><tr
id=sl_svn102_334

><td class="source">		leafE = leafS;<br></td></tr
><tr
id=sl_svn102_335

><td class="source">		for(int32_t nx = startx1; nx &lt;= endx2; nx += FLOOR_SIZE){<br></td></tr
><tr
id=sl_svn102_336

><td class="source">			if(leafE){<br></td></tr
><tr
id=sl_svn102_337
...
><td class="source">				CreatureVector&amp; node_list = leafE-&gt;creature_list;<br></td></tr
><tr
id=sl_svn102_339

><td class="source">				CreatureVector::const_iterator node_iter = node_list.begin();<br></td></tr
><tr
id=sl_svn102_340

><td class="source">				CreatureVector::const_iterator node_end = node_list.end();<br></td></tr
><tr
id=sl_svn102_341

><td class="source">				if(node_iter != node_end){<br></td></tr
><tr
id=sl_svn102_342
...
><td class="source">						Creature* creature = *node_iter;<br></td></tr
><tr
id=sl_svn102_344

><td class="source">						const Position&amp; cpos = creature-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_345

><td class="source">						int32_t offsetZ = centerPos.z - cpos.z;<br></td></tr
><tr
id=sl_svn102_346
...
><td class="source">						if(cpos.z &lt; minRangeZ || cpos.z &gt; maxRangeZ){<br></td></tr
><tr
id=sl_svn102_348
...
><td class="source">						if(cpos.y &lt; (centerPos.y + minRangeY + offsetZ) || cpos.y &gt; (centerPos.y + maxRangeY + offsetZ)){<br></td></tr
><tr
id=sl_svn102_351
...
><td class="source">						if(cpos.x &lt; (centerPos.x + minRangeX + offsetZ) || cpos.x &gt; (centerPos.x + maxRangeX + offsetZ) ){<br></td></tr
><tr
id=sl_svn102_354
...
><td class="source">						if(checkforduplicate){<br></td></tr
><tr
id=sl_svn102_358

><td class="source">							if(std::find(list.begin(), list.end(), creature) == list.end()){<br></td></tr
><tr
id=sl_svn102_359

><td class="source">								list.push_back(creature);<br></td></tr
><tr
id=sl_svn102_360
...
><td class="source">					}while(++node_iter != node_end);<br></td></tr
><tr
id=sl_svn102_366
...
><td class="source">				leafE = leafE-&gt;stepEast();<br></td></tr
><tr
id=sl_svn102_369
...
><td class="source">				leafE = getLeaf(nx + FLOOR_SIZE, ny);<br></td></tr
><tr
id=sl_svn102_372
...
><td class="source">		if(leafS){<br></td></tr
><tr
id=sl_svn102_376

><td class="source">			leafS = leafS-&gt;stepSouth();<br></td></tr
><tr
id=sl_svn102_377
...
><td class="source">			leafS = getLeaf(startx1, ny + FLOOR_SIZE);<br></td></tr
><tr
id=sl_svn102_380
...
><td class="source">	if(list.size() != oldList.size()){<br></td></tr
><tr
id=sl_svn102_385

><td class="source">		std::cout &lt;&lt; &quot;missmatch size&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_386
...
><td class="source">void Map::getSpectators(SpectatorVec&amp; list, const Position&amp; centerPos,<br></td></tr
><tr
id=sl_svn102_391
...
><td class="source">	bool foundCache = false;<br></td></tr
><tr
id=sl_svn102_396

><td class="source">	bool cacheResult = false;<br></td></tr
><tr
id=sl_svn102_397

><td class="source">	if(minRangeX == 0 &amp;&amp; maxRangeX == 0 &amp;&amp; minRangeY == 0 &amp;&amp; maxRangeY == 0 &amp;&amp; multifloor == true &amp;&amp; checkforduplicate == false) {<br></td></tr
><tr
id=sl_svn102_398

><td class="source">		SpectatorCache::iterator it = spectatorCache.find(centerPos);<br></td></tr
><tr
id=sl_svn102_399

><td class="source">		if(it != spectatorCache.end()){<br></td></tr
><tr
id=sl_svn102_400

><td class="source">			list = *it-&gt;second;<br></td></tr
><tr
id=sl_svn102_401

><td class="source">			foundCache = true;<br></td></tr
><tr
id=sl_svn102_402
...
><td class="source">			cacheResult = true;<br></td></tr
><tr
id=sl_svn102_405
...
><td class="source">	if(!foundCache){<br></td></tr
><tr
id=sl_svn102_409

><td class="source">		minRangeX = (minRangeX == 0 ? -maxViewportX : -minRangeX);<br></td></tr
><tr
id=sl_svn102_410

><td class="source">		maxRangeX = (maxRangeX == 0 ? maxViewportX : maxRangeX);<br></td></tr
><tr
id=sl_svn102_411

><td class="source">		minRangeY = (minRangeY == 0 ? -maxViewportY : -minRangeY);<br></td></tr
><tr
id=sl_svn102_412

><td class="source">		maxRangeY = (maxRangeY == 0 ? maxViewportY : maxRangeY);<br></td></tr
><tr
id=sl_svn102_413
...
><td class="source">		int32_t minRangeZ;<br></td></tr
><tr
id=sl_svn102_415

><td class="source">		int32_t maxRangeZ;<br></td></tr
><tr
id=sl_svn102_416
...
><td class="source">		if(multifloor){<br></td></tr
><tr
id=sl_svn102_418

><td class="source">			if(centerPos.z &gt; 7){<br></td></tr
><tr
id=sl_svn102_419

><td class="source">				//underground<br></td></tr
><tr
id=sl_svn102_420
...
><td class="source">				//8-&gt;15<br></td></tr
><tr
id=sl_svn102_422

><td class="source">				minRangeZ = std::max(centerPos.z - 2, 0);<br></td></tr
><tr
id=sl_svn102_423

><td class="source">				maxRangeZ = std::min(centerPos.z + 2, MAP_MAX_LAYERS - 1);<br></td></tr
><tr
id=sl_svn102_424
...
><td class="source">			//above ground<br></td></tr
><tr
id=sl_svn102_426

><td class="source">			else if(centerPos.z == 6){<br></td></tr
><tr
id=sl_svn102_427

><td class="source">				minRangeZ = 0;<br></td></tr
><tr
id=sl_svn102_428

><td class="source">				maxRangeZ = 8;<br></td></tr
><tr
id=sl_svn102_429
...
><td class="source">			else if(centerPos.z == 7){<br></td></tr
><tr
id=sl_svn102_431
...
><td class="source">				maxRangeZ = 9;<br></td></tr
><tr
id=sl_svn102_433
...
><td class="source">				maxRangeZ = 7;<br></td></tr
><tr
id=sl_svn102_437
...
><td class="source">			minRangeZ = centerPos.z;<br></td></tr
><tr
id=sl_svn102_441

><td class="source">			maxRangeZ = centerPos.z;<br></td></tr
><tr
id=sl_svn102_442
...
><td class="source">		getSpectatorsInternal(list, centerPos, true,<br></td></tr
><tr
id=sl_svn102_445

><td class="source">			minRangeX, maxRangeX,<br></td></tr
><tr
id=sl_svn102_446

><td class="source">			minRangeY, maxRangeY,<br></td></tr
><tr
id=sl_svn102_447

><td class="source">			minRangeZ, maxRangeZ);<br></td></tr
><tr
id=sl_svn102_448
...
><td class="source">		if(cacheResult){<br></td></tr
><tr
id=sl_svn102_450

><td class="source">			spectatorCache[centerPos].reset(new SpectatorVec(list));<br></td></tr
><tr
id=sl_svn102_451
...
><td class="source">const SpectatorVec&amp; Map::getSpectators(const Position&amp; centerPos)<br></td></tr
><tr
id=sl_svn102_456
...
><td class="source">		boost::shared_ptr&lt;SpectatorVec&gt; p(new SpectatorVec());<br></td></tr
><tr
id=sl_svn102_462

><td class="source">		spectatorCache[centerPos] = p;<br></td></tr
><tr
id=sl_svn102_463

><td class="source">		SpectatorVec&amp; list = *p;<br></td></tr
><tr
id=sl_svn102_464
...
><td class="source">		int32_t minRangeX = -maxViewportX;<br></td></tr
><tr
id=sl_svn102_466

><td class="source">		int32_t maxRangeX = maxViewportX;<br></td></tr
><tr
id=sl_svn102_467

><td class="source">		int32_t minRangeY = -maxViewportY;<br></td></tr
><tr
id=sl_svn102_468

><td class="source">		int32_t maxRangeY = maxViewportY;<br></td></tr
><tr
id=sl_svn102_469
...
><td class="source">		getSpectatorsInternal(list, centerPos, false,<br></td></tr
><tr
id=sl_svn102_495
...
><td class="source">void Map::clearSpectatorCache()<br></td></tr
><tr
id=sl_svn102_504
...
><td class="source">	spectatorCache.clear();<br></td></tr
><tr
id=sl_svn102_506
...
><td class="source">bool Map::canThrowObjectTo(const Position&amp; fromPos, const Position&amp; toPos, bool checkLineOfSight /*= true*/,<br></td></tr
><tr
id=sl_svn102_509
...
><td class="source">	//z checks<br></td></tr
><tr
id=sl_svn102_512

><td class="source">	//underground 8-&gt;15<br></td></tr
><tr
id=sl_svn102_513

><td class="source">	//ground level and above 7-&gt;0<br></td></tr
><tr
id=sl_svn102_514

><td class="source">	if((fromPos.z &gt;= 8 &amp;&amp; toPos.z &lt; 8) || (toPos.z &gt;= 8 &amp;&amp; fromPos.z &lt; 8)){<br></td></tr
><tr
id=sl_svn102_515
...
><td class="source">	if(fromPos.z - fromPos.z &gt; 2){<br></td></tr
><tr
id=sl_svn102_519
...
><td class="source">	int deltax, deltay, deltaz;<br></td></tr
><tr
id=sl_svn102_523

><td class="source">	deltax = std::abs(fromPos.x - toPos.x);<br></td></tr
><tr
id=sl_svn102_524

><td class="source">	deltay = std::abs(fromPos.y - toPos.y);<br></td></tr
><tr
id=sl_svn102_525

><td class="source">	deltaz = std::abs(fromPos.z - toPos.z);<br></td></tr
><tr
id=sl_svn102_526
...
><td class="source">	//distance checks<br></td></tr
><tr
id=sl_svn102_528

><td class="source">	if(deltax - deltaz &gt; rangex || deltay - deltaz &gt; rangey){<br></td></tr
><tr
id=sl_svn102_529
...
><td class="source">	if(!checkLineOfSight){<br></td></tr
><tr
id=sl_svn102_533
...
><td class="source">	return isSightClear(fromPos, toPos, false);<br></td></tr
><tr
id=sl_svn102_537
...
><td class="source">bool Map::checkSightLine(const Position&amp; fromPos, const Position&amp; toPos) const<br></td></tr
><tr
id=sl_svn102_540
...
><td class="source">	Position start = fromPos;<br></td></tr
><tr
id=sl_svn102_542

><td class="source">	Position end = toPos;<br></td></tr
><tr
id=sl_svn102_543
...
><td class="source">	int dx, dy, dz;<br></td></tr
><tr
id=sl_svn102_546

><td class="source">	int sx, sy, sz;<br></td></tr
><tr
id=sl_svn102_547

><td class="source">	int ey, ez;<br></td></tr
><tr
id=sl_svn102_548
...
><td class="source">	dx = abs(start.x - end.x);<br></td></tr
><tr
id=sl_svn102_550

><td class="source">	dy = abs(start.y - end.y);<br></td></tr
><tr
id=sl_svn102_551

><td class="source">	dz = abs(start.z - end.z);<br></td></tr
><tr
id=sl_svn102_552
...
><td class="source">	int max = dx, dir = 0;<br></td></tr
><tr
id=sl_svn102_554

><td class="source">	if(dy &gt; max){<br></td></tr
><tr
id=sl_svn102_555

><td class="source">		max = dy;<br></td></tr
><tr
id=sl_svn102_556

><td class="source">		dir = 1;<br></td></tr
><tr
id=sl_svn102_557
...
><td class="source">	if(dz &gt; max){<br></td></tr
><tr
id=sl_svn102_559

><td class="source">		max = dz;<br></td></tr
><tr
id=sl_svn102_560

><td class="source">		dir = 2;<br></td></tr
><tr
id=sl_svn102_561
...
><td class="source">			std::swap(start.x, start.y);<br></td></tr
><tr
id=sl_svn102_574

><td class="source">			std::swap(end.x, end.y);<br></td></tr
><tr
id=sl_svn102_575

><td class="source">			std::swap(dx, dy);<br></td></tr
><tr
id=sl_svn102_576
...
><td class="source">			//z -&gt; x<br></td></tr
><tr
id=sl_svn102_581

><td class="source">			std::swap(start.x, start.z);<br></td></tr
><tr
id=sl_svn102_582

><td class="source">			std::swap(end.x, end.z);<br></td></tr
><tr
id=sl_svn102_583

><td class="source">			std::swap(dx, dz);<br></td></tr
><tr
id=sl_svn102_584
...
><td class="source">	sx = ((start.x &lt; end.x) ? 1 : -1);<br></td></tr
><tr
id=sl_svn102_588

><td class="source">	sy = ((start.y &lt; end.y) ? 1 : -1);<br></td></tr
><tr
id=sl_svn102_589

><td class="source">	sz = ((start.z &lt; end.z) ? 1 : -1);<br></td></tr
><tr
id=sl_svn102_590
...
><td class="source">	ey = 0, ez = 0;<br></td></tr
><tr
id=sl_svn102_592

><td class="source">	x = start.x;<br></td></tr
><tr
id=sl_svn102_593

><td class="source">	y = start.y;<br></td></tr
><tr
id=sl_svn102_594

><td class="source">	z = start.z;<br></td></tr
><tr
id=sl_svn102_595
...
><td class="source">	int lastrx = x, lastry = y, lastrz = z;<br></td></tr
><tr
id=sl_svn102_597
...
><td class="source">	for( ; x != end.x + sx; x += sx){<br></td></tr
><tr
id=sl_svn102_599

><td class="source">		int rx, ry, rz;<br></td></tr
><tr
id=sl_svn102_600
...
><td class="source">			rx = y; ry = x; rz = z;<br></td></tr
><tr
id=sl_svn102_603
...
><td class="source">			rx = z; ry = y; rz = x;<br></td></tr
><tr
id=sl_svn102_606
...
><td class="source">		default: //0<br></td></tr
><tr
id=sl_svn102_608

><td class="source">			rx = x; ry = y; rz = z;<br></td></tr
><tr
id=sl_svn102_609
...
><td class="source">		if(!(toPos.x == rx &amp;&amp; toPos.y == ry &amp;&amp; toPos.z == rz) &amp;&amp;<br></td></tr
><tr
id=sl_svn102_613

><td class="source">		  !(fromPos.x == rx &amp;&amp; fromPos.y == ry &amp;&amp; fromPos.z == rz)){<br></td></tr
><tr
id=sl_svn102_614

><td class="source">			if(lastrz != rz){<br></td></tr
><tr
id=sl_svn102_615

><td class="source">				if(const_cast&lt;Map*&gt;(this)-&gt;getTile(lastrx, lastry, std::min(lastrz, rz))){<br></td></tr
><tr
id=sl_svn102_616
...
><td class="source">			lastrx = rx; lastry = ry; lastrz = rz;<br></td></tr
><tr
id=sl_svn102_620
...
><td class="source">			const Tile* tile = const_cast&lt;Map*&gt;(this)-&gt;getTile(rx, ry, rz);<br></td></tr
><tr
id=sl_svn102_622
...
><td class="source">		ey += dy;<br></td></tr
><tr
id=sl_svn102_632

><td class="source">		ez += dz;<br></td></tr
><tr
id=sl_svn102_633

><td class="source">		if(2*ey &gt;= dx){<br></td></tr
><tr
id=sl_svn102_634

><td class="source">			y  += sy;<br></td></tr
><tr
id=sl_svn102_635

><td class="source">			ey -= dx;<br></td></tr
><tr
id=sl_svn102_636
...
><td class="source">		if(2*ez &gt;= dx){<br></td></tr
><tr
id=sl_svn102_638

><td class="source">			z  += sz;<br></td></tr
><tr
id=sl_svn102_639

><td class="source">			ez -= dx;<br></td></tr
><tr
id=sl_svn102_640
...
><td class="source">bool Map::isSightClear(const Position&amp; fromPos, const Position&amp; toPos, bool floorCheck) const<br></td></tr
><tr
id=sl_svn102_647
...
><td class="source">	if(floorCheck &amp;&amp; fromPos.z != toPos.z){<br></td></tr
><tr
id=sl_svn102_649
...
><td class="source">	// Cast two converging rays and see if either yields a result.<br></td></tr
><tr
id=sl_svn102_653
...
><td class="source">		checkSightLine(fromPos, toPos) ||<br></td></tr
><tr
id=sl_svn102_655

><td class="source">		checkSightLine(toPos, fromPos);<br></td></tr
><tr
id=sl_svn102_656
...
><td class="source">const Tile* Map::canWalkTo(const Creature* creature, const Position&amp; pos)<br></td></tr
><tr
id=sl_svn102_659
...
><td class="source">	switch(creature-&gt;getWalkCache(pos)){<br></td></tr
><tr
id=sl_svn102_661

><td class="source">		case 0: return NULL;<br></td></tr
><tr
id=sl_svn102_662

><td class="source">		case 1: return getTile(pos);<br></td></tr
><tr
id=sl_svn102_663
...
><td class="source">	//used for none-cached tiles<br></td></tr
><tr
id=sl_svn102_667

><td class="source">	Tile* tile = getTile(pos);<br></td></tr
><tr
id=sl_svn102_668

><td class="source">	if(creature-&gt;getTile() != tile){<br></td></tr
><tr
id=sl_svn102_669

><td class="source">		if(!tile || tile-&gt;__queryAdd(0, creature, 1, FLAG_PATHFINDING | FLAG_IGNOREFIELDDAMAGE) != RET_NOERROR){<br></td></tr
><tr
id=sl_svn102_670
...
><td class="source">	return tile;<br></td></tr
><tr
id=sl_svn102_675
...
><td class="source">bool Map::getPathTo(const Creature* creature, const Position&amp; destPos,<br></td></tr
><tr
id=sl_svn102_678
...
><td class="source">	if(canWalkTo(creature, destPos) == NULL){<br></td></tr
><tr
id=sl_svn102_681
...
><td class="source">	listDir.clear();<br></td></tr
><tr
id=sl_svn102_685
...
><td class="source">	Position startPos = destPos;<br></td></tr
><tr
id=sl_svn102_687

><td class="source">	Position endPos = creature-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_688
...
><td class="source">	if(startPos.z != endPos.z){<br></td></tr
><tr
id=sl_svn102_690
...
><td class="source">	AStarNodes nodes;<br></td></tr
><tr
id=sl_svn102_694

><td class="source">	AStarNode* startNode = nodes.createOpenNode();<br></td></tr
><tr
id=sl_svn102_695
...
><td class="source">	startNode-&gt;x = startPos.x;<br></td></tr
><tr
id=sl_svn102_697

><td class="source">	startNode-&gt;y = startPos.y;<br></td></tr
><tr
id=sl_svn102_698
...
><td class="source">	startNode-&gt;g = 0;<br></td></tr
><tr
id=sl_svn102_700

><td class="source">	startNode-&gt;h = nodes.getEstimatedDistance(startPos.x, startPos.y, endPos.x, endPos.y);<br></td></tr
><tr
id=sl_svn102_701

><td class="source">	startNode-&gt;f = startNode-&gt;g + startNode-&gt;h;<br></td></tr
><tr
id=sl_svn102_702

><td class="source">	startNode-&gt;parent = NULL;<br></td></tr
><tr
id=sl_svn102_703
...
><td class="source">	pos.z = startPos.z;<br></td></tr
><tr
id=sl_svn102_706
...
><td class="source">	static int32_t neighbourOrderList[8][2] =<br></td></tr
><tr
id=sl_svn102_708
...
><td class="source">		//diagonal<br></td></tr
><tr
id=sl_svn102_715

><td class="source">		{-1, -1},<br></td></tr
><tr
id=sl_svn102_716
...
><td class="source">	const Tile* tile = NULL;<br></td></tr
><tr
id=sl_svn102_722

><td class="source">	AStarNode* found = NULL;<br></td></tr
><tr
id=sl_svn102_723
...
><td class="source">	while(maxSearchDist != -1 || nodes.countClosedNodes() &lt; 100){<br></td></tr
><tr
id=sl_svn102_725

><td class="source">		AStarNode* n = nodes.getBestNode();<br></td></tr
><tr
id=sl_svn102_726
...
><td class="source">			return false; //no path found<br></td></tr
><tr
id=sl_svn102_729
...
><td class="source">		if(n-&gt;x == endPos.x &amp;&amp; n-&gt;y == endPos.y){<br></td></tr
><tr
id=sl_svn102_732

><td class="source">			found = n;<br></td></tr
><tr
id=sl_svn102_733
...
><td class="source">			for(int i = 0; i &lt; 8; ++i){<br></td></tr
><tr
id=sl_svn102_737

><td class="source">				pos.x = n-&gt;x + neighbourOrderList[i][0];<br></td></tr
><tr
id=sl_svn102_738

><td class="source">				pos.y = n-&gt;y + neighbourOrderList[i][1];<br></td></tr
><tr
id=sl_svn102_739
...
><td class="source">				bool outOfRange = false;<br></td></tr
><tr
id=sl_svn102_741

><td class="source">				if(maxSearchDist != -1 &amp;&amp; (std::abs(endPos.x - pos.x) &gt; maxSearchDist ||<br></td></tr
><tr
id=sl_svn102_742

><td class="source">					std::abs(endPos.y - pos.y) &gt; maxSearchDist) ){<br></td></tr
><tr
id=sl_svn102_743

><td class="source">					outOfRange = true;<br></td></tr
><tr
id=sl_svn102_744
...
><td class="source">				if(!outOfRange &amp;&amp; (tile = canWalkTo(creature, pos))){<br></td></tr
><tr
id=sl_svn102_747

><td class="source">					//The cost (g) for this neighbour<br></td></tr
><tr
id=sl_svn102_748

><td class="source">					int32_t cost = nodes.getMapWalkCost(creature, n, tile, pos);<br></td></tr
><tr
id=sl_svn102_749

><td class="source">					int32_t extraCost = nodes.getTileWalkCost(creature, tile);<br></td></tr
><tr
id=sl_svn102_750

><td class="source">					int32_t newg = n-&gt;g + cost + extraCost;<br></td></tr
><tr
id=sl_svn102_751
...
><td class="source">					//Check if the node is already in the closed/open list<br></td></tr
><tr
id=sl_svn102_753

><td class="source">					//If it exists and the nodes already on them has a lower cost (g) then we can ignore this neighbour node<br></td></tr
><tr
id=sl_svn102_754
...
><td class="source">					AStarNode* neighbourNode = nodes.getNodeInList(pos.x, pos.y);<br></td></tr
><tr
id=sl_svn102_756

><td class="source">					if(neighbourNode){<br></td></tr
><tr
id=sl_svn102_757

><td class="source">						if(neighbourNode-&gt;g &lt;= newg){<br></td></tr
><tr
id=sl_svn102_758

><td class="source">							//The node on the closed/open list is cheaper than this one<br></td></tr
><tr
id=sl_svn102_759
...
><td class="source">						nodes.openNode(neighbourNode);<br></td></tr
><tr
id=sl_svn102_763
...
><td class="source">						//Does not exist in the open/closed list, create a new node<br></td></tr
><tr
id=sl_svn102_766

><td class="source">						neighbourNode = nodes.createOpenNode();<br></td></tr
><tr
id=sl_svn102_767
...
><td class="source">							//seems we ran out of nodes<br></td></tr
><tr
id=sl_svn102_769
...
><td class="source">					//This node is the best node so far with this state<br></td></tr
><tr
id=sl_svn102_775

><td class="source">					neighbourNode-&gt;x = pos.x;<br></td></tr
><tr
id=sl_svn102_776

><td class="source">					neighbourNode-&gt;y = pos.y;<br></td></tr
><tr
id=sl_svn102_777

><td class="source">					neighbourNode-&gt;parent = n;<br></td></tr
><tr
id=sl_svn102_778

><td class="source">					neighbourNode-&gt;g = newg;<br></td></tr
><tr
id=sl_svn102_779

><td class="source">					neighbourNode-&gt;h = nodes.getEstimatedDistance(neighbourNode-&gt;x, neighbourNode-&gt;y,<br></td></tr
><tr
id=sl_svn102_780

><td class="source">						endPos.x, endPos.y);<br></td></tr
><tr
id=sl_svn102_781

><td class="source">					neighbourNode-&gt;f = neighbourNode-&gt;g + neighbourNode-&gt;h;<br></td></tr
><tr
id=sl_svn102_782
...
><td class="source">			nodes.closeNode(n);<br></td></tr
><tr
id=sl_svn102_786
...
><td class="source">	int32_t prevx = endPos.x;<br></td></tr
><tr
id=sl_svn102_790

><td class="source">	int32_t prevy = endPos.y;<br></td></tr
><tr
id=sl_svn102_791

><td class="source">	int32_t dx, dy;<br></td></tr
><tr
id=sl_svn102_792
...
><td class="source">	while(found){<br></td></tr
><tr
id=sl_svn102_794

><td class="source">		pos.x = found-&gt;x;<br></td></tr
><tr
id=sl_svn102_795

><td class="source">		pos.y = found-&gt;y;<br></td></tr
><tr
id=sl_svn102_796
...
><td class="source">		found = found-&gt;parent;<br></td></tr
><tr
id=sl_svn102_798
...
><td class="source">		dx = pos.x - prevx;<br></td></tr
><tr
id=sl_svn102_800

><td class="source">		dy = pos.y - prevy;<br></td></tr
><tr
id=sl_svn102_801
...
><td class="source">		prevx = pos.x;<br></td></tr
><tr
id=sl_svn102_803

><td class="source">		prevy = pos.y;<br></td></tr
><tr
id=sl_svn102_804
...
><td class="source">		if(dx == -1 &amp;&amp; dy == -1){<br></td></tr
><tr
id=sl_svn102_806

><td class="source">			listDir.push_back(NORTHWEST);<br></td></tr
><tr
id=sl_svn102_807
...
><td class="source">		else if(dx == 1 &amp;&amp; dy == -1){<br></td></tr
><tr
id=sl_svn102_809

><td class="source">			listDir.push_back(NORTHEAST);<br></td></tr
><tr
id=sl_svn102_810
...
><td class="source">			listDir.push_back(SOUTHWEST);<br></td></tr
><tr
id=sl_svn102_813
...
><td class="source">			listDir.push_back(SOUTHEAST);<br></td></tr
><tr
id=sl_svn102_816
...
><td class="source">		else if(dx == -1){<br></td></tr
><tr
id=sl_svn102_818

><td class="source">			listDir.push_back(WEST);<br></td></tr
><tr
id=sl_svn102_819
...
><td class="source">			listDir.push_back(EAST);<br></td></tr
><tr
id=sl_svn102_822
...
><td class="source">		else if(dy == -1){<br></td></tr
><tr
id=sl_svn102_824

><td class="source">			listDir.push_back(NORTH);<br></td></tr
><tr
id=sl_svn102_825
...
><td class="source">			listDir.push_back(SOUTH);<br></td></tr
><tr
id=sl_svn102_828
...
><td class="source">	return !listDir.empty();<br></td></tr
><tr
id=sl_svn102_832
...
><td class="source">bool Map::getPathMatching(const Creature* creature, std::list&lt;Direction&gt;&amp; dirList,<br></td></tr
><tr
id=sl_svn102_835

><td class="source">	const FrozenPathingConditionCall&amp; pathCondition, const FindPathParams&amp; fpp)<br></td></tr
><tr
id=sl_svn102_836
...
><td class="source">	dirList.clear();<br></td></tr
><tr
id=sl_svn102_838
...
><td class="source">	Position startPos = creature-&gt;getPosition();<br></td></tr
><tr
id=sl_svn102_840

><td class="source">	Position endPos;<br></td></tr
><tr
id=sl_svn102_841
...
><td class="source">	startNode-&gt;f = 0;<br></td></tr
><tr
id=sl_svn102_849
...
><td class="source">	int32_t bestMatch = 0;<br></td></tr
><tr
id=sl_svn102_854
...
><td class="source">	while(fpp.maxSearchDist != -1 || nodes.countClosedNodes() &lt; 100){<br></td></tr
><tr
id=sl_svn102_872
...
><td class="source">				//not quite what we want, but we found something<br></td></tr
><tr
id=sl_svn102_876
...
><td class="source">		if(pathCondition(startPos, Position(n-&gt;x, n-&gt;y, startPos.z), fpp, bestMatch)){<br></td></tr
><tr
id=sl_svn102_884
...
><td class="source">			endPos = Position(n-&gt;x, n-&gt;y, startPos.z);<br></td></tr
><tr
id=sl_svn102_886

><td class="source">			if(bestMatch == 0){<br></td></tr
><tr
id=sl_svn102_887
...
><td class="source">		int32_t dirCount = (fpp.allowDiagonal ? 8 : 4);<br></td></tr
><tr
id=sl_svn102_892

><td class="source">		for(int32_t i = 0; i &lt; dirCount; ++i){<br></td></tr
><tr
id=sl_svn102_893
...
><td class="source">			bool inRange = true;<br></td></tr
><tr
id=sl_svn102_897

><td class="source">			if(fpp.maxSearchDist != -1 &amp;&amp; (std::abs(startPos.x - pos.x) &gt; fpp.maxSearchDist ||<br></td></tr
><tr
id=sl_svn102_898

><td class="source">				std::abs(startPos.y - pos.y) &gt; fpp.maxSearchDist) ){<br></td></tr
><tr
id=sl_svn102_899
...
><td class="source">			if(fpp.keepDistance){<br></td></tr
><tr
id=sl_svn102_903

><td class="source">				if(!pathCondition.isInRange(startPos, pos, fpp)){<br></td></tr
><tr
id=sl_svn102_904
...
><td class="source">			if(inRange &amp;&amp; (tile = canWalkTo(creature, pos))){<br></td></tr
><tr
id=sl_svn102_909
...
><td class="source">				int32_t newf = n-&gt;f + cost + extraCost;<br></td></tr
><tr
id=sl_svn102_913
...
><td class="source">					if(neighbourNode-&gt;f &lt;= newf){<br></td></tr
><tr
id=sl_svn102_920
...
><td class="source">				neighbourNode-&gt;f = newf;<br></td></tr
><tr
id=sl_svn102_946
...
><td class="source">			dirList.push_front(NORTHWEST);<br></td></tr
><tr
id=sl_svn102_973
...
><td class="source">			dirList.push_front(NORTHEAST);<br></td></tr
><tr
id=sl_svn102_976
...
><td class="source">			dirList.push_front(SOUTHWEST);<br></td></tr
><tr
id=sl_svn102_979
...
><td class="source">			dirList.push_front(SOUTHEAST);<br></td></tr
><tr
id=sl_svn102_982
...
><td class="source">			dirList.push_front(WEST);<br></td></tr
><tr
id=sl_svn102_985
...
><td class="source">			dirList.push_front(EAST);<br></td></tr
><tr
id=sl_svn102_988
...
><td class="source">			dirList.push_front(NORTH);<br></td></tr
><tr
id=sl_svn102_991
...
><td class="source">			dirList.push_front(SOUTH);<br></td></tr
><tr
id=sl_svn102_994
...
><td class="source">//*********** AStarNodes *************<br></td></tr
><tr
id=sl_svn102_1003
...
><td class="source">AStarNodes::AStarNodes()<br></td></tr
><tr
id=sl_svn102_1005
...
><td class="source">	curNode = 0;<br></td></tr
><tr
id=sl_svn102_1007

><td class="source">	openNodes.reset();<br></td></tr
><tr
id=sl_svn102_1008
...
><td class="source">AStarNode* AStarNodes::createOpenNode()<br></td></tr
><tr
id=sl_svn102_1011
...
><td class="source">	if(curNode &gt;= MAX_NODES){<br></td></tr
><tr
id=sl_svn102_1013
...
><td class="source">	uint32_t ret_node = curNode;<br></td></tr
><tr
id=sl_svn102_1017

><td class="source">	curNode++;<br></td></tr
><tr
id=sl_svn102_1018

><td class="source">	openNodes[ret_node] = 1;<br></td></tr
><tr
id=sl_svn102_1019

><td class="source">	return &amp;nodes[ret_node];<br></td></tr
><tr
id=sl_svn102_1020
...
><td class="source">AStarNode* AStarNodes::getBestNode()<br></td></tr
><tr
id=sl_svn102_1023
...
><td class="source">	if(curNode == 0)<br></td></tr
><tr
id=sl_svn102_1025
...
><td class="source">	int best_node_f = 100000;<br></td></tr
><tr
id=sl_svn102_1028

><td class="source">	uint32_t best_node = 0;<br></td></tr
><tr
id=sl_svn102_1029
...
><td class="source">	for(uint32_t i = 0; i &lt; curNode; i++){<br></td></tr
><tr
id=sl_svn102_1032

><td class="source">		if(nodes[i].f &lt; best_node_f &amp;&amp; openNodes[i] == 1){<br></td></tr
><tr
id=sl_svn102_1033
...
><td class="source">			best_node_f = nodes[i].f;<br></td></tr
><tr
id=sl_svn102_1035

><td class="source">			best_node = i;<br></td></tr
><tr
id=sl_svn102_1036
...
><td class="source">		return &amp;nodes[best_node];<br></td></tr
><tr
id=sl_svn102_1041
...
><td class="source">void AStarNodes::closeNode(AStarNode* node)<br></td></tr
><tr
id=sl_svn102_1047
...
><td class="source">	uint32_t pos = GET_NODE_INDEX(node);<br></td></tr
><tr
id=sl_svn102_1049

><td class="source">	if(pos &gt;= MAX_NODES){<br></td></tr
><tr
id=sl_svn102_1050

><td class="source">		assert(pos &gt;= MAX_NODES);<br></td></tr
><tr
id=sl_svn102_1051

><td class="source">		std::cout &lt;&lt; &quot;AStarNodes. trying to close node out of range&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1052
...
><td class="source">	openNodes[pos] = 0;<br></td></tr
><tr
id=sl_svn102_1056
...
><td class="source">void AStarNodes::openNode(AStarNode* node)<br></td></tr
><tr
id=sl_svn102_1059
...
><td class="source">		std::cout &lt;&lt; &quot;AStarNodes. trying to open node out of range&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_1064
...
><td class="source">	openNodes[pos] = 1;<br></td></tr
><tr
id=sl_svn102_1068
...
><td class="source">uint32_t AStarNodes::countClosedNodes()<br></td></tr
><tr
id=sl_svn102_1071
...
><td class="source">		if(openNodes[i] == 0){<br></td></tr
><tr
id=sl_svn102_1075
...
><td class="source">uint32_t AStarNodes::countOpenNodes()<br></td></tr
><tr
id=sl_svn102_1082
...
><td class="source">		if(openNodes[i] == 1){<br></td></tr
><tr
id=sl_svn102_1086
...
><td class="source">bool AStarNodes::isInList(int32_t x, int32_t y)<br></td></tr
><tr
id=sl_svn102_1093
...
><td class="source">		if(nodes[i].x == x &amp;&amp; nodes[i].y == y){<br></td></tr
><tr
id=sl_svn102_1096
...
><td class="source">AStarNode* AStarNodes::getNodeInList(int32_t x, int32_t y)<br></td></tr
><tr
id=sl_svn102_1103
...
><td class="source">			return &amp;nodes[i];<br></td></tr
><tr
id=sl_svn102_1107
...
><td class="source">int32_t AStarNodes::getMapWalkCost(const Creature* creature, AStarNode* node,<br></td></tr
><tr
id=sl_svn102_1114

><td class="source">	const Tile* neighbourTile, const Position&amp; neighbourPos)<br></td></tr
><tr
id=sl_svn102_1115
...
><td class="source">	int cost = 0;<br></td></tr
><tr
id=sl_svn102_1117

><td class="source">	if(std::abs((int)node-&gt;x - neighbourPos.x) == std::abs((int)node-&gt;y - neighbourPos.y)){<br></td></tr
><tr
id=sl_svn102_1118

><td class="source">		//diagonal movement extra cost<br></td></tr
><tr
id=sl_svn102_1119

><td class="source">		cost = MAP_DIAGONALWALKCOST;<br></td></tr
><tr
id=sl_svn102_1120
...
><td class="source">		cost = MAP_NORMALWALKCOST;<br></td></tr
><tr
id=sl_svn102_1123
...
><td class="source">	return cost;<br></td></tr
><tr
id=sl_svn102_1126
...
><td class="source">int32_t AStarNodes::getTileWalkCost(const Creature* creature, const Tile* tile)<br></td></tr
><tr
id=sl_svn102_1129
...
><td class="source">	if(!tile-&gt;creatures.empty()){<br></td></tr
><tr
id=sl_svn102_1132

><td class="source">		//destroy creature cost<br></td></tr
><tr
id=sl_svn102_1133

><td class="source">		cost += MAP_NORMALWALKCOST * 3;<br></td></tr
><tr
id=sl_svn102_1134
...
><td class="source">	if(const MagicField* field = tile-&gt;getFieldItem()){<br></td></tr
><tr
id=sl_svn102_1137

><td class="source">		if(!creature-&gt;isImmune(field-&gt;getCombatType())){<br></td></tr
><tr
id=sl_svn102_1138
...
><td class="source">int AStarNodes::getEstimatedDistance(int32_t x, int32_t y, int32_t xGoal, int32_t yGoal)<br></td></tr
><tr
id=sl_svn102_1146
...
><td class="source">	int h_diagonal = std::min(std::abs(x - xGoal), std::abs(y - yGoal));<br></td></tr
><tr
id=sl_svn102_1148

><td class="source">	int h_straight = (std::abs(x - xGoal) + std::abs(y - yGoal));<br></td></tr
><tr
id=sl_svn102_1149
...
><td class="source">	return MAP_DIAGONALWALKCOST * h_diagonal + MAP_NORMALWALKCOST * (h_straight - 2 * h_diagonal);<br></td></tr
><tr
id=sl_svn102_1151

><td class="source">	//return (std::abs(x - xGoal) + std::abs(y - yGoal)) * MAP_NORMALWALKCOST;<br></td></tr
><tr
id=sl_svn102_1152
...
><td class="source">//*********** Floor constructor **************<br></td></tr
><tr
id=sl_svn102_1155
...
><td class="source">Floor::Floor()<br></td></tr
><tr
id=sl_svn102_1157
...
><td class="source">	for(uint32_t i = 0; i &lt; FLOOR_SIZE; ++i){<br></td></tr
><tr
id=sl_svn102_1159

><td class="source">		for(uint32_t j = 0; j &lt; FLOOR_SIZE; ++j){<br></td></tr
><tr
id=sl_svn102_1160

><td class="source">			tiles[i][j] = 0;<br></td></tr
><tr
id=sl_svn102_1161
...
><td class="source">//**************** QTreeNode **********************<br></td></tr
><tr
id=sl_svn102_1166

><td class="source">QTreeNode::QTreeNode()<br></td></tr
><tr
id=sl_svn102_1167
...
><td class="source">	m_isLeaf = false;<br></td></tr
><tr
id=sl_svn102_1169

><td class="source">	m_child[0] = NULL;<br></td></tr
><tr
id=sl_svn102_1170

><td class="source">	m_child[1] = NULL;<br></td></tr
><tr
id=sl_svn102_1171

><td class="source">	m_child[2] = NULL;<br></td></tr
><tr
id=sl_svn102_1172

><td class="source">	m_child[3] = NULL;<br></td></tr
><tr
id=sl_svn102_1173
...
><td class="source">	delete m_child[0];<br></td></tr
><tr
id=sl_svn102_1178

><td class="source">	delete m_child[1];<br></td></tr
><tr
id=sl_svn102_1179

><td class="source">	delete m_child[2];<br></td></tr
><tr
id=sl_svn102_1180

><td class="source">	delete m_child[3];<br></td></tr
><tr
id=sl_svn102_1181
...
><td class="source">QTreeLeafNode* QTreeNode::getLeaf(uint32_t x, uint32_t y)<br></td></tr
><tr
id=sl_svn102_1184
...
><td class="source">	if(!isLeaf()){<br></td></tr
><tr
id=sl_svn102_1186

><td class="source">#ifndef __SWAP_ENDIAN__<br></td></tr
><tr
id=sl_svn102_1187

><td class="source">		uint32_t index = ((x &amp; 0x8000) &gt;&gt; 15) | ((y &amp; 0x8000) &gt;&gt; 14);<br></td></tr
><tr
id=sl_svn102_1188
...
><td class="source">		uint32_t index = ((swap_uint32(x) &amp; 0x8000) &gt;&gt; 15) | ((swap_uint32(y) &amp; 0x8000) &gt;&gt; 14);<br></td></tr
><tr
id=sl_svn102_1190
...
><td class="source">		if(m_child[index]){<br></td></tr
><tr
id=sl_svn102_1192

><td class="source">			return m_child[index]-&gt;getLeaf(x*2, y*2);<br></td></tr
><tr
id=sl_svn102_1193
...
><td class="source">		return static_cast&lt;QTreeLeafNode*&gt;(this);<br></td></tr
><tr
id=sl_svn102_1200
...
><td class="source">QTreeLeafNode* QTreeNode::getLeafStatic(QTreeNode* root, uint32_t x, uint32_t y)<br></td></tr
><tr
id=sl_svn102_1204
...
><td class="source">	QTreeNode* currentNode = root;<br></td></tr
><tr
id=sl_svn102_1206

><td class="source">	uint32_t currentX = x, currentY = y;<br></td></tr
><tr
id=sl_svn102_1207

><td class="source">	while(currentNode){<br></td></tr
><tr
id=sl_svn102_1208

><td class="source">		if(!currentNode-&gt;isLeaf()){<br></td></tr
><tr
id=sl_svn102_1209
...
><td class="source">			uint32_t index = ((currentX &amp; 0x8000) &gt;&gt; 15) | ((currentY &amp; 0x8000) &gt;&gt; 14);<br></td></tr
><tr
id=sl_svn102_1211
...
><td class="source">			uint32_t index = ((swap_uint32(currentX) &amp; 0x8000) &gt;&gt; 15) | ((swap_uint32(currentY) &amp; 0x8000) &gt;&gt; 14);<br></td></tr
><tr
id=sl_svn102_1213
...
><td class="source">			if(currentNode-&gt;m_child[index]){<br></td></tr
><tr
id=sl_svn102_1215

><td class="source">				currentNode = currentNode-&gt;m_child[index];<br></td></tr
><tr
id=sl_svn102_1216

><td class="source">				currentX = currentX*2;<br></td></tr
><tr
id=sl_svn102_1217

><td class="source">				currentY = currentY*2;<br></td></tr
><tr
id=sl_svn102_1218
...
><td class="source">			return static_cast&lt;QTreeLeafNode*&gt;(currentNode);<br></td></tr
><tr
id=sl_svn102_1225
...
><td class="source">QTreeLeafNode* QTreeNode::createLeaf(uint32_t x, uint32_t y, uint32_t level)<br></td></tr
><tr
id=sl_svn102_1231
...
><td class="source">			if(level != FLOOR_BITS){<br></td></tr
><tr
id=sl_svn102_1240

><td class="source">				m_child[index] = new QTreeNode();<br></td></tr
><tr
id=sl_svn102_1241
...
><td class="source">				m_child[index] = new QTreeLeafNode();<br></td></tr
><tr
id=sl_svn102_1244

><td class="source">				QTreeLeafNode::newLeaf = true;<br></td></tr
><tr
id=sl_svn102_1245
...
><td class="source">		return m_child[index]-&gt;createLeaf(x*2, y*2, level - 1);<br></td></tr
><tr
id=sl_svn102_1248
...
><td class="source">//************ LeafNode  ************************<br></td></tr
><tr
id=sl_svn102_1256

><td class="source">bool QTreeLeafNode::newLeaf = false;<br></td></tr
><tr
id=sl_svn102_1257

><td class="source">QTreeLeafNode::QTreeLeafNode()<br></td></tr
><tr
id=sl_svn102_1258
...
><td class="source">	for(unsigned int i = 0; i &lt; MAP_MAX_LAYERS; ++i){<br></td></tr
><tr
id=sl_svn102_1260

><td class="source">		m_array[i] = NULL;<br></td></tr
><tr
id=sl_svn102_1261
...
><td class="source">	m_isLeaf = true;<br></td></tr
><tr
id=sl_svn102_1263

><td class="source">	m_leafS = NULL;<br></td></tr
><tr
id=sl_svn102_1264

><td class="source">	m_leafE = NULL;<br></td></tr
><tr
id=sl_svn102_1265
...
><td class="source">		delete m_array[i];<br></td></tr
><tr
id=sl_svn102_1271
...
><td class="source">Floor* QTreeLeafNode::createFloor(uint32_t z)<br></td></tr
><tr
id=sl_svn102_1275
...
><td class="source">	if(!m_array[z]){<br></td></tr
><tr
id=sl_svn102_1277

><td class="source">		m_array[z] = new Floor();<br></td></tr
><tr
id=sl_svn102_1278
...
><td class="source">	return m_array[z];<br></td></tr
><tr
id=sl_svn102_1280
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/map.cpp&amp;old_path=/trunk/src/map.cpp&amp;old=86">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/map.cpp';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=86&amp;format=side&amp;path=/trunk/src/map.cpp&amp;old_path=/trunk/src/map.cpp&amp;old=57">Diff</a>
 <br>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/avesta74/source/detail?spec=svn102&r=57">r57</a>
 by r...@ymail.com
 on Jul 10, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=57&amp;format=side&amp;path=/trunk/src/map.cpp&amp;old_path=/trunk/src/map.cpp&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/map.cpp&amp;old_path=/trunk/src/map.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/map.cpp&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 30042 bytes,
 1280 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/map.cpp">View raw file</a></div>
 </div>
