...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAeL_6do7-V9GddLf5HTdFoONRGGIA:1406096642926";
 
 
 var CS_env = {"relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAeL_6do7-V9GddLf5HTdFoONRGGIA:1406096642926", "projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Foutputmessage.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>outputmessage.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/outputmessage.cpp?edit=1"
...
><td class="source">//extern Dispatcher g_dispatcher;<br></td></tr
><tr
id=sl_svn102_28
...
><td class="source">OutputMessage::OutputMessage()<br></td></tr
><tr
id=sl_svn102_30
...
><td class="source">	freeMessage();<br></td></tr
><tr
id=sl_svn102_32
...
><td class="source">//*********** OutputMessagePool ****************<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">OutputMessagePool::OutputMessagePool()<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">	for(uint32_t i = 0; i &lt; OUTPUT_POOL_SIZE; ++i){<br></td></tr
><tr
id=sl_svn102_39

><td class="source">		OutputMessage* msg = new OutputMessage();<br></td></tr
><tr
id=sl_svn102_40

><td class="source">		m_outputMessages.push_back(msg);<br></td></tr
><tr
id=sl_svn102_41

><td class="source">#ifdef __TRACK_NETWORK__<br></td></tr
><tr
id=sl_svn102_42

><td class="source">		m_allOutputMessages.push_back(msg);<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	m_frameTime = OTSYS_TIME();<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">void OutputMessagePool::startExecutionFrame()<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	//boost::recursive_mutex::scoped_lock lockClass(m_outputPoolLock);<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">	m_isOpen = true;<br></td></tr
><tr
id=sl_svn102_53
...
><td class="source">	InternalOutputMessageList::iterator it;<br></td></tr
><tr
id=sl_svn102_58

><td class="source">	for(it = m_outputMessages.begin(); it != m_outputMessages.end(); ++it){<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	m_outputMessages.clear();<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">void OutputMessagePool::send(OutputMessage_ptr msg)<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	m_outputPoolLock.lock();<br></td></tr
><tr
id=sl_svn102_67

><td class="source">	OutputMessage::OutputMessageState state = msg-&gt;getState();<br></td></tr
><tr
id=sl_svn102_68

><td class="source">	m_outputPoolLock.unlock();<br></td></tr
><tr
id=sl_svn102_69
...
><td class="source">	if(state == OutputMessage::STATE_ALLOCATED_NO_AUTOSEND){<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">		std::cout &lt;&lt; &quot;Sending message - SINGLE&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">		if(msg-&gt;getConnection()){<br></td></tr
><tr
id=sl_svn102_76

><td class="source">			if(!msg-&gt;getConnection()-&gt;send(msg)){<br></td></tr
><tr
id=sl_svn102_77

><td class="source">				// Send only fails when connection is closing (or in error state)<br></td></tr
><tr
id=sl_svn102_78

><td class="source">				// This call will free the message<br></td></tr
><tr
id=sl_svn102_79
...
><td class="source">			std::cout &lt;&lt; &quot;Error: [OutputMessagePool::send] NULL connection.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">		std::cout &lt;&lt; &quot;Warning: [OutputMessagePool::send] State != STATE_ALLOCATED_NO_AUTOSEND&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">void OutputMessagePool::sendAll()<br></td></tr
><tr
id=sl_svn102_96
...
><td class="source">	OutputMessageMessageList::iterator it;<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">	for(it = m_toAddQueue.begin(); it != m_toAddQueue.end();){<br></td></tr
><tr
id=sl_svn102_101

><td class="source">		//drop messages that are older than 10 seconds<br></td></tr
><tr
id=sl_svn102_102

><td class="source">		if(OTSYS_TIME() - (*it)-&gt;getFrame() &gt; 10000){<br></td></tr
><tr
id=sl_svn102_103

><td class="source">			(*it)-&gt;getProtocol()-&gt;onSendMessage(*it);<br></td></tr
><tr
id=sl_svn102_104

><td class="source">			it = m_toAddQueue.erase(it);<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">		(*it)-&gt;setState(OutputMessage::STATE_ALLOCATED);<br></td></tr
><tr
id=sl_svn102_109

><td class="source">		m_autoSendOutputMessages.push_back(*it);<br></td></tr
><tr
id=sl_svn102_110
...
><td class="source">	m_toAddQueue.clear();<br></td></tr
><tr
id=sl_svn102_114
...
><td class="source">	for(it = m_autoSendOutputMessages.begin(); it != m_autoSendOutputMessages.end(); ){<br></td></tr
><tr
id=sl_svn102_116

><td class="source">		OutputMessage_ptr omsg = *it;<br></td></tr
><tr
id=sl_svn102_117

><td class="source">		#ifdef __NO_PLAYER_SENDBUFFER__<br></td></tr
><tr
id=sl_svn102_118

><td class="source">		//use this define only for debugging<br></td></tr
><tr
id=sl_svn102_119

><td class="source">		bool v = 1;<br></td></tr
><tr
id=sl_svn102_120
...
><td class="source">		//It will send only messages bigger then 1 kb or with a lifetime greater than 10 ms<br></td></tr
><tr
id=sl_svn102_122

><td class="source">		bool v = omsg-&gt;getMessageLength() &gt; 1024 || (m_frameTime - omsg-&gt;getFrame() &gt; 10);<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">			std::cout &lt;&lt; &quot;Sending message - ALL&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_127
...
><td class="source">			if(omsg-&gt;getConnection()){<br></td></tr
><tr
id=sl_svn102_130

><td class="source">				if(!omsg-&gt;getConnection()-&gt;send(omsg)){<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">					omsg-&gt;getProtocol()-&gt;onSendMessage(omsg);<br></td></tr
><tr
id=sl_svn102_134
...
><td class="source">			it = m_autoSendOutputMessages.erase(it);<br></td></tr
><tr
id=sl_svn102_143
...
><td class="source">void OutputMessagePool::releaseMessage(OutputMessage* msg)<br></td></tr
><tr
id=sl_svn102_151
...
><td class="source">		createTask(boost::bind(&amp;OutputMessagePool::internalReleaseMessage, this, msg)), true);<br></td></tr
><tr
id=sl_svn102_154
...
><td class="source">void OutputMessagePool::internalReleaseMessage(OutputMessage* msg)<br></td></tr
><tr
id=sl_svn102_157
...
><td class="source">	if(msg-&gt;getProtocol()){<br></td></tr
><tr
id=sl_svn102_159

><td class="source">		msg-&gt;getProtocol()-&gt;unRef();<br></td></tr
><tr
id=sl_svn102_160
...
><td class="source">		std::cout &lt;&lt; &quot;Removing reference to protocol &quot; &lt;&lt; msg-&gt;getProtocol() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">		std::cout &lt;&lt; &quot;No protocol found.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_166
...
><td class="source">		msg-&gt;getConnection()-&gt;unRef();<br></td></tr
><tr
id=sl_svn102_170
...
><td class="source">		std::cout &lt;&lt; &quot;Removing reference to connection &quot; &lt;&lt; msg-&gt;getConnection() &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_172
...
><td class="source">		std::cout &lt;&lt; &quot;No connection found.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">	msg-&gt;freeMessage();<br></td></tr
><tr
id=sl_svn102_179
...
><td class="source">	msg-&gt;clearTrack();<br></td></tr
><tr
id=sl_svn102_182
...
><td class="source">OutputMessage_ptr OutputMessagePool::getOutputMessage(Protocol* protocol, bool autosend /*= true*/)<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">	std::cout &lt;&lt; &quot;request output message - auto = &quot; &lt;&lt; autosend &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_193
...
><td class="source">	if(!m_isOpen){<br></td></tr
><tr
id=sl_svn102_196

><td class="source">		return OutputMessage_ptr();<br></td></tr
><tr
id=sl_svn102_197
...
><td class="source">	if(protocol-&gt;getConnection() == NULL){<br></td></tr
><tr
id=sl_svn102_202
...
><td class="source">	if(m_outputMessages.empty()){<br></td></tr
><tr
id=sl_svn102_206
...
><td class="source">	OutputMessage_ptr outputmessage;<br></td></tr
><tr
id=sl_svn102_215

><td class="source">	outputmessage.reset(m_outputMessages.back(),<br></td></tr
><tr
id=sl_svn102_216

><td class="source">		boost::bind(&amp;OutputMessagePool::releaseMessage, this, _1));<br></td></tr
><tr
id=sl_svn102_217
...
><td class="source">	m_outputMessages.pop_back();<br></td></tr
><tr
id=sl_svn102_219
...
><td class="source">	configureOutputMessage(outputmessage, protocol, autosend);<br></td></tr
><tr
id=sl_svn102_221

><td class="source">	return outputmessage;<br></td></tr
><tr
id=sl_svn102_222
...
><td class="source">void OutputMessagePool::configureOutputMessage(OutputMessage_ptr msg, Protocol* protocol, bool autosend)<br></td></tr
><tr
id=sl_svn102_225
...
><td class="source">	if(autosend){<br></td></tr
><tr
id=sl_svn102_229

><td class="source">		msg-&gt;setState(OutputMessage::STATE_ALLOCATED);<br></td></tr
><tr
id=sl_svn102_230

><td class="source">		m_autoSendOutputMessages.push_back(msg);<br></td></tr
><tr
id=sl_svn102_231
...
><td class="source">		msg-&gt;setState(OutputMessage::STATE_ALLOCATED_NO_AUTOSEND);<br></td></tr
><tr
id=sl_svn102_234
...
><td class="source">	Connection* connection = protocol-&gt;getConnection();<br></td></tr
><tr
id=sl_svn102_237

><td class="source">	assert(connection != NULL);<br></td></tr
><tr
id=sl_svn102_238
...
><td class="source">	msg-&gt;setProtocol(protocol);<br></td></tr
><tr
id=sl_svn102_240

><td class="source">	protocol-&gt;addRef();<br></td></tr
><tr
id=sl_svn102_241
...
><td class="source">	std::cout &lt;&lt; &quot;Adding reference to protocol - &quot; &lt;&lt; protocol &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_243
...
><td class="source">	msg-&gt;setConnection(connection);<br></td></tr
><tr
id=sl_svn102_245

><td class="source">	connection-&gt;addRef();<br></td></tr
><tr
id=sl_svn102_246
...
><td class="source">	std::cout &lt;&lt; &quot;Adding reference to connection - &quot; &lt;&lt; connection &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_248
...
><td class="source">	msg-&gt;setFrame(m_frameTime);<br></td></tr
><tr
id=sl_svn102_250
...
><td class="source">void OutputMessagePool::addToAutoSend(OutputMessage_ptr msg)<br></td></tr
><tr
id=sl_svn102_253
...
><td class="source">	m_toAddQueue.push_back(msg);<br></td></tr
><tr
id=sl_svn102_255
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/outputmessage.cpp&amp;old_path=/trunk/src/outputmessage.cpp&amp;old=">Diff</a>
 </div>
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/outputmessage.cpp&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/outputmessage.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/outputmessage.cpp'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "profileUrl": "/u/108692122734644646415/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAeL_6do7-V9GddLf5HTdFoONRGGIA:1406096642926", "projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74"}, '', 'svn102', paths,
