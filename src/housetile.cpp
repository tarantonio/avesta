...
<head>
 ...
 var codesite_token = "ABZ6GAdzIdcfpQWFDHpb3u8PROF0PjyZtQ:1406096504731";
 
 
 var CS_env = {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAdzIdcfpQWFDHpb3u8PROF0PjyZtQ:1406096504731", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fhousetile.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>housetile.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/housetile.cpp?edit=1"
...
><td class="source">HouseTile::HouseTile(int x, int y, int z, House* _house) :<br></td></tr
><tr
id=sl_svn102_29

><td class="source">	Tile(x, y, z)<br></td></tr
><tr
id=sl_svn102_30
...
><td class="source">	setFlag(TILESTATE_HOUSE);<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">HouseTile::~HouseTile()<br></td></tr
><tr
id=sl_svn102_36
...
><td class="source">void HouseTile::__addThing(int32_t index, Thing* thing)<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	Tile::__addThing(index, thing);<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">		updateHouse(item);<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">void HouseTile::__internalAddThing(uint32_t index, Thing* thing)<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	Tile::__internalAddThing(index, thing);<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">void HouseTile::updateHouse(Item* item)<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">	if(item-&gt;getTile() == this){<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">			BedItem* bed = item-&gt;getBed();<br></td></tr
><tr
id=sl_svn102_70

><td class="source">			if(bed)<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">				// next, add it to the house<br></td></tr
><tr
id=sl_svn102_73

><td class="source">				house-&gt;addBed(bed);<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">ReturnValue HouseTile::__queryAdd(int32_t index, const Thing* thing, uint32_t count,<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">	if(const Creature* creature = thing-&gt;getCreature()){<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">			if(!house-&gt;isInvited(player) &amp;&amp; !player-&gt;hasFlag(PlayerFlag_CanEditHouses))<br></td></tr
><tr
id=sl_svn102_86

><td class="source">				return RET_PLAYERISNOTINVITED;<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	return Tile::__queryAdd(index, thing, count, flags);<br></td></tr
><tr
id=sl_svn102_91
...
><td class="source">Cylinder* HouseTile::__queryDestination(int32_t&amp; index, const Thing* thing, Item** destItem,<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">			if(!house-&gt;isInvited(player)){<br></td></tr
><tr
id=sl_svn102_99

><td class="source">				const Position&amp; entryPos = house-&gt;getEntryPosition();<br></td></tr
><tr
id=sl_svn102_100

><td class="source">				Tile* destTile = g_game.getTile(entryPos.x, entryPos.y, entryPos.z);<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">				if(!destTile){<br></td></tr
><tr
id=sl_svn102_103
...
><td class="source">					assert(destTile != NULL);<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">					std::cout &lt;&lt; &quot;Error: [HouseTile::__queryDestination] House entry not correct&quot;<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">						&lt;&lt; &quot; - House id: &quot; &lt;&lt; house-&gt;getHouseId()<br></td></tr
><tr
id=sl_svn102_109

><td class="source">						&lt;&lt; &quot; - Tile not found: &quot; &lt;&lt; entryPos &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_110
...
><td class="source">					const Position&amp; templePos = player-&gt;getTemplePosition();<br></td></tr
><tr
id=sl_svn102_112

><td class="source">					destTile = g_game.getTile(templePos.x, templePos.y, templePos.z);<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">						destTile = &amp;(Tile::null_tile);<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">				return destTile;<br></td></tr
><tr
id=sl_svn102_121
...
><td class="source">	return Tile::__queryDestination(index, thing, destItem, flags);<br></td></tr
><tr
id=sl_svn102_126
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/housetile.cpp&amp;old_path=/trunk/src/housetile.cpp&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/housetile.cpp';
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/housetile.cpp&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/housetile.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/housetile.cpp'}
 codereviews = CR_controller.setup(
 {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAdzIdcfpQWFDHpb3u8PROF0PjyZtQ:1406096504731", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph"}, '', 'svn102', paths,
