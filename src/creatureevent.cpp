...
<head>
 ...
 var codesite_token = "ABZ6GAdYJzV9jYLf6ff5wUtbBA8bdmhl-g:1406096445359";
 
 
 var CS_env = {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdYJzV9jYLf6ff5wUtbBA8bdmhl-g:1406096445359", "relativeBaseUrl": "", "domainName": null, "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "profileUrl": "/u/108692122734644646415/"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fcreatureevent.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>creatureevent.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/creatureevent.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/creatureevent.cpp?r=81" title="Previous">&lsaquo;r81</a></li>
...
><td class="source">CreatureEvents::CreatureEvents() :<br></td></tr
><tr
id=sl_svn102_29

><td class="source">m_scriptInterface(&quot;CreatureScript Interface&quot;)<br></td></tr
><tr
id=sl_svn102_30
...
><td class="source">	for(it = m_creatureEvents.begin(); it != m_creatureEvents.end(); ++it)<br></td></tr
><tr
id=sl_svn102_38
...
><td class="source">void CreatureEvents::clear()<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">	//clear all events<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	CreatureEventList::iterator it = m_creatureEvents.begin();<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	while(it != m_creatureEvents.end()){<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">		m_creatureEvents.erase(it);<br></td></tr
><tr
id=sl_svn102_48

><td class="source">		it = m_creatureEvents.begin();<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	//clear lua state<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">LuaScriptInterface&amp; CreatureEvents::getScriptInterface()<br></td></tr
><tr
id=sl_svn102_56
...
><td class="source">std::string CreatureEvents::getScriptBaseName()<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	return &quot;creaturescripts&quot;;<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">Event* CreatureEvents::getEvent(const std::string&amp; nodeName)<br></td></tr
><tr
id=sl_svn102_66
...
><td class="source">	if(asLowerCaseString(nodeName) == &quot;event&quot;){<br></td></tr
><tr
id=sl_svn102_68

><td class="source">		return new CreatureEvent(&amp;m_scriptInterface);<br></td></tr
><tr
id=sl_svn102_69
...
><td class="source">bool CreatureEvents::registerEvent(Event* event, xmlNodePtr p)<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">	CreatureEvent* creatureEvent = dynamic_cast&lt;CreatureEvent*&gt;(event);<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	if(!creatureEvent)<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	switch(creatureEvent-&gt;getEventType())<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">		case CREATURE_EVENT_NONE:<br></td></tr
><tr
id=sl_svn102_82

><td class="source">			std::cout &lt;&lt; &quot;Error: [CreatureEvents::registerEvent] Trying to register event without type!.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">		//events are stored in a std::map<br></td></tr
><tr
id=sl_svn102_86
...
><td class="source">			m_creatureEvents[creatureEvent-&gt;getName()] = creatureEvent;<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">CreatureEvent* CreatureEvents::getEventByName(const std::string&amp; name)<br></td></tr
><tr
id=sl_svn102_95
...
><td class="source">	CreatureEventList::iterator it = m_creatureEvents.find(name);<br></td></tr
><tr
id=sl_svn102_97

><td class="source">	if(it != m_creatureEvents.end())<br></td></tr
><tr
id=sl_svn102_98
...
><td class="source">bool CreatureEvents::playerLogIn(Player* player)<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">	for(CreatureEventList::iterator it = m_creatureEvents.begin(); it != m_creatureEvents.end(); ++it)<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">		if(it-&gt;second-&gt;getEventType() == CREATURE_EVENT_LOGIN){<br></td></tr
><tr
id=sl_svn102_109

><td class="source">			if(!it-&gt;second-&gt;executeOnLogin(player))<br></td></tr
><tr
id=sl_svn102_110
...
><td class="source">bool CreatureEvents::playerLogOut(Player* player)<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">		if(it-&gt;second-&gt;getEventType() == CREATURE_EVENT_LOGOUT){<br></td></tr
><tr
id=sl_svn102_122

><td class="source">			if(!it-&gt;second-&gt;executeOnLogout(player))<br></td></tr
><tr
id=sl_svn102_123
...
><td class="source">CreatureEvent::CreatureEvent(LuaScriptInterface* _interface) :<br></td></tr
><tr
id=sl_svn102_133
...
><td class="source">	m_type = CREATURE_EVENT_NONE;<br></td></tr
><tr
id=sl_svn102_136
...
><td class="source">CreatureEvent::~CreatureEvent()<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">bool CreatureEvent::configureEvent(xmlNodePtr p)<br></td></tr
><tr
id=sl_svn102_144
...
><td class="source">	//Name that will be used in monster xml files and<br></td></tr
><tr
id=sl_svn102_147

><td class="source">	// lua function to register events to reference this event<br></td></tr
><tr
id=sl_svn102_148

><td class="source">	if(readXMLString(p, &quot;name&quot;, str)){<br></td></tr
><tr
id=sl_svn102_149

><td class="source">		m_eventName = str;<br></td></tr
><tr
id=sl_svn102_150
...
><td class="source">		std::cout &lt;&lt; &quot;Error: [CreatureEvent::configureEvent] No name for creature event.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_153
...
><td class="source">	if(readXMLString(p, &quot;type&quot;, str)){<br></td></tr
><tr
id=sl_svn102_157

><td class="source">		if(asLowerCaseString(str) == &quot;login&quot;){<br></td></tr
><tr
id=sl_svn102_158

><td class="source">			m_type = CREATURE_EVENT_LOGIN;<br></td></tr
><tr
id=sl_svn102_159
...
><td class="source">		else if(asLowerCaseString(str) == &quot;logout&quot;){<br></td></tr
><tr
id=sl_svn102_161

><td class="source">			m_type = CREATURE_EVENT_LOGOUT;<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">		else if(asLowerCaseString(str) == &quot;die&quot;){<br></td></tr
><tr
id=sl_svn102_164

><td class="source">			m_type = CREATURE_EVENT_DIE;<br></td></tr
><tr
id=sl_svn102_165
...
><td class="source">		else if(asLowerCaseString(str) == &quot;kill&quot;){<br></td></tr
><tr
id=sl_svn102_167

><td class="source">			m_type = CREATURE_EVENT_KILL;<br></td></tr
><tr
id=sl_svn102_168
...
><td class="source">		else if(asLowerCaseString(str) == &quot;advance&quot;){<br></td></tr
><tr
id=sl_svn102_170

><td class="source">			m_type = CREATURE_EVENT_ADVANCE;<br></td></tr
><tr
id=sl_svn102_171
...
><td class="source">		else if(asLowerCaseString(str) == &quot;look&quot;){<br></td></tr
><tr
id=sl_svn102_173

><td class="source">			m_type = CREATURE_EVENT_LOOK;<br></td></tr
><tr
id=sl_svn102_174
...
><td class="source">			std::cout &lt;&lt; &quot;Error: [CreatureEvent::configureEvent] No valid type for creature event.&quot; &lt;&lt; str &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_177
...
><td class="source">		std::cout &lt;&lt; &quot;Error: [CreatureEvent::configureEvent] No type for creature event.&quot;  &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_182
...
><td class="source">std::string CreatureEvent::getScriptEventName()<br></td></tr
><tr
id=sl_svn102_189
...
><td class="source">	//Depending on the type script event name is different<br></td></tr
><tr
id=sl_svn102_191

><td class="source">	switch(m_type){<br></td></tr
><tr
id=sl_svn102_192

><td class="source">	case CREATURE_EVENT_LOGIN:<br></td></tr
><tr
id=sl_svn102_193

><td class="source">		return &quot;onLogin&quot;;<br></td></tr
><tr
id=sl_svn102_194

><td class="source">	case CREATURE_EVENT_LOGOUT:<br></td></tr
><tr
id=sl_svn102_195

><td class="source">		return &quot;onLogout&quot;;<br></td></tr
><tr
id=sl_svn102_196

><td class="source">	case CREATURE_EVENT_DIE:<br></td></tr
><tr
id=sl_svn102_197

><td class="source">		return &quot;onDie&quot;;<br></td></tr
><tr
id=sl_svn102_198

><td class="source">	case CREATURE_EVENT_KILL:<br></td></tr
><tr
id=sl_svn102_199

><td class="source">		return &quot;onKill&quot;;<br></td></tr
><tr
id=sl_svn102_200

><td class="source">	case CREATURE_EVENT_ADVANCE:<br></td></tr
><tr
id=sl_svn102_201

><td class="source">		return &quot;onAdvance&quot;;<br></td></tr
><tr
id=sl_svn102_202

><td class="source">	case CREATURE_EVENT_LOOK:<br></td></tr
><tr
id=sl_svn102_203

><td class="source">		return &quot;onLook&quot;;<br></td></tr
><tr
id=sl_svn102_204
...
><td class="source">bool CreatureEvent::executeOnLogin(Player* player)<br></td></tr
><tr
id=sl_svn102_211
...
><td class="source">	//onLogin(cid)<br></td></tr
><tr
id=sl_svn102_213
...
><td class="source">		desc &lt;&lt; player-&gt;getName();<br></td></tr
><tr
id=sl_svn102_219
...
><td class="source">		bool result = m_scriptInterface-&gt;callFunction(1);<br></td></tr
><tr
id=sl_svn102_233
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. CreatureEvent::executeOnLogin&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_239
...
><td class="source">bool CreatureEvent::executeOnLogout(Player* player)<br></td></tr
><tr
id=sl_svn102_244
...
><td class="source">	//onLogout(cid)<br></td></tr
><tr
id=sl_svn102_246
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. CreatureEvent::executeOnLogout&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_272
...
><td class="source">void CreatureEvent::executeOnDie(Creature* creature, Item* corpse)<br></td></tr
><tr
id=sl_svn102_277
...
><td class="source">	//onDie(cid, corpse)<br></td></tr
><tr
id=sl_svn102_279
...
><td class="source">		desc &lt;&lt; creature-&gt;getName();<br></td></tr
><tr
id=sl_svn102_285
...
><td class="source">		uint32_t corpseid = env-&gt;addThing(corpse);<br></td></tr
><tr
id=sl_svn102_293
...
><td class="source">		lua_pushnumber(L, corpseid);<br></td></tr
><tr
id=sl_svn102_299
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. CreatureEvent::executeOnDie&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_305
...
><td class="source">void CreatureEvent::executeOnKill(Creature* creature, Creature* target, bool lastHit)<br></td></tr
><tr
id=sl_svn102_309
...
><td class="source">	//onKill(cid, target, lasthit)<br></td></tr
><tr
id=sl_svn102_311
...
><td class="source">		uint32_t targetId = env-&gt;addThing(target);<br></td></tr
><tr
id=sl_svn102_325
...
><td class="source">		lua_pushnumber(L, targetId);<br></td></tr
><tr
id=sl_svn102_331

><td class="source">		lua_pushboolean(L, (lastHit ? true : false));<br></td></tr
><tr
id=sl_svn102_332
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] __ENABLE_SERVER_DIAGNOSTIC__Call stack overflow. CreatureEvent::executeOnKill&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_338
...
><td class="source">void CreatureEvent::executeOnAdvance(Player* player, levelTypes_t type,<br></td></tr
><tr
id=sl_svn102_342

><td class="source">	uint32_t oldLevel, uint32_t newLevel)<br></td></tr
><tr
id=sl_svn102_343
...
><td class="source">	//onAdvance(cid, type, oldlevel, newlevel)<br></td></tr
><tr
id=sl_svn102_345
...
><td class="source">		lua_pushnumber(L, (uint32_t)type);<br></td></tr
><tr
id=sl_svn102_364

><td class="source">		lua_pushnumber(L, oldLevel);<br></td></tr
><tr
id=sl_svn102_365

><td class="source">		lua_pushnumber(L, newLevel);<br></td></tr
><tr
id=sl_svn102_366
...
><td class="source">		m_scriptInterface-&gt;callFunction(4);<br></td></tr
><tr
id=sl_svn102_368
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. CreatureEvent::executeOnAdvance&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_372
...
><td class="source">bool CreatureEvent::executeOnLook(Player* player, Thing* target, uint16_t itemId)<br></td></tr
><tr
id=sl_svn102_376
...
><td class="source">	//onLook(cid, thing, itemId)<br></td></tr
><tr
id=sl_svn102_378
...
><td class="source">		uint32_t target_id = 0;<br></td></tr
><tr
id=sl_svn102_396

><td class="source">		if(target){<br></td></tr
><tr
id=sl_svn102_397

><td class="source">			if(target-&gt;getCreature())<br></td></tr
><tr
id=sl_svn102_398

><td class="source">				target_id = env-&gt;addThing(target-&gt;getCreature());<br></td></tr
><tr
id=sl_svn102_399

><td class="source">			else if(target-&gt;getItem())<br></td></tr
><tr
id=sl_svn102_400

><td class="source">				target_id = env-&gt;addThing(target-&gt;getItem());<br></td></tr
><tr
id=sl_svn102_401
...
><td class="source">				target = NULL;<br></td></tr
><tr
id=sl_svn102_403
...
><td class="source">			LuaScriptInterface::pushThing(L, target, target_id);<br></td></tr
><tr
id=sl_svn102_407
...
><td class="source">		lua_pushnumber(L, itemId);<br></td></tr
><tr
id=sl_svn102_411
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. CreatureEvent::executeOnLook&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_418
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/creatureevent.cpp&amp;old_path=/trunk/src/creatureevent.cpp&amp;old=81">Diff</a>
 </div>
...
don't recommend using this revision</pre>
 ...
 var selected_path = '/trunk/src/creatureevent.cpp';
 ...
 by r...@ymail.com
 on Jul 14, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=81&amp;format=side&amp;path=/trunk/src/creatureevent.cpp&amp;old_path=/trunk/src/creatureevent.cpp&amp;old=52">Diff</a>
 <br>
...
onLook added</pre>
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/creatureevent.cpp&amp;old_path=/trunk/src/creatureevent.cpp&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/creatureevent.cpp&amp;old_path=/trunk/src/creatureevent.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/creatureevent.cpp&start=95">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 11216 bytes,
 420 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/creatureevent.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/creatureevent.cpp'}
 codereviews = CR_controller.setup(
 {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdYJzV9jYLf6ff5wUtbBA8bdmhl-g:1406096445359", "relativeBaseUrl": "", "domainName": null, "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "profileUrl": "/u/108692122734644646415/"}, '', 'svn102', paths,
