...
<head>
 ...
 var codesite_token = "ABZ6GAet_APBArlxKVnpzaAg1A7aazsokQ:1406096588495";
 
 
 var CS_env = {"loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectName": "avesta74", "token": "ABZ6GAet_APBArlxKVnpzaAg1A7aazsokQ:1406096588495", "profileUrl": "/u/108692122734644646415/"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fmap.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>map.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/map.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/map.h?r=86" title="Previous">&lsaquo;r86</a></li>
...
><td class="source">#ifndef __OTSERV_MAP_H__<br></td></tr
><tr
id=sl_svn102_23

><td class="source">#define __OTSERV_MAP_H__<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">#include &quot;waypoints.h&quot;<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">#include &lt;bitset&gt;<br></td></tr
><tr
id=sl_svn102_36
...
><td class="source">#include &lt;boost/shared_ptr.hpp&gt;<br></td></tr
><tr
id=sl_svn102_39

><td class="source">using boost::shared_ptr;<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">#define MAP_MAX_LAYERS 16<br></td></tr
><tr
id=sl_svn102_47
...
><td class="source">class IOMap;<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">struct AStarNode{<br></td></tr
><tr
id=sl_svn102_53

><td class="source">	int32_t x, y;<br></td></tr
><tr
id=sl_svn102_54

><td class="source">	AStarNode* parent;<br></td></tr
><tr
id=sl_svn102_55

><td class="source">	int32_t f, g, h;<br></td></tr
><tr
id=sl_svn102_56
...
><td class="source">#define MAX_NODES 512<br></td></tr
><tr
id=sl_svn102_59

><td class="source">#define GET_NODE_INDEX(a) (a - &amp;nodes[0])<br></td></tr
><tr
id=sl_svn102_60
...
><td class="source">#define MAP_NORMALWALKCOST 10<br></td></tr
><tr
id=sl_svn102_62

><td class="source">#define MAP_DIAGONALWALKCOST 25<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">class AStarNodes{<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	AStarNode* createOpenNode();<br></td></tr
><tr
id=sl_svn102_70

><td class="source">	AStarNode* getBestNode();<br></td></tr
><tr
id=sl_svn102_71

><td class="source">	void closeNode(AStarNode* node);<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	void openNode(AStarNode* node);<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	uint32_t countClosedNodes();<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	uint32_t countOpenNodes();<br></td></tr
><tr
id=sl_svn102_75

><td class="source">	bool isInList(int32_t x, int32_t y);<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	AStarNode* getNodeInList(int32_t x, int32_t y);<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	int32_t getMapWalkCost(const Creature* creature, AStarNode* node,<br></td></tr
><tr
id=sl_svn102_79
...
><td class="source">    static int32_t getTileWalkCost(const Creature* creature, const Tile* tile);<br></td></tr
><tr
id=sl_svn102_81

><td class="source">	int getEstimatedDistance(int32_t x, int32_t y, int32_t xGoal, int32_t yGoal);<br></td></tr
><tr
id=sl_svn102_82
...
><td class="source">	AStarNode nodes[MAX_NODES];<br></td></tr
><tr
id=sl_svn102_85

><td class="source">	std::bitset&lt;MAX_NODES&gt; openNodes;<br></td></tr
><tr
id=sl_svn102_86

><td class="source">	uint32_t curNode;<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">template&lt;class T&gt; class lessPointer : public std::binary_function&lt;T*, T*, bool&gt;<br></td></tr
><tr
id=sl_svn102_90
...
><td class="source">	bool operator()(T*&amp; t1, T*&amp; t2) {<br></td></tr
><tr
id=sl_svn102_93

><td class="source">		return *t1 &lt; *t2;<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">typedef std::list&lt;Creature*&gt; SpectatorVec;<br></td></tr
><tr
id=sl_svn102_98

><td class="source">typedef std::list&lt;Player*&gt; PlayerList;<br></td></tr
><tr
id=sl_svn102_99

><td class="source">typedef std::map&lt;Position, boost::shared_ptr&lt;SpectatorVec&gt; &gt; SpectatorCache;<br></td></tr
><tr
id=sl_svn102_100
...
><td class="source">#define FLOOR_BITS 3<br></td></tr
><tr
id=sl_svn102_102

><td class="source">#define FLOOR_SIZE (1 &lt;&lt; FLOOR_BITS)<br></td></tr
><tr
id=sl_svn102_103

><td class="source">#define FLOOR_MASK (FLOOR_SIZE - 1)<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">struct Floor{<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	Floor();<br></td></tr
><tr
id=sl_svn102_107

><td class="source">	Tile* tiles[FLOOR_SIZE][FLOOR_SIZE];<br></td></tr
><tr
id=sl_svn102_108
...
><td class="source">class QTreeLeafNode;<br></td></tr
><tr
id=sl_svn102_112
...
><td class="source">class QTreeNode{<br></td></tr
><tr
id=sl_svn102_114
...
><td class="source">	virtual ~QTreeNode();<br></td></tr
><tr
id=sl_svn102_117
...
><td class="source">	bool isLeaf(){return m_isLeaf;}<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">	static QTreeLeafNode* getLeafStatic(QTreeNode* root, uint32_t x, uint32_t y);<br></td></tr
><tr
id=sl_svn102_121

><td class="source">	QTreeLeafNode* createLeaf(uint32_t x, uint32_t y, uint32_t level);<br></td></tr
><tr
id=sl_svn102_122
...
><td class="source">	bool m_isLeaf;<br></td></tr
><tr
id=sl_svn102_125

><td class="source">	QTreeNode* m_child[4];<br></td></tr
><tr
id=sl_svn102_126
...
><td class="source">class QTreeLeafNode : public QTreeNode{<br></td></tr
><tr
id=sl_svn102_131
...
><td class="source">	QTreeLeafNode();<br></td></tr
><tr
id=sl_svn102_133

><td class="source">	virtual ~QTreeLeafNode();<br></td></tr
><tr
id=sl_svn102_134
...
><td class="source">	Floor* createFloor(uint32_t z);<br></td></tr
><tr
id=sl_svn102_136

><td class="source">	Floor* getFloor(uint16_t z){return m_array[z];}<br></td></tr
><tr
id=sl_svn102_137
...
><td class="source">	QTreeLeafNode* stepSouth(){return m_leafS;}<br></td></tr
><tr
id=sl_svn102_139

><td class="source">	QTreeLeafNode* stepEast(){return m_leafE;}<br></td></tr
><tr
id=sl_svn102_140
...
><td class="source">	void addCreature(Creature* c);<br></td></tr
><tr
id=sl_svn102_142

><td class="source">	void removeCreature(Creature* c);<br></td></tr
><tr
id=sl_svn102_143
...
><td class="source">	static bool newLeaf;<br></td></tr
><tr
id=sl_svn102_146

><td class="source">	QTreeLeafNode* m_leafS;<br></td></tr
><tr
id=sl_svn102_147

><td class="source">	QTreeLeafNode* m_leafE;<br></td></tr
><tr
id=sl_svn102_148

><td class="source">	Floor* m_array[MAP_MAX_LAYERS];<br></td></tr
><tr
id=sl_svn102_149

><td class="source">	CreatureVector creature_list;<br></td></tr
><tr
id=sl_svn102_150
...
><td class="source">	friend class QTreeNode;<br></td></tr
><tr
id=sl_svn102_153
...
><td class="source">  * Map class.<br></td></tr
><tr
id=sl_svn102_159

><td class="source">  * Holds all the actual map-data<br></td></tr
><tr
id=sl_svn102_160
...
><td class="source">	static const int32_t maxViewportX = 11;         //min value: maxClientViewportX + 1<br></td></tr
><tr
id=sl_svn102_169

><td class="source">	static const int32_t maxViewportY = 11;         //min value: max<br></td></tr
><tr
id=sl_svn102_170

><td class="source">	static const int32_t maxClientViewportX = 8;<br></td></tr
><tr
id=sl_svn102_171

><td class="source">	static const int32_t maxClientViewportY = 6;<br></td></tr
><tr
id=sl_svn102_172
...
><td class="source">	* \param identifier file/database to load<br></td></tr
><tr
id=sl_svn102_176

><td class="source">	* \param type map type &quot;OTBM&quot;, &quot;XML&quot;<br></td></tr
><tr
id=sl_svn102_177

><td class="source">	* \return true if the map was loaded successfully<br></td></tr
><tr
id=sl_svn102_178
...
><td class="source">	bool loadMap(const std::string&amp; identifier, const std::string&amp; type);<br></td></tr
><tr
id=sl_svn102_180
...
><td class="source">	* Save a map.<br></td></tr
><tr
id=sl_svn102_183

><td class="source">	* \param identifier file/database to save to<br></td></tr
><tr
id=sl_svn102_184

><td class="source">	* \return true if the map was saved successfully<br></td></tr
><tr
id=sl_svn102_185
...
><td class="source">	bool saveMap();<br></td></tr
><tr
id=sl_svn102_187
...
><td class="source">	* Get a single tile.<br></td></tr
><tr
id=sl_svn102_190

><td class="source">	* \return A pointer to that tile.<br></td></tr
><tr
id=sl_svn102_191
...
><td class="source">	Tile* getTile(uint16_t x, uint16_t y, uint16_t z);<br></td></tr
><tr
id=sl_svn102_193

><td class="source">	Tile* getTile(const Position&amp; pos);<br></td></tr
><tr
id=sl_svn102_194
...
><td class="source">	QTreeLeafNode* getLeaf(uint16_t x, uint16_t y){ return root.getLeaf(x, y);}<br></td></tr
><tr
id=sl_svn102_196
...
><td class="source">	* Set a single tile.<br></td></tr
><tr
id=sl_svn102_199

><td class="source">	* \param a tile to set for the<br></td></tr
><tr
id=sl_svn102_200
...
><td class="source">	void setTile(uint16_t _x, uint16_t _y, uint16_t _z, Tile* newtile);<br></td></tr
><tr
id=sl_svn102_202

><td class="source">	void setTile(const Position&amp; pos, Tile* newtile) {<br></td></tr
><tr
id=sl_svn102_203

><td class="source">        setTile(pos.x, pos.y, pos.z, newtile);<br></td></tr
><tr
id=sl_svn102_204
...
><td class="source">	* Place a creature on the map<br></td></tr
><tr
id=sl_svn102_208
...
><td class="source">	* \param extendedPos If true, the creature will in first-hand be placed 2 tiles away<br></td></tr
><tr
id=sl_svn102_211

><td class="source">	* \param forceLogin If true, placing the creature will not fail becase of obstacles (creatures/chests)<br></td></tr
><tr
id=sl_svn102_212
...
><td class="source">	bool placeCreature(const Position&amp; centerPos, Creature* creature, bool extendedPos = false, bool forceLogin = false);<br></td></tr
><tr
id=sl_svn102_214
...
><td class="source">	* Remove a creature from the map.<br></td></tr
><tr
id=sl_svn102_217

><td class="source">	* \param c Creature pointer to the creature to remove<br></td></tr
><tr
id=sl_svn102_218
...
><td class="source">	bool removeCreature(Creature* c);<br></td></tr
><tr
id=sl_svn102_220
...
><td class="source">	* Checks if you can throw an object to that position<br></td></tr
><tr
id=sl_svn102_223

><td class="source">	*	\param fromPos from Source point<br></td></tr
><tr
id=sl_svn102_224

><td class="source">	*	\param toPos Destination point<br></td></tr
><tr
id=sl_svn102_225

><td class="source">	*   \param rangex maximum allowed range horizontially<br></td></tr
><tr
id=sl_svn102_226

><td class="source">	*   \param rangey maximum allowed range vertically<br></td></tr
><tr
id=sl_svn102_227

><td class="source">	*   \param checkLineOfSight checks if there is any blocking objects in the way<br></td></tr
><tr
id=sl_svn102_228

><td class="source">	*	\return The result if you can throw there or not<br></td></tr
><tr
id=sl_svn102_229
...
><td class="source">	* Checks if path is clear from fromPos to toPos<br></td></tr
><tr
id=sl_svn102_235

><td class="source">	* Notice: This only checks a straight line if the path is clear, for path finding use getPathTo.<br></td></tr
><tr
id=sl_svn102_236
...
><td class="source">	*	\param floorCheck if true then view is not clear if fromPos.z is not the same as toPos.z<br></td></tr
><tr
id=sl_svn102_239

><td class="source">	*	\return The result if there is no obstacles<br></td></tr
><tr
id=sl_svn102_240
...
><td class="source">	bool isSightClear(const Position&amp; fromPos, const Position&amp; toPos, bool floorCheck) const;<br></td></tr
><tr
id=sl_svn102_242

><td class="source">	bool checkSightLine(const Position&amp; fromPos, const Position&amp; toPos) const;<br></td></tr
><tr
id=sl_svn102_243
...
><td class="source">	const Tile* canWalkTo(const Creature* creature, const Position&amp; pos);<br></td></tr
><tr
id=sl_svn102_245
...
><td class="source">	* Get the path to a specific position on the map.<br></td></tr
><tr
id=sl_svn102_248

><td class="source">	* \param creature The creature that wants a path<br></td></tr
><tr
id=sl_svn102_249

><td class="source">	* \param destPos The position we want a path calculated to<br></td></tr
><tr
id=sl_svn102_250

><td class="source">	* \param listDir contains a list of directions to the destination<br></td></tr
><tr
id=sl_svn102_251

><td class="source">	* \param maxDist Maximum distance from our current position to search, default: -1 (no limit)<br></td></tr
><tr
id=sl_svn102_252

><td class="source">	* \returns returns true if a path was found<br></td></tr
><tr
id=sl_svn102_253
...
><td class="source">		std::list&lt;Direction&gt;&amp; listDir, int32_t maxDist = -1);<br></td></tr
><tr
id=sl_svn102_256
...
><td class="source">	bool getPathMatching(const Creature* creature, std::list&lt;Direction&gt;&amp; dirList,<br></td></tr
><tr
id=sl_svn102_258
...
><td class="source">	// Waypoints on the map<br></td></tr
><tr
id=sl_svn102_261

><td class="source">	Waypoints waypoints;<br></td></tr
><tr
id=sl_svn102_262
...
><td class="source">	uint32_t mapWidth, mapHeight;<br></td></tr
><tr
id=sl_svn102_265

><td class="source">	std::string spawnfile;<br></td></tr
><tr
id=sl_svn102_266

><td class="source">	std::string housefile;<br></td></tr
><tr
id=sl_svn102_267

><td class="source">	SpectatorCache spectatorCache;<br></td></tr
><tr
id=sl_svn102_268
...
><td class="source">	// Actually scans the map for spectators<br></td></tr
><tr
id=sl_svn102_270

><td class="source">	void getSpectatorsInternal(SpectatorVec&amp; list, const Position&amp; centerPos, bool checkforduplicate,<br></td></tr
><tr
id=sl_svn102_271
...
><td class="source">	// Use this when a custom spectator vector is needed, this support many<br></td></tr
><tr
id=sl_svn102_276

><td class="source">	// more parameters than the heavily cached version below.<br></td></tr
><tr
id=sl_svn102_277
...
><td class="source">	// The returned SpectatorVec is a temporary and should not be kept around<br></td></tr
><tr
id=sl_svn102_282

><td class="source">	// Take special heed in that the vector will be destroyed if any function<br></td></tr
><tr
id=sl_svn102_283

><td class="source">	// that calls clearSpectatorCache is called.<br></td></tr
><tr
id=sl_svn102_284
...
><td class="source">	// Root node of the quad tree<br></td></tr
><tr
id=sl_svn102_289

><td class="source">	QTreeNode root;<br></td></tr
><tr
id=sl_svn102_290
...
><td class="source">	struct RefreshBlock_t{<br></td></tr
><tr
id=sl_svn102_292

><td class="source">		ItemVector list;<br></td></tr
><tr
id=sl_svn102_293

><td class="source">		uint64_t lastRefresh;<br></td></tr
><tr
id=sl_svn102_294
...
><td class="source">	typedef std::map&lt;Tile*, RefreshBlock_t&gt; TileMap;<br></td></tr
><tr
id=sl_svn102_297

><td class="source">	TileMap refreshTileMap;<br></td></tr
><tr
id=sl_svn102_298
...
><td class="source">	friend class IOMapOTBM;<br></td></tr
><tr
id=sl_svn102_302

><td class="source">	friend class IOMapXML;<br></td></tr
><tr
id=sl_svn102_303

><td class="source">	friend class IOMap;<br></td></tr
><tr
id=sl_svn102_304

><td class="source">	friend class IOMapSerialize;<br></td></tr
><tr
id=sl_svn102_305
...
><td class="source">inline void QTreeLeafNode::addCreature(Creature* c) {<br></td></tr
><tr
id=sl_svn102_308

><td class="source">	creature_list.push_back(c);<br></td></tr
><tr
id=sl_svn102_309
...
><td class="source">inline void QTreeLeafNode::removeCreature(Creature* c) {<br></td></tr
><tr
id=sl_svn102_312

><td class="source">	CreatureVector::iterator iter = std::find(creature_list.begin(), creature_list.end(), c);<br></td></tr
><tr
id=sl_svn102_313

><td class="source">	assert(iter != creature_list.end());<br></td></tr
><tr
id=sl_svn102_314

><td class="source">	std::swap(*iter, creature_list.back());<br></td></tr
><tr
id=sl_svn102_315

><td class="source">	creature_list.pop_back();<br></td></tr
><tr
id=sl_svn102_316
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/map.h&amp;old_path=/trunk/src/map.h&amp;old=86">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/map.h';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=86&amp;format=side&amp;path=/trunk/src/map.h&amp;old_path=/trunk/src/map.h&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/map.h&amp;old_path=/trunk/src/map.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/map.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/map.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/map.h'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectName": "avesta74", "token": "ABZ6GAet_APBArlxKVnpzaAg1A7aazsokQ:1406096588495", "profileUrl": "/u/108692122734644646415/"}, '', 'svn102', paths,
