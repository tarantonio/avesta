...
<head>
 ...
 var codesite_token = "ABZ6GAc_huwxLdOw7JxBaYGpYTTdKRSEIQ:1406096453122";
 
 
 var CS_env = {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAc_huwxLdOw7JxBaYGpYTTdKRSEIQ:1406096453122", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fcylinder.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>cylinder.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/cylinder.h?edit=1"
...
><td class="source">#ifndef __OTSERV_CYLINDER_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_CYLINDER_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">#define INDEX_WHEREEVER -1<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">enum cylinderflags_t {<br></td></tr
><tr
id=sl_svn102_35

><td class="source">	FLAG_NOLIMIT = 1,				                  //Bypass limits like capacity/container limits, blocking items/creatures etc.<br></td></tr
><tr
id=sl_svn102_36

><td class="source">	FLAG_IGNOREBLOCKITEM = 2,		              //Bypass moveable blocking item checks<br></td></tr
><tr
id=sl_svn102_37

><td class="source">	FLAG_IGNOREBLOCKCREATURE = 4,	          //Bypass creature checks<br></td></tr
><tr
id=sl_svn102_38

><td class="source">	FLAG_CHILDISOWNER = 8,			              //Used by containers to query capacity of the carrier (player)<br></td></tr
><tr
id=sl_svn102_39

><td class="source">	FLAG_PATHFINDING = 16,			              //An additional check is done for floor changing/teleport items<br></td></tr
><tr
id=sl_svn102_40

><td class="source">	FLAG_IGNOREFIELDDAMAGE = 32,	          //Bypass field damage checks<br></td></tr
><tr
id=sl_svn102_41

><td class="source">	FLAG_IGNORENOTMOVEABLE = 64             //Bypass check for movability<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">enum cylinderlink_t{<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	LINK_OWNER,<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	LINK_PARENT,<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	LINK_TOPPARENT,<br></td></tr
><tr
id=sl_svn102_48

><td class="source">	LINK_NEAR<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">class Cylinder : virtual public Thing{<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">	  * Query if the cylinder can add an object<br></td></tr
><tr
id=sl_svn102_55

><td class="source">	  * \param index points to the destination index (inventory slot/container position)<br></td></tr
><tr
id=sl_svn102_56

><td class="source">		* -1 is a internal value and means add to a empty position, with no destItem<br></td></tr
><tr
id=sl_svn102_57

><td class="source">	  * \param thing the object to move/add<br></td></tr
><tr
id=sl_svn102_58

><td class="source">	  * \param count is the amount that we want to move/add<br></td></tr
><tr
id=sl_svn102_59

><td class="source">	  * \param flags if FLAG_CHILDISOWNER if set the query is from a child-cylinder (check cap etc.)<br></td></tr
><tr
id=sl_svn102_60

><td class="source">		* if FLAG_NOLIMIT is set blocking items/container limits is ignored<br></td></tr
><tr
id=sl_svn102_61

><td class="source">	  * \return ReturnValue holds the return value<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">	virtual ReturnValue __queryAdd(int32_t index, const Thing* Item, uint32_t count,<br></td></tr
><tr
id=sl_svn102_64

><td class="source">		uint32_t flags) const = 0;<br></td></tr
><tr
id=sl_svn102_65
...
><td class="source">	  * Query the cylinder how much it can accept<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	  * \param item the object to move/add<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">	  * \param maxQueryCount is the max amount that the cylinder can accept<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">	virtual ReturnValue __queryMaxCount(int32_t index, const Thing* thing, uint32_t count, uint32_t&amp; maxQueryCount,<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	  * Query if the cylinder can remove an object<br></td></tr
><tr
id=sl_svn102_81

><td class="source">	  * \param item the object to move/remove<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	  * \param count is the amount that we want to remove<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">	virtual ReturnValue __queryRemove(const Thing* thing, uint32_t count, uint32_t flags) const = 0;<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	  * Query the destination cylinder<br></td></tr
><tr
id=sl_svn102_90
...
><td class="source">		* this method can change the index to point to the new cylinder index<br></td></tr
><tr
id=sl_svn102_93

><td class="source">	  * \param destItem is the destination object<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">		* this method can modifiy the flags<br></td></tr
><tr
id=sl_svn102_96

><td class="source">	  * \return Cylinder returns the destination cylinder<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">	virtual Cylinder* __queryDestination(int32_t&amp; index, const Thing* thing, Item** destItem,<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">	  * Add the object to the cylinder<br></td></tr
><tr
id=sl_svn102_103

><td class="source">	  * \param item is the object to add<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	virtual void __addThing(Thing* thing) = 0;<br></td></tr
><tr
id=sl_svn102_106
...
><td class="source">	virtual void __addThing(int32_t index, Thing* thing) = 0;<br></td></tr
><tr
id=sl_svn102_113
...
><td class="source">	  * Update the item count or type for an object<br></td></tr
><tr
id=sl_svn102_116

><td class="source">	  * \param thing is the object to update<br></td></tr
><tr
id=sl_svn102_117

><td class="source">	  * \param itemId is the new item id<br></td></tr
><tr
id=sl_svn102_118

><td class="source">	  * \param count is the new count value<br></td></tr
><tr
id=sl_svn102_119
...
><td class="source">	virtual void __updateThing(Thing* thing, uint16_t itemId, uint32_t count) = 0;<br></td></tr
><tr
id=sl_svn102_121
...
><td class="source">	  * Replace an object with a new<br></td></tr
><tr
id=sl_svn102_124

><td class="source">	  * \param index is the position to change (inventory slot/container position)<br></td></tr
><tr
id=sl_svn102_125
...
><td class="source">	virtual void __replaceThing(uint32_t index, Thing* thing) = 0;<br></td></tr
><tr
id=sl_svn102_128
...
><td class="source">	  * Remove an object<br></td></tr
><tr
id=sl_svn102_131

><td class="source">	  * \param thing is the object to delete<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	virtual void __removeThing(Thing* thing, uint32_t count) = 0;<br></td></tr
><tr
id=sl_svn102_135
...
><td class="source">	  * Is sent after an operation (move/add) to update internal values<br></td></tr
><tr
id=sl_svn102_138

><td class="source">	  * \param thing is the object that has been added<br></td></tr
><tr
id=sl_svn102_139

><td class="source">	  * \param index is the objects new index value<br></td></tr
><tr
id=sl_svn102_140

><td class="source">	  * \param link holds the relation the object has to the cylinder<br></td></tr
><tr
id=sl_svn102_141
...
><td class="source">	virtual void postAddNotification(Thing* thing, const Cylinder* oldParent, int32_t index, cylinderlink_t link = LINK_OWNER) = 0;<br></td></tr
><tr
id=sl_svn102_143
...
><td class="source">	  * Is sent after an operation (move/remove) to update internal values<br></td></tr
><tr
id=sl_svn102_146

><td class="source">	  * \param thing is the object that has been removed<br></td></tr
><tr
id=sl_svn102_147

><td class="source">	  * \param index is the previous index of the removed object<br></td></tr
><tr
id=sl_svn102_148

><td class="source">	  * \param isCompleteRemoval indicates if the item was completely removed or just partially (stackables)<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">	virtual void postRemoveNotification(Thing* thing, const Cylinder* newParent, int32_t index, bool isCompleteRemoval, cylinderlink_t link = LINK_OWNER) = 0;<br></td></tr
><tr
id=sl_svn102_152
...
><td class="source">	  * Gets the index of an object<br></td></tr
><tr
id=sl_svn102_155

><td class="source">	  * \param thing the object to get the index value from<br></td></tr
><tr
id=sl_svn102_156

><td class="source">	  * \return the index of the object, returns -1 if not found<br></td></tr
><tr
id=sl_svn102_157
...
><td class="source">	virtual int32_t __getIndexOfThing(const Thing* thing) const;<br></td></tr
><tr
id=sl_svn102_159
...
><td class="source">	  * Return the first index<br></td></tr
><tr
id=sl_svn102_162

><td class="source">	  * \returns the first index, if not implemented -1 is returned<br></td></tr
><tr
id=sl_svn102_163
...
><td class="source">	virtual int32_t __getFirstIndex() const;<br></td></tr
><tr
id=sl_svn102_165
...
><td class="source">	  * Return the last index<br></td></tr
><tr
id=sl_svn102_168

><td class="source">	  * \return the last index, if not implemented -1 is returned<br></td></tr
><tr
id=sl_svn102_169
...
><td class="source">	virtual int32_t __getLastIndex() const;<br></td></tr
><tr
id=sl_svn102_171
...
><td class="source">	  * Gets the object based on index<br></td></tr
><tr
id=sl_svn102_174

><td class="source">	  * \return the object, returns NULL if not found<br></td></tr
><tr
id=sl_svn102_175
...
><td class="source">	virtual Thing* __getThing(uint32_t index) const;<br></td></tr
><tr
id=sl_svn102_177
...
><td class="source">	  * Get the amount of items of a certain type<br></td></tr
><tr
id=sl_svn102_180

><td class="source">	  * \param itemId is the item type to the get the count of<br></td></tr
><tr
id=sl_svn102_181

><td class="source">	  * \param subType is the extra type an item can have such as charges/fluidtype, -1 means not used<br></td></tr
><tr
id=sl_svn102_182

><td class="source">	  * \param itemCount if set to true it will only count items and not other subtypes like charges<br></td></tr
><tr
id=sl_svn102_183

><td class="source">	  * \param returns the amount of items of the asked item type<br></td></tr
><tr
id=sl_svn102_184
...
><td class="source">	virtual uint32_t __getItemTypeCount(uint16_t itemId, int32_t subType = -1, bool itemCount = true) const;<br></td></tr
><tr
id=sl_svn102_186
...
><td class="source">	  * Get the amount of items of a all types<br></td></tr
><tr
id=sl_svn102_189

><td class="source">	  * \param countMap a map to put the itemID:count mapping in<br></td></tr
><tr
id=sl_svn102_190
...
><td class="source">	  * \param returns a map mapping item id to count (same as first argument)<br></td></tr
><tr
id=sl_svn102_192
...
><td class="source">	virtual std::map&lt;uint32_t, uint32_t&gt;&amp; __getAllItemTypeCount(std::map&lt;uint32_t, uint32_t&gt;&amp; countMap, bool itemCount = true) const;<br></td></tr
><tr
id=sl_svn102_195
...
><td class="source">	  * Adds an object to the cylinder without sending to the client(s)<br></td></tr
><tr
id=sl_svn102_198

><td class="source">	  * \param thing is the object to add<br></td></tr
><tr
id=sl_svn102_199
...
><td class="source">	virtual void __internalAddThing(Thing* thing);<br></td></tr
><tr
id=sl_svn102_201
...
><td class="source">	virtual void __internalAddThing(uint32_t index, Thing* thing);<br></td></tr
><tr
id=sl_svn102_208
...
><td class="source">class VirtualCylinder : public Cylinder<br></td></tr
><tr
id=sl_svn102_213
...
><td class="source">    static VirtualCylinder* virtualCylinder;<br></td></tr
><tr
id=sl_svn102_216
...
><td class="source">    virtual ReturnValue __queryAdd(int32_t index, const Thing* thing, uint32_t count,<br></td></tr
><tr
id=sl_svn102_218

><td class="source">        uint32_t flags) const {return RET_NOTPOSSIBLE;}<br></td></tr
><tr
id=sl_svn102_219

><td class="source">    virtual ReturnValue __queryMaxCount(int32_t index, const Thing* thing, uint32_t count,<br></td></tr
><tr
id=sl_svn102_220

><td class="source">        uint32_t&amp; maxQueryCount, uint32_t flags) const {return RET_NOTPOSSIBLE;}<br></td></tr
><tr
id=sl_svn102_221

><td class="source">    virtual ReturnValue __queryRemove(const Thing* thing, uint32_t count, uint32_t flags) const {return RET_NOTPOSSIBLE;}<br></td></tr
><tr
id=sl_svn102_222
...
><td class="source">        uint32_t&amp; flags) {return NULL;}<br></td></tr
><tr
id=sl_svn102_224
...
><td class="source">    virtual void __addThing(Thing* thing) {}<br></td></tr
><tr
id=sl_svn102_226

><td class="source">    virtual void __addThing(int32_t index, Thing* thing) {}<br></td></tr
><tr
id=sl_svn102_227

><td class="source">    virtual void __updateThing(Thing* thing, uint16_t itemId, uint32_t count) {}<br></td></tr
><tr
id=sl_svn102_228

><td class="source">    virtual void __replaceThing(uint32_t index, Thing* thing) {}<br></td></tr
><tr
id=sl_svn102_229

><td class="source">    virtual void __removeThing(Thing* thing, uint32_t count) {}<br></td></tr
><tr
id=sl_svn102_230
...
><td class="source">    virtual void postAddNotification(Thing* thing, const Cylinder* oldParent, int32_t index, cylinderlink_t link = LINK_OWNER) {}<br></td></tr
><tr
id=sl_svn102_232

><td class="source">    virtual void postRemoveNotification(Thing* thing, const Cylinder* newParent, int32_t index, bool isCompleteRemoval,<br></td></tr
><tr
id=sl_svn102_233

><td class="source">        cylinderlink_t link = LINK_OWNER) {}<br></td></tr
><tr
id=sl_svn102_234
...
><td class="source">    virtual bool isPushable() const {return false;}<br></td></tr
><tr
id=sl_svn102_236
...
><td class="source">    virtual std::string getDescription(int32_t lookDistance) const {return &quot;&quot;;}<br></td></tr
><tr
id=sl_svn102_238
...
><td class="source">    virtual bool isRemoved() const {return false;}<br></td></tr
><tr
id=sl_svn102_240
...
<script type="text/javascript">
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/cylinder.h&amp;old_path=/trunk/src/cylinder.h&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/cylinder.h';
 ...
 <a href="/p/avesta74/source/list?path=/trunk/src/cylinder.h&start=7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 10051 bytes,
 242 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/cylinder.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/cylinder.h'}
 codereviews = CR_controller.setup(
 {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74", "projectHomeUrl": "/p/avesta74", "relativeBaseUrl": "", "loggedInUserEmail": "jose.guitian@coremain.com", "profileUrl": "/u/108692122734644646415/", "token": "ABZ6GAc_huwxLdOw7JxBaYGpYTTdKRSEIQ:1406096453122", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph"}, '', 'svn102', paths,
