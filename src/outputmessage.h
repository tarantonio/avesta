...
<head>
 ...
 var codesite_token = "ABZ6GAdYkK5UaD-lZw88OTQCHITqejQ_eg:1406096644878";
 
 
 var CS_env = {"projectName": "avesta74", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdYkK5UaD-lZw88OTQCHITqejQ_eg:1406096644878", "profileUrl": "/u/108692122734644646415/", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Foutputmessage.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>outputmessage.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/outputmessage.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/outputmessage.h?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#ifndef __OTSERV_OUTPUT_MESSAGE_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_OUTPUT_MESSAGE_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">#include &lt;boost/utility.hpp&gt;<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">class Protocol;<br></td></tr
><tr
id=sl_svn102_36

><td class="source">class Connection;<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">#define OUTPUT_POOL_SIZE 100<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">class OutputMessage : public NetworkMessage, boost::noncopyable<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	OutputMessage();<br></td></tr
><tr
id=sl_svn102_44
...
><td class="source">	char* getOutputBuffer() { return (char*)&amp;m_MsgBuf[m_outputBufferStart];}<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	void writeMessageLength()<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">        *(uint16_t*)(m_MsgBuf + 2) = m_MsgSize;<br></td></tr
><tr
id=sl_svn102_53

><td class="source">        //added header size to the message size<br></td></tr
><tr
id=sl_svn102_54

><td class="source">        m_MsgSize = m_MsgSize + 2;<br></td></tr
><tr
id=sl_svn102_55

><td class="source">        m_outputBufferStart = 2;<br></td></tr
><tr
id=sl_svn102_56
...
><td class="source">	void addCryptoHeader()<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">		*(uint16_t*)(m_MsgBuf) = m_MsgSize;<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">		m_outputBufferStart = 0;<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">	enum OutputMessageState{<br></td></tr
><tr
id=sl_svn102_66

><td class="source">		STATE_FREE,<br></td></tr
><tr
id=sl_svn102_67

><td class="source">		STATE_ALLOCATED,<br></td></tr
><tr
id=sl_svn102_68

><td class="source">		STATE_ALLOCATED_NO_AUTOSEND,<br></td></tr
><tr
id=sl_svn102_69

><td class="source">		STATE_WAITING<br></td></tr
><tr
id=sl_svn102_70
...
><td class="source">	Protocol* getProtocol() { return m_protocol;}<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	Connection* getConnection() { return m_connection;}<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	uint64_t getFrame() const { return m_frame;}<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">	//void setOutputBufferStart(uint32_t pos) {m_outputBufferStart = pos;}<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	//uint32_t getOutputBufferStart() const {return m_outputBufferStart;}<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">	virtual void Track(std::string file, long line, std::string func)<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">		if(last_uses.size() &gt;= 25) {<br></td></tr
><tr
id=sl_svn102_83

><td class="source">			last_uses.pop_front();<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">		os &lt;&lt; /*file &lt;&lt; &quot;:&quot;*/ &quot;line &quot; &lt;&lt; line &lt;&lt; &quot; &quot; &lt;&lt; func;<br></td></tr
><tr
id=sl_svn102_87

><td class="source">		last_uses.push_back(os.str());<br></td></tr
><tr
id=sl_svn102_88
...
><td class="source">	virtual void clearTrack()<br></td></tr
><tr
id=sl_svn102_90
...
><td class="source">		last_uses.clear();<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">	void PrintTrace()<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">		int n = 1;<br></td></tr
><tr
id=sl_svn102_96

><td class="source">		for(std::list&lt;std::string&gt;::const_reverse_iterator iter = last_uses.rbegin(); iter != last_uses.rend(); ++iter, ++n) {<br></td></tr
><tr
id=sl_svn102_97

><td class="source">			std::cout &lt;&lt; &quot;\t&quot; &lt;&lt; n &lt;&lt; &quot;.\t&quot; &lt;&lt; *iter &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_98
...
><td class="source">	std::list&lt;std::string&gt; last_uses;<br></td></tr
><tr
id=sl_svn102_105
...
><td class="source">	void freeMessage()<br></td></tr
><tr
id=sl_svn102_108
...
><td class="source">		setConnection(NULL);<br></td></tr
><tr
id=sl_svn102_110

><td class="source">		setProtocol(NULL);<br></td></tr
><tr
id=sl_svn102_111

><td class="source">		m_frame = 0;<br></td></tr
><tr
id=sl_svn102_112

><td class="source">		m_outputBufferStart = 4;<br></td></tr
><tr
id=sl_svn102_113

><td class="source">		//setState have to be the last one<br></td></tr
><tr
id=sl_svn102_114

><td class="source">		setState(OutputMessage::STATE_FREE);<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">	friend class OutputMessagePool;<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">	void setProtocol(Protocol* protocol){ m_protocol = protocol;}<br></td></tr
><tr
id=sl_svn102_120

><td class="source">	void setConnection(Connection* connection){ m_connection = connection;}<br></td></tr
><tr
id=sl_svn102_121
...
><td class="source">	void setState(OutputMessageState state) { m_state = state;}<br></td></tr
><tr
id=sl_svn102_123

><td class="source">	OutputMessageState getState() const { return m_state;}<br></td></tr
><tr
id=sl_svn102_124
...
><td class="source">	void setFrame(uint64_t frame) { m_frame = frame;}<br></td></tr
><tr
id=sl_svn102_126
...
><td class="source">	Protocol* m_protocol;<br></td></tr
><tr
id=sl_svn102_128

><td class="source">	Connection* m_connection;<br></td></tr
><tr
id=sl_svn102_129
...
><td class="source">	uint32_t m_outputBufferStart;<br></td></tr
><tr
id=sl_svn102_131

><td class="source">	uint64_t m_frame;<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">	OutputMessageState m_state;<br></td></tr
><tr
id=sl_svn102_134
...
><td class="source">typedef boost::shared_ptr&lt;OutputMessage&gt; OutputMessage_ptr;<br></td></tr
><tr
id=sl_svn102_137
...
><td class="source">class OutputMessagePool<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">	static OutputMessagePool* getInstance()<br></td></tr
><tr
id=sl_svn102_147
...
><td class="source">		static OutputMessagePool instance;<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">	void send(OutputMessage_ptr msg);<br></td></tr
><tr
id=sl_svn102_153

><td class="source">	void sendAll();<br></td></tr
><tr
id=sl_svn102_154

><td class="source">	void stop() {m_isOpen = false;}<br></td></tr
><tr
id=sl_svn102_155

><td class="source">	OutputMessage_ptr getOutputMessage(Protocol* protocol, bool autosend = true);<br></td></tr
><tr
id=sl_svn102_156

><td class="source">	void startExecutionFrame();<br></td></tr
><tr
id=sl_svn102_157
...
><td class="source">	size_t getTotalMessageCount() const {return m_allOutputMessages.size();}<br></td></tr
><tr
id=sl_svn102_159

><td class="source">	size_t getAvailableMessageCount() const {return m_outputMessages.size();}<br></td></tr
><tr
id=sl_svn102_160

><td class="source">	size_t getAutoMessageCount() const {return m_autoSendOutputMessages.size();}<br></td></tr
><tr
id=sl_svn102_161

><td class="source">	void addToAutoSend(OutputMessage_ptr msg);<br></td></tr
><tr
id=sl_svn102_162
...
><td class="source">	void configureOutputMessage(OutputMessage_ptr msg, Protocol* protocol, bool autosend);<br></td></tr
><tr
id=sl_svn102_166

><td class="source">	void releaseMessage(OutputMessage* msg);<br></td></tr
><tr
id=sl_svn102_167

><td class="source">	void internalReleaseMessage(OutputMessage* msg);<br></td></tr
><tr
id=sl_svn102_168
...
><td class="source">	typedef std::list&lt;OutputMessage*&gt; InternalOutputMessageList;<br></td></tr
><tr
id=sl_svn102_170

><td class="source">	typedef std::list&lt;OutputMessage_ptr&gt; OutputMessageMessageList;<br></td></tr
><tr
id=sl_svn102_171
...
><td class="source">	InternalOutputMessageList m_outputMessages;<br></td></tr
><tr
id=sl_svn102_173

><td class="source">	InternalOutputMessageList m_allOutputMessages;<br></td></tr
><tr
id=sl_svn102_174

><td class="source">	OutputMessageMessageList m_autoSendOutputMessages;<br></td></tr
><tr
id=sl_svn102_175

><td class="source">	OutputMessageMessageList m_toAddQueue;<br></td></tr
><tr
id=sl_svn102_176

><td class="source">	boost::recursive_mutex m_outputPoolLock;<br></td></tr
><tr
id=sl_svn102_177

><td class="source">	uint64_t m_frameTime;<br></td></tr
><tr
id=sl_svn102_178

><td class="source">	bool m_isOpen;<br></td></tr
><tr
id=sl_svn102_179
...
><td class="source">#define TRACK_MESSAGE(omsg) (omsg)-&gt;Track(__FILE__, __LINE__, __FUNCTION__)<br></td></tr
><tr
id=sl_svn102_183
...
><td class="source">#define TRACK_MESSAGE(omsg)<br></td></tr
><tr
id=sl_svn102_185
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/outputmessage.h&amp;old_path=/trunk/src/outputmessage.h&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/outputmessage.h';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/outputmessage.h&amp;old_path=/trunk/src/outputmessage.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/outputmessage.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/outputmessage.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/outputmessage.h'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdYkK5UaD-lZw88OTQCHITqejQ_eg:1406096644878", "profileUrl": "/u/108692122734644646415/", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/avesta74"}, '', 'svn102', paths,
