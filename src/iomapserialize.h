...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAce0ra9N3j_fHVhGkZyN7iCk9Hp9g:1406096532864";
 
 
 var CS_env = {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAce0ra9N3j_fHVhGkZyN7iCk9Hp9g:1406096532864", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectHomeUrl": "/p/avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fiomapserialize.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>iomapserialize.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/iomapserialize.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/iomapserialize.h?r=86" title="Previous">&lsaquo;r86</a></li>
...
><td class="source">#ifndef __OTSERV_IOMAPSERIALIZE_H__<br></td></tr
><tr
id=sl_svn102_23

><td class="source">#define __OTSERV_IOMAPSERIALIZE_H__<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">class IOMapSerialize{<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">	static IOMapSerialize* getInstance()<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">        static IOMapSerialize instance;<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">    IOMapSerialize() {}<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	/** Load the map from a file/database<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	  * \param map pointer to the Map class<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	  * \return Returns true if the map was loaded successfully<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">	bool loadMap(Map* map);<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	/** Save the map to a file/database<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">	  * \return Returns true if the map was saved successfully<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">	bool saveMap(Map* map);<br></td></tr
><tr
id=sl_svn102_56
...
><td class="source">	/** Load the house access list to a file/database<br></td></tr
><tr
id=sl_svn102_58
...
><td class="source">	  * \return Returns true if the house access list was opened successfully<br></td></tr
><tr
id=sl_svn102_60
...
><td class="source">	bool loadHouseInfo(Map* map);<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">	/** Save the house access list to a file/database<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">	  * \return Returns true if the house access list was saved successfully<br></td></tr
><tr
id=sl_svn102_66
...
><td class="source">	bool saveHouseInfo(Map* map);<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	// Relational storage uses a row for each item/tile<br></td></tr
><tr
id=sl_svn102_71

><td class="source">	bool loadMapRelational(Map* map);<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	bool saveMapRelational(Map* map);<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">	bool saveItems(Database* db, uint32_t tileId, uint32_t houseId, const Tile* tile);<br></td></tr
><tr
id=sl_svn102_75

><td class="source">	bool loadItems(Database* db, DBResult* result, Cylinder* parent);<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">	// Binary storage uses a giant BLOB field for storing everything<br></td></tr
><tr
id=sl_svn102_78

><td class="source">	bool loadMapBinary(Map* map);<br></td></tr
><tr
id=sl_svn102_79

><td class="source">	bool saveMapBinary(Map* map);<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">	bool saveItem(PropWriteStream&amp; stream, const Item* item);<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	bool saveTile(PropWriteStream&amp; stream, const Tile* tile);<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	bool loadItem(PropStream&amp; propStream, Cylinder* parent);<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	bool loadContainer(PropStream&amp; propStream, Container* container);<br></td></tr
><tr
id=sl_svn102_85
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/iomapserialize.h&amp;old_path=/trunk/src/iomapserialize.h&amp;old=86">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/iomapserialize.h';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=86&amp;format=side&amp;path=/trunk/src/iomapserialize.h&amp;old_path=/trunk/src/iomapserialize.h&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/iomapserialize.h&amp;old_path=/trunk/src/iomapserialize.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/iomapserialize.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/iomapserialize.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/iomapserialize.h'}
 codereviews = CR_controller.setup(
 {"projectName": "avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAce0ra9N3j_fHVhGkZyN7iCk9Hp9g:1406096532864", "profileUrl": "/u/108692122734644646415/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectHomeUrl": "/p/avesta74"}, '', 'svn102', paths,
