...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAcxmLhTHGbq0TW5wjDayF_rBG_RiQ:1406096638808";
 
 
 var CS_env = {"domainName": null, "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAcxmLhTHGbq0TW5wjDayF_rBG_RiQ:1406096638808", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Foutfit.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>outfit.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/outfit.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/outfit.cpp?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">#include &quot;outfit.h&quot;<br></td></tr
><tr
id=sl_svn102_24
...
><td class="source">OutfitList::OutfitList()<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">	OutfitListType::iterator it;<br></td></tr
><tr
id=sl_svn102_40

><td class="source">	for(it = m_list.begin(); it != m_list.end(); it++){<br></td></tr
><tr
id=sl_svn102_41
...
><td class="source">	m_list.clear();<br></td></tr
><tr
id=sl_svn102_44
...
><td class="source">void OutfitList::addOutfit(const Outfit&amp; outfit)<br></td></tr
><tr
id=sl_svn102_47
...
><td class="source">		if((*it)-&gt;looktype == outfit.looktype){<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">	//adding a new outfit<br></td></tr
><tr
id=sl_svn102_55

><td class="source">	Outfit* new_outfit = new Outfit;<br></td></tr
><tr
id=sl_svn102_56

><td class="source">	new_outfit-&gt;looktype = outfit.looktype;<br></td></tr
><tr
id=sl_svn102_57

><td class="source">	new_outfit-&gt;premium = outfit.premium;<br></td></tr
><tr
id=sl_svn102_58

><td class="source">	m_list.push_back(new_outfit);<br></td></tr
><tr
id=sl_svn102_59
...
><td class="source">bool OutfitList::remOutfit(const Outfit&amp; outfit)<br></td></tr
><tr
id=sl_svn102_62
...
><td class="source">bool OutfitList::isInList(uint32_t looktype, bool playerPremium) const<br></td></tr
><tr
id=sl_svn102_73
...
><td class="source">	OutfitListType::const_iterator it;<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">		if((*it)-&gt;looktype == looktype){<br></td></tr
><tr
id=sl_svn102_77

><td class="source">			if(((*it)-&gt;premium &amp;&amp; playerPremium) || !(*it)-&gt;premium){<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">Outfits::Outfits()<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">	Outfit outfit;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	//build default outfit lists<br></td></tr
><tr
id=sl_svn102_92

><td class="source">	outfit.premium = false;<br></td></tr
><tr
id=sl_svn102_93

><td class="source">	for(int i = PLAYER_FEMALE_1; i &lt;= PLAYER_FEMALE_7; i++){<br></td></tr
><tr
id=sl_svn102_94

><td class="source">		outfit.looktype = i;<br></td></tr
><tr
id=sl_svn102_95

><td class="source">		m_female_list.addOutfit(outfit);<br></td></tr
><tr
id=sl_svn102_96
...
><td class="source">	for(int i = PLAYER_MALE_1; i &lt;= PLAYER_MALE_7; i++){<br></td></tr
><tr
id=sl_svn102_99
...
><td class="source">		m_male_list.addOutfit(outfit);<br></td></tr
><tr
id=sl_svn102_101
...
><td class="source">	m_list.resize(10, NULL);<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	OutfitsListVector::iterator it;<br></td></tr
><tr
id=sl_svn102_109
...
><td class="source">bool Outfits::loadFromXml(const std::string&amp; datadir)<br></td></tr
><tr
id=sl_svn102_116
...
><td class="source">	std::string filename = datadir + &quot;outfits.xml&quot;;<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">		if(xmlStrcmp(root-&gt;name,(const xmlChar*)&quot;outfits&quot;) != 0){<br></td></tr
><tr
id=sl_svn102_125
...
><td class="source">			std::cout &lt;&lt; &quot;Warning: outfits.xml not found, using defaults.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_127
...
><td class="source">			int intVal;<br></td></tr
><tr
id=sl_svn102_135

><td class="source">			if(xmlStrcmp(p-&gt;name, (const xmlChar*)&quot;outfit&quot;) == 0){<br></td></tr
><tr
id=sl_svn102_136

><td class="source">				if(readXMLInteger(p, &quot;type&quot;, intVal)){<br></td></tr
><tr
id=sl_svn102_137

><td class="source">					if(intVal &gt; 9 || intVal &lt; 0){<br></td></tr
><tr
id=sl_svn102_138

><td class="source">						std::cout &lt;&lt; &quot;Warning: No valid outfit type &quot; &lt;&lt; intVal &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">						OutfitList* list;<br></td></tr
><tr
id=sl_svn102_142
...
><td class="source">						if(m_list[intVal] != NULL){<br></td></tr
><tr
id=sl_svn102_144

><td class="source">							list = m_list[intVal];<br></td></tr
><tr
id=sl_svn102_145
...
><td class="source">							list = new OutfitList;<br></td></tr
><tr
id=sl_svn102_148

><td class="source">							m_list[intVal] = list;<br></td></tr
><tr
id=sl_svn102_149
...
><td class="source">						std::string outfitName;<br></td></tr
><tr
id=sl_svn102_153

><td class="source">						bool enabled = true;<br></td></tr
><tr
id=sl_svn102_154

><td class="source">						readXMLString(p, &quot;name&quot;, outfitName);<br></td></tr
><tr
id=sl_svn102_155

><td class="source">						if(readXMLInteger(p, &quot;looktype&quot;, intVal)){<br></td></tr
><tr
id=sl_svn102_156

><td class="source">							outfit.looktype = intVal;<br></td></tr
><tr
id=sl_svn102_157
...
><td class="source">							std::cout &lt;&lt; &quot;Missing looktype on an outfit.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_160
...
><td class="source">						if(readXMLInteger(p, &quot;premium&quot;, intVal))<br></td></tr
><tr
id=sl_svn102_163

><td class="source">							outfit.premium = (intVal != 0);<br></td></tr
><tr
id=sl_svn102_164
...
><td class="source">						if(readXMLInteger(p, &quot;enabled&quot;, intVal)){<br></td></tr
><tr
id=sl_svn102_167

><td class="source">							enabled = (intVal != 0);<br></td></tr
><tr
id=sl_svn102_168
...
><td class="source">						outfitNamesMap[outfit.looktype] = outfitName;<br></td></tr
><tr
id=sl_svn102_171
...
><td class="source">						if(enabled){ //This way you can add names for outfits without adding them to default list<br></td></tr
><tr
id=sl_svn102_173

><td class="source">							list-&gt;addOutfit(outfit);<br></td></tr
><tr
id=sl_svn102_174
...
><td class="source">					std::cout &lt;&lt; &quot;Missing outfit type.&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_179
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/outfit.cpp&amp;old_path=/trunk/src/outfit.cpp&amp;old=7">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/outfit.cpp';
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/outfit.cpp&amp;old_path=/trunk/src/outfit.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/outfit.cpp&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/outfit.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/outfit.cpp'}
 codereviews = CR_controller.setup(
 {"domainName": null, "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAcxmLhTHGbq0TW5wjDayF_rBG_RiQ:1406096638808", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74"}, '', 'svn102', paths,
