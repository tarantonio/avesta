...
<head>
 ...
 var codesite_token = "ABZ6GAcn3JhF_-PX5ILQ9rOSzeJPIZahqw:1406096626643";
 
 
 var CS_env = {"token": "ABZ6GAcn3JhF_-PX5ILQ9rOSzeJPIZahqw:1406096626643", "profileUrl": "/u/108692122734644646415/", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": ""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fotsystem.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>otsystem.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/otsystem.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/otsystem.h?r=47" title="Previous">&lsaquo;r47</a></li>
...
><td class="source">#ifndef __OTSERV_OTTHREAD_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_OTTHREAD_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">typedef std::vector&lt; std::pair&lt;uint32_t, uint32_t&gt; &gt; IPList;<br></td></tr
><tr
id=sl_svn102_32
...
><td class="source">#ifdef __WINDOWS__<br></td></tr
><tr
id=sl_svn102_34

><td class="source">#ifdef __WIN_LOW_FRAG_HEAP__<br></td></tr
><tr
id=sl_svn102_35
...
><td class="source">#include &lt;sys/types.h&gt;<br></td></tr
><tr
id=sl_svn102_41

><td class="source">#include &lt;sys/timeb.h&gt;<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">#ifndef EWOULDBLOCK<br></td></tr
><tr
id=sl_svn102_44

><td class="source">	#define EWOULDBLOCK WSAEWOULDBLOCK<br></td></tr
><tr
id=sl_svn102_45
...
><td class="source">inline int64_t OTSYS_TIME()<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">  _timeb t;<br></td></tr
><tr
id=sl_svn102_50

><td class="source">  _ftime(&amp;t);<br></td></tr
><tr
id=sl_svn102_51

><td class="source">  return ((int64_t)t.millitm) + ((int64_t)t.time) * 1000;<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">typedef int socklen_t;<br></td></tr
><tr
id=sl_svn102_55
...
><td class="source">#else  // __WINDOWS__<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">#include &lt;sys/socket.h&gt;<br></td></tr
><tr
id=sl_svn102_61

><td class="source">#include &lt;netinet/in.h&gt;<br></td></tr
><tr
id=sl_svn102_62

><td class="source">#include &lt;arpa/inet.h&gt;<br></td></tr
><tr
id=sl_svn102_63

><td class="source">#include &lt;netdb.h&gt;<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">	timeb t;<br></td></tr
><tr
id=sl_svn102_70

><td class="source">	ftime(&amp;t);<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">#ifndef SOCKET<br></td></tr
><tr
id=sl_svn102_75

><td class="source">#define SOCKET int<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">#ifndef closesocket<br></td></tr
><tr
id=sl_svn102_79

><td class="source">#define closesocket close<br></td></tr
><tr
id=sl_svn102_80
...
><td class="source">#endif // #if defined __WINDOWS__<br></td></tr
><tr
id=sl_svn102_83
...
><td class="source">#endif // #ifndef __OTSYSTEM_H__<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/otsystem.h&amp;old_path=/trunk/src/otsystem.h&amp;old=47">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/otsystem.h';
 ...
 by r...@ymail.com
 on Apr 15, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=47&amp;format=side&amp;path=/trunk/src/otsystem.h&amp;old_path=/trunk/src/otsystem.h&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/otsystem.h&amp;old_path=/trunk/src/otsystem.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/otsystem.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/otsystem.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/otsystem.h'}
 codereviews = CR_controller.setup(
 {"token": "ABZ6GAcn3JhF_-PX5ILQ9rOSzeJPIZahqw:1406096626643", "profileUrl": "/u/108692122734644646415/", "projectName": "avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": ""}, '', 'svn102', paths,
