...
<head>
 ...
 var codesite_token = "ABZ6GAf-02DqWts8afPwdhHTJaYEwwFmNw:1406096204348";
 
 
 var CS_env = {"assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "relativeBaseUrl": "", "token": "ABZ6GAf-02DqWts8afPwdhHTJaYEwwFmNw:1406096204348", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Factions.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>actions.cpp</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/actions.cpp?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/actions.cpp?r=52" title="Previous">&lsaquo;r52</a></li>
...
><td class="source">Actions::Actions() :<br></td></tr
><tr
id=sl_svn102_53

><td class="source">m_scriptInterface(&quot;Action Interface&quot;)<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">inline void Actions::clearMap(ActionUseMap&amp; map)<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">	ActionUseMap::iterator it = map.begin();<br></td></tr
><tr
id=sl_svn102_66

><td class="source">	while(it != map.end()){<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">		map.erase(it);<br></td></tr
><tr
id=sl_svn102_69

><td class="source">		it = map.begin();<br></td></tr
><tr
id=sl_svn102_70
...
><td class="source">void Actions::clear()<br></td></tr
><tr
id=sl_svn102_74
...
><td class="source">	clearMap(useItemMap);<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	clearMap(uniqueItemMap);<br></td></tr
><tr
id=sl_svn102_77

><td class="source">	clearMap(actionItemMap);<br></td></tr
><tr
id=sl_svn102_78
...
><td class="source">LuaScriptInterface&amp; Actions::getScriptInterface()<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">std::string Actions::getScriptBaseName()<br></td></tr
><tr
id=sl_svn102_89
...
><td class="source">Event* Actions::getEvent(const std::string&amp; nodeName)<br></td></tr
><tr
id=sl_svn102_94
...
><td class="source">	if(asLowerCaseString(nodeName) == &quot;action&quot;){<br></td></tr
><tr
id=sl_svn102_96

><td class="source">		return new Action(&amp;m_scriptInterface);<br></td></tr
><tr
id=sl_svn102_97
...
><td class="source">bool Actions::registerEvent(Event* event, xmlNodePtr p)<br></td></tr
><tr
id=sl_svn102_104
...
><td class="source">	Action* action = dynamic_cast&lt;Action*&gt;(event);<br></td></tr
><tr
id=sl_svn102_106

><td class="source">	if(!action)<br></td></tr
><tr
id=sl_svn102_107
...
><td class="source">	int value;<br></td></tr
><tr
id=sl_svn102_110

><td class="source">	if(readXMLInteger(p,&quot;itemid&quot;,value)){<br></td></tr
><tr
id=sl_svn102_111

><td class="source">		useItemMap[value] = action;<br></td></tr
><tr
id=sl_svn102_112
...
><td class="source">	else if(readXMLInteger(p,&quot;uniqueid&quot;,value)){<br></td></tr
><tr
id=sl_svn102_114

><td class="source">		uniqueItemMap[value] = action;<br></td></tr
><tr
id=sl_svn102_115
...
><td class="source">	else if(readXMLInteger(p,&quot;actionid&quot;,value)){<br></td></tr
><tr
id=sl_svn102_117

><td class="source">		actionItemMap[value] = action;<br></td></tr
><tr
id=sl_svn102_118
...
><td class="source">ReturnValue Actions::canUse(const Player* player, const Position&amp; pos)<br></td></tr
><tr
id=sl_svn102_127
...
><td class="source">		if(playerPos.z &gt; pos.z){<br></td></tr
><tr
id=sl_svn102_132
...
><td class="source">		else if(playerPos.z &lt; pos.z){<br></td></tr
><tr
id=sl_svn102_135
...
><td class="source">		else if(!Position::areInRange&lt;1,1,0&gt;(playerPos, pos)){<br></td></tr
><tr
id=sl_svn102_138

><td class="source">			return RET_TOOFARAWAY;<br></td></tr
><tr
id=sl_svn102_139
...
><td class="source">bool Actions::hasAction(const Item* item) const<br></td></tr
><tr
id=sl_svn102_146
...
><td class="source">	return	(getAction(item, ACTION_UNIQUEID) != NULL) ||<br></td></tr
><tr
id=sl_svn102_148

><td class="source">			(getAction(item, ACTION_ACTIONID) != NULL) || <br></td></tr
><tr
id=sl_svn102_149

><td class="source">			(getAction(item, ACTION_ITEMID) != NULL) || <br></td></tr
><tr
id=sl_svn102_150

><td class="source">			(getAction(item, ACTION_RUNEID) != NULL);<br></td></tr
><tr
id=sl_svn102_151
...
><td class="source">ReturnValue Actions::canUse(const Player* player, const Position&amp; pos, const Item* item)<br></td></tr
><tr
id=sl_svn102_154
...
><td class="source">	Action* action = getAction(item, ACTION_UNIQUEID);<br></td></tr
><tr
id=sl_svn102_156
...
><td class="source">		ReturnValue ret = action-&gt;canExecuteAction(player, pos);<br></td></tr
><tr
id=sl_svn102_158
...
><td class="source">	action = getAction(item, ACTION_ACTIONID);<br></td></tr
><tr
id=sl_svn102_166
...
><td class="source">	action = getAction(item, ACTION_ITEMID);<br></td></tr
><tr
id=sl_svn102_176
...
><td class="source">	action = getAction(item, ACTION_RUNEID);<br></td></tr
><tr
id=sl_svn102_186
...
><td class="source">ReturnValue Actions::canUseFar(const Creature* creature, const Position&amp; toPos, bool checkLineOfSight)<br></td></tr
><tr
id=sl_svn102_199
...
><td class="source">	if(creaturePos.z &gt; toPos.z){<br></td></tr
><tr
id=sl_svn102_207
...
><td class="source">	else if(creaturePos.z &lt; toPos.z){<br></td></tr
><tr
id=sl_svn102_210
...
><td class="source">	else if(!Position::areInRange&lt;7,5,0&gt;(toPos, creaturePos)){<br></td></tr
><tr
id=sl_svn102_213
...
><td class="source">	if(checkLineOfSight &amp;&amp; !g_game.canThrowObjectTo(creaturePos, toPos)){<br></td></tr
><tr
id=sl_svn102_217

><td class="source">		return RET_CANNOTTHROW;<br></td></tr
><tr
id=sl_svn102_218
...
><td class="source">Action* Actions::getAction(const Item* item, ActionType_t type /* = ACTION_ANY*/) const<br></td></tr
><tr
id=sl_svn102_224
...
><td class="source">	if(item-&gt;getUniqueId() != 0 &amp;&amp; (type == ACTION_ANY || type == ACTION_UNIQUEID) ){<br></td></tr
><tr
id=sl_svn102_226

><td class="source">		ActionUseMap::const_iterator it = uniqueItemMap.find(item-&gt;getUniqueId());<br></td></tr
><tr
id=sl_svn102_227

><td class="source">		if(it != uniqueItemMap.end()){<br></td></tr
><tr
id=sl_svn102_228
...
><td class="source">	if(item-&gt;getActionId() != 0 &amp;&amp; (type == ACTION_ANY || type == ACTION_ACTIONID)){<br></td></tr
><tr
id=sl_svn102_232

><td class="source">		ActionUseMap::const_iterator it = actionItemMap.find(item-&gt;getActionId());<br></td></tr
><tr
id=sl_svn102_233

><td class="source">		if (it != actionItemMap.end()){<br></td></tr
><tr
id=sl_svn102_234
...
><td class="source">	if(type == ACTION_ANY || type == ACTION_ITEMID){<br></td></tr
><tr
id=sl_svn102_239

><td class="source">		ActionUseMap::const_iterator it = useItemMap.find(item-&gt;getID());<br></td></tr
><tr
id=sl_svn102_240

><td class="source">		if(it != useItemMap.end()){<br></td></tr
><tr
id=sl_svn102_241
...
><td class="source">	if(type == ACTION_ANY || type == ACTION_RUNEID){<br></td></tr
><tr
id=sl_svn102_246

><td class="source">		//rune items<br></td></tr
><tr
id=sl_svn102_247

><td class="source">		Action* runeSpell = g_spells-&gt;getRuneSpell(item-&gt;getID());<br></td></tr
><tr
id=sl_svn102_248

><td class="source">		if(runeSpell){<br></td></tr
><tr
id=sl_svn102_249

><td class="source">			return runeSpell;<br></td></tr
><tr
id=sl_svn102_250
...
><td class="source">bool Actions::executeUse(Action* action, Player* player, Item* item,<br></td></tr
><tr
id=sl_svn102_257
...
><td class="source">	if(!action-&gt;executeUse(player, item, posEx, posEx, false, creatureId)){<br></td></tr
><tr
id=sl_svn102_260
...
><td class="source">ReturnValue Actions::internalUseItem(Player* player, const Position&amp; pos,<br></td></tr
><tr
id=sl_svn102_267
...
><td class="source">	//check if it is a house door<br></td></tr
><tr
id=sl_svn102_270
...
><td class="source">		if(!door-&gt;canUse(player)){<br></td></tr
><tr
id=sl_svn102_272

><td class="source">			return RET_CANNOTUSETHISOBJECT;<br></td></tr
><tr
id=sl_svn102_273
...
><td class="source">	int32_t stack = item-&gt;getParent()-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_277

><td class="source">	PositionEx posEx(pos, stack);<br></td></tr
><tr
id=sl_svn102_278

><td class="source">	bool foundAction = false;<br></td></tr
><tr
id=sl_svn102_279
...
><td class="source">		//only continue with next action in the list if the previous returns false<br></td></tr
><tr
id=sl_svn102_283

><td class="source">		if(executeUse(action, player, item, posEx, creatureId)){<br></td></tr
><tr
id=sl_svn102_284
...
><td class="source">		foundAction = true;<br></td></tr
><tr
id=sl_svn102_287
...
><td class="source">	if(BedItem* bed = item-&gt;getBed()){<br></td></tr
><tr
id=sl_svn102_317

><td class="source">		if(!bed-&gt;canUse(player)){<br></td></tr
><tr
id=sl_svn102_318
...
><td class="source">		bed-&gt;sleep(player);<br></td></tr
><tr
id=sl_svn102_322
...
><td class="source">	//if it is a container try to open it<br></td></tr
><tr
id=sl_svn102_326
...
><td class="source">		Container* openContainer = NULL;<br></td></tr
><tr
id=sl_svn102_329

><td class="source">		//depot container<br></td></tr
><tr
id=sl_svn102_330

><td class="source">		if(Depot* depot = container-&gt;getDepot()){<br></td></tr
><tr
id=sl_svn102_331

><td class="source">			Depot* myDepot = player-&gt;getDepot(depot-&gt;getDepotId(), true);<br></td></tr
><tr
id=sl_svn102_332

><td class="source">			myDepot-&gt;setParent(depot-&gt;getParent());<br></td></tr
><tr
id=sl_svn102_333

><td class="source">			openContainer = myDepot;<br></td></tr
><tr
id=sl_svn102_334
...
><td class="source">			openContainer = container;<br></td></tr
><tr
id=sl_svn102_337
...
><td class="source">		//open/close container<br></td></tr
><tr
id=sl_svn102_340

><td class="source">		int32_t oldcid = player-&gt;getContainerID(openContainer);<br></td></tr
><tr
id=sl_svn102_341

><td class="source">		if(oldcid != -1){<br></td></tr
><tr
id=sl_svn102_342

><td class="source">			player-&gt;onCloseContainer(openContainer);<br></td></tr
><tr
id=sl_svn102_343

><td class="source">			player-&gt;closeContainer(oldcid);<br></td></tr
><tr
id=sl_svn102_344
...
><td class="source">			player-&gt;addContainer(index, openContainer);<br></td></tr
><tr
id=sl_svn102_347

><td class="source">			player-&gt;onSendContainer(openContainer);<br></td></tr
><tr
id=sl_svn102_348
...
><td class="source">	if(item-&gt;isReadable()){<br></td></tr
><tr
id=sl_svn102_354

><td class="source">		if(item-&gt;canWriteText()){<br></td></tr
><tr
id=sl_svn102_355

><td class="source">			player-&gt;setWriteItem(item, item-&gt;getMaxWriteLength());<br></td></tr
><tr
id=sl_svn102_356

><td class="source">			player-&gt;sendTextWindow(item, item-&gt;getMaxWriteLength(), true);<br></td></tr
><tr
id=sl_svn102_357
...
><td class="source">			player-&gt;sendTextWindow(item, 0, false);<br></td></tr
><tr
id=sl_svn102_361
...
><td class="source">	if(foundAction){<br></td></tr
><tr
id=sl_svn102_367
...
><td class="source">bool Actions::useItem(Player* player, const Position&amp; pos, uint8_t index,<br></td></tr
><tr
id=sl_svn102_373
...
><td class="source">	ReturnValue ret = internalUseItem(player, pos, index, item, 0);<br></td></tr
><tr
id=sl_svn102_383
...
><td class="source">	player-&gt;setNextAction(OTSYS_TIME() + g_config.getNumber(ConfigManager::MIN_ACTIONTIME));<br></td></tr
><tr
id=sl_svn102_389
...
><td class="source">bool Actions::executeUseEx(Action* action, Player* player, Item* item, const PositionEx&amp; fromPosEx,<br></td></tr
><tr
id=sl_svn102_393
...
><td class="source">	if(!action-&gt;executeUse(player, item, fromPosEx, toPosEx, true, creatureId)){<br></td></tr
><tr
id=sl_svn102_396
...
><td class="source">ReturnValue Actions::internalUseItemEx(Player* player, const PositionEx&amp; fromPosEx, const PositionEx&amp; toPosEx,<br></td></tr
><tr
id=sl_svn102_403

><td class="source">	Item* item, uint32_t creatureId, bool&amp; isSuccess)<br></td></tr
><tr
id=sl_svn102_404
...
><td class="source">	isSuccess = false;<br></td></tr
><tr
id=sl_svn102_406
...
><td class="source">		ReturnValue ret = action-&gt;canExecuteAction(player, toPosEx);<br></td></tr
><tr
id=sl_svn102_410
...
><td class="source">		isSuccess = executeUseEx(action, player, item, fromPosEx, toPosEx, creatureId);<br></td></tr
><tr
id=sl_svn102_416

><td class="source">		if(isSuccess || action-&gt;hasOwnErrorHandler()){<br></td></tr
><tr
id=sl_svn102_417
...
><td class="source">bool Actions::useItemEx(Player* player, const Position&amp; fromPos, const Position&amp; toPos,<br></td></tr
><tr
id=sl_svn102_468
...
><td class="source">	Action* action = getAction(item);<br></td></tr
><tr
id=sl_svn102_478
...
><td class="source">	int32_t fromStackPos = item-&gt;getParent()-&gt;__getIndexOfThing(item);<br></td></tr
><tr
id=sl_svn102_484

><td class="source">	PositionEx fromPosEx(fromPos, fromStackPos);<br></td></tr
><tr
id=sl_svn102_485

><td class="source">	PositionEx toPosEx(toPos, toStackPos);<br></td></tr
><tr
id=sl_svn102_486
...
><td class="source">    ret = internalUseItemEx(player, fromPosEx, toPosEx, item, creatureId, isSuccess);<br></td></tr
><tr
id=sl_svn102_490
...
><td class="source">	player-&gt;setNextAction(OTSYS_TIME() + g_config.getNumber(ConfigManager::MIN_ACTIONEXTIME));<br></td></tr
><tr
id=sl_svn102_496
...
><td class="source">Action::Action(LuaScriptInterface* _interface) :<br></td></tr
><tr
id=sl_svn102_500
...
><td class="source">	allowFarUse = false;<br></td></tr
><tr
id=sl_svn102_503

><td class="source">	checkLineOfSight = true;<br></td></tr
><tr
id=sl_svn102_504
...
><td class="source">Action::~Action()<br></td></tr
><tr
id=sl_svn102_507
...
><td class="source">bool Action::configureEvent(xmlNodePtr p)<br></td></tr
><tr
id=sl_svn102_512
...
><td class="source">	if(readXMLInteger(p, &quot;allowfaruse&quot;, intValue)){<br></td></tr
><tr
id=sl_svn102_515
...
><td class="source">			setAllowFarUse(true);<br></td></tr
><tr
id=sl_svn102_517
...
><td class="source">	if(readXMLInteger(p, &quot;blockwalls&quot;, intValue)){<br></td></tr
><tr
id=sl_svn102_520
...
><td class="source">			setCheckLineOfSight(false);<br></td></tr
><tr
id=sl_svn102_522
...
><td class="source">std::string Action::getScriptEventName()<br></td></tr
><tr
id=sl_svn102_529
...
><td class="source">	return &quot;onUse&quot;;<br></td></tr
><tr
id=sl_svn102_531
...
><td class="source">ReturnValue Action::canExecuteAction(const Player* player, const Position&amp; toPos)<br></td></tr
><tr
id=sl_svn102_534
...
><td class="source">	if(!getAllowFarUse()){<br></td></tr
><tr
id=sl_svn102_538

><td class="source">		ret = g_actions-&gt;canUse(player, toPos);<br></td></tr
><tr
id=sl_svn102_539
...
><td class="source">		ret = g_actions-&gt;canUseFar(player, toPos, getCheckLineOfSight());<br></td></tr
><tr
id=sl_svn102_545
...
><td class="source">bool Action::executeUse(Player* player, Item* item, const PositionEx&amp; fromPos,<br></td></tr
><tr
id=sl_svn102_554

><td class="source">	const PositionEx&amp; toPos, bool extendedUse, uint32_t creatureId)<br></td></tr
><tr
id=sl_svn102_555
...
><td class="source">	// onUse(cid, item1, position1, item2, position2)<br></td></tr
><tr
id=sl_svn102_557
...
><td class="source">		desc &lt;&lt; player-&gt;getName() &lt;&lt; &quot; - &quot; &lt;&lt; item-&gt;getID() &lt;&lt; &quot; &quot; &lt;&lt; fromPos &lt;&lt; &quot;|&quot; &lt;&lt; toPos;<br></td></tr
><tr
id=sl_svn102_563
...
><td class="source">		uint32_t itemid1 = env-&gt;addThing(item);<br></td></tr
><tr
id=sl_svn102_571
...
><td class="source">		LuaScriptInterface::pushThing(L, item, itemid1);<br></td></tr
><tr
id=sl_svn102_577

><td class="source">		LuaScriptInterface::pushPosition(L, fromPos, fromPos.stackpos);<br></td></tr
><tr
id=sl_svn102_578

><td class="source">		//std::cout &lt;&lt; &quot;posTo&quot; &lt;&lt;  (Position)posTo &lt;&lt; &quot; stack&quot; &lt;&lt; (int)posTo.stackpos &lt;&lt;std::endl;<br></td></tr
><tr
id=sl_svn102_579

><td class="source">		Thing* thing = g_game.internalGetThing(player, toPos, toPos.stackpos);<br></td></tr
><tr
id=sl_svn102_580

><td class="source">		if(thing &amp;&amp; (!extendedUse || thing != item)){<br></td></tr
><tr
id=sl_svn102_581

><td class="source">			uint32_t thingId2 = env-&gt;addThing(thing);<br></td></tr
><tr
id=sl_svn102_582

><td class="source">			LuaScriptInterface::pushThing(L, thing, thingId2);<br></td></tr
><tr
id=sl_svn102_583

><td class="source">			LuaScriptInterface::pushPosition(L, toPos, toPos.stackpos);<br></td></tr
><tr
id=sl_svn102_584
...
><td class="source">			LuaScriptInterface::pushThing(L, NULL, 0);<br></td></tr
><tr
id=sl_svn102_587

><td class="source">			Position posEx;<br></td></tr
><tr
id=sl_svn102_588

><td class="source">			LuaScriptInterface::pushPosition(L, posEx, 0);<br></td></tr
><tr
id=sl_svn102_589
...
><td class="source">		bool result = m_scriptInterface-&gt;callFunction(5);<br></td></tr
><tr
id=sl_svn102_592
...
><td class="source">		std::cout &lt;&lt; &quot;[Error] Call stack overflow. Action::executeUse&quot; &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn102_598
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 28, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=95&amp;format=side&amp;path=/trunk/src/actions.cpp&amp;old_path=/trunk/src/actions.cpp&amp;old=52">Diff</a>
 </div>
...
don't recommend using this revision</pre>
 ...
 var selected_path = '/trunk/src/actions.cpp';
 ...
 by r...@ymail.com
 on Jul 8, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=52&amp;format=side&amp;path=/trunk/src/actions.cpp&amp;old_path=/trunk/src/actions.cpp&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/actions.cpp&amp;old_path=/trunk/src/actions.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/actions.cpp&start=95">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 15183 bytes,
 600 lines</div>
 
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/actions.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/actions.cpp'}
 codereviews = CR_controller.setup(
 {"assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "relativeBaseUrl": "", "token": "ABZ6GAf-02DqWts8afPwdhHTJaYEwwFmNw:1406096204348", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74", "loggedInUserEmail": "jose.guitian@coremain.com", "projectName": "avesta74"}, '', 'svn102', paths,
