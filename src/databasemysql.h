...
<head>
 ...
 var codesite_token = "ABZ6GAcM-2n7167ye3na4BIdAmMlxaZr_w:1406096464260";
 
 
 var CS_env = {"profileUrl": "/u/108692122734644646415/", "domainName": null, "loggedInUserEmail": "jose.guitian@coremain.com", "token": "ABZ6GAcM-2n7167ye3na4BIdAmMlxaZr_w:1406096464260", "projectHomeUrl": "/p/avesta74", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "projectName": "avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fdatabasemysql.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>databasemysql.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/databasemysql.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/databasemysql.h?r=91" title="Previous">&lsaquo;r91</a></li>
...
><td class="source">#ifndef __OTSERV_DATABASEMYSQL_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_DATABASEMYSQL_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">#error &quot;database.h should be included first.&quot;<br></td></tr
><tr
id=sl_svn102_26
...
><td class="source">#include &lt;mysql.h&gt;<br></td></tr
><tr
id=sl_svn102_32
...
><td class="source">#include &lt;mysql/mysql.h&gt;<br></td></tr
><tr
id=sl_svn102_34
...
><td class="source">class DatabaseMySQL : public _Database<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">	DatabaseMySQL();<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	DATABASE_VIRTUAL ~DatabaseMySQL();<br></td></tr
><tr
id=sl_svn102_43
...
><td class="source">	DATABASE_VIRTUAL bool getParam(DBParam_t param);<br></td></tr
><tr
id=sl_svn102_45
...
><td class="source">	DATABASE_VIRTUAL bool beginTransaction();<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	DATABASE_VIRTUAL bool rollback();<br></td></tr
><tr
id=sl_svn102_48

><td class="source">	DATABASE_VIRTUAL bool commit();<br></td></tr
><tr
id=sl_svn102_49
...
><td class="source">	DATABASE_VIRTUAL bool executeQuery(const std::string &amp;query);<br></td></tr
><tr
id=sl_svn102_51

><td class="source">	DATABASE_VIRTUAL DBResult* storeQuery(const std::string &amp;query);<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">	DATABASE_VIRTUAL uint64_t getLastInsertedRowID();<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">	DATABASE_VIRTUAL std::string escapeString(const std::string &amp;s);<br></td></tr
><tr
id=sl_svn102_56

><td class="source">	DATABASE_VIRTUAL std::string escapeBlob(const char* s, uint32_t length);<br></td></tr
><tr
id=sl_svn102_57
...
><td class="source">	DATABASE_VIRTUAL uint64_t getLastInsertId() {return (uint64_t)mysql_insert_id(&amp;m_handle);}<br></td></tr
><tr
id=sl_svn102_61
...
><td class="source">	MYSQL m_handle;<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">class MySQLResult : public _DBResult<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">	friend class DatabaseMySQL;<br></td></tr
><tr
id=sl_svn102_69
...
><td class="source">	DATABASE_VIRTUAL int32_t getDataInt(const std::string &amp;s);<br></td></tr
><tr
id=sl_svn102_72

><td class="source">	DATABASE_VIRTUAL int64_t getDataLong(const std::string &amp;s);<br></td></tr
><tr
id=sl_svn102_73

><td class="source">	DATABASE_VIRTUAL std::string getDataString(const std::string &amp;s);<br></td></tr
><tr
id=sl_svn102_74

><td class="source">	DATABASE_VIRTUAL const char* getDataStream(const std::string &amp;s, unsigned long &amp;size);<br></td></tr
><tr
id=sl_svn102_75
...
><td class="source">	DATABASE_VIRTUAL bool next();<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	MySQLResult(MYSQL_RES* res);<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	DATABASE_VIRTUAL ~MySQLResult();<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">	typedef std::map&lt;const std::string, uint32_t&gt; listNames_t;<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	listNames_t m_listNames;<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">	MYSQL_RES* m_handle;<br></td></tr
><tr
id=sl_svn102_86

><td class="source">	MYSQL_ROW m_row;<br></td></tr
><tr
id=sl_svn102_87
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Sep 29, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=97&amp;format=side&amp;path=/trunk/src/databasemysql.h&amp;old_path=/trunk/src/databasemysql.h&amp;old=91">Diff</a>
 </div>
 <pre>more fixes</pre>
 </div>
 ...
 var selected_path = '/trunk/src/databasemysql.h';
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/databasemysql.h&amp;old_path=/trunk/src/databasemysql.h&amp;old=7">Diff</a>
 <br>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/databasemysql.h&amp;old_path=/trunk/src/databasemysql.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/databasemysql.h&start=97">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/databasemysql.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/databasemysql.h'}
