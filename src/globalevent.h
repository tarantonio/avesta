...
<head>
 ...
 var codesite_token = "ABZ6GAcQt_wA3CauA8jD9OtHvqQDnsJ8Tg:1406096497545";
 
 
 var CS_env = {"loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectName": "avesta74", "token": "ABZ6GAcQt_wA3CauA8jD9OtHvqQDnsJ8Tg:1406096497545", "profileUrl": "/u/108692122734644646415/"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fglobalevent.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>globalevent.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/globalevent.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/globalevent.h?r=75" title="Previous">&lsaquo;r75</a></li>
...
><td class="source">#ifndef __OTSERV_GLOBALEVENT_H__<br></td></tr
><tr
id=sl_svn102_20

><td class="source">#define __OTSERV_GLOBALEVENT_H__<br></td></tr
><tr
id=sl_svn102_21
...
><td class="source">#define TIMER_INTERVAL 1000<br></td></tr
><tr
id=sl_svn102_26
...
><td class="source">enum GlobalEvent_t<br></td></tr
><tr
id=sl_svn102_28
...
><td class="source">	GLOBALEVENT_NONE,<br></td></tr
><tr
id=sl_svn102_30

><td class="source">	GLOBALEVENT_TIMER,<br></td></tr
><tr
id=sl_svn102_31

><td class="source">	GLOBALEVENT_STARTUP,<br></td></tr
><tr
id=sl_svn102_32

><td class="source">	GLOBALEVENT_SHUTDOWN<br></td></tr
><tr
id=sl_svn102_33
...
><td class="source">class GlobalEvent;<br></td></tr
><tr
id=sl_svn102_36

><td class="source">typedef std::map&lt;std::string, GlobalEvent*&gt; GlobalEventMap;<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">class GlobalEvents : public BaseEvents<br></td></tr
><tr
id=sl_svn102_39
...
><td class="source">	GlobalEvents();<br></td></tr
><tr
id=sl_svn102_42

><td class="source">	virtual ~GlobalEvents();<br></td></tr
><tr
id=sl_svn102_43

><td class="source">	void startup();<br></td></tr
><tr
id=sl_svn102_44
...
><td class="source">	void timer();<br></td></tr
><tr
id=sl_svn102_46

><td class="source">	void think();<br></td></tr
><tr
id=sl_svn102_47

><td class="source">	void execute(GlobalEvent_t type);<br></td></tr
><tr
id=sl_svn102_48
...
><td class="source">	GlobalEventMap getEventMap(GlobalEvent_t type);<br></td></tr
><tr
id=sl_svn102_50

><td class="source">	void clearMap(GlobalEventMap&amp; map);<br></td></tr
><tr
id=sl_svn102_51
...
><td class="source">	virtual std::string getScriptBaseName() {return &quot;globalevents&quot;;}<br></td></tr
><tr
id=sl_svn102_54
...
><td class="source">	virtual LuaScriptInterface&amp; getScriptInterface() {return m_scriptInterface;}<br></td></tr
><tr
id=sl_svn102_60
...
><td class="source">	GlobalEventMap thinkMap, serverMap, timerMap;<br></td></tr
><tr
id=sl_svn102_63

><td class="source">	int32_t thinkEventId, timerEventId;<br></td></tr
><tr
id=sl_svn102_64
...
><td class="source">class GlobalEvent : public Event<br></td></tr
><tr
id=sl_svn102_67
...
><td class="source">	GlobalEvent(LuaScriptInterface* _interface);<br></td></tr
><tr
id=sl_svn102_70

><td class="source">	virtual ~GlobalEvent() {}<br></td></tr
><tr
id=sl_svn102_71
...
><td class="source">	uint32_t executeRecord(uint32_t current, uint32_t old);<br></td></tr
><tr
id=sl_svn102_75

><td class="source">	uint32_t executeEvent();<br></td></tr
><tr
id=sl_svn102_76
...
><td class="source">	GlobalEvent_t getEventType() const {return m_eventType;}<br></td></tr
><tr
id=sl_svn102_78

><td class="source">	std::string getName() const {return m_name;}<br></td></tr
><tr
id=sl_svn102_79
...
><td class="source">	uint32_t getInterval() const {return m_interval;}<br></td></tr
><tr
id=sl_svn102_81
...
><td class="source">	int64_t getLastExecution() const {return m_lastExecution;}<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	void setLastExecution(int64_t time) {m_lastExecution = time;}<br></td></tr
><tr
id=sl_svn102_84
...
><td class="source">	time_t getNextExecution() const {return m_nextExecution;}<br></td></tr
><tr
id=sl_svn102_86

><td class="source">	void setNextExecution(time_t time) {m_nextExecution = time;}<br></td></tr
><tr
id=sl_svn102_87
...
><td class="source">	GlobalEvent_t m_eventType;<br></td></tr
><tr
id=sl_svn102_90
...
><td class="source">	time_t m_nextExecution;<br></td></tr
><tr
id=sl_svn102_95

><td class="source">	int64_t m_lastExecution;<br></td></tr
><tr
id=sl_svn102_96

><td class="source">	uint32_t m_interval;<br></td></tr
><tr
id=sl_svn102_97
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/globalevent.h&amp;old_path=/trunk/src/globalevent.h&amp;old=75">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/globalevent.h';
 ...
 by r...@ymail.com
 on Jul 11, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=75&amp;format=side&amp;path=/trunk/src/globalevent.h&amp;old_path=/trunk/src/globalevent.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">global events</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/globalevent.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/globalevent.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/globalevent.h'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": "jose.guitian@coremain.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/avesta74", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectName": "avesta74", "token": "ABZ6GAcQt_wA3CauA8jD9OtHvqQDnsJ8Tg:1406096497545", "profileUrl": "/u/108692122734644646415/"}, '', 'svn102', paths,
