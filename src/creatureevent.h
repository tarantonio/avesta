...
<head>
 ...
 var codesite_token = "ABZ6GAdq1nCB49kkTiS8RsliyYvaonKmzQ:1406096447842";
 
 
 var CS_env = {"domainName": null, "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdq1nCB49kkTiS8RsliyYvaonKmzQ:1406096447842", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Favesta74%2Fsource%2Fbrowse%2Ftrunk%2Fsrc%2Fcreatureevent.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/avesta74/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/avesta74/source/browse/trunk/src/">src</a><span class="sp">/&nbsp;</span>creatureevent.h</span>
 ...
 <a href="/p/avesta74/source/browse/trunk/src/creatureevent.h?edit=1"
 ...
 <li><a href="/p/avesta74/source/browse/trunk/src/creatureevent.h?r=81" title="Previous">&lsaquo;r81</a></li>
...
><td class="source">#ifndef __OTSERV_CREATUREEVENT_H__<br></td></tr
><tr
id=sl_svn102_22

><td class="source">#define __OTSERV_CREATUREEVENT_H__<br></td></tr
><tr
id=sl_svn102_23
...
><td class="source">enum CreatureEventType_t{<br></td></tr
><tr
id=sl_svn102_30

><td class="source">	CREATURE_EVENT_NONE,<br></td></tr
><tr
id=sl_svn102_31

><td class="source">	CREATURE_EVENT_LOGIN,<br></td></tr
><tr
id=sl_svn102_32

><td class="source">	CREATURE_EVENT_LOGOUT,<br></td></tr
><tr
id=sl_svn102_33

><td class="source">	CREATURE_EVENT_DIE,<br></td></tr
><tr
id=sl_svn102_34

><td class="source">	CREATURE_EVENT_KILL,<br></td></tr
><tr
id=sl_svn102_35

><td class="source">	CREATURE_EVENT_ADVANCE,<br></td></tr
><tr
id=sl_svn102_36

><td class="source">	CREATURE_EVENT_LOOK<br></td></tr
><tr
id=sl_svn102_37
...
><td class="source">class CreatureEvent;<br></td></tr
><tr
id=sl_svn102_40
...
><td class="source">class CreatureEvents : public BaseEvents<br></td></tr
><tr
id=sl_svn102_42
...
><td class="source">	CreatureEvents();<br></td></tr
><tr
id=sl_svn102_45

><td class="source">	virtual ~CreatureEvents();<br></td></tr
><tr
id=sl_svn102_46
...
><td class="source">	bool playerLogIn(Player* player);<br></td></tr
><tr
id=sl_svn102_49

><td class="source">	bool playerLogOut(Player* player);<br></td></tr
><tr
id=sl_svn102_50
...
><td class="source">	CreatureEvent* getEventByName(const std::string&amp; name);<br></td></tr
><tr
id=sl_svn102_52
...
><td class="source">	//creature events<br></td></tr
><tr
id=sl_svn102_61

><td class="source">	typedef std::map&lt;std::string, CreatureEvent*&gt; CreatureEventList;<br></td></tr
><tr
id=sl_svn102_62

><td class="source">	CreatureEventList m_creatureEvents;<br></td></tr
><tr
id=sl_svn102_63
...
><td class="source">class CreatureEvent : public Event<br></td></tr
><tr
id=sl_svn102_68
...
><td class="source">	CreatureEvent(LuaScriptInterface* _interface);<br></td></tr
><tr
id=sl_svn102_71

><td class="source">	virtual ~CreatureEvent();<br></td></tr
><tr
id=sl_svn102_72
...
><td class="source">	CreatureEventType_t getEventType() const { return m_type; }<br></td></tr
><tr
id=sl_svn102_76

><td class="source">	const std::string&amp; getName() const { return m_eventName; }<br></td></tr
><tr
id=sl_svn102_77
...
><td class="source">	bool executeOnLogin(Player* player);<br></td></tr
><tr
id=sl_svn102_80

><td class="source">	bool executeOnLogout(Player* player);<br></td></tr
><tr
id=sl_svn102_81

><td class="source">	void executeOnDie(Creature* creature, Item* corpse);<br></td></tr
><tr
id=sl_svn102_82

><td class="source">	void executeOnKill(Creature* creature, Creature* target, bool lastHit);<br></td></tr
><tr
id=sl_svn102_83

><td class="source">	void executeOnAdvance(Player* player, levelTypes_t type, uint32_t oldLevel, uint32_t newLevel);<br></td></tr
><tr
id=sl_svn102_84

><td class="source">	bool executeOnLook(Player* player, Thing* target, uint16_t itemId);<br></td></tr
><tr
id=sl_svn102_85
...
><td class="source">	std::string m_eventName;<br></td></tr
><tr
id=sl_svn102_91

><td class="source">	CreatureEventType_t m_type;<br></td></tr
><tr
id=sl_svn102_92
...
><td class="source">#endif // __OTSERV_CREATUREEVENT_H__<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by r...@ymail.com
 on Jul 17, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=91&amp;format=side&amp;path=/trunk/src/creatureevent.h&amp;old_path=/trunk/src/creatureevent.h&amp;old=81">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/src/creatureevent.h';
 ...
 by r...@ymail.com
 on Jul 14, 2012
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=81&amp;format=side&amp;path=/trunk/src/creatureevent.h&amp;old_path=/trunk/src/creatureevent.h&amp;old=7">Diff</a>
 <br>
...
onLook added</pre>
 ...
 by RSXQ66
 on Jul 23, 2010
 &nbsp; <a href="/p/avesta74/source/diff?spec=svn102&r=7&amp;format=side&amp;path=/trunk/src/creatureevent.h&amp;old_path=/trunk/src/creatureevent.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/avesta74/source/list?path=/trunk/src/creatureevent.h&start=91">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//avesta74.googlecode.com/svn/trunk/src/creatureevent.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn102': '/trunk/src/creatureevent.h'}
 codereviews = CR_controller.setup(
 {"domainName": null, "relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "jose.guitian@coremain.com", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "token": "ABZ6GAdq1nCB49kkTiS8RsliyYvaonKmzQ:1406096447842", "projectName": "avesta74", "profileUrl": "/u/108692122734644646415/", "projectHomeUrl": "/p/avesta74"}, '', 'svn102', paths,
